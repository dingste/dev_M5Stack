# 1 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/wifi_provisioning//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c"
# 15 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c"
...
# 43 "/home/dieter/SoftwareDevelop/esp-idf/components/newlib/include/sys/cdefs.h"
...
# 44 "/home/dieter/SoftwareDevelop/esp-idf/components/newlib/include/sys/cdefs.h" 2
...
# 16 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 2
...
# 24 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 2
...
esp_err_t wifi_prov_scan_handler(uint32_t session_id, const uint8_t *inbuf, ssize_t inlen,
                                 uint8_t **outbuf, ssize_t *outlen, void *priv_data);
# 25 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/include/wifi_provisioning/manager.h" 2
...
# 26 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 2
...
# 27 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 2
...
{
    return (*ctx ? & (*ctx)->wifi_cfg : 
# 37 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 3 4
                                       ((void *)0)
# 37 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c"
                                           );
}
...
static void free_config(wifi_prov_ctx_t **ctx)
{
    free(*ctx);
    *ctx = 
# 50 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 3 4
          ((void *)0)
# 50 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c"
              ;
}
...
static esp_err_t get_status_handler(wifi_prov_config_get_data_t *resp_data, wifi_prov_ctx_t **ctx)
{
    ...
    if (wifi_prov_mgr_get_wifi_state(&resp_data->wifi_state) != 0) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Wi-Fi provisioning manager not running" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Wi-Fi provisioning manager not running" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Wi-Fi provisioning manager not running" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Wi-Fi provisioning manager not running" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Wi-Fi provisioning manager not running" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x103;
    }

    if (resp_data->wifi_state == WIFI_PROV_STA_CONNECTED) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Got state : connected" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Got state : connected" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Got state : connected" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Got state : connected" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Got state : connected" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Got state : disconnected" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Got state : disconnected" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Got state : disconnected" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Got state : disconnected" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Got state : disconnected" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);


        wifi_prov_mgr_get_wifi_disconnect_reason(&resp_data->fail_reason);
    } else {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Got state : connecting" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Got state : connecting" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Got state : connecting" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Got state : connecting" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Got state : connecting" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    }
    return 0;
}
...
static esp_err_t set_config_handler(const wifi_prov_config_set_data_t *req_data, wifi_prov_ctx_t **ctx)
{
    ...
    if (!wifi_cfg) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Unable to allocate Wi-Fi config" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Unable to allocate Wi-Fi config" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Unable to allocate Wi-Fi config" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Unable to allocate Wi-Fi config" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Unable to allocate Wi-Fi config" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x101;
    }

    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Wi-Fi Credentials Received" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Wi-Fi Credentials Received" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Wi-Fi Credentials Received" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Wi-Fi Credentials Received" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Wi-Fi Credentials Received" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
...
static esp_err_t apply_config_handler(wifi_prov_ctx_t **ctx)
{
    wifi_config_t *wifi_cfg = get_config(ctx);
    if (!wifi_cfg) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Wi-Fi config not set" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Wi-Fi config not set" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Wi-Fi config not set" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Wi-Fi config not set" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Wi-Fi config not set" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x103;
    }

    esp_err_t ret = wifi_prov_mgr_configure_sta(wifi_cfg);
    if (ret == 0) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Wi-Fi Credentials Applied" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Wi-Fi Credentials Applied" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Wi-Fi Credentials Applied" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Wi-Fi Credentials Applied" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Wi-Fi Credentials Applied" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    } else {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to apply Wi-Fi Credentials" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to apply Wi-Fi Credentials" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to apply Wi-Fi Credentials" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to apply Wi-Fi Credentials" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to apply Wi-Fi Credentials" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    }
...
esp_err_t get_wifi_prov_handlers(wifi_prov_config_handlers_t *ptr)
{
    ...
    ptr->ctx = 
# 146 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 3 4
              ((void *)0)
# 146 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c"
                  ;
    return 0;
}
...
static esp_err_t scan_start(
# 152 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 3 4
                           _Bool 
# 152 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c"
                                blocking, 
# 152 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 3 4
                                          _Bool 
# 152 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c"
...
static esp_err_t scan_status(
# 159 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 3 4
                            _Bool 
# 159 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c"
                                 *scan_finished,
                             uint16_t *result_count,
                             wifi_prov_scan_ctx_t **ctx)
{
...
esp_err_t get_wifi_scan_handlers(wifi_prov_scan_handlers_t *ptr)
{
    ...
    ptr->ctx = 
# 197 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c" 3 4
              ((void *)0)
# 197 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/handlers.c"
                  ;
    return 0;
}
