# 1 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c"
# 1 "/home/dieter/Development/ProjektEi/build/wifi_provisioning//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c"
# 15 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c"
...
# 16 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 2
...
# 8 "/home/dieter/Development/esp-idf/components/wifi_provisioning/proto-c/wifi_constants.pb-c.h" 2
...
# 21 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 2
# 1 "/home/dieter/Development/esp-idf/components/wifi_provisioning/proto-c/wifi_config.pb-c.h" 1
# 9 "/home/dieter/Development/esp-idf/components/wifi_provisioning/proto-c/wifi_config.pb-c.h"
...
# 22 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 2
...
# 24 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 2
...
# 92 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 3 4
                                      ((void *)0)
# 92 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c"
                                          ) {
                free(resp_payload);
                return 0x101;
            }
...
# 100 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 3 4
                                        ((void *)0)
# 100 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c"
                                            ) {
...
# 108 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 3 4
                                       ((void *)0)
# 108 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c"
                                           ) {
                                        ...
                                        WiFiConfigPayload *resp, void *priv_data)
{
    ...
    if (resp_payload == 
# 146 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 3 4
                       ((void *)0)
# 146 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c"
                           ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x101;
    }
...
# 312 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 3 4
                                      ((void *)0)
# 312 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c"
                                          , inlen, inbuf);
    if (!req) {
...
# 326 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c" 3 4
                                            ((void *)0)
# 326 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_config.c"
                                                );
