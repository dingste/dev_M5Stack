# 1 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
# 1 "/home/dieter/Development/ProjektEi/build/wifi_provisioning//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
# 15 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
...
# 16 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 24 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 90 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 3 4
   _Bool 
# 90 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
        scan_finished = 
# 90 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 3 4
                        0
# 90 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
...
# 120 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 3 4
                              ((void *)0)
# 120 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
                                  ;
    wifi_prov_scan_handlers_t *h = (wifi_prov_scan_handlers_t *) priv_data;
    if (!h) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
...
# 262 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 3 4
                                    ((void *)0)
# 262 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
                                        , inlen, inbuf);
    if (!req) {
...
# 294 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 3 4
                                          ((void *)0)
# 294 "/home/dieter/Development/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
                                              );
