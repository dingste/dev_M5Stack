# 1 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/wifi_provisioning//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
# 15 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
...
# 16 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 20 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 200 "/home/dieter/SoftwareDevelop/esp-idf/components/protobuf-c/protobuf-c/protobuf-c/protobuf-c.h"
# 1 "/home/dieter/SoftwareDevelop/esp-idf/components/newlib/include/limits.h" 1
...
typedef enum _WifiStationState {
  ...
  WIFI_STATION_STATE__ConnectionFailed = 3
    , _WIFI_STATION_STATE_IS_INT_SIZE = 0x7fffffff
} WifiStationState;
typedef enum _WifiConnectFailedReason {
  ...
  WIFI_CONNECT_FAILED_REASON__NetworkNotFound = 1
    , _WIFI_CONNECT_FAILED_REASON_IS_INT_SIZE = 0x7fffffff
...
typedef enum _WifiAuthMode {
  ...
  WIFI_AUTH_MODE__WPA2_ENTERPRISE = 5
    , _WIFI_AUTH_MODE_IS_INT_SIZE = 0x7fffffff
} WifiAuthMode;
...
typedef enum _WiFiScanMsgType {
  ...
  WI_FI_SCAN_MSG_TYPE__TypeRespScanResult = 5
    , _WI_FI_SCAN_MSG_TYPE_IS_INT_SIZE = 0x7fffffff
} WiFiScanMsgType;
...
typedef enum {
  ...
  WI_FI_SCAN_PAYLOAD__PAYLOAD_RESP_SCAN_RESULT = 15
    , _WI_FI_SCAN_PAYLOAD__PAYLOAD_IS_INT_SIZE = 0x7fffffff
...
# 22 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
...
# 24 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 2
                                        ...
                                        WiFiScanPayload *resp, void *priv_data)
{
    ...
    if (!h) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x103;
    }

    RespScanStart *resp_payload = (RespScanStart *) malloc(sizeof(RespScanStart));
    if (!resp_payload) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x101;
    }
...
# 90 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 3 4
   _Bool 
# 90 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
        scan_finished = 
# 90 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 3 4
                        0
# 90 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
    ...
    resp->status = (h->scan_status(&scan_finished, &result_count, &h->ctx) == 0 ?
                            STATUS__Success : STATUS__InternalError);
...
# 120 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 3 4
                              ((void *)0)
# 120 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
                                  ;
    wifi_prov_scan_handlers_t *h = (wifi_prov_scan_handlers_t *) priv_data;
    if (!h) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Command invoked without handlers" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    ...
    if (!results) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to allocate memory for results array" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to allocate memory for results array" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to allocate memory for results array" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to allocate memory for results array" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to allocate memory for results array" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x101;
    }
    ...
    for (uint16_t i = 0; i < req->cmd_scan_result->count; i++) {
        ...
        if (!results[i]) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to allocate memory for result entry" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to allocate memory for result entry" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to allocate memory for result entry" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to allocate memory for result entry" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to allocate memory for result entry" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
            return 0x101;
        }
        ...
        if (!results[i]->ssid.data) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to allocate memory for scan result entry SSID" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to allocate memory for scan result entry SSID" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to allocate memory for scan result entry SSID" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to allocate memory for scan result entry SSID" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to allocate memory for scan result entry SSID" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
            return 0x101;
        }
        ...
        if (!results[i]->bssid.data) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to allocate memory for scan result entry BSSID" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to allocate memory for scan result entry BSSID" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to allocate memory for scan result entry BSSID" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to allocate memory for scan result entry BSSID" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to allocate memory for scan result entry BSSID" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
            return 0x101;
        }
...
static void wifi_prov_scan_cmd_cleanup(WiFiScanPayload *resp, void *priv_data)
{
    switch (resp->msg) {
        ...
        case WI_FI_SCAN_MSG_TYPE__TypeRespScanResult:
            ...
            break;
        default:
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Unsupported response type in cleanup_handler" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Unsupported response type in cleanup_handler" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Unsupported response type in cleanup_handler" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Unsupported response type in cleanup_handler" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Unsupported response type in cleanup_handler" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
            break;
    }
    return;
}
                                               ...
                                               WiFiScanPayload *resp, void *priv_data)
{
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "In wifi_prov_scan_cmd_dispatcher Cmd=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, req->msg); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "In wifi_prov_scan_cmd_dispatcher Cmd=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, req->msg); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "In wifi_prov_scan_cmd_dispatcher Cmd=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, req->msg); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "In wifi_prov_scan_cmd_dispatcher Cmd=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, req->msg); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "In wifi_prov_scan_cmd_dispatcher Cmd=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, req->msg); } } while(0); } while(0);

    int cmd_index = lookup_cmd_handler(req->msg);
    if (cmd_index < 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid command handler lookup" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Invalid command handler lookup" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Invalid command handler lookup" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Invalid command handler lookup" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Invalid command handler lookup" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return -1;
    }

    ret = cmd_table[cmd_index].command_handler(req, resp, priv_data);
    if (ret != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Error executing command handler" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Error executing command handler" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Error executing command handler" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Error executing command handler" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Error executing command handler" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return -1;
    }
                                 ...
                                 uint8_t **outbuf, ssize_t *outlen, void *priv_data)
{
    ...
    req = wi_fi_scan_payload__unpack(
# 262 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 3 4
                                    ((void *)0)
# 262 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
                                        , inlen, inbuf);
    if (!req) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Unable to unpack scan message" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Unable to unpack scan message" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Unable to unpack scan message" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Unable to unpack scan message" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Unable to unpack scan message" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x102;
    }
    ...
    if (ret != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Command dispatcher error %d" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Command dispatcher error %d" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Command dispatcher error %d" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Command dispatcher error %d" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Command dispatcher error %d" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } } while(0); } while(0);
        ret = -1;
        goto exit;
    }
    ...
    *outlen = wi_fi_scan_payload__get_packed_size(&resp);
    if (*outlen <= 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid encoding for response" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Invalid encoding for response" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Invalid encoding for response" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Invalid encoding for response" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Invalid encoding for response" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        ret = -1;
        goto exit;
    }
    ...
    *outbuf = (uint8_t *) malloc(*outlen);
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Response packet size : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, *outlen); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Response packet size : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, *outlen); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Response packet size : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, *outlen); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Response packet size : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, *outlen); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Response packet size : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, *outlen); } } while(0); } while(0);
    exit:

    wi_fi_scan_payload__free_unpacked(req, 
# 294 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c" 3 4
                                          ((void *)0)
# 294 "/home/dieter/SoftwareDevelop/esp-idf/components/wifi_provisioning/src/wifi_scan.c"
                                              );
