...
# 50 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
...
# 54 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
...
# 133 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
static int
...
# 229 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 232 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/ascii.h" 1
# 233 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
# 300 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c" 1
# 134 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c"
static int
normal_scanComment(const ENCODING *enc, const char *ptr, const char *end,
...
static int
normal_scanDecl(const ENCODING *enc, const char *ptr, const char *end,
                 const char **nextTokPtr) {
  { if (! (end - ptr >= 1 * 1)) { return -1; } };
  switch ((((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)])) {
  case BT_MINUS:
...
static int
normal_checkPiTarget(const ENCODING *enc, const char *ptr, const char *end,
                      int *tokPtr) {
  int upper = 0;
  (void)enc;
  *tokPtr = 11;
...
static int
normal_scanPi(const ENCODING *enc, const char *ptr, const char *end,
               const char **nextTokPtr) {
  int tok;
...
static int
normal_scanCdataSection(const ENCODING *enc, const char *ptr, const char *end,
                         const char **nextTokPtr) {
  static const char CDATA_LSQB[]
      = {0x43, 0x44, 0x41, 0x54, 0x41, 0x5B};
  int i;
  (void)enc;
...
static int
normal_cdataSectionTok(const ENCODING *enc, const char *ptr, const char *end,
                        const char **nextTokPtr) {
  if (ptr >= end)
    return -4;
  if (1 > 1) {
...
# 397 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c"
      case BT_LEAD2: if (end - ptr < 2 || (((const struct normal_encoding *)(enc))->isInvalid2(enc, ptr))) { *nextTokPtr = ptr; return 6; } ptr += 2; break;
      case BT_LEAD3: if (end - ptr < 3 || (((const struct normal_encoding *)(enc))->isInvalid3(enc, ptr))) { *nextTokPtr = ptr; return 6; } ptr += 3; break;
      case BT_LEAD4: if (end - ptr < 4 || (((const struct normal_encoding *)(enc))->isInvalid4(enc, ptr))) { *nextTokPtr = ptr; return 6; } ptr += 4; break;
...
static int
normal_scanEndTag(const ENCODING *enc, const char *ptr, const char *end,
                   const char **nextTokPtr) {
  { if (! (end - ptr >= 1 * 1)) { return -1; } };
  switch ((((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)])) {
    case BT_NONASCII: if (! (0)) { *nextTokPtr = ptr; return 0; } case BT_NMSTRT: case BT_HEX: ptr += 1; break; case BT_LEAD2: if (end - ptr < 2) return -2; if (! (((const struct normal_encoding *)(enc))->isNmstrt2(enc, ptr))) { *nextTokPtr = ptr; return 0; } ptr += 2; break; case BT_LEAD3: if (end - ptr < 3) return -2; if (! (((const struct normal_encoding *)(enc))->isNmstrt3(enc, ptr))) { *nextTokPtr = ptr; return 0; } ptr += 3; break; case BT_LEAD4: if (end - ptr < 4) return -2; if (! (((const struct normal_encoding *)(enc))->isNmstrt4(enc, ptr))) { *nextTokPtr = ptr; return 0; } ptr += 4; break;
...
static int
normal_scanHexCharRef(const ENCODING *enc, const char *ptr, const char *end,
                       const char **nextTokPtr) {
  if ((end - ptr >= 1 * 1)) {
    switch ((((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)])) {
    case BT_DIGIT:
...
static int
normal_scanCharRef(const ENCODING *enc, const char *ptr, const char *end,
                    const char **nextTokPtr) {
  if ((end - ptr >= 1 * 1)) {
    if ((*(ptr) == 0x78))
...
normal_scanLt(const ENCODING *enc, const char *ptr, const char *end,
  ...
  case BT_EXCL:
    ...
    case BT_MINUS:
      return normal_scanComment(enc, ptr + 1, end, nextTokPtr);
    case BT_LSQB:
      return normal_scanCdataSection(enc, ptr + 1, end, nextTokPtr);
    }
    *nextTokPtr = ptr;
    return 0;
  case BT_QUEST:
...
normal_contentTok(const ENCODING *enc, const char *ptr, const char *end,
  ...
  while ((end - ptr >= 1 * 1)) {
    switch ((((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)])) {
# 872 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c"
      case BT_LEAD2: if (end - ptr < 2 || (((const struct normal_encoding *)(enc))->isInvalid2(enc, ptr))) { *nextTokPtr = ptr; return 6; } ptr += 2; break;
      case BT_LEAD3: if (end - ptr < 3 || (((const struct normal_encoding *)(enc))->isInvalid3(enc, ptr))) { *nextTokPtr = ptr; return 6; } ptr += 3; break;
      case BT_LEAD4: if (end - ptr < 4 || (((const struct normal_encoding *)(enc))->isInvalid4(enc, ptr))) { *nextTokPtr = ptr; return 6; } ptr += 4; break;
...
static int
normal_scanLit(int open, const ENCODING *enc, const char *ptr, const char *end,
                const char **nextTokPtr) {
  while ((end - ptr >= 1 * 1)) {
...
# 1149 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c"
    case BT_LEAD2: if (end - ptr < 2) return -2; if ((((const struct normal_encoding *)(enc))->isNmstrt2(enc, ptr))) { ptr += 2; tok = 18; break; } if ((((const struct normal_encoding *)(enc))->isName2(enc, ptr))) { ptr += 2; tok = 19; break; } *nextTokPtr = ptr; return 0;
    case BT_LEAD3: if (end - ptr < 3) return -2; if ((((const struct normal_encoding *)(enc))->isNmstrt3(enc, ptr))) { ptr += 3; tok = 18; break; } if ((((const struct normal_encoding *)(enc))->isName3(enc, ptr))) { ptr += 3; tok = 19; break; } *nextTokPtr = ptr; return 0;
    case BT_LEAD4: if (end - ptr < 4) return -2; if ((((const struct normal_encoding *)(enc))->isNmstrt4(enc, ptr))) { ptr += 4; tok = 18; break; } if ((((const struct normal_encoding *)(enc))->isName4(enc, ptr))) { ptr += 4; tok = 19; break; } *nextTokPtr = ptr; return 0;
...
static int
normal_attributeValueTok(const ENCODING *enc, const char *ptr, const char *end,
                          const char **nextTokPtr) {
  const char *start;
  if (ptr >= end)
    return -4;
  ...
  while ((end - ptr >= 1 * 1)) {
    switch ((((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)])) {
      ...
      case BT_LEAD2: ptr += 2; break;
      case BT_LEAD3: ptr += 3; break;
      case BT_LEAD4: ptr += 4; break;
...
static int
normal_entityValueTok(const ENCODING *enc, const char *ptr, const char *end,
                       const char **nextTokPtr) {
  const char *start;
  if (ptr >= end)
    return -4;
  ...
  while ((end - ptr >= 1 * 1)) {
    ...
    case BT_PERCNT:
      if (ptr == start) {
        int tok = normal_scanPercent(enc, ptr + 1, end, nextTokPtr);
        return (tok == 22) ? 0 : tok;
      }
      *nextTokPtr = ptr;
      return 6;
...
static int
normal_ignoreSectionTok(const ENCODING *enc, const char *ptr, const char *end,
                         const char **nextTokPtr) {
  int level = 0;
  if (1 > 1) {
    size_t n = end - ptr;
...
static int
normal_getAtts(const ENCODING *enc, const char *ptr, int attsMax,
                ATTRIBUTE *atts) {
  ...
  for (ptr += 1;; ptr += 1) {
    switch ((((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)])) {
# 1516 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c"
      case BT_LEAD2: if (state == other) { if (nAtts < attsMax) { atts[nAtts].name = ptr; atts[nAtts].normalized = 1; } state = inName; } ptr += (2 - 1); break;
      case BT_LEAD3: if (state == other) { if (nAtts < attsMax) { atts[nAtts].name = ptr; atts[nAtts].normalized = 1; } state = inName; } ptr += (3 - 1); break;
      case BT_LEAD4: if (state == other) { if (nAtts < attsMax) { atts[nAtts].name = ptr; atts[nAtts].normalized = 1; } state = inName; } ptr += (4 - 1); break;
...
static void
normal_updatePosition(const ENCODING *enc, const char *ptr, const char *end,
                       POSITION *pos) {
  while ((end - ptr >= 1 * 1)) {
    switch ((((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)])) {
...
# 301 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
# 313 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
enum {
       UTF8_cval1 = 0x00,
       UTF8_cval2 = 0xc0,
       UTF8_cval3 = 0xe0,
...
# 362 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
 _Bool 
# 362 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
      input_incomplete = 
# 362 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                         0
# 362 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 363 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
 _Bool 
# 363 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
      output_exhausted = 
# 363 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                         0
# 363 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
  ...
  if (bytesAvailable > bytesStorable) {
    ...
    output_exhausted = 
# 371 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                      1
# 371 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                          ;
  }
...

  {
    ...
    if (fromLim < fromLimBefore) {
      input_incomplete = 
# 379 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                        1
# 379 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                            ;
    }
  }
...
# 459 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
...
# 460 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
       },
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/asciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 469 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/utf8tab.h"
           BT_TRAIL, BT_TRAIL, BT_TRAIL, BT_TRAIL,
               ...
               BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               BT_NONXML, BT_NONXML, BT_MALFORM, BT_MALFORM,
# 471 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
       },
       utf8_isName2, utf8_isName3, isNever, utf8_isNmstrt2, utf8_isNmstrt3, isNever, utf8_isInvalid2, utf8_isInvalid3, utf8_isInvalid4};
...
# 34 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/iasciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 480 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/utf8tab.h" 1
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/utf8tab.h"
           BT_TRAIL, BT_TRAIL, BT_TRAIL, BT_TRAIL,
               BT_TRAIL, BT_TRAIL, BT_TRAIL, BT_TRAIL,
               ...
               BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               BT_NONXML, BT_NONXML, BT_MALFORM, BT_MALFORM,
# 481 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
       },
       utf8_isName2, utf8_isName3, isNever, utf8_isNmstrt2, utf8_isNmstrt3, isNever, utf8_isInvalid2, utf8_isInvalid3, utf8_isInvalid4};
...
# 34 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/iasciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 491 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/utf8tab.h"
           BT_TRAIL, BT_TRAIL, BT_TRAIL, BT_TRAIL,
               ...
               BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               BT_NONXML, BT_NONXML, BT_MALFORM, BT_MALFORM,
# 493 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
       },
       utf8_isName2, utf8_isName3, isNever, utf8_isNmstrt2, utf8_isNmstrt3, isNever, utf8_isInvalid2, utf8_isInvalid3, utf8_isInvalid4};
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/asciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 538 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
...
# 540 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                           ((void *)0)
# 540 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                           , 
# 540 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                           ((void *)0)
# 540 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/asciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 549 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/latin1tab.h"
           BT_OTHER, BT_OTHER, BT_OTHER, BT_OTHER,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
# 551 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
       },
       
# 552 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                           ((void *)0)
# 552 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                           , 
# 552 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                           ((void *)0)
# 552 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/asciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 573 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2

       },
       
# 575 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                           ((void *)0)
# 575 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                           , 
# 575 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                           ((void *)0)
# 575 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/asciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 584 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2


       },
       
# 587 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                           ((void *)0)
# 587 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                           , 
# 587 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                           ((void *)0)
# 587 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 717 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
static enum XML_Convert_Result little2_toUtf8( const ENCODING *enc, const char **fromP, const char *fromLim, char **toP, const char *toLim) { const char *from = *fromP; (void)enc; fromLim = from + (((fromLim - from) >> 1) << 1); for (; from < fromLim; from += 2) { int plane; unsigned char lo2; unsigned char lo = ((unsigned char)(from)[0]); unsigned char hi = ((unsigned char)(from)[1]); switch (hi) { case 0: if (lo < 0x80) { if (*toP == toLim) { *fromP = from; return XML_CONVERT_OUTPUT_EXHAUSTED; } *(*toP)++ = lo; break; } case 0x1: case 0x2: case 0x3: case 0x4: case 0x5: case 0x6: case 0x7: if (toLim - *toP < 2) { *fromP = from; return XML_CONVERT_OUTPUT_EXHAUSTED; } *(*toP)++ = ((lo >> 6) | (hi << 2) | UTF8_cval2); *(*toP)++ = ((lo & 0x3f) | 0x80); break; default: if (toLim - *toP < 3) { *fromP = from; return XML_CONVERT_OUTPUT_EXHAUSTED; } *(*toP)++ = ((hi >> 4) | UTF8_cval3); *(*toP)++ = (((hi & 0xf) << 2) | (lo >> 6) | 0x80); *(*toP)++ = ((lo & 0x3f) | 0x80); break; case 0xD8: case 0xD9: case 0xDA: case 0xDB: if (toLim - *toP < 4) { *fromP = from; return XML_CONVERT_OUTPUT_EXHAUSTED; } if (fromLim - from < 4) { *fromP = from; return XML_CONVERT_INPUT_INCOMPLETE; } plane = (((hi & 0x3) << 2) | ((lo >> 6) & 0x3)) + 1; *(*toP)++ = (char)((plane >> 2) | UTF8_cval4); *(*toP)++ = (((lo >> 2) & 0xF) | ((plane & 0x3) << 4) | 0x80); from += 2; lo2 = ((unsigned char)(from)[0]); *(*toP)++ = (((lo & 0x3) << 4) | ((((unsigned char)(from)[1]) & 0x3) << 2) | (lo2 >> 6) | 0x80); *(*toP)++ = ((lo2 & 0x3f) | 0x80); break; } } *fromP = from; if (from < fromLim) return XML_CONVERT_INPUT_INCOMPLETE; else return XML_CONVERT_COMPLETED; }
static enum XML_Convert_Result little2_toUtf16( const ENCODING *enc, const char **fromP, const char *fromLim, unsigned short **toP, const unsigned short *toLim) { enum XML_Convert_Result res = XML_CONVERT_COMPLETED; (void)enc; fromLim = *fromP + (((fromLim - *fromP) >> 1) << 1); if (fromLim - *fromP > ((toLim - *toP) << 1) && (((unsigned char)(fromLim - 2)[1]) & 0xF8) == 0xD8) { fromLim -= 2; res = XML_CONVERT_INPUT_INCOMPLETE; } for (; *fromP < fromLim && *toP < toLim; *fromP += 2) *(*toP)++ = (((unsigned char)(*fromP)[1]) << 8) | ((unsigned char)(*fromP)[0]); if ((*toP == toLim) && (*fromP < fromLim)) return XML_CONVERT_OUTPUT_EXHAUSTED; else return res; }
# 728 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
static enum XML_Convert_Result big2_toUtf8( const ENCODING *enc, const char **fromP, const char *fromLim, char **toP, const char *toLim) { const char *from = *fromP; (void)enc; fromLim = from + (((fromLim - from) >> 1) << 1); for (; from < fromLim; from += 2) { int plane; unsigned char lo2; unsigned char lo = ((unsigned char)(from)[1]); unsigned char hi = ((unsigned char)(from)[0]); switch (hi) { case 0: if (lo < 0x80) { if (*toP == toLim) { *fromP = from; return XML_CONVERT_OUTPUT_EXHAUSTED; } *(*toP)++ = lo; break; } case 0x1: case 0x2: case 0x3: case 0x4: case 0x5: case 0x6: case 0x7: if (toLim - *toP < 2) { *fromP = from; return XML_CONVERT_OUTPUT_EXHAUSTED; } *(*toP)++ = ((lo >> 6) | (hi << 2) | UTF8_cval2); *(*toP)++ = ((lo & 0x3f) | 0x80); break; default: if (toLim - *toP < 3) { *fromP = from; return XML_CONVERT_OUTPUT_EXHAUSTED; } *(*toP)++ = ((hi >> 4) | UTF8_cval3); *(*toP)++ = (((hi & 0xf) << 2) | (lo >> 6) | 0x80); *(*toP)++ = ((lo & 0x3f) | 0x80); break; case 0xD8: case 0xD9: case 0xDA: case 0xDB: if (toLim - *toP < 4) { *fromP = from; return XML_CONVERT_OUTPUT_EXHAUSTED; } if (fromLim - from < 4) { *fromP = from; return XML_CONVERT_INPUT_INCOMPLETE; } plane = (((hi & 0x3) << 2) | ((lo >> 6) & 0x3)) + 1; *(*toP)++ = (char)((plane >> 2) | UTF8_cval4); *(*toP)++ = (((lo >> 2) & 0xF) | ((plane & 0x3) << 4) | 0x80); from += 2; lo2 = ((unsigned char)(from)[1]); *(*toP)++ = (((lo & 0x3) << 4) | ((((unsigned char)(from)[0]) & 0x3) << 2) | (lo2 >> 6) | 0x80); *(*toP)++ = ((lo2 & 0x3f) | 0x80); break; } } *fromP = from; if (from < fromLim) return XML_CONVERT_INPUT_INCOMPLETE; else return XML_CONVERT_COMPLETED; }
static enum XML_Convert_Result big2_toUtf16( const ENCODING *enc, const char **fromP, const char *fromLim, unsigned short **toP, const unsigned short *toLim) { enum XML_Convert_Result res = XML_CONVERT_COMPLETED; (void)enc; fromLim = *fromP + (((fromLim - *fromP) >> 1) << 1); if (fromLim - *fromP > ((toLim - *toP) << 1) && (((unsigned char)(fromLim - 2)[0]) & 0xF8) == 0xD8) { fromLim -= 2; res = XML_CONVERT_INPUT_INCOMPLETE; } for (; *fromP < fromLim && *toP < toLim; *fromP += 2) *(*toP)++ = (((unsigned char)(*fromP)[0]) << 8) | ((unsigned char)(*fromP)[1]); if ((*toP == toLim) && (*fromP < fromLim)) return XML_CONVERT_OUTPUT_EXHAUSTED; else return res; }
# 794 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c" 1
# 134 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c"
static int
little2_scanComment(const ENCODING *enc, const char *ptr, const char *end,
                    const char **nextTokPtr) {
  if ((end - ptr >= 1 * 2)) {
...
static int
little2_scanDecl(const ENCODING *enc, const char *ptr, const char *end,
                 const char **nextTokPtr) {
  { if (! (end - ptr >= 1 * 2)) { return -1; } };
  switch (((ptr)[1] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)] : unicode_byte_type((ptr)[1], (ptr)[0]))) {
  case BT_MINUS:
...
static int
little2_checkPiTarget(const ENCODING *enc, const char *ptr, const char *end,
                      int *tokPtr) {
  int upper = 0;
  (void)enc;
  *tokPtr = 11;
...
static int
little2_scanPi(const ENCODING *enc, const char *ptr, const char *end,
               const char **nextTokPtr) {
  int tok;
  const char *target = ptr;
  { if (! (end - ptr >= 1 * 2)) { return -1; } };
...
static int
little2_scanCdataSection(const ENCODING *enc, const char *ptr, const char *end,
                         const char **nextTokPtr) {
  static const char CDATA_LSQB[]
      = {0x43, 0x44, 0x41, 0x54, 0x41, 0x5B};
  int i;
...
static int
little2_cdataSectionTok(const ENCODING *enc, const char *ptr, const char *end,
                        const char **nextTokPtr) {
  if (ptr >= end)
    return -4;
  if (2 > 1) {
  ...
  while ((end - ptr >= 1 * 2)) {
    switch (((ptr)[1] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)] : unicode_byte_type((ptr)[1], (ptr)[0]))) {
# 397 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c"
      case BT_LEAD2: if (end - ptr < 2 || (0)) { *nextTokPtr = ptr; return 6; } ptr += 2; break;
      case BT_LEAD3: if (end - ptr < 3 || (0)) { *nextTokPtr = ptr; return 6; } ptr += 3; break;
      case BT_LEAD4: if (end - ptr < 4 || (0)) { *nextTokPtr = ptr; return 6; } ptr += 4; break;
...
static int
little2_scanEndTag(const ENCODING *enc, const char *ptr, const char *end,
                   const char **nextTokPtr) {
  { if (! (end - ptr >= 1 * 2)) { return -1; } };
  switch (((ptr)[1] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)] : unicode_byte_type((ptr)[1], (ptr)[0]))) {
    case BT_NONASCII: if (! (namingBitmap[(nmstrtPages[(unsigned char)ptr[1]] << 3) + (((unsigned char)ptr[0]) >> 5)] & (1u << (((unsigned char)ptr[0])&0x1F)))) { *nextTokPtr = ptr; return 0; } case BT_NMSTRT: case BT_HEX: ptr += 2; break; case BT_LEAD2: if (end - ptr < 2) return -2; if (! (0)) { *nextTokPtr = ptr; return 0; } ptr += 2; break; case BT_LEAD3: if (end - ptr < 3) return -2; if (! (0)) { *nextTokPtr = ptr; return 0; } ptr += 3; break; case BT_LEAD4: if (end - ptr < 4) return -2; if (! (0)) { *nextTokPtr = ptr; return 0; } ptr += 4; break;
...
static int
little2_scanHexCharRef(const ENCODING *enc, const char *ptr, const char *end,
                       const char **nextTokPtr) {
  if ((end - ptr >= 1 * 2)) {
    switch (((ptr)[1] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)] : unicode_byte_type((ptr)[1], (ptr)[0]))) {
    case BT_DIGIT:
...
static int
little2_scanCharRef(const ENCODING *enc, const char *ptr, const char *end,
                    const char **nextTokPtr) {
  if ((end - ptr >= 1 * 2)) {
...
little2_scanLt(const ENCODING *enc, const char *ptr, const char *end,
  ...
  case BT_EXCL:
    ...
    case BT_MINUS:
      return little2_scanComment(enc, ptr + 2, end, nextTokPtr);
    case BT_LSQB:
      return little2_scanCdataSection(enc, ptr + 2, end, nextTokPtr);
    }
    *nextTokPtr = ptr;
    return 0;
  case BT_QUEST:
...
static int
little2_scanLit(int open, const ENCODING *enc, const char *ptr, const char *end,
                const char **nextTokPtr) {
  while ((end - ptr >= 1 * 2)) {
...
# 1149 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c"
    case BT_LEAD2: if (end - ptr < 2) return -2; if ((0)) { ptr += 2; tok = 18; break; } if (0) { ptr += 2; tok = 19; break; } *nextTokPtr = ptr; return 0;
    case BT_LEAD3: if (end - ptr < 3) return -2; if ((0)) { ptr += 3; tok = 18; break; } if (0) { ptr += 3; tok = 19; break; } *nextTokPtr = ptr; return 0;
    case BT_LEAD4: if (end - ptr < 4) return -2; if ((0)) { ptr += 4; tok = 18; break; } if (0) { ptr += 4; tok = 19; break; } *nextTokPtr = ptr; return 0;
...
static int
little2_attributeValueTok(const ENCODING *enc, const char *ptr, const char *end,
                          const char **nextTokPtr) {
  const char *start;
  if (ptr >= end)
    return -4;
...
static int
little2_entityValueTok(const ENCODING *enc, const char *ptr, const char *end,
                       const char **nextTokPtr) {
  const char *start;
  if (ptr >= end)
    return -4;
  ...
  while ((end - ptr >= 1 * 2)) {
    ...
    case BT_PERCNT:
      if (ptr == start) {
        int tok = little2_scanPercent(enc, ptr + 2, end, nextTokPtr);
        return (tok == 22) ? 0 : tok;
      }
      *nextTokPtr = ptr;
      return 6;
...
static int
little2_ignoreSectionTok(const ENCODING *enc, const char *ptr, const char *end,
                         const char **nextTokPtr) {
  int level = 0;
  if (2 > 1) {
    size_t n = end - ptr;
...
static int
little2_getAtts(const ENCODING *enc, const char *ptr, int attsMax,
                ATTRIBUTE *atts) {
  enum { other, inName, inValue } state = inName;
  int nAtts = 0;
  int open = 0;
  ...
  for (ptr += 2;; ptr += 2) {
    switch (((ptr)[1] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)] : unicode_byte_type((ptr)[1], (ptr)[0]))) {
# 1516 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c"
      case BT_LEAD2: if (state == other) { if (nAtts < attsMax) { atts[nAtts].name = ptr; atts[nAtts].normalized = 1; } state = inName; } ptr += (2 - 2); break;
      case BT_LEAD3: if (state == other) { if (nAtts < attsMax) { atts[nAtts].name = ptr; atts[nAtts].normalized = 1; } state = inName; } ptr += (3 - 2); break;
      case BT_LEAD4: if (state == other) { if (nAtts < attsMax) { atts[nAtts].name = ptr; atts[nAtts].normalized = 1; } state = inName; } ptr += (4 - 2); break;
...
static void
little2_updatePosition(const ENCODING *enc, const char *ptr, const char *end,
                       POSITION *pos) {
  while ((end - ptr >= 1 * 2)) {
    switch (((ptr)[1] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)] : unicode_byte_type((ptr)[1], (ptr)[0]))) {
...
# 795 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
# 811 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/asciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 821 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/latin1tab.h" 1
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/latin1tab.h"
           BT_OTHER, BT_OTHER, BT_OTHER, BT_OTHER,
               BT_OTHER, BT_OTHER, BT_OTHER, BT_OTHER,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
# 822 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
       },
       
# 823 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                                ((void *)0)
# 823 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                                , 
# 823 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                                ((void *)0)
# 823 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/asciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 838 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/latin1tab.h"
           BT_OTHER, BT_OTHER, BT_OTHER, BT_OTHER,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
# 840 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
       },
       
# 841 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                                ((void *)0)
# 841 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                                , 
# 841 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                                ((void *)0)
# 841 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 34 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/iasciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 851 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/latin1tab.h" 1
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/latin1tab.h"
           BT_OTHER, BT_OTHER, BT_OTHER, BT_OTHER,
               BT_OTHER, BT_OTHER, BT_OTHER, BT_OTHER,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
# 852 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
       },
       
# 853 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                                ((void *)0)
# 853 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                                , 
# 853 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                                ((void *)0)
# 853 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 34 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/iasciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 862 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/latin1tab.h"
           BT_OTHER, BT_OTHER, BT_OTHER, BT_OTHER,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
# 864 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
       },
       
# 865 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                                ((void *)0)
# 865 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                                , 
# 865 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                                ((void *)0)
# 865 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 929 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c" 1
# 134 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_impl.c"
static int
big2_scanComment(const ENCODING *enc, const char *ptr, const char *end,
                    const char **nextTokPtr) {
  if ((end - ptr >= 1 * 2)) {
...
static int
big2_scanDecl(const ENCODING *enc, const char *ptr, const char *end,
                 const char **nextTokPtr) {
  { if (! (end - ptr >= 1 * 2)) { return -1; } };
  switch (((ptr)[0] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)(ptr)[1]] : unicode_byte_type((ptr)[0], (ptr)[1]))) {
  case BT_MINUS:
...
static int
big2_checkPiTarget(const ENCODING *enc, const char *ptr, const char *end,
                      int *tokPtr) {
  int upper = 0;
  (void)enc;
  *tokPtr = 11;
...
static int
big2_scanPi(const ENCODING *enc, const char *ptr, const char *end,
               const char **nextTokPtr) {
  int tok;
  const char *target = ptr;
  { if (! (end - ptr >= 1 * 2)) { return -1; } };
...
static int
big2_scanCdataSection(const ENCODING *enc, const char *ptr, const char *end,
                         const char **nextTokPtr) {
  static const char CDATA_LSQB[]
      = {0x43, 0x44, 0x41, 0x54, 0x41, 0x5B};
  int i;
...
static int
big2_cdataSectionTok(const ENCODING *enc, const char *ptr, const char *end,
                        const char **nextTokPtr) {
  if (ptr >= end)
    return -4;
  if (2 > 1) {
...
static int
big2_scanEndTag(const ENCODING *enc, const char *ptr, const char *end,
                   const char **nextTokPtr) {
  { if (! (end - ptr >= 1 * 2)) { return -1; } };
  switch (((ptr)[0] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)(ptr)[1]] : unicode_byte_type((ptr)[0], (ptr)[1]))) {
    case BT_NONASCII: if (! (namingBitmap[(nmstrtPages[(unsigned char)ptr[0]] << 3) + (((unsigned char)ptr[1]) >> 5)] & (1u << (((unsigned char)ptr[1])&0x1F)))) { *nextTokPtr = ptr; return 0; } case BT_NMSTRT: case BT_HEX: ptr += 2; break; case BT_LEAD2: if (end - ptr < 2) return -2; if (! (0)) { *nextTokPtr = ptr; return 0; } ptr += 2; break; case BT_LEAD3: if (end - ptr < 3) return -2; if (! (0)) { *nextTokPtr = ptr; return 0; } ptr += 3; break; case BT_LEAD4: if (end - ptr < 4) return -2; if (! (0)) { *nextTokPtr = ptr; return 0; } ptr += 4; break;
...
static int
big2_scanHexCharRef(const ENCODING *enc, const char *ptr, const char *end,
                       const char **nextTokPtr) {
  if ((end - ptr >= 1 * 2)) {
    switch (((ptr)[0] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)(ptr)[1]] : unicode_byte_type((ptr)[0], (ptr)[1]))) {
    case BT_DIGIT:
...
static int
big2_scanCharRef(const ENCODING *enc, const char *ptr, const char *end,
                    const char **nextTokPtr) {
  if ((end - ptr >= 1 * 2)) {
...
big2_scanLt(const ENCODING *enc, const char *ptr, const char *end,
  ...
  case BT_EXCL:
    ...
    case BT_MINUS:
      return big2_scanComment(enc, ptr + 2, end, nextTokPtr);
    case BT_LSQB:
      return big2_scanCdataSection(enc, ptr + 2, end, nextTokPtr);
    }
    *nextTokPtr = ptr;
    return 0;
  case BT_QUEST:
...
static int
big2_scanLit(int open, const ENCODING *enc, const char *ptr, const char *end,
                const char **nextTokPtr) {
  while ((end - ptr >= 1 * 2)) {
...
static int
big2_attributeValueTok(const ENCODING *enc, const char *ptr, const char *end,
                          const char **nextTokPtr) {
  const char *start;
  if (ptr >= end)
    return -4;
...
static int
big2_entityValueTok(const ENCODING *enc, const char *ptr, const char *end,
                       const char **nextTokPtr) {
  const char *start;
  if (ptr >= end)
    return -4;
  ...
  while ((end - ptr >= 1 * 2)) {
    ...
    case BT_PERCNT:
      if (ptr == start) {
        int tok = big2_scanPercent(enc, ptr + 2, end, nextTokPtr);
        return (tok == 22) ? 0 : tok;
      }
      *nextTokPtr = ptr;
      return 6;
...
static int
big2_ignoreSectionTok(const ENCODING *enc, const char *ptr, const char *end,
                         const char **nextTokPtr) {
  int level = 0;
  if (2 > 1) {
    size_t n = end - ptr;
...
static int
big2_getAtts(const ENCODING *enc, const char *ptr, int attsMax,
                ATTRIBUTE *atts) {
  enum { other, inName, inValue } state = inName;
  int nAtts = 0;
  int open = 0;
...
static void
big2_updatePosition(const ENCODING *enc, const char *ptr, const char *end,
                       POSITION *pos) {
  while ((end - ptr >= 1 * 2)) {
    switch (((ptr)[0] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)(ptr)[1]] : unicode_byte_type((ptr)[0], (ptr)[1]))) {
...
# 930 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
# 946 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/asciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 956 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/latin1tab.h" 1
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/latin1tab.h"
           BT_OTHER, BT_OTHER, BT_OTHER, BT_OTHER,
               BT_OTHER, BT_OTHER, BT_OTHER, BT_OTHER,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
# 957 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
       },
       
# 958 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                             ((void *)0)
# 958 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                             , 
# 958 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                             ((void *)0)
# 958 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/asciitab.h"
           BT_NONXML, BT_NONXML, BT_NONXML, BT_NONXML,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_OTHER,
               BT_VERBAR, BT_OTHER, BT_OTHER, BT_OTHER,
# 973 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/latin1tab.h"
           BT_OTHER, BT_OTHER, BT_OTHER, BT_OTHER,
               ...
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
               BT_NMSTRT, BT_NMSTRT, BT_NMSTRT, BT_NMSTRT,
# 975 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
       },
       
# 976 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                             ((void *)0)
# 976 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                             , 
# 976 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                             ((void *)0)
# 976 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
...
# 1006 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
static int
...
parsePseudoAttribute(const ENCODING *enc, const char *ptr, const char *end,
  ...
  if (ptr == end) {
    *namePtr = 
# 1067 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
              ((void *)0)
# 1067 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                  ;
    return 1;
  }
  ...
  if (ptr == end) {
    *namePtr = 
# 1078 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
              ((void *)0)
# 1078 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                  ;
    return 1;
  }
  *namePtr = ptr;
...
static const char KW_encoding[] = {0x65, 0x6E, 0x63, 0x6F, 0x64,
                                   0x69, 0x6E, 0x67, '\0'};
...
doParseXmlDecl(const ENCODING *(*encodingFinder)(const ENCODING *, const char *,
  ...
  const char *val = 
# 1158 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                   ((void *)0)
# 1158 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                       ;
  const char *name = 
# 1159 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                    ((void *)0)
# 1159 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                        ;
  const char *nameEnd = 
# 1160 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
                       ((void *)0)
# 1160 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                           ;
...
getEncodingIndex(const char *name) {
  ...
  int i;
  if (name == 
# 1509 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 3 4
             ((void *)0)
# 1509 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
                 )
    return NO_ENC;
...
# 1531 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
static int
initScan(const ENCODING *const *encodingTable, const INIT_ENCODING *enc,
  ...
  encPtr = enc->encPtr;
  if (ptr + 1 == end) {
# 1548 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
    ...
    case 0xFF:
    case 0xEF:
      if (((int)(enc)->initEnc.isUtf16) == ISO_8859_1_ENC && state == 1)
        break;
...
# 1631 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
        if (state == 1)
          break;
        *encPtr = encodingTable[UTF_16LE_ENC];
        return (((*encPtr)->scanners[state])(*encPtr, ptr, end, nextTokPtr));
...
static const ENCODING *const encodings[] = {
    &latin1_encoding.enc, &ascii_encoding.enc,
    &utf8_encoding.enc, &big2_encoding.enc,
    &big2_encoding.enc, &little2_encoding.enc,
    &utf8_encoding.enc
};
...
initScanProlog(const ENCODING *enc, const char *ptr, const char *end,
                   const char **nextTokPtr) {
  return initScan(encodings, (const INIT_ENCODING *)enc, 0,
                  ptr, end, nextTokPtr);
}
...
initScanContent(const ENCODING *enc, const char *ptr, const char *end,
                    const char **nextTokPtr) {
  return initScan(encodings, (const INIT_ENCODING *)enc, 1,
                  ptr, end, nextTokPtr);
}
...
int
XmlParseXmlDecl(int isGeneralTextEntity, const ENCODING *enc,
                    const char *ptr, const char *end, const char **badPtr,
                    const char **versionPtr, const char **versionEndPtr,
                    const char **encodingName, const ENCODING **encoding,
                    int *standalone) {
  return doParseXmlDecl(findEncoding, isGeneralTextEntity, enc, ptr, end,
                        badPtr, versionPtr, versionEndPtr, encodingName,
                        encoding, standalone);
}
# 1647 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
# 1657 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_ns.c" 1
# 35 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok_ns.c"
const ENCODING *
...
static const ENCODING *const encodingsNS[] = {
    &latin1_encoding_ns.enc, &ascii_encoding_ns.enc,
    &utf8_encoding_ns.enc, &big2_encoding_ns.enc,
    &big2_encoding_ns.enc, &little2_encoding_ns.enc,
...
initScanPrologNS(const ENCODING *enc, const char *ptr, const char *end,
                   const char **nextTokPtr) {
  return initScan(encodingsNS, (const INIT_ENCODING *)enc, 0,
                  ptr, end, nextTokPtr);
}
...
initScanContentNS(const ENCODING *enc, const char *ptr, const char *end,
                    const char **nextTokPtr) {
  return initScan(encodingsNS, (const INIT_ENCODING *)enc, 1,
                  ptr, end, nextTokPtr);
}
...
int
XmlParseXmlDeclNS(int isGeneralTextEntity, const ENCODING *enc,
                    const char *ptr, const char *end, const char **badPtr,
                    const char **versionPtr, const char **versionEndPtr,
                    const char **encodingName, const ENCODING **encoding,
                    int *standalone) {
  return doParseXmlDecl(findEncodingNS, isGeneralTextEntity, enc, ptr, end,
                        badPtr, versionPtr, versionEndPtr, encodingName,
                        encoding, standalone);
}
# 1658 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/expat/expat/expat/lib/xmltok.c" 2
