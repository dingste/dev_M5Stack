# 1 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/efuse//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c"
# 15 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c"
...
# 16 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c" 2
...
# 25 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c" 2
# 1 "/home/dieter/SoftwareDevelop/esp-idf/components/bootloader_support/include/bootloader_random.h" 1
# 15 "/home/dieter/SoftwareDevelop/esp-idf/components/bootloader_support/include/bootloader_random.h"
       

# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/xtensa/lib/gcc/xtensa-esp32-elf/5.2.0/include/stddef.h" 1 3 4
# 18 "/home/dieter/SoftwareDevelop/esp-idf/components/bootloader_support/include/bootloader_random.h" 2
# 33 "/home/dieter/SoftwareDevelop/esp-idf/components/bootloader_support/include/bootloader_random.h"
...
# 26 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c" 2
# 1 "/home/dieter/SoftwareDevelop/esp-idf/components/soc/esp32/include/soc/apb_ctrl_reg.h" 1
# 27 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c" 2
...
uint8_t esp_efuse_get_chip_ver(void)
{
    ...
    eco_bit2 = (({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff66000 + 0x7C))) >= 0x3ff00000) && (((0x3ff66000 + 0x7C))) <= 0x3ff13FFC)), (!(((((0x3ff66000 + 0x7C))) >= 0x3ff00000) && (((0x3ff66000 + 0x7C))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff66000 + 0x7C))) >= 0x3ff00000) && (((0x3ff66000 + 0x7C))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c", 38, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff66000 + 0x7C))) >= 0x3ff00000) && (((0x3ff66000 + 0x7C))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff66000 + 0x7C))); }) & 0x80000000) >> 31;
...
void esp_efuse_disable_basic_rom_console(void)
{
    if (esp_efuse_write_field_cnt(ESP_EFUSE_CONSOLE_DEBUG_DISABLE, 1) == 0) {
        do { if (3 >= ESP_LOG_INFO) { ets_printf("\033[0;" "32" "m" "I" " (%d) %s: " "Disable BASIC ROM Console fallback via efuse..." "\033[0m" "\n", esp_log_timestamp(), TAG); }} while(0);
    }
}
...
{
    if (in_bytes == 
# 91 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c" 3 4
                   ((void *)0) 
# 91 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c"
                        || out_words == 
# 91 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c" 3 4
                                        ((void *)0) 
# 91 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c"
...
void esp_efuse_write_random_key(uint32_t blk_wdata0_reg)
{
    uint32_t buf[8];
    uint8_t raw[24];
    uint32_t coding_scheme = ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c", 122, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x018))); }) & ((0x3)<<(0));
    ...
    if (coding_scheme == 0x0) {
        ...
        (void) r;
        ((r == 0) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c", 130, __func__, "r == ESP_OK"));
    }

    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Writing random values to address 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, blk_wdata0_reg); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Writing random values to address 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, blk_wdata0_reg); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Writing random values to address 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, blk_wdata0_reg); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Writing random values to address 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, blk_wdata0_reg); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Writing random values to address 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, blk_wdata0_reg); } } while(0); } while(0);
    for (int i = 0; i < 8; i++) {
        do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "EFUSE_BLKx_WDATA%d_REG = 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, i, buf[i]); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "EFUSE_BLKx_WDATA%d_REG = 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, i, buf[i]); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "EFUSE_BLKx_WDATA%d_REG = 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, i, buf[i]); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "EFUSE_BLKx_WDATA%d_REG = 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, i, buf[i]); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "EFUSE_BLKx_WDATA%d_REG = 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, i, buf[i]); } } while(0); } while(0);
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((blk_wdata0_reg + 4 * i)) >= 0x3ff00000) && ((blk_wdata0_reg + 4 * i)) <= 0x3ff13FFC)), (!((((blk_wdata0_reg + 4 * i)) >= 0x3ff00000) && ((blk_wdata0_reg + 4 * i)) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!((((blk_wdata0_reg + 4 * i)) >= 0x3ff00000) && ((blk_wdata0_reg + 4 * i)) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c", 136, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!((((blk_wdata0_reg + 4 * i)) >= 0x3ff00000) && ((blk_wdata0_reg + 4 * i)) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)(blk_wdata0_reg + 4 * i)) = (buf[i]); });
    }
    bzero(buf, sizeof(buf));
    bzero(raw, sizeof(raw));
}
# 195 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c"
uint32_t esp_efuse_read_secure_version()
{
# 208 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c"
    return 0;

}
# 225 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c"

# 225 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c" 3 4
_Bool 
# 225 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c"
    esp_efuse_check_secure_version(uint32_t secure_version)
{
...
esp_err_t esp_efuse_update_secure_version(uint32_t secure_version)
{
# 259 "/home/dieter/SoftwareDevelop/esp-idf/components/efuse/src/esp_efuse_fields.c"
    return 0;
}
