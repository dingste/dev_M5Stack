# 1 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c"
# 1 "/home/dieter/Development/ProjektEi/build/efuse//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c"
# 15 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c"
...
# 16 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c" 2
...
# 21 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c" 2
...
esp_efuse_coding_scheme_t esp_efuse_get_coding_scheme(esp_efuse_block_t blk)
{
    ...
    if (blk == EFUSE_BLK0) {
        ...
        uint32_t coding_scheme = ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), 1), "(Cannot use REG_GET_FIELD for DPORT registers use DPORT_REG_GET_FIELD)"); 
# 57 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c" 3 4
                                ((
# 57 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c"
                                "(Cannot use REG_GET_FIELD for DPORT registers use DPORT_REG_GET_FIELD)" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))
# 57 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c" 3 4
                                ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c", 57, __func__, 
# 57 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c"
                                "\"(Cannot use REG_GET_FIELD for DPORT registers use DPORT_REG_GET_FIELD)\" && (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC))"
# 57 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c" 3 4
                                ))
# 57 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c"
                                ; } while(0);; ((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x018))) >= 0x3ff00000) && (((0x3ff5A000 + 0x018))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); 
# 57 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c" 3 4
                                ((
# 57 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c"
...
# 57 "/home/dieter/Development/esp-idf/components/efuse/src/esp32/esp_efuse_api.c"
                                ; } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x018))); }) >> (0)) & (0x3)); });
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "coding scheme %d" "\033[0m" "\n", esp_log_timestamp(), TAG, scheme); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "coding scheme %d" "\033[0m" "\n", esp_log_timestamp(), TAG, scheme); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "coding scheme %d" "\033[0m" "\n", esp_log_timestamp(), TAG, scheme); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "coding scheme %d" "\033[0m" "\n", esp_log_timestamp(), TAG, scheme); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "coding scheme %d" "\033[0m" "\n", esp_log_timestamp(), TAG, scheme); } } while(0); } while(0);
    return scheme;
}
