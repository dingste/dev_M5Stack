# 1 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_local_ctrl//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c"
# 15 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c"
...
# 16 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/include/esp_local_ctrl.h" 2
...
esp_err_t esp_local_ctrl_set_handler(const char *ep_name,
                                     ...
                                     void *user_ctx);
# 21 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c" 2
# 1 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/proto-c/esp_local_ctrl.pb-c.h" 1
...
# 8 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/proto-c/esp_local_ctrl.pb-c.h" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/proto-c/esp_local_ctrl.pb-c.h" 2
...
typedef enum _LocalCtrlMsgType {
  ...
  LOCAL_CTRL_MSG_TYPE__TypeRespSetPropertyValues = 7
    , _LOCAL_CTRL_MSG_TYPE_IS_INT_SIZE = 0x7fffffff
} LocalCtrlMsgType;
...
typedef enum {
  ...
  LOCAL_CTRL_MESSAGE__PAYLOAD_RESP_SET_PROP_VALS = 15
    , _LOCAL_CTRL_MESSAGE__PAYLOAD_IS_INT_SIZE = 0x7fffffff
...
# 23 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c" 2
# 31 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c"
                                            ...
                                            LocalCtrlMessage *resp, void **ctx)
{
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Got properties count %d" "\033[0m" "\n", esp_log_timestamp(), TAG, prop_count); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Got properties count %d" "\033[0m" "\n", esp_log_timestamp(), TAG, prop_count); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Got properties count %d" "\033[0m" "\n", esp_log_timestamp(), TAG, prop_count); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Got properties count %d" "\033[0m" "\n", esp_log_timestamp(), TAG, prop_count); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Got properties count %d" "\033[0m" "\n", esp_log_timestamp(), TAG, prop_count); } } while(0); } while(0);
    return 0;
}
...
static esp_err_t cmd_get_prop_vals_handler(LocalCtrlMessage *req,
                                           LocalCtrlMessage *resp, void **ctx)
{
    RespGetPropertyValues *resp_payload = (RespGetPropertyValues *) malloc(sizeof(RespGetPropertyValues)); if (!resp_payload) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0); return 0x101; };
    ...
    if (!vals || !descs || !free_fns || !resp_payload->props) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to allocate memory for getting values" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to allocate memory for getting values" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to allocate memory for getting values" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to allocate memory for getting values" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to allocate memory for getting values" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        free(vals);
        free(descs);
        free(free_fns);
...
static esp_err_t cmd_set_prop_vals_handler(LocalCtrlMessage *req,
                                           LocalCtrlMessage *resp, void **ctx)
{
    RespSetPropertyValues *resp_payload = (RespSetPropertyValues *) malloc(sizeof(RespSetPropertyValues)); if (!resp_payload) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Error allocating memory" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0); return 0x101; };
    ...
    esp_local_ctrl_prop_val_t *vals = calloc(req->cmd_set_prop_vals->n_props,
                                             sizeof(esp_local_ctrl_prop_val_t));
    if (!idxs || !vals) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to allocate memory for setting values" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to allocate memory for setting values" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to allocate memory for setting values" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to allocate memory for setting values" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to allocate memory for setting values" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        free(idxs);
        free(vals);
        return 0x101;
    }
...
{
    void *temp_ctx = 
# 259 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c" 3 4
                    ((void *)0)
# 259 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c"
                        ;
    LocalCtrlMessage *req = local_ctrl_message__unpack(
# 260 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c" 3 4
                                                      ((void *)0)
# 260 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c"
                                                          , inlen, inbuf);
    if (!req) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Unable to unpack payload data" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Unable to unpack payload data" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Unable to unpack payload data" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Unable to unpack payload data" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Unable to unpack payload data" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x102;
    }
    ...
    if (ret != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "command dispatcher failed" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "command dispatcher failed" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "command dispatcher failed" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "command dispatcher failed" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "command dispatcher failed" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        esp_local_ctrl_command_cleanup(&resp, &temp_ctx);
        local_ctrl_message__free_unpacked(req, 
# 274 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c" 3 4
                                              ((void *)0)
# 274 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c"
                                                  );
        return -1;
    }

    local_ctrl_message__free_unpacked(req, 
# 278 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c" 3 4
                                          ((void *)0)
# 278 "/home/dieter/Development/esp-idf/components/esp_local_ctrl/src/esp_local_ctrl_handler.c"
                                              );
    ...
    *outbuf = (uint8_t *) malloc(*outlen);
    ...
    esp_local_ctrl_command_cleanup(&resp, &temp_ctx);
    do { if ( 3 >= (ESP_LOG_DEBUG) ) { esp_log_buffer_hex_internal( TAG, *outbuf, *outlen, ESP_LOG_DEBUG ); } } while(0);
    return 0;
}
