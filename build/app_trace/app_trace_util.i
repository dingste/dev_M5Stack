# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/app_trace//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c" 2
# 27 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c"
esp_err_t esp_apptrace_tmo_check(esp_apptrace_tmo_t *tmo)
{
...
# 61 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c" 3 4
       _Bool 
# 61 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c"
...
uint8_t *esp_apptrace_rb_produce(esp_apptrace_rb_t *rb, uint32_t size)
{
    ...
    if (rb->rd <= rb->wr) {
        ...
        if (rb->wr + size >= rb->size) {
            if (rb->rd == 0) {
                return 
# 104 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c" 3 4
                      ((void *)0)
# 104 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c"
                          ;
            }
            if (rb->wr + size == rb->size) {
                rb->wr = 0;
                ...
                if (size > rb->rd - 1) {
                    return 
# 111 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c" 3 4
                          ((void *)0)
# 111 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c"
                              ;
                }
        ...
        if (size > rb->rd - rb->wr - 1) {
            return 
# 131 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c" 3 4
                  ((void *)0)
# 131 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c"
                      ;
        }
        rb->wr += size;
    }
...
uint8_t *esp_apptrace_rb_consume(esp_apptrace_rb_t *rb, uint32_t size)
{
    ...
    if (rb->rd <= rb->wr) {
        ...
        if (rb->rd + size > rb->wr) {
            return 
# 144 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c" 3 4
                  ((void *)0)
# 144 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c"
                      ;
        }
        rb->rd += size;
    } else {
        ...
        if (rb->rd + size > rb->cur_size) {
            return 
# 150 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c" 3 4
                  ((void *)0)
# 150 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/app_trace/app_trace_util.c"
                      ;
