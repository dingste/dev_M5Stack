# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/freertos//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c"
# 71 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c"
...
# 72 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c" 2
...
# 80 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c" 2
...
# 81 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c" 2
...
# 82 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c" 2
...
# 83 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c" 2
# 113 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c"
typedef struct xEventGroupDefinition
{
 EventBits_t uxEventBits;
 List_t xTasksWaitingForBits;
# 126 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c"
 portMUX_TYPE eventGroupMux;
} EventGroup_t;
# 140 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c"
static BaseType_t prvTestWaitCondition( const EventBits_t uxCurrentEventBits, const EventBits_t uxBitsToWaitFor, const BaseType_t xWaitForAllBits );
# 187 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c"
 EventGroupHandle_t xEventGroupCreate( void )
 {
 EventGroup_t *pxEventBits;
  ...
  if( pxEventBits != 
# 194 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c" 3 4
                    ((void *)0) 
# 194 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c"
                         )
  {
   pxEventBits->uxEventBits = 0;
   vListInitialise( &( pxEventBits->xTasksWaitingForBits ) );
# 208 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c"
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
 ...
 if (!(( uxBitsToWaitFor & 0xff000000UL ) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c", 230, __FUNCTION__); abort(); };
 if (!(uxBitsToWaitFor != 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c", 231, __FUNCTION__); abort(); };

 {
  if (!(!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c", 234, __FUNCTION__); abort(); };
 }
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
 ...
 if (!(xEventGroup)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c", 350, __FUNCTION__); abort(); };
 if (!(( uxBitsToWaitFor & 0xff000000UL ) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c", 351, __FUNCTION__); abort(); };
 if (!(uxBitsToWaitFor != 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c", 352, __FUNCTION__); abort(); };

 {
  if (!(!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c", 355, __FUNCTION__); abort(); };
 }
...
EventBits_t uxReturn;
 ...
 if (!(xEventGroup)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c", 498, __FUNCTION__); abort(); };
 if (!(( uxBitsToClear & 0xff000000UL ) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c", 499, __FUNCTION__); abort(); };
...
# 533 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c"
EventBits_t xEventGroupGetBitsFromISR( EventGroupHandle_t xEventGroup )
{
...
BaseType_t xMatchFound = ( ( BaseType_t ) 0 );
 ...
 if (!(xEventGroup)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c", 560, __FUNCTION__); abort(); };
 if (!(( uxBitsToSet & 0xff000000UL ) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c", 561, __FUNCTION__); abort(); };
...
void vEventGroupDelete( EventGroupHandle_t xEventGroup )
{
 ...
 vTaskEnterCritical(&pxEventBits->eventGroupMux);
 {
  ...
  while( ( ( pxTasksWaitingForBits )->uxNumberOfItems ) > ( UBaseType_t ) 0 )
  {
   ...
   if (!(pxTasksWaitingForBits->xListEnd.pxNext != ( ListItem_t * ) &( pxTasksWaitingForBits->xListEnd ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c", 660, __FUNCTION__); abort(); };
...
# 687 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/event_groups.c"
 }
 ( void ) xTaskResumeAll();
}
