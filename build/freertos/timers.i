# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/freertos//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
# 71 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
...
# 72 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 2
...
# 79 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 2
...
# 80 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 2
...
# 81 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 2
...
# 82 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/include/freertos/portmacro.h" 1
# 83 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 2
# 105 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
...
# 174 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
                                                  ((void *)0)
# 174 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
                                                      ;


 portMUX_TYPE xTimerMux = { .owner = 0xB33FFFFF, .count = 0, };
# 193 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
...
# 270 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
 prvCheckForValidListAndQueue();

 if( xTimerQueue != 
# 272 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
                   ((void *)0) 
# 272 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
                        )
 {
# 284 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
  {

   xReturn = xTaskCreatePinnedToCore( prvTimerTask, "Tmr Svc", ( uint16_t ) 2048, 
# 286 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
                                                                                                         ((void *)0)
# 286 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
...
# 286 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
 ...
 if (!(xReturn)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c", 295, __FUNCTION__); abort(); };
 return xReturn;
}
 ...
 Timer_t *pxNewTimer;
  ...
  if( pxNewTimer != 
# 312 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
                   ((void *)0) 
# 312 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
                        )
  {
   prvInitialiseNewTimer( pcTimerName, xTimerPeriodInTicks, uxAutoReload, pvTimerID, pxCallbackFunction, pxNewTimer );
# 324 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
  }

  return pxNewTimer;
 }
# 377 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
static void prvInitialiseNewTimer( const char * const pcTimerName,
         const TickType_t xTimerPeriodInTicks,
         const UBaseType_t uxAutoReload,
         void * const pvTimerID,
         ...
         Timer_t *pxNewTimer )
{
 ...
 if (!(( xTimerPeriodInTicks > 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c", 385, __FUNCTION__); abort(); };

 if( pxNewTimer != 
# 387 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
                  ((void *)0) 
# 387 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
                       )
 {
...
DaemonTaskMessage_t xMessage;
 ...
 if( xTimerQueue != 
# 413 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
                   ((void *)0) 
# 413 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
                        )
 {
...
# 460 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
TickType_t xTimerGetPeriod( TimerHandle_t xTimer )
{
Timer_t *pxTimer = ( Timer_t * ) xTimer;

    if (!(xTimer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c", 464, __FUNCTION__); abort(); };
...
TickType_t xReturn;
    ...
    if (!(xTimer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c", 474, __FUNCTION__); abort(); };
...
# 509 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
                                                                                         ((void *)0)
# 509 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
                                                                                             , ( TickType_t ) 0U );
   if (!(xResult)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c", 510, __FUNCTION__); abort(); };
   ( void ) xResult;
  }
  else
  {
...
{
TickType_t xNextExpireTime;
# 616 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
 ...
 while( xQueueGenericReceive( ( xTimerQueue ), ( &xMessage ), ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) != ( ( ( BaseType_t ) 0 ) ) )
 {

  {
   ...
   if( xMessage.xMessageID < ( BaseType_t ) 0 )
   {
    ...
    if (!(pxCallback)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c", 714, __FUNCTION__); abort(); };
...
# 734 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
      ((void *)0) 
# 734 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
      ) ) ) == ( ( BaseType_t ) 0 ) )
   {
...
# 771 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
                                                                                                                                                      ((void *)0)
# 771 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
                                                                                                                                                          , ( TickType_t ) 0U );
       if (!(xResult)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c", 772, __FUNCTION__); abort(); };
       ( void ) xResult;
      }
      else
      {
    ...
    case ( ( BaseType_t ) 9 ) :
     ...
     if (!(( pxTimer->xTimerPeriodInTicks > 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c", 795, __FUNCTION__); abort(); };
...
# 831 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
     break;
...
BaseType_t xResult;
 ...
 while( ( ( BaseType_t ) ( ( pxCurrentTimerList )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
 {
  ...
  if( pxTimer->uxAutoReload == ( UBaseType_t ) ( ( BaseType_t ) 1 ) )
  {
   ...
   {
    xResult = xTimerGenericCommand( pxTimer, ( ( BaseType_t ) 0 ), xNextExpireTime, 
# 884 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
                                                                                          ((void *)0)
# 884 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
                                                                                              , ( TickType_t ) 0U );
    if (!(xResult)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c", 885, __FUNCTION__); abort(); };
    ( void ) xResult;
   }
  }
  else
...
static void prvCheckForValidListAndQueue( void )
{
# 911 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
 if( xTimerQueue == 
# 911 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
                   ((void *)0) 
# 911 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
 ...
 {
  if( xTimerQueue == 
# 915 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
                    ((void *)0) 
# 915 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
                         )
  {
   ...
   if (!(xTimerQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c", 922, __FUNCTION__); abort(); };
# 936 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
  }
  else
  {
   ;
...
# 957 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c" 3 4
                                          ((void *)0) 
# 957 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c"
                                          ) ) ) );
 }
 vTaskExitCritical(&xTimerMux);
...
Timer_t * const pxTimer = ( Timer_t * ) xTimer;
    ...
    if (!(xTimer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c", 977, __FUNCTION__); abort(); };
 ...
 BaseType_t xReturn;
  ...
  if (!(xTimerQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/timers.c", 1021, __FUNCTION__); abort(); };
