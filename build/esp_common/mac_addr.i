# 1 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c"
...
# 2 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c" 2
...
# 3 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c" 2
...
# 4 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c" 2
...
# 5 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c" 2
...
# 6 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c" 2
...
# 9 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c" 2
...
{
    if (mac == 
# 19 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c" 3 4
              ((void *)0)
# 19 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c"
                  ) {
    ...
    if (mac[0] & 0x01) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Base MAC must be a unicast MAC" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Base MAC must be a unicast MAC" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Base MAC must be a unicast MAC" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Base MAC must be a unicast MAC" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Base MAC must be a unicast MAC" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x102;
    }
...
esp_err_t esp_derive_local_mac(uint8_t* local_mac, const uint8_t* universal_mac)
{
    ...
    if (local_mac == 
# 106 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c" 3 4
                    ((void *)0) 
# 106 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c"
                         || universal_mac == 
# 106 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c" 3 4
                                             ((void *)0)
# 106 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c"
...
esp_err_t esp_read_mac(uint8_t* mac, esp_mac_type_t type)
{
    ...
    if (mac == 
# 128 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c" 3 4
              ((void *)0)
# 128 "/home/dieter/Development/esp-idf/components/esp_common/src/mac_addr.c"
                  ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "mac address param is NULL" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "mac address param is NULL" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "mac address param is NULL" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "mac address param is NULL" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "mac address param is NULL" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x102;
    }
