# 1 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c"
# 1 "/home/dieter/Development/ProjektEi/build/nghttp//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c"
# 25 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c"
# 1 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.h" 1
# 29 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.h"
...
# 30 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.h" 2
...
# 33 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.h" 2
...
int nghttp2_map_each(nghttp2_map *map,
                     int (*func)(nghttp2_map_entry *entry, void *ptr),
                     void *ptr);
# 26 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c" 2
...
int nghttp2_map_init(nghttp2_map *map, nghttp2_mem *mem) {
  ...
  if (map->table == 
# 36 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
                   ((void *)0)
# 36 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c"
                       ) {
...
void nghttp2_map_each_free(nghttp2_map *map,
  ...
  for (i = 0; i < map->tablelen; ++i) {
    ...
    map->table[i] = 
# 60 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
                   ((void *)0)
# 60 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c"
                       ;
  }
}
...
void nghttp2_map_entry_init(nghttp2_map_entry *entry, key_type key) {
  entry->key = key;
  entry->next = 
# 83 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
               ((void *)0)
# 83 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c"
                   ;
}
...
static int insert(nghttp2_map_entry **table, uint32_t tablelen,
  ...
  if (table[h] == 
# 98 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
                 ((void *)0)
# 98 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c"
                     ) {
    table[h] = entry;
  } else {
    nghttp2_map_entry *p;
...
static int resize(nghttp2_map *map, uint32_t new_tablelen) {
  ...
  if (new_table == 
# 121 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
                  ((void *)0)
# 121 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c"
                      ) {
    return NGHTTP2_ERR_NOMEM;
  }
  ...
  for (i = 0; i < map->tablelen; ++i) {
    ...
    for (entry = map->table[i]; entry;) {
      nghttp2_map_entry *next = entry->next;
      entry->next = 
# 129 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
                   ((void *)0)
# 129 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c"
                       ;
...
nghttp2_map_entry *nghttp2_map_find(nghttp2_map *map, key_type key) {
  ...
  return 
# 168 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c" 3 4
        ((void *)0)
# 168 "/home/dieter/Development/esp-idf/components/nghttp/nghttp2/lib/nghttp2_map.c"
            ;
}
