# 1 "/home/dieter/Development/esp-idf/components/spi_flash/esp32/flash_ops_esp32.c"
# 1 "/home/dieter/Development/ProjektEi/build/spi_flash//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/spi_flash/esp32/flash_ops_esp32.c"
# 14 "/home/dieter/Development/esp-idf/components/spi_flash/esp32/flash_ops_esp32.c"
...
# 15 "/home/dieter/Development/esp-idf/components/spi_flash/esp32/flash_ops_esp32.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/spi_flash/esp32/flash_ops_esp32.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/spi_flash/esp32/flash_ops_esp32.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/spi_flash/esp32/flash_ops_esp32.c" 2

static inline void __attribute__((section(".iram1" "." "9"))) spi_flash_guard_start(void)
{
...
static inline void __attribute__((section(".iram1" "." "10"))) spi_flash_guard_end(void)
{
    const spi_flash_guard_funcs_t *ops = spi_flash_guard_get();
    if (ops && ops->end) {
        ops->end();
...
esp_rom_spiflash_result_t __attribute__((section(".iram1" "." "11"))) spi_flash_write_encrypted_chip(size_t dest_addr, const void *src, size_t size)
{
