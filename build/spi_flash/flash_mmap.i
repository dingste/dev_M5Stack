...
static inline __attribute__((section(".iram1" "." "23"))) 
...
# 50 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
...
static struct mmap_entries_head { struct mmap_entry_ *lh_first; } s_mmap_entries_head =
        { 
# 59 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
       ((void *)0) 
# 59 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
       };
static uint8_t s_mmap_page_refcnt[4 * 64] = {0};
static uint32_t s_mmap_last_handle = 0;


static void __attribute__((section(".iram1" "." "24"))) spi_flash_mmap_init()
{
...
static void __attribute__((section(".iram1" "." "25"))) get_mmu_region(spi_flash_mmap_memory_t memory, int* out_begin, int* out_size,uint32_t* region_addr)
{
...
esp_err_t __attribute__((section(".iram1" "." "26"))) spi_flash_mmap(size_t src_addr, size_t size, spi_flash_mmap_memory_t memory,
                         const void** out_ptr, spi_flash_mmap_handle_t* out_handle)
{
    esp_err_t ret;
    if (src_addr & 0xffff) {
    ...
    if (pages == 
# 119 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                ((void *)0)
# 119 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
                    ) {
        return 0x101;
    }
...
esp_err_t __attribute__((section(".iram1" "." "27"))) spi_flash_mmap_pages(const int *pages, size_t page_count, spi_flash_mmap_memory_t memory,
                         const void** out_ptr, spi_flash_mmap_handle_t* out_handle)
{
    esp_err_t ret;
    
# 134 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
   _Bool 
# 134 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
        need_flush = 
# 134 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                     0
# 134 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
    ...
    if (start == end) {
        *out_handle = 0;
        *out_ptr = 
# 189 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                  ((void *)0)
# 189 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
                      ;
        ret = 0x101;
    } else {
...
# 199 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
            ,
...
# 199 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
            ...
            if (s_mmap_page_refcnt[i] == 0) {
                if (entry_pro != pages[pageno] || entry_app != pages[pageno]) {
                    ...
                    need_flush = 
# 206 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                                1
# 206 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
                                    ;
                }
            }
...
# 212 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
       ((void *)0)
# 212 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
    ...
    if (*out_ptr == 
# 236 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                   ((void *)0)
# 236 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
                       ) {
        free(new_entry);
    }
    return ret;
...
void __attribute__((section(".iram1" "." "28"))) spi_flash_munmap(spi_flash_mmap_handle_t handle)
{
    spi_flash_disable_interrupts_caches_and_other_cpu();
    mmap_entry_t* it;

    for (it = ((&s_mmap_entries_head)->lh_first); it != 
# 247 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                                                     ((void *)0)
# 247 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
        ...
        if (it->handle == handle) {
            ...
            for (int i = it->page; i < it->page + it->count; ++i) {
                ((s_mmap_page_refcnt[i] > 0) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c", 253, __func__, "s_mmap_page_refcnt[i] > 0"));
                if (--s_mmap_page_refcnt[i] == 0) {
                    ((volatile uint32_t*) 0x3FF10000)[i] = 0x100;
                    ((volatile uint32_t*) 0x3FF12000)[i] = 0x100;
                }
...
# 259 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
           ((void *)0)
# 259 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
    ...
    spi_flash_enable_interrupts_caches_and_other_cpu();
    if (it == 
# 264 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
             ((void *)0)
# 264 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
                 ) {
        ((0 && "invalid handle, or handle already unmapped") ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c", 265, __func__, "0 && \"invalid handle, or handle already unmapped\""));
    }
    free(it);
}

static void __attribute__((section(".iram1" "." "29"))) __attribute__((noinline)) spi_flash_protected_mmap_init()
{
    spi_flash_disable_interrupts_caches_and_other_cpu();
    spi_flash_mmap_init();
    spi_flash_enable_interrupts_caches_and_other_cpu();
...
static uint32_t __attribute__((section(".iram1" "." "30"))) __attribute__((noinline)) spi_flash_protected_read_mmu_entry(int index)
{
    uint32_t value;
    spi_flash_disable_interrupts_caches_and_other_cpu();
...
void spi_flash_mmap_dump()
{
    ...
    mmap_entry_t* it;
    for (it = ((&s_mmap_entries_head)->lh_first); it != 
# 291 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                                                     ((void *)0)
# 291 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
                                                         ; it = ((it)->entries.le_next)) {
...
uint32_t __attribute__((section(".iram1" "." "31"))) spi_flash_mmap_get_free_pages(spi_flash_mmap_memory_t memory)
{
    spi_flash_disable_interrupts_caches_and_other_cpu();
    spi_flash_mmap_init();
    int count = 0;
...
const void *__attribute__((section(".iram1" "." "32"))) spi_flash_phys2cache(uint32_t phys_offs, spi_flash_mmap_memory_t memory)
{
    ...
    spi_flash_enable_interrupts_caches_and_other_cpu();
    return 
# 381 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
          ((void *)0)
# 381 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
              ;
}

static 
# 384 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
      _Bool 
# 384 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
           __attribute__((section(".iram1" "." "33"))) is_page_mapped_in_cache(uint32_t phys_page)
{
    int start[2], end[2];
    ...
    start[1] = ((0x400D0000 - 0x40000000) / 0x10000 + 64);
    end[1] = 256;
    ...
    for (int j = 0; j < 2; j++) {
        for (int i = start[j]; i < end[j]; i++) {
            if (DPORT_SEQUENCE_REG_READ((uint32_t)&((volatile uint32_t*) 0x3FF10000)[i]) == phys_page) {
                ;
                return 
# 401 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                      1
# 401 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
                          ;
            }
        }
    }
    ;
    return 
# 406 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
          0
# 406 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
               ;
}


__attribute__((section(".iram1" "." "34"))) 
# 410 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
         _Bool 
# 410 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
              spi_flash_check_and_flush_cache(size_t start_addr, size_t length)
{
    ...
    for (uint32_t addr = page_start_addr; addr < page_start_addr + length; addr += 0x10000) {
        ...
        if (page >= 256) {
            return 
# 419 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                  0
# 419 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
                       ;
        }
        ...
        if (is_page_mapped_in_cache(page)) {
            ...
            return 
# 430 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                  1
# 430 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
                      ;
        }
    }
    return 
# 433 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c" 3 4
          0
# 433 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/flash_mmap.c"
               ;
}
