...
static void __attribute__((section(".iram1" "." "23"))) spi_flash_disable_cache(uint32_t cpuid, uint32_t* saved_state);
static void __attribute__((section(".iram1" "." "24"))) spi_flash_restore_cache(uint32_t cpuid, uint32_t saved_state);
...
void __attribute__((section(".iram1" "." "25"))) spi_flash_disable_interrupts_caches_and_other_cpu()
{
    spi_flash_op_lock();
...
void __attribute__((section(".iram1" "." "26"))) spi_flash_enable_interrupts_caches_and_other_cpu()
{
...
void __attribute__((section(".iram1" "." "27"))) spi_flash_disable_interrupts_caches_and_other_cpu_no_os()
{
...
void __attribute__((section(".iram1" "." "28"))) spi_flash_enable_interrupts_caches_no_os()
{
...
static void __attribute__((section(".iram1" "." "29"))) spi_flash_disable_cache(uint32_t cpuid, uint32_t* saved_state)
{
    uint32_t ret = 0;
    if (cpuid == 0) {
...
static void __attribute__((section(".iram1" "." "30"))) spi_flash_restore_cache(uint32_t cpuid, uint32_t saved_state)
{
    if (cpuid == 0) {
...
__attribute__((section(".iram1" "." "31"))) 
