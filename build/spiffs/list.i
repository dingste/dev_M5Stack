# 1 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
# 1 "/home/dieter/Development/ProjektEi/build/spiffs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
# 30 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
...
# 31 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 2
...
# 33 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 2
...
# 34 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 2
...
# 35 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 2

# 1 "/home/dieter/Development/ProjektEi/components/spiffs/list.h" 1
# 33 "/home/dieter/Development/ProjektEi/components/spiffs/list.h"
...
# 34 "/home/dieter/Development/ProjektEi/components/spiffs/list.h" 2
# 1 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.h" 1
# 36 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.h"
...
# 37 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.h" 2
...
# 38 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.h" 2
...
# 37 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 2


void list_init(struct list *list, int first_index) {

    mtx_init(&list->mutex, 
# 41 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
                          ((void *)0)
# 41 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                              , 
# 41 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
                                ((void *)0)
# 41 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
    ...
    list->indexes = 0;
    list->free = 
# 46 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
                ((void *)0)
# 46 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                    ;
    list->index = 
# 47 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
                 ((void *)0)
# 47 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                     ;
...
int list_add(struct list *list, void *item, int *item_index) {
    struct list_index *index = 
# 54 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
                              ((void *)0)
# 54 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                                  ;
    struct list_index *indexa = 
# 55 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
                               ((void *)0)
# 55 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                                   ;
    int grow = 0;
    ...
    if (grow) {
        ...
        if (!indexa) {
            mtx_unlock(&list->mutex);
            return 
# 78 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
                  12
# 78 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                        ;
        }
    ...
    index->next = 
# 100 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
                 ((void *)0)
# 100 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                     ;
    index->item = item;
    index->deleted = 0;
...
int __attribute__((section(".iram1" "." "2"))) list_get(struct list *list, int index, void **item) {
    struct list_index *cindex = 
# 113 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
                               ((void *)0)
# 113 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                                   ;
    int iindex;
    ...
    if (!list->indexes) {
        mtx_unlock(&list->mutex);
        return 
# 120 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
              22
# 120 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                    ;
    }
    ...
    if (index < list->first_index) {
        mtx_unlock(&list->mutex);
        return 
# 126 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
              22
# 126 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                    ;
    }
    ...
    if (iindex > list->indexes) {
        mtx_unlock(&list->mutex);
        return 
# 135 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
              22
# 135 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                    ;
    }
    ...
    if (cindex->deleted) {
        mtx_unlock(&list->mutex);
        return 
# 142 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
              22
# 142 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                    ;
    }
...
int list_remove(struct list *list, int index, int destroy) {
    struct list_index *cindex = 
# 153 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
                               ((void *)0)
# 153 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                                   ;
    int iindex;
    ...
    if (index < list->first_index) {
        mtx_unlock(&list->mutex);
        return 
# 161 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
              22
# 161 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                    ;
    }
    ...
    if ((iindex < 0) || (iindex > list->indexes)) {
        mtx_unlock(&list->mutex);
        return 
# 170 "/home/dieter/Development/ProjektEi/components/spiffs/list.c" 3 4
              22
# 170 "/home/dieter/Development/ProjektEi/components/spiffs/list.c"
                    ;
    }
...
int __attribute__((section(".iram1" "." "3"))) list_first(struct list *list) {
    int index;
    int res = -1;
...
int __attribute__((section(".iram1" "." "4"))) list_next(struct list *list, int index) {
    int res = -1;
    int iindex;
