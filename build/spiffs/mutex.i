# 1 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c"
# 1 "/home/dieter/Development/ProjektEi/build/spiffs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c"
# 33 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c"
...
# 34 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c" 2
# 1 "/home/dieter/Development/esp-idf/components/xtensa/include/esp_attr.h" 1
# 35 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c" 2
# 1 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.h" 1
# 37 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.h"
...
# 36 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c" 2
...
# 57 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c" 3 4
           ((void *)0)
# 57 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        }
    }
}

void __attribute__((section(".iram1" "." "2"))) mtx_lock(struct mtx *mutex) {
    if (port_interruptNesting[xPortGetCoreID()] != 0) {
        BaseType_t xHigherPriorityTaskWoken = ( ( BaseType_t ) 0 );
        xQueueReceiveFromISR( ( QueueHandle_t ) ( mutex->sem ), 
# 65 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c" 3 4
       ((void *)0)
# 65 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c"
       , ( &xHigherPriorityTaskWoken ) );
        if (xHigherPriorityTaskWoken) { _frxt_setup_switch(); };
    } else {
        xQueueGenericReceive( ( QueueHandle_t ) ( mutex->sem ), 
# 68 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c" 3 4
       ((void *)0)
# 68 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c"
...
# 73 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c" 3 4
       ((void *)0)
# 73 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c"
...
void __attribute__((section(".iram1" "." "3"))) mtx_unlock(struct mtx *mutex) {
    if (port_interruptNesting[xPortGetCoreID()] != 0) {
        BaseType_t xHigherPriorityTaskWoken = ( ( BaseType_t ) 0 );
        xQueueGiveFromISR( ( QueueHandle_t ) ( mutex->sem ), ( &xHigherPriorityTaskWoken ) );
        if (xHigherPriorityTaskWoken) { _frxt_setup_switch(); };
        ...
        xQueueGenericSend( ( QueueHandle_t ) ( mutex->sem ), 
# 86 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c" 3 4
       ((void *)0)
# 86 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
}
...
void mtx_destroy(struct mtx *mutex) {
    if (port_interruptNesting[xPortGetCoreID()] != 0) {
        ...
        xQueueGenericSend( ( QueueHandle_t ) ( mutex->sem ), 
# 96 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c" 3 4
       ((void *)0)
# 96 "/home/dieter/Development/ProjektEi/components/spiffs/mutex.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
