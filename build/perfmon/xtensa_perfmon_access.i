# 1 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c"
# 1 "/home/dieter/Development/ProjektEi/build/perfmon//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c"
# 15 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c"
...
# 16 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c" 2


esp_err_t xtensa_perfmon_init(int id, uint16_t select, uint16_t mask, int kernelcnt, int tracelevel)
{
    if (id >= 
# 22 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c" 3 4
             2
# 22 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c"
                            ) {
        return 0x102;
    }
    uint32_t pmc =
    ...
    eri_write(((0x100000 +0x1000)+0x0080) + id * sizeof(int32_t), 0);
    eri_write(((0x100000 +0x1000)+0x0100) + id * sizeof(int32_t), pmc);
    return 0;
}

void xtensa_perfmon_dump(void)
{
    uint32_t pgm = eri_read(((0x100000 +0x1000)+0x0000));
    uint32_t intpc = eri_read(((0x100000 +0x1000)+0x0010));
    printf("perfmon: PGM=%08x, INTPC=%08x\n", pgm, intpc);

    for (int i = 0 ; i < 
# 42 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c" 3 4
                        2 
# 42 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c"
                                        ; i++) {
        uint32_t pm = eri_read(((0x100000 +0x1000)+0x0080) + i * sizeof(int32_t));
        uint32_t pmctrl = eri_read(((0x100000 +0x1000)+0x0100) + i * sizeof(int32_t));
        uint32_t pmstat = eri_read(((0x100000 +0x1000)+0x0180) + i * sizeof(int32_t));
...
{
    if (id >= 
# 52 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c" 3 4
             2
# 52 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c"
                            ) {
        return 0x102;
    }
    eri_write(((0x100000 +0x1000)+0x0080) + id * sizeof(int32_t), 0);
...
void xtensa_perfmon_start(void)
{
    eri_write(((0x100000 +0x1000)+0x0000), (1<<0));
}

void xtensa_perfmon_stop(void)
{
    eri_write(((0x100000 +0x1000)+0x0000), 0);
}

uint32_t xtensa_perfmon_value(int id)
{
    if (id >= 
# 71 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c" 3 4
             2
# 71 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c"
                            ) {
        return 0;
    }
    uint32_t result = eri_read(((0x100000 +0x1000)+0x0080) + id * sizeof(int32_t));
    return result;
}
...
{
    if (id >= 
# 80 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c" 3 4
             2
# 80 "/home/dieter/Development/esp-idf/components/perfmon/xtensa_perfmon_access.c"
                            ) {
        return 0x102;
    }
    uint32_t result = eri_read(((0x100000 +0x1000)+0x0180) + id * sizeof(int32_t));
    if (result & 1) {
        return -1;
    }
    return 0;
