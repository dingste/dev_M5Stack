# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
# 1 "/home/dieter/Development/ProjektEi/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
# 9 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
...
# 10 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 2
...
# 12 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 2
...
# 13 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 2
...
# 14 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 2
...
# 15 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 2
...
int wpa_auth_for_each_auth(struct wpa_authenticator *wpa_auth,
      ...
      void *cb_ctx);
# 20 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 2
...
# 219 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/esp_supplicant/esp_wifi_driver.h"
                                                   start);
# 21 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 2
...
# 60 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
    bss->wmm_enabled = -1;
...
struct hostapd_config * hostapd_config_defaults(void)
{
    ...
    if (conf == 
# 79 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 3 4
               ((void *)0) 
# 79 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
                    || bss == 
# 79 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 3 4
                              ((void *)0)
# 79 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
                                  ) {
     do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to allocate memory for " "configuration data." "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to allocate memory for " "configuration data." "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Failed to allocate memory for " "configuration data." "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Failed to allocate memory for " "configuration data." "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to allocate memory for " "configuration data." "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                     ;
        free((conf));
        free((bss));
        return 
# 84 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 3 4
              ((void *)0)
# 84 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
                  ;
    }
...
static int hostapd_derive_psk(struct hostapd_ssid *ssid)
{
    ...
    if (ssid->wpa_psk == 
# 124 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 3 4
                        ((void *)0)
# 124 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
                            ) {
     do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Unable to alloc space for PSK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Unable to alloc space for PSK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Unable to alloc space for PSK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Unable to alloc space for PSK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Unable to alloc space for PSK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
        return -1;
    }
    wpa_hexdump_ascii(ESP_LOG_DEBUG, "SSID",
              (u8 *) ssid->ssid, ssid->ssid_len);
    wpa_hexdump_ascii_key(ESP_LOG_DEBUG, "PSK (ASCII passphrase)",
    ...
    wpa_hexdump_key(ESP_LOG_DEBUG, "PSK (from passphrase)",
            ssid->wpa_psk->psk, 32);
    return 0;
}
...
# 151 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 3 4
                               ((void *)0)
# 151 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
                                   ) {
        if (ssid->wpa_psk != 
# 152 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 3 4
                            ((void *)0)
# 152 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
                                ) {
         do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Using pre-configured WPA PSK " "instead of passphrase" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Using pre-configured WPA PSK " "instead of passphrase" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Using pre-configured WPA PSK " "instead of passphrase" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Using pre-configured WPA PSK " "instead of passphrase" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Using pre-configured WPA PSK " "instead of passphrase" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                           ;
        } else {
         do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Deriving WPA PSK based on " "passphrase\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Deriving WPA PSK based on " "passphrase\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Deriving WPA PSK based on " "passphrase\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Deriving WPA PSK based on " "passphrase\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Deriving WPA PSK based on " "passphrase\n" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                  ;
...
# 191 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
int hostapd_maclist_found(struct mac_acl_entry *list, int num_entries,
              const u8 *addr, int *vlan_id)
{
...
int hostapd_rate_found(int *list, int rate)
{
    ...
    if (list == 
# 221 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 3 4
               ((void *)0)
# 221 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
                   )
        return 0;
...
# 235 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 3 4
                             ((void *)0)
# 235 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
                                 ;

    for (psk = conf->ssid.wpa_psk; psk != 
# 237 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 3 4
                                         ((void *)0)
# 237 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
                                             ; psk = psk->next) {
        if (next_ok &&
    ...
    return 
# 246 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c" 3 4
          ((void *)0)
# 246 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/ap/ap_config.c"
              ;
}
