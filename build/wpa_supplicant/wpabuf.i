# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
# 1 "/home/dieter/Development/ProjektEi/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
# 15 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
...
# 16 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 2
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/include/utils/wpabuf.h" 1
# 19 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 2
# 37 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
static void wpabuf_overflow(const struct wpabuf *buf, size_t len)
{
 ...
 do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "wpabuf %p (size=%lu used=%lu) overflow len=%lu" "\033[0m" "\n", esp_log_timestamp(), "wpa", buf, (unsigned long) buf->size, (unsigned long) buf->used, (unsigned long) len); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "wpabuf %p (size=%lu used=%lu) overflow len=%lu" "\033[0m" "\n", esp_log_timestamp(), "wpa", buf, (unsigned long) buf->size, (unsigned long) buf->used, (unsigned long) len); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "wpabuf %p (size=%lu used=%lu) overflow len=%lu" "\033[0m" "\n", esp_log_timestamp(), "wpa", buf, (unsigned long) buf->size, (unsigned long) buf->used, (unsigned long) len); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "wpabuf %p (size=%lu used=%lu) overflow len=%lu" "\033[0m" "\n", esp_log_timestamp(), "wpa", buf, (unsigned long) buf->size, (unsigned long) buf->used, (unsigned long) len); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "wpabuf %p (size=%lu used=%lu) overflow len=%lu" "\033[0m" "\n", esp_log_timestamp(), "wpa", buf, (unsigned long) buf->size, (unsigned long) buf->used, (unsigned long) len); } } while(0); } while(0)
...
int wpabuf_resize(struct wpabuf **_buf, size_t add_len)
{
 ...
 if (buf == 
# 59 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
           ((void *)0)
# 59 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
               ) {
  *_buf = wpabuf_alloc(add_len);
  return *_buf == 
# 61 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
                 ((void *)0) 
# 61 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
                      ? -1 : 0;
 }
# 73 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
 if (buf->used + add_len > buf->size) {
  unsigned char *nbuf;
  if (buf->ext_data) {
   nbuf = (unsigned char*)realloc((buf->ext_data), (buf->used + add_len));
   if (nbuf == 
# 77 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
              ((void *)0)
# 77 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
                  )
    return -1;
   memset(nbuf + buf->used, 0, add_len);
   buf->ext_data = nbuf;
  } else {
# 94 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
   nbuf = (unsigned char*)realloc((buf), (sizeof(struct wpabuf) + buf->used + add_len))
                           ;
   if (nbuf == 
# 96 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
              ((void *)0)
# 96 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
                  )
    return -1;
...
struct wpabuf * wpabuf_alloc(size_t len)
{
# 127 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
 struct wpabuf *buf = (struct wpabuf *)calloc(1, (sizeof(struct wpabuf) + len));
 if (buf == 
# 128 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
           ((void *)0)
# 128 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
               )
  return 
# 129 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
        ((void *)0)
# 129 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
            ;
...
struct wpabuf * wpabuf_alloc_ext_data(u8 *data, size_t len)
{
# 148 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
 struct wpabuf *buf = (struct wpabuf *)calloc(1, (sizeof(struct wpabuf)));
 if (buf == 
# 149 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
           ((void *)0)
# 149 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
               )
  return 
# 150 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
        ((void *)0)
# 150 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
            ;
...
void wpabuf_free(struct wpabuf *buf)
{
# 198 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
 if (buf == 
# 198 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
           ((void *)0)
# 198 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
               )
  return;
...
# 226 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
struct wpabuf * wpabuf_concat(struct wpabuf *a, struct wpabuf *b)
{
 struct wpabuf *n = 
# 228 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
                   ((void *)0)
# 228 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
                       ;
 size_t len = 0;

 if (b == 
# 231 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
         ((void *)0)
# 231 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
             )
  return a;
...
# 266 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
struct wpabuf * wpabuf_zeropad(struct wpabuf *buf, size_t len)
{
 struct wpabuf *ret;
 size_t blen;
 ...
 if (buf == 
# 271 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
           ((void *)0)
# 271 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
               )
  return 
# 272 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
        ((void *)0)
# 272 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
            ;
...
# 294 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
__builtin_va_start(
# 294 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
ap
# 294 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
,
# 294 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
...
# 296 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
__builtin_va_end(
# 296 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
ap
# 296 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c" 3 4
)
# 296 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpabuf.c"
