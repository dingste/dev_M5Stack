# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
# 1 "/home/dieter/Development/ProjektEi/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
# 9 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
...
# 10 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 2
...
# 12 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 2
...
# 13 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 2
...
int bignum_exptmod(const struct bignum *a, const struct bignum *b,
     const struct bignum *c, struct bignum *d);
# 14 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 2
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.h" 1
# 12 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.h"
...
# 15 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 2
        ...
        struct bignum *num)
{
 ...
 if (pos == 
# 35 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
           ((void *)0)
# 35 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
               )
  return 
# 36 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
        ((void *)0)
# 36 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
            ;
 ...
 if (asn1_get_next(pos, end - pos, &hdr) < 0 ||
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSA: Expected INTEGER - found class %d " "tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSA: Expected INTEGER - found class %d " "tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSA: Expected INTEGER - found class %d " "tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSA: Expected INTEGER - found class %d " "tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSA: Expected INTEGER - found class %d " "tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } } while(0); } while(0)
                                     ;
  return 
# 42 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
        ((void *)0)
# 42 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
            ;
 }
 ...
 if (bignum_set_unsigned_bin(num, hdr.payload, hdr.length) < 0) {
  ...
  return 
# 47 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
        ((void *)0)
# 47 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
            ;
 }

 return hdr.payload + hdr.length;
}
# 60 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
struct crypto_rsa_key *
crypto_rsa_import_public_key(const u8 *buf, size_t len)
{
 ...
 if (key == 
# 68 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
           ((void *)0)
# 68 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
               )
  return 
# 69 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
        ((void *)0)
# 69 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
            ;

 key->n = bignum_init();
 key->e = bignum_init();
 if (key->n == 
# 73 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
              ((void *)0) 
# 73 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
                   || key->e == 
# 73 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
                                ((void *)0)
# 73 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
  ...
  crypto_rsa_free(key);
  return 
# 75 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
        ((void *)0)
# 75 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
            ;
 }
# 86 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
 ...
 if (pos == 
# 100 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
           ((void *)0)
# 100 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
               )
  goto error;
...
error:
 crypto_rsa_free(key);
 return 
# 114 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
       ((void *)0)
# 114 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
           ;
}
# 124 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
struct crypto_rsa_key *
crypto_rsa_import_private_key(const u8 *buf, size_t len)
{
 struct crypto_rsa_key *key;
 ...
 key = (struct crypto_rsa_key *)calloc(1, (sizeof(*key)));
 if (key == 
# 133 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
           ((void *)0)
# 133 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
               )
  return 
# 134 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
        ((void *)0)
# 134 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
            ;
 ...
 if (key->n == 
# 147 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
              ((void *)0) 
# 147 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
                   || key->e == 
# 147 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
                                ((void *)0) 
# 147 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
...
# 147 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
                                                       ||
     key->p == 
# 148 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
              ((void *)0) 
# 148 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
                   || key->q == 
# 148 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
                                ((void *)0) 
# 148 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
...
# 148 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
                                                          ||
     key->dmq1 == 
# 149 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
                 ((void *)0) 
# 149 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
                      || key->iqmp == 
# 149 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
                                      ((void *)0)
# 149 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
  ...
  crypto_rsa_free(key);
  return 
# 151 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
        ((void *)0)
# 151 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
            ;
 }
# 170 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
 if (asn1_get_next(buf, len, &hdr) < 0 ||
     hdr.class != 0 ||
     hdr.tag != 0x10) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSA: Expected SEQUENCE " "(public key) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } } while(0); } while(0)
 ...
 zero = bignum_init();
 if (zero == 
# 182 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
            ((void *)0)
# 182 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
                )
  goto error;
 pos = crypto_rsa_parse_integer(pos, end, zero);
 if (pos == 
# 185 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
           ((void *)0) 
# 185 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
 ...
 if (pos == 
# 202 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
           ((void *)0)
# 202 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
               )
  goto error;
...
error:
 crypto_rsa_free(key);
 return 
# 216 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
       ((void *)0)
# 216 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
           ;
}
...
# 241 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
int crypto_rsa_exptmod(const u8 *in, size_t inlen, u8 *out, size_t *outlen,
         struct crypto_rsa_key *key, int use_private)
{
 struct bignum *tmp, *a = 
# 244 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
                         ((void *)0)
# 244 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
                             , *b = 
# 244 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
                                    ((void *)0)
# 244 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
 ...
 tmp = bignum_init();
 if (tmp == 
# 252 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
           ((void *)0)
# 252 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
               )
  return -1;
 ...
 if (use_private) {
# 276 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
  a = bignum_init();
  b = bignum_init();
  if (a == 
# 278 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
          ((void *)0) 
# 278 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
               || b == 
# 278 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
                       ((void *)0)
# 278 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
...
# 318 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c" 3 4
                                                  ((void *)0)
# 318 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
                                                      ) < 0)
  goto error;
...
# 339 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/rsa.c"
void crypto_rsa_free(struct crypto_rsa_key *key)
{
 if (key) {
  bignum_deinit(key->n);
