# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
# 1 "/home/dieter/Development/ProjektEi/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
# 9 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
...
# 10 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 2
...
# 12 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 2
# 22 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
void inc_byte_array(u8 *counter, size_t len)
{
 int pos = len - 1;
 while (pos >= 0) {
...
# 66 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
int hexstr2bin(const char *hex, u8 *buf, size_t len)
{
 size_t i;
 int a;
...
void wpa_get_ntp_timestamp(u8 *buf)
{
 ...
 tmp = (( be32) (__extension__ ({ unsigned int __bsx = ((sec)); ((((__bsx) & 0xff000000) >> 24) | (((__bsx) & 0x00ff0000) >> 8) | (((__bsx) & 0x0000ff00) << 8) | (((__bsx) & 0x000000ff) << 24)); })));
 memcpy((buf), ((u8 *) &tmp), (4));
 tmp = (( be32) (__extension__ ({ unsigned int __bsx = ((usec)); ((((__bsx) & 0xff000000) >> 24) | (((__bsx) & 0x00ff0000) >> 8) | (((__bsx) & 0x0000ff00) << 8) | (((__bsx) & 0x000000ff) << 24)); })));
...
char * wpa_config_parse_string(const char *value, size_t *len)
{
 if (*value == '"') {
  ...
  value++;
  pos = 
# 238 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
       ((void *)0)
# 238 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
                             ;
  if (pos == 
# 239 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
            ((void *)0) 
# 239 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
                 || pos[1] != '\0')
   return 
# 240 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 240 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
             ;
  *len = pos - value;
  str = dup_binstr(value, *len);
  if (str == 
# 243 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
            ((void *)0)
# 243 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
                )
   return 
# 244 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 244 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
             ;
  return str;
  ...
  value += 2;
  pos = 
# 251 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
       ((void *)0)
# 251 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
                             ;
  if (pos == 
# 252 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
            ((void *)0) 
# 252 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
                 || pos[1] != '\0')
   return 
# 253 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 253 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
             ;
  tlen = pos - value;
  tstr = dup_binstr(value, tlen);
  if (tstr == 
# 256 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
             ((void *)0)
# 256 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
                 )
   return 
# 257 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 257 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
             ;

  str = malloc((tlen + 1));
  if (str == 
# 260 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
            ((void *)0)
# 260 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
                ) {
   free((tstr));
   return 
# 262 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 262 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
             ;
  }
  ...
  *len = printf_decode((u8 *) str, tlen + 1, tstr);
  ...
  if (hlen & 1)
   return 
# 273 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 273 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
             ;
  tlen = hlen / 2;
  str = malloc((tlen + 1));
  if (str == 
# 276 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
            ((void *)0)
# 276 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
                )
   return 
# 277 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 277 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
             ;
  if (hexstr2bin(value, str, tlen)) {
   free((str));
   return 
# 280 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 280 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
             ;
  }
  str[tlen] = '\0';
  *len = tlen;
...
char * dup_binstr(const void *src, size_t len)
{
 ...
 if (src == 
# 337 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
           ((void *)0)
# 337 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
               )
  return 
# 338 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
        ((void *)0)
# 338 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
            ;
 res = malloc((len + 1));
 if (res == 
# 340 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
           ((void *)0)
# 340 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
               )
  return 
# 341 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c" 3 4
        ((void *)0)
# 341 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/common.c"
            ;
 memcpy((res), (src), (len));
 res[len] = '\0';
