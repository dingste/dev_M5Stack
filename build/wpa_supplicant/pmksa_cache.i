# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
# 1 "/home/dieter/Development/ProjektEi/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
# 9 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
...
# 10 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 2
...
# 12 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 2
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_i.h" 1
# 13 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 2
...
# 14 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 2
...
# 15 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 2
...
static void pmksa_cache_expire(void *eloop_ctx)
{
    ...
    while (pmksa->pmksa && pmksa->pmksa->expiration <= now_sec) {
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSN: expired PMKSA cache entry for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSN: expired PMKSA cache entry for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSN: expired PMKSA cache entry for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSN: expired PMKSA cache entry for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5]); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSN: expired PMKSA cache entry for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5]); } } while(0); } while(0)
                                           ;
...
static void pmksa_cache_set_expiration(struct rsn_pmksa_cache *pmksa)
{
    ...
    if (pmksa->pmksa == 
# 77 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                       ((void *)0)
# 77 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                           )
        return;
...
# 104 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
struct rsn_pmksa_cache_entry *
pmksa_cache_add(struct rsn_pmksa_cache *pmksa, const u8 *pmk, size_t pmk_len,
        const u8 *kck, size_t kck_len,
        const u8 *aa, const u8 *spa, void *network_ctx, int akmp)
{
    ...
    if (pmk_len > 32)
        return 
# 113 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
              ((void *)0)
# 113 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                  ;

    if (wpa_key_mgmt_suite_b(akmp) && !kck)
        return 
# 116 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
              ((void *)0)
# 116 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                  ;

    entry = calloc(1, (sizeof(*entry)));
    if (entry == 
# 119 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                ((void *)0)
# 119 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                    )
        return 
# 120 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
              ((void *)0)
# 120 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                  ;
    ...
    pos = pmksa->pmksa;
    prev = 
# 135 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
          ((void *)0)
# 135 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
              ;
    while (pos) {
        if (memcmp((aa), (pos->aa), (6)) == 0) {
            if (pos->pmk_len == pmk_len &&
                    ...
                    memcmp((pos->pmkid), (entry->pmkid), (16))
                                   == 0) {
                do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPA: reusing previous " "PMKSA entry" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPA: reusing previous " "PMKSA entry" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPA: reusing previous " "PMKSA entry" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPA: reusing previous " "PMKSA entry" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPA: reusing previous " "PMKSA entry" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                      ;
                free((entry));
                return pos;
            }
            if (prev == 
# 147 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                       ((void *)0)
# 147 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                           )
                pmksa->pmksa = pos->next;
            else
                prev->next = pos->next;
# 161 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSN: Replace PMKSA entry for " "the current AP and any PMKSA cache entry " "that was based on the old PMK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSN: Replace PMKSA entry for " "the current AP and any PMKSA cache entry " "that was based on the old PMK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSN: Replace PMKSA entry for " "the current AP and any PMKSA cache entry " "that was based on the old PMK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSN: Replace PMKSA entry for " "the current AP and any PMKSA cache entry " "that was based on the old PMK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSN: Replace PMKSA entry for " "the current AP and any PMKSA cache entry " "that was based on the old PMK" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
...
# 185 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                                                  ((void *)0)
# 185 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                                                      ;
        } else
            pmksa->pmksa = pos->next;

        if (pos) {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSN: removed the oldest idle " "PMKSA cache entry (for " "%02x:%02x:%02x:%02x:%02x:%02x" ") to " "make room for new one" "\033[0m" "\n", esp_log_timestamp(), "wpa", (pos->aa)[0], (pos->aa)[1], (pos->aa)[2], (pos->aa)[3], (pos->aa)[4], (pos->aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSN: removed the oldest idle " "PMKSA cache entry (for " "%02x:%02x:%02x:%02x:%02x:%02x" ") to " "make room for new one" "\033[0m" "\n", esp_log_timestamp(), "wpa", (pos->aa)[0], (pos->aa)[1], (pos->aa)[2], (pos->aa)[3], (pos->aa)[4], (pos->aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSN: removed the oldest idle " "PMKSA cache entry (for " "%02x:%02x:%02x:%02x:%02x:%02x" ") to " "make room for new one" "\033[0m" "\n", esp_log_timestamp(), "wpa", (pos->aa)[0], (pos->aa)[1], (pos->aa)[2], (pos->aa)[3], (pos->aa)[4], (pos->aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSN: removed the oldest idle " "PMKSA cache entry (for " "%02x:%02x:%02x:%02x:%02x:%02x" ") to " "make room for new one" "\033[0m" "\n", esp_log_timestamp(), "wpa", (pos->aa)[0], (pos->aa)[1], (pos->aa)[2], (pos->aa)[3], (pos->aa)[4], (pos->aa)[5]); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSN: removed the oldest idle " "PMKSA cache entry (for " "%02x:%02x:%02x:%02x:%02x:%02x" ") to " "make room for new one" "\033[0m" "\n", esp_log_timestamp(), "wpa", (pos->aa)[0], (pos->aa)[1], (pos->aa)[2], (pos->aa)[3], (pos->aa)[4], (pos->aa)[5]); } } while(0); } while(0)
    ...
    pos = pmksa->pmksa;
    prev = 
# 200 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
          ((void *)0)
# 200 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
              ;
    while (pos) {
    ...
    if (prev == 
# 207 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
               ((void *)0)
# 207 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                   ) {
    ...
    pmksa->pmksa_count++;
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSN: Added PMKSA cache entry for " "%02x:%02x:%02x:%02x:%02x:%02x" " network_ctx=%p" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5], network_ctx); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSN: Added PMKSA cache entry for " "%02x:%02x:%02x:%02x:%02x:%02x" " network_ctx=%p" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5], network_ctx); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSN: Added PMKSA cache entry for " "%02x:%02x:%02x:%02x:%02x:%02x" " network_ctx=%p" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5], network_ctx); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSN: Added PMKSA cache entry for " "%02x:%02x:%02x:%02x:%02x:%02x" " network_ctx=%p" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5], network_ctx); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSN: Added PMKSA cache entry for " "%02x:%02x:%02x:%02x:%02x:%02x" " network_ctx=%p" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5], network_ctx); } } while(0); } while(0)
                                                               ;

    return entry;
}
# 230 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
void pmksa_cache_flush(struct rsn_pmksa_cache *pmksa, void *network_ctx,
        const u8 *pmk, size_t pmk_len)
{
    struct rsn_pmksa_cache_entry *entry, *prev = 
# 233 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                                                ((void *)0)
# 233 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                                                    , *tmp;
    int removed = 0;
    ...
    while (entry) {
        if ((entry->network_ctx == network_ctx ||
                    network_ctx == 
# 239 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                                  ((void *)0)
# 239 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                                      ) &&
                (pmk == 
# 240 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                       ((void *)0) 
# 240 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                            ||
                 (pmk_len == entry->pmk_len &&
                  memcmp((pmk), (entry->pmk), (pmk_len)) == 0))) {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSN: Flush PMKSA cache entry " "for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSN: Flush PMKSA cache entry " "for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSN: Flush PMKSA cache entry " "for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSN: Flush PMKSA cache entry " "for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5]); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSN: Flush PMKSA cache entry " "for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (entry->aa)[0], (entry->aa)[1], (entry->aa)[2], (entry->aa)[3], (entry->aa)[4], (entry->aa)[5]); } } while(0); } while(0)
                                                      ;
            if (prev)
...
void pmksa_cache_deinit(struct rsn_pmksa_cache *pmksa)
{
    ...
    if (pmksa == 
# 271 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                ((void *)0)
# 271 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                    )
        return;

    entry = pmksa->pmksa;
    pmksa->pmksa = 
# 275 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                  ((void *)0)
# 275 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                      ;
    while (entry) {
        prev = entry;
        entry = entry->next;
...
# 295 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
struct rsn_pmksa_cache_entry * pmksa_cache_get(struct rsn_pmksa_cache *pmksa,
        const u8 *aa, const u8 *pmkid,
        const void *network_ctx)
{
    ...
    while (entry) {
        if ((aa == 
# 301 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                  ((void *)0) 
# 301 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                       || memcmp((entry->aa), (aa), (6)) == 0) &&
                (pmkid == 
# 302 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                         ((void *)0) 
# 302 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                              ||
                 memcmp((entry->pmkid), (pmkid), (16)) == 0) &&
                (network_ctx == 
# 304 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                               ((void *)0) 
# 304 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                                    || network_ctx == entry->network_ctx))
            return entry;
        entry = entry->next;
    }
    return 
# 308 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
          ((void *)0)
# 308 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
              ;
}
...
# 320 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
           ((void *)0)
# 320 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
               , 0,
            aa, pmksa->sm->own_addr,
            old_entry->network_ctx, old_entry->akmp);
    if (new_entry == 
# 323 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                    ((void *)0)
# 323 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                        )
        return 
# 324 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
              ((void *)0)
# 324 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                  ;
...
# 345 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
struct rsn_pmksa_cache_entry *
        ...
        const u8 *aa)
{
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSN: Consider " "%02x:%02x:%02x:%02x:%02x:%02x" " for OKC" "\033[0m" "\n", esp_log_timestamp(), "wpa", (aa)[0], (aa)[1], (aa)[2], (aa)[3], (aa)[4], (aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSN: Consider " "%02x:%02x:%02x:%02x:%02x:%02x" " for OKC" "\033[0m" "\n", esp_log_timestamp(), "wpa", (aa)[0], (aa)[1], (aa)[2], (aa)[3], (aa)[4], (aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSN: Consider " "%02x:%02x:%02x:%02x:%02x:%02x" " for OKC" "\033[0m" "\n", esp_log_timestamp(), "wpa", (aa)[0], (aa)[1], (aa)[2], (aa)[3], (aa)[4], (aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSN: Consider " "%02x:%02x:%02x:%02x:%02x:%02x" " for OKC" "\033[0m" "\n", esp_log_timestamp(), "wpa", (aa)[0], (aa)[1], (aa)[2], (aa)[3], (aa)[4], (aa)[5]); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSN: Consider " "%02x:%02x:%02x:%02x:%02x:%02x" " for OKC" "\033[0m" "\n", esp_log_timestamp(), "wpa", (aa)[0], (aa)[1], (aa)[2], (aa)[3], (aa)[4], (aa)[5]); } } while(0); } while(0);
    if (network_ctx == 
# 352 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                      ((void *)0)
# 352 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                          )
        return 
# 353 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
              ((void *)0)
# 353 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                  ;
    while (entry) {
        if (entry->network_ctx == network_ctx) {
            entry = pmksa_cache_clone_entry(pmksa, entry, aa);
            if (entry) {
                do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSN: added " "opportunistic PMKSA cache entry " "for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (aa)[0], (aa)[1], (aa)[2], (aa)[3], (aa)[4], (aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSN: added " "opportunistic PMKSA cache entry " "for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (aa)[0], (aa)[1], (aa)[2], (aa)[3], (aa)[4], (aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSN: added " "opportunistic PMKSA cache entry " "for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (aa)[0], (aa)[1], (aa)[2], (aa)[3], (aa)[4], (aa)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSN: added " "opportunistic PMKSA cache entry " "for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (aa)[0], (aa)[1], (aa)[2], (aa)[3], (aa)[4], (aa)[5]); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSN: added " "opportunistic PMKSA cache entry " "for " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (aa)[0], (aa)[1], (aa)[2], (aa)[3], (aa)[4], (aa)[5]); } } while(0); } while(0)
    ...
    return 
# 366 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
          ((void *)0)
# 366 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
              ;
}
...
{
    if (sm == 
# 377 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
             ((void *)0)
# 377 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                 )
        return 
# 378 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
              ((void *)0)
# 378 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                  ;
    return sm->cur_pmksa;
}
...
{
    if (sm == 
# 389 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
             ((void *)0)
# 389 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                 )
        return;
    sm->cur_pmksa = 
# 391 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                   ((void *)0)
# 391 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                       ;
}
# 404 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
int pmksa_cache_set_current(struct wpa_sm *sm, const u8 *pmkid,
        const u8 *bssid, void *network_ctx,
        int try_opportunistic)
{
    struct rsn_pmksa_cache *pmksa = sm->pmksa;
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSN: PMKSA cache search - network_ctx=%p " "try_opportunistic=%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", network_ctx, try_opportunistic); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSN: PMKSA cache search - network_ctx=%p " "try_opportunistic=%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", network_ctx, try_opportunistic); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSN: PMKSA cache search - network_ctx=%p " "try_opportunistic=%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", network_ctx, try_opportunistic); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSN: PMKSA cache search - network_ctx=%p " "try_opportunistic=%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", network_ctx, try_opportunistic); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSN: PMKSA cache search - network_ctx=%p " "try_opportunistic=%d" "\033[0m" "\n", esp_log_timestamp(), "wpa", network_ctx, try_opportunistic); } } while(0); } while(0)
                                                                   ;
    if (pmkid)
        wpa_hexdump(ESP_LOG_DEBUG, "RSN: Search for PMKID",
                pmkid, 16);
    if (bssid)
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSN: Search for BSSID " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (bssid)[0], (bssid)[1], (bssid)[2], (bssid)[3], (bssid)[4], (bssid)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSN: Search for BSSID " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (bssid)[0], (bssid)[1], (bssid)[2], (bssid)[3], (bssid)[4], (bssid)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSN: Search for BSSID " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (bssid)[0], (bssid)[1], (bssid)[2], (bssid)[3], (bssid)[4], (bssid)[5]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSN: Search for BSSID " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (bssid)[0], (bssid)[1], (bssid)[2], (bssid)[3], (bssid)[4], (bssid)[5]); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSN: Search for BSSID " "%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "wpa", (bssid)[0], (bssid)[1], (bssid)[2], (bssid)[3], (bssid)[4], (bssid)[5]); } } while(0); } while(0)
                               ;

    sm->cur_pmksa = 
# 418 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                   ((void *)0)
# 418 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                       ;
    if (pmkid)
        sm->cur_pmksa = pmksa_cache_get(pmksa, 
# 420 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                                              ((void *)0)
# 420 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                                                  , pmkid,
                network_ctx);
    if (sm->cur_pmksa == 
# 422 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                        ((void *)0) 
# 422 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                             && bssid)
        sm->cur_pmksa = pmksa_cache_get(pmksa, bssid, 
# 423 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                                                     ((void *)0)
# 423 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                                                         ,
                network_ctx);
    if (sm->cur_pmksa == 
# 425 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                        ((void *)0) 
# 425 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                             && try_opportunistic && bssid)
        sm->cur_pmksa = pmksa_cache_get_opportunistic(pmksa,
                network_ctx,
                bssid);
    if (sm->cur_pmksa) {
        wpa_hexdump(ESP_LOG_DEBUG, "RSN: PMKSA cache entry found - PMKID",
                sm->cur_pmksa->pmkid, 16);
        return 0;
    }
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSN: No PMKSA cache entry found" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSN: No PMKSA cache entry found" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSN: No PMKSA cache entry found" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSN: No PMKSA cache entry found" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSN: No PMKSA cache entry found" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
    return -1;
}
# 449 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
int pmksa_cache_list(struct rsn_pmksa_cache *pmksa, char *buf, size_t len)
{
    int i, ret;
    char *pos = buf;
...
# 491 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
struct rsn_pmksa_cache *
pmksa_cache_init(void (*free_cb)(struct rsn_pmksa_cache_entry *entry,
            void *ctx, enum pmksa_free_reason reason),
        void *ctx, struct wpa_sm *sm)
{
    ...
    if (pmksa) {
        ...
        pmksa->pmksa_count = 0;
        pmksa->pmksa = 
# 504 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c" 3 4
                      ((void *)0)
# 504 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/pmksa_cache.c"
                          ;
