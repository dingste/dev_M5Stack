# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
# 1 "/home/dieter/Development/ProjektEi/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
# 9 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
...
# 10 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 2
...
# 12 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 2
...
int hmac_md5(const uint8_t *key, size_t key_len, const uint8_t *data, size_t data_len,
      uint8_t *mac);
# 13 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 2
...
# 14 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 2
...
# 15 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 2
# 31 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
int tlsv1_record_set_cipher_suite(struct tlsv1_record_layer *rl,
      u16 cipher_suite)
{
 ...
 if (suite == 
# 42 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 3 4
             ((void *)0)
# 42 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
                 )
  return -1;
 ...
 if (data == 
# 57 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 3 4
            ((void *)0)
# 57 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
                )
  return -1;
...
# 76 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
int tlsv1_record_change_write_cipher(struct tlsv1_record_layer *rl)
{
 ...
 if (rl->write_cbc) {
  ...
  rl->write_cbc = 
# 85 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 3 4
                 ((void *)0)
# 85 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
                     ;
 ...
 if (rl->cipher_alg != CRYPTO_CIPHER_NULL) {
  ...
  if (rl->write_cbc == 
# 93 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 3 4
                      ((void *)0)
# 93 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
                          ) {
...
# 112 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
int tlsv1_record_change_read_cipher(struct tlsv1_record_layer *rl)
{
 ...
 if (rl->read_cbc) {
  ...
  rl->read_cbc = 
# 121 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 3 4
                 ((void *)0)
# 121 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
                     ;
 }
 ...
 if (rl->cipher_alg != CRYPTO_CIPHER_NULL) {
  rl->read_cbc = crypto_cipher_init(rl->cipher_alg,
         ...
         rl->key_material_len);
  if (rl->read_cbc == 
# 128 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 3 4
                     ((void *)0)
# 128 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
                         ) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Failed to initialize " "cipher" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                ;
   return -1;
...
# 154 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
int tlsv1_record_send(struct tlsv1_record_layer *rl, u8 content_type, u8 *buf,
        size_t buf_size, const u8 *payload, size_t payload_len,
        size_t *out_len)
{
...
# 159 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 3 4
                           ((void *)0)
# 159 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
                               ;
 size_t clen;
 int explicit_iv;
 ...
 *pos++ = content_type;
 ...
 if (rl->write_cipher_suite != 0x0000) {
  ...
  if (hmac == 
# 212 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 3 4
             ((void *)0)
# 212 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
                 ) {
  ...
  crypto_hash_update(hmac, rl->write_seq_num, 8);

  crypto_hash_update(hmac, ct_start, 5);
  ...
  if (clen < rl->hash_size) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Record Layer - Not " "enough room for MAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Record Layer - Not " "enough room for MAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Record Layer - Not " "enough room for MAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Record Layer - Not " "enough room for MAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Record Layer - Not " "enough room for MAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                             ;
   crypto_hash_finish(hmac, 
# 225 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 3 4
                           ((void *)0)
# 225 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
                               , 
# 225 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 3 4
                                 ((void *)0)
# 225 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
...
# 282 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
int tlsv1_record_receive(struct tlsv1_record_layer *rl,
    const u8 *in_data, size_t in_len,
    u8 *out_data, size_t *out_len, u8 *alert)
{
 ...
 u8 padlen;
 struct crypto_hash *hmac = 
# 288 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 3 4
                           ((void *)0)
# 288 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
                               ;
 u8 len[2], hash[100];
 ...
 if (rl->read_cipher_suite != 0x0000) {
  ...
  if (rl->iv_size) {
# 383 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
 ...
 check_mac:
  ...
  if (hmac == 
# 443 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c" 3 4
             ((void *)0)
# 443 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/tlsv1_record.c"
                 ) {
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "TLSv1: Record Layer - Failed " "to initialize HMAC" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                            ;
   *alert = 80;
  ...
  crypto_hash_update(hmac, rl->read_seq_num, 8);

  crypto_hash_update(hmac, in_data - 5, 3);
