# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
# 1 "/home/dieter/Development/ProjektEi/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
# 9 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
...
# 10 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 2
...
# 12 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 2
...
# 13 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 2
...
int bignum_exptmod(const struct bignum *a, const struct bignum *b,
     const struct bignum *c, struct bignum *d);
# 14 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 2
...
# 15 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 2
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.h" 1
# 12 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.h"
...
# 17 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 2
...
struct crypto_private_key * pkcs8_key_import(const u8 *buf, size_t len)
{
 ...
 if (asn1_get_next(buf, len, &hdr) < 0 ||
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #8: Does not start with PKCS #8 " "header (SEQUENCE); assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #8: Does not start with PKCS #8 " "header (SEQUENCE); assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #8: Does not start with PKCS #8 " "header (SEQUENCE); assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #8: Does not start with PKCS #8 " "header (SEQUENCE); assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #8: Does not start with PKCS #8 " "header (SEQUENCE); assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                                   ;
  return 
# 34 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 34 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
 }
 pos = hdr.payload;
 end = pos + hdr.length;
 ...
 if (asn1_get_next(pos, end - pos, &hdr) < 0 ||
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #8: Expected INTEGER - found " "class %d tag 0x%x; assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #8: Expected INTEGER - found " "class %d tag 0x%x; assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #8: Expected INTEGER - found " "class %d tag 0x%x; assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #8: Expected INTEGER - found " "class %d tag 0x%x; assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #8: Expected INTEGER - found " "class %d tag 0x%x; assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } } while(0); } while(0)
                         ...
                         ;
  return 
# 45 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 45 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
 }

 zero = bignum_init();
 if (zero == 
# 49 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
            ((void *)0)
# 49 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
                )
  return 
# 50 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 50 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
 ...
 if (bignum_set_unsigned_bin(zero, hdr.payload, hdr.length) < 0) {
  ...
  bignum_deinit(zero);
  return 
# 55 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 55 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
 }
 ...
 if (bignum_cmp_d(zero, 0) != 0) {
  ...
  bignum_deinit(zero);
  return 
# 64 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 64 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
 }
 bignum_deinit(zero);
 ...
 if (asn1_get_next(pos, len, &hdr) < 0 ||
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #8: Expected SEQUENCE " "(AlgorithmIdentifier) - found class %d tag 0x%x; " "assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #8: Expected SEQUENCE " "(AlgorithmIdentifier) - found class %d tag 0x%x; " "assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #8: Expected SEQUENCE " "(AlgorithmIdentifier) - found class %d tag 0x%x; " "assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #8: Expected SEQUENCE " "(AlgorithmIdentifier) - found class %d tag 0x%x; " "assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #8: Expected SEQUENCE " "(AlgorithmIdentifier) - found class %d tag 0x%x; " "assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } } while(0); } while(0)
                         ...
                         ;
  return 
# 77 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 77 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
 }
 ...
 if (asn1_get_oid(hdr.payload, hdr.length, &oid, &pos)) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #8: Failed to parse OID " "(algorithm); assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #8: Failed to parse OID " "(algorithm); assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #8: Failed to parse OID " "(algorithm); assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #8: Failed to parse OID " "(algorithm); assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #8: Failed to parse OID " "(algorithm); assume PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                                             ;
  return 
# 83 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 83 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
 }
 ...
 if (oid.len != 7 ||
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #8: Unsupported private key " "algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #8: Unsupported private key " "algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #8: Unsupported private key " "algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #8: Unsupported private key " "algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #8: Unsupported private key " "algorithm %s" "\033[0m" "\n", esp_log_timestamp(), "wpa", obuf); } } while(0); } while(0)
                           ;
  return 
# 99 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 99 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
 }
 ...
 if (asn1_get_next(pos, end - pos, &hdr) < 0 ||
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #8: Expected OCTETSTRING " "(privateKey) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #8: Expected OCTETSTRING " "(privateKey) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #8: Expected OCTETSTRING " "(privateKey) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #8: Expected OCTETSTRING " "(privateKey) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #8: Expected OCTETSTRING " "(privateKey) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } } while(0); } while(0)
                         ...
                         ;
  return 
# 111 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 111 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
 }
...
pkcs8_enc_key_import(const u8 *buf, size_t len, const char *passwd)
{
 ...
 if (passwd == 
# 129 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
              ((void *)0)
# 129 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
                  )
  return 
# 130 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 130 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
# 141 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
 if (asn1_get_next(buf, len, &hdr) < 0 ||
     hdr.class != 0 ||
     hdr.tag != 0x10) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #8: Does not start with PKCS #8 " "header (SEQUENCE); assume encrypted PKCS #8 not " "used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #8: Does not start with PKCS #8 " "header (SEQUENCE); assume encrypted PKCS #8 not " "used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #8: Does not start with PKCS #8 " "header (SEQUENCE); assume encrypted PKCS #8 not " "used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #8: Does not start with PKCS #8 " "header (SEQUENCE); assume encrypted PKCS #8 not " "used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #8: Does not start with PKCS #8 " "header (SEQUENCE); assume encrypted PKCS #8 not " "used" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
             ...
             ;
  return 
# 147 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 147 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
 }
 pos = hdr.payload;
 end = pos + hdr.length;
 ...
 if (asn1_get_next(pos, end - pos, &hdr) < 0 ||
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #8: Expected SEQUENCE " "(AlgorithmIdentifier) - found class %d tag 0x%x; " "assume encrypted PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #8: Expected SEQUENCE " "(AlgorithmIdentifier) - found class %d tag 0x%x; " "assume encrypted PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #8: Expected SEQUENCE " "(AlgorithmIdentifier) - found class %d tag 0x%x; " "assume encrypted PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #8: Expected SEQUENCE " "(AlgorithmIdentifier) - found class %d tag 0x%x; " "assume encrypted PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #8: Expected SEQUENCE " "(AlgorithmIdentifier) - found class %d tag 0x%x; " "assume encrypted PKCS #8 not used" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } } while(0); } while(0)
                         ...
                         ;
  return 
# 160 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 160 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
 }
 enc_alg = hdr.payload;
 ...
 if (asn1_get_next(pos, end - pos, &hdr) < 0 ||
  ...
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "PKCS #8: Expected OCTETSTRING " "(encryptedData) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "PKCS #8: Expected OCTETSTRING " "(encryptedData) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "PKCS #8: Expected OCTETSTRING " "(encryptedData) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "PKCS #8: Expected OCTETSTRING " "(encryptedData) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "PKCS #8: Expected OCTETSTRING " "(encryptedData) - found class %d tag 0x%x" "\033[0m" "\n", esp_log_timestamp(), "wpa", hdr.class, hdr.tag); } } while(0); } while(0)
                         ...
                         ;
  return 
# 173 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
        ((void *)0)
# 173 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
            ;
 }
 ...
 return 
# 185 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c" 3 4
       ((void *)0)
# 185 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/tls/pkcs8.c"
           ;
}
