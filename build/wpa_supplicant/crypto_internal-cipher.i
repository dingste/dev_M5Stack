# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
# 1 "/home/dieter/Development/ProjektEi/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
# 24 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
...
# 21 "/home/dieter/Development/esp-idf/components/wpa_supplicant/port/include/os.h" 2
...
# 25 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 2
...
# 26 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 2
...
int crypto_ec_point_cmp(const struct crypto_ec *e,
        ...
        const struct crypto_ec_point *b);
# 27 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 2
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/aes.h" 1
# 20 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/aes.h"
void * aes_encrypt_init(const u8 *key, size_t len);
void aes_encrypt(void *ctx, const u8 *plain, u8 *crypt);
void aes_encrypt_deinit(void *ctx);
void * aes_decrypt_init(const u8 *key, size_t len);
void aes_decrypt(void *ctx, const u8 *crypt, u8 *plain);
void aes_decrypt_deinit(void *ctx);
# 28 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 2
...
# 33 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 2
...
# 66 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
 } u;
};
       ...
       size_t key_len)
{
 ...
 if (ctx == 
# 77 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
           ((void *)0)
# 77 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
               )
  return 
# 78 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
        ((void *)0)
# 78 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
            ;
 ...
 case CRYPTO_CIPHER_ALG_RC4:
  if (key_len > sizeof(ctx->u.rc4.key)) {
   free((ctx));
   return 
# 86 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
         ((void *)0)
# 86 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
             ;
  }
 ...
 case CRYPTO_CIPHER_ALG_AES:
  ...
  esp_aes_setkey(&(ctx->u.aes.ctx_enc), key, key_len * 8);
  esp_aes_init(&(ctx->u.aes.ctx_dec));
  esp_aes_setkey(&(ctx->u.aes.ctx_dec), key, key_len * 8);
# 110 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
  memcpy((ctx->u.aes.cbc), (iv), (16));
  break;
# 132 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
 default:
  free((ctx));
  return 
# 134 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
        ((void *)0)
# 134 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
            ;
 }
     ...
     u8 *crypt, size_t len)
{
 ...
 case CRYPTO_CIPHER_ALG_AES:
  ...
  for (i = 0; i < blocks; i++) {
   ...
   if (esp_internal_aes_encrypt(&(ctx->u.aes.ctx_enc),
  ...
  break;
# 206 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
 default:
  return -1;
 }
     ...
     u8 *plain, size_t len)
{
 ...
 case CRYPTO_CIPHER_ALG_AES:
  ...
  for (i = 0; i < blocks; i++) {
   ...
   if (esp_internal_aes_decrypt(&(ctx->u.aes.ctx_dec),
        crypt, plain) != 0)
    return -1;
  ...
  break;
# 280 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
 default:
  return -1;
 }
...
void crypto_cipher_deinit(struct crypto_cipher *ctx)
{
 ...
 case CRYPTO_CIPHER_ALG_AES:
  ...
  esp_aes_free(&(ctx->u.aes.ctx_enc));
  esp_aes_free(&(ctx->u.aes.ctx_dec));
