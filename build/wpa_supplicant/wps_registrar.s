...
.LVL157:
	...
	l32i.n	a9, a8, 0
	beqz.n	a9, .L140
	.loc 3 1880 0 is_stmt 0 discriminator 1
	l32i.n	a8, a8, 12
	beqz.n	a8, .L140
	.loc 3 1882 0 is_stmt 1 discriminator 1
	movi.n	a8, 0xf
	moveqz	a4, a8, a4
.LVL158:
.L140:
...
.LBE214:
	...
	l32i	a6, a2, 648
	beqz.n	a6, .L356
	.loc 3 1703 0 is_stmt 0 discriminator 1
	l32i	a6, a4, 264
	beqz.n	a6, .L356
.LBB215:
...
.LC67:
	...
	.literal .LC60, .LC59
	.literal .LC61, 4158
	.literal .LC62, __FUNCTION__$6262
	.literal .LC64, .LC63
	.literal .LC66, .LC65
	.literal .LC68, .LC67
	.literal .LC69, 4159
...
.LCFI41:
	...
	movi.n	a4, 0x15
	beq	a5, a4, .L585
	.loc 3 3166 0 is_stmt 0 discriminator 1
	l32i	a4, a2, 620
	bnez.n	a4, .L585
.LVL632:
.L587:
	.loc 3 3169 0 is_stmt 1
	movi.n	a2, 2
.LVL633:
	retw.n
.LVL634:
...
.LVL639:
	...
	l32i.n	a3, a4, 8
	bnei	a3, 1, .L588
	.loc 3 3213 0 is_stmt 0 discriminator 1
	l32i	a7, a2, 336
	beqz.n	a7, .L588
	.loc 3 3213 0 discriminator 2
	l32i.n	a3, a4, 0
	beqz.n	a3, .L588
	.loc 3 3214 0 is_stmt 1
	l32i.n	a3, a4, 4
	l32i	a11, a3, 68
	bnez.n	a11, .L588
.LBB325:
...
.LBE325:
	...
	l32i.n	a3, a3, 0
	bnez.n	a3, .L590
	.loc 3 3239 0 is_stmt 0 discriminator 1
	l32i.n	a3, a2, 8
	bnez.n	a3, .L590
	.loc 3 3240 0 is_stmt 1
	mov.n	a10, a2
...
.LC97:
	...
	.literal .LC89, __FUNCTION__$6395
	.literal .LC90, .LC63
	.literal .LC91, .LC65
	.literal .LC93, .LC92
	.literal .LC94, __FUNCTION__$6403
	.literal .LC96, .LC95
	.literal .LC98, .LC97
	.literal .LC99, 4110
	.align	4
...
.LVL876:
	.loc 3 3509 0
	bltz	a10, .L844
	.loc 3 3509 0 is_stmt 0 discriminator 1
	bgeu	a10, a5, .L844
	mov.n	a2, a10
	retw.n
.LVL877:
.L836:
	.loc 3 3490 0 is_stmt 1
	movi	a10, 0x8c
	movi.n	a12, 0x28
	addi	a11, sp, 16
	add.n	a10, a2, a10
