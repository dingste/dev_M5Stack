# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpa_debug.c"
# 1 "/home/dieter/Development/ProjektEi/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpa_debug.c"
# 15 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpa_debug.c"
...
# 16 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpa_debug.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpa_debug.c" 2
...
{
    char output[50];
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "%s\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", desc); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "%s\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", desc); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "%s\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", desc); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "%s\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", desc); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "%s\n" "\033[0m" "\n", esp_log_timestamp(), "wpa", desc); } } while(0); } while(0);
    if (addr){
        uint16_t i=0;
        for (i = 0; i < len / 16; i++) {
            _wpa_snprintf_hex(output, 50, addr + i * 16, 16, 0, 1);
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "%s" "\033[0m" "\n", esp_log_timestamp(), "wpa", output); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "%s" "\033[0m" "\n", esp_log_timestamp(), "wpa", output); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "%s" "\033[0m" "\n", esp_log_timestamp(), "wpa", output); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "%s" "\033[0m" "\n", esp_log_timestamp(), "wpa", output); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "%s" "\033[0m" "\n", esp_log_timestamp(), "wpa", output); } } while(0); } while(0);
        }
        if (len % 16) {
...
void wpa_debug_print_timestamp(void)
{
    ...
    struct os_time tv;
    os_get_time(&tv);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "%ld.%06u: " "\033[0m" "\n", esp_log_timestamp(), "wpa", (long) tv.sec, (unsigned int) tv.usec); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "%ld.%06u: " "\033[0m" "\n", esp_log_timestamp(), "wpa", (long) tv.sec, (unsigned int) tv.usec); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "%ld.%06u: " "\033[0m" "\n", esp_log_timestamp(), "wpa", (long) tv.sec, (unsigned int) tv.usec); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "%ld.%06u: " "\033[0m" "\n", esp_log_timestamp(), "wpa", (long) tv.sec, (unsigned int) tv.usec); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "%ld.%06u: " "\033[0m" "\n", esp_log_timestamp(), "wpa", (long) tv.sec, (unsigned int) tv.usec); } } while(0); } while(0);
...
void wpa_hexdump(int level, const char *title, const u8 *buf, size_t len)
{
 ...
 do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "%s - hexdump(len=%lu):" "\033[0m" "\n", esp_log_timestamp(), "wpa", title, (unsigned long) len); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "%s - hexdump(len=%lu):" "\033[0m" "\n", esp_log_timestamp(), "wpa", title, (unsigned long) len); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "%s - hexdump(len=%lu):" "\033[0m" "\n", esp_log_timestamp(), "wpa", title, (unsigned long) len); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "%s - hexdump(len=%lu):" "\033[0m" "\n", esp_log_timestamp(), "wpa", title, (unsigned long) len); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "%s - hexdump(len=%lu):" "\033[0m" "\n", esp_log_timestamp(), "wpa", title, (unsigned long) len); } } while(0); } while(0);
 if (buf == 
# 98 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpa_debug.c" 3 4
           ((void *)0)
# 98 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/utils/wpa_debug.c"
               ) {
  do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " " [NULL]" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " " [NULL]" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " " [NULL]" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " " [NULL]" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " " [NULL]" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0);
 } else {
  for (i = 0; i < len / 16; i++) {
