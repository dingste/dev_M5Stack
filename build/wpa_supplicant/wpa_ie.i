# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
# 1 "/home/dieter/Development/ProjektEi/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
# 16 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
...
# 17 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 2
...
# 21 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 2
...
int wpa_parse_wpa_ie(const u8 *wpa_ie, size_t wpa_ie_len,
             struct wpa_ie_data *data);
# 22 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 2
...
# 23 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 2
# 33 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
int wpa_parse_wpa_ie(const u8 *wpa_ie, size_t wpa_ie_len,
       struct wpa_ie_data *data)
{
                  ...
                  int key_mgmt)
{
    ...
    if (group_cipher == (1UL << (3))) {
        WPA_PUT_BE32((u8 *) (pos), (((((u32) (0x00)) << 24) | (((u32) (0x50)) << 16) | (((u32) (0xf2)) << 8) | (u32) (4))));
    } else if (group_cipher == (1UL << (1))) {
        WPA_PUT_BE32((u8 *) (pos), (((((u32) (0x00)) << 24) | (((u32) (0x50)) << 16) | (((u32) (0xf2)) << 8) | (u32) (2))));
    } else if (group_cipher == (1UL << (8))) {
        WPA_PUT_BE32((u8 *) (pos), (((((u32) (0x00)) << 24) | (((u32) (0x50)) << 16) | (((u32) (0xf2)) << 8) | (u32) (5))));
    } else if (group_cipher == (1UL << (7))) {
        WPA_PUT_BE32((u8 *) (pos), (((((u32) (0x00)) << 24) | (((u32) (0x50)) << 16) | (((u32) (0xf2)) << 8) | (u32) (1))));
    } else {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid group cipher (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", group_cipher); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Invalid group cipher (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", group_cipher); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Invalid group cipher (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", group_cipher); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Invalid group cipher (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", group_cipher); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Invalid group cipher (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", group_cipher); } } while(0); } while(0)
                            ;
        return -1;
    }
    pos += 4;
    ...
    *pos++ = 1;
    *pos++ = 0;
    if (pairwise_cipher == (1UL << (3))) {
        WPA_PUT_BE32((u8 *) (pos), (((((u32) (0x00)) << 24) | (((u32) (0x50)) << 16) | (((u32) (0xf2)) << 8) | (u32) (4))));
    } else if (pairwise_cipher == (1UL << (1))) {
        WPA_PUT_BE32((u8 *) (pos), (((((u32) (0x00)) << 24) | (((u32) (0x50)) << 16) | (((u32) (0xf2)) << 8) | (u32) (2))));
    } else if (pairwise_cipher == (1UL << (0))) {
        WPA_PUT_BE32((u8 *) (pos), (((((u32) (0x00)) << 24) | (((u32) (0x50)) << 16) | (((u32) (0xf2)) << 8) | (u32) (0))));
    } else {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid pairwise cipher (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", pairwise_cipher); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Invalid pairwise cipher (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", pairwise_cipher); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Invalid pairwise cipher (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", pairwise_cipher); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Invalid pairwise cipher (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", pairwise_cipher); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Invalid pairwise cipher (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", pairwise_cipher); } } while(0); } while(0)
                               ;
        return -1;
    }
    pos += 4;
    ...
    *pos++ = 0;
    if (key_mgmt == (1UL << (0))) {
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid key management type (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", key_mgmt); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Invalid key management type (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", key_mgmt); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Invalid key management type (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", key_mgmt); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Invalid key management type (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", key_mgmt); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Invalid key management type (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", key_mgmt); } } while(0); } while(0)
                        ;
        return -1;
    }
    pos += 4;
...
# 109 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 3 4
   ((
# 109 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
   (size_t) (pos - wpa_ie) <= wpa_ie_len
# 109 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c", 109, __func__, 
# 109 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
   "(size_t) (pos - wpa_ie) <= wpa_ie_len"
# 109 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 3 4
   ))
                  ...
                  struct wpa_sm *sm)
{
    ...
    if (rsn_ie_len < sizeof(*hdr) + 4 +
            2 + 4 + 2 + 4 + 2 +
            (sm->cur_pmksa ? 2 + 16 : 0)) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "RSN: Too short IE buffer (%lu bytes)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) rsn_ie_len); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "RSN: Too short IE buffer (%lu bytes)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) rsn_ie_len); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "RSN: Too short IE buffer (%lu bytes)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) rsn_ie_len); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "RSN: Too short IE buffer (%lu bytes)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) rsn_ie_len); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "RSN: Too short IE buffer (%lu bytes)" "\033[0m" "\n", esp_log_timestamp(), "wpa", (unsigned long) rsn_ie_len); } } while(0); } while(0)
                                           ;
        return -1;
    }
...
# 139 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 3 4
                                         1
# 139 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
                                             ) || (key_mgmt == (1UL << (0))) ) {
    ...
    if ( (sm->ap_notify_completed_rsne == 
# 169 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 3 4
                                         0
# 169 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
                                              ) && (key_mgmt != (1UL << (0))) ) {
    ...
    *pos++ = 0;
    if (key_mgmt == (1UL << (0))) {
        ...
        WPA_PUT_BE32((u8 *) (pos), (((((u32) (0x00)) << 24) | (((u32) (0x0f)) << 16) | (((u32) (0xac)) << 8) | (u32) (2))));
# 207 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
    } else {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid key management type (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", key_mgmt); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "Invalid key management type (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", key_mgmt); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "Invalid key management type (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", key_mgmt); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "Invalid key management type (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", key_mgmt); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "Invalid key management type (%d)." "\033[0m" "\n", esp_log_timestamp(), "wpa", key_mgmt); } } while(0); } while(0)
                        ;
        return -1;
...
# 248 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
    hdr->len = (pos - rsn_ie) - 2;

    
# 250 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 3 4
   ((
# 250 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
   (size_t) (pos - rsn_ie) <= rsn_ie_len
# 250 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c", 250, __func__, 
# 250 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
   "(size_t) (pos - rsn_ie) <= rsn_ie_len"
# 250 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c" 3 4
   ))
...
# 266 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
int wpa_gen_wpa_ie(struct wpa_sm *sm, u8 *wpa_ie, size_t wpa_ie_len)
{
    if (sm->proto == (1UL << (1)))
...
# 289 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
        ...
        struct wpa_eapol_ie_parse *ie)
{
 ...
 if (pos[1] >= 6 &&
  ...
  wpa_hexdump(ESP_LOG_DEBUG, "WPA: WPA IE in EAPOL-Key",
 ...
 if (pos + 1 + 4 < end &&
  ...
  ie->pmkid = pos + 2 + 4;
  wpa_hexdump(ESP_LOG_DEBUG, "WPA: PMKID in EAPOL-Key",
       pos, pos[1] + 2);
  return 0;
 }
 ...
 if (pos[1] > 4 + 2 &&
  ...
  ie->gtk = pos + 2 + 4;
  ie->gtk_len = pos[1] - 4;
  wpa_hexdump(ESP_LOG_DEBUG, "WPA: GTK in EAPOL-Key",
    pos, pos[1] + 2);
  return 0;
 }
 ...
 if (pos[1] > 4 + 2 &&
  ...
  wpa_hexdump(ESP_LOG_DEBUG, "WPA: MAC Address in EAPOL-Key",
       pos, pos[1] + 2);
  return 0;
 }
 return 0;
}
# 343 "/home/dieter/Development/esp-idf/components/wpa_supplicant/src/rsn_supp/wpa_ie.c"
int wpa_supplicant_parse_ies(const u8 *buf, size_t len,
        struct wpa_eapol_ie_parse *ie)
{
 const u8 *pos, *end;
 ...
 for (pos = buf, end = pos + len; pos + 1 < end; pos += 2 + pos[1]) {
  ...
  if (pos + 2 + pos[1] > end) {
   ...
   do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "WPA: EAPOL-Key Key Data " "underflow (ie=%d len=%d pos=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0], pos[1], (int) (pos - buf)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "WPA: EAPOL-Key Key Data " "underflow (ie=%d len=%d pos=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0], pos[1], (int) (pos - buf)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "WPA: EAPOL-Key Key Data " "underflow (ie=%d len=%d pos=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0], pos[1], (int) (pos - buf)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "WPA: EAPOL-Key Key Data " "underflow (ie=%d len=%d pos=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0], pos[1], (int) (pos - buf)); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "WPA: EAPOL-Key Key Data " "underflow (ie=%d len=%d pos=%d)" "\033[0m" "\n", esp_log_timestamp(), "wpa", pos[0], pos[1], (int) (pos - buf)); } } while(0); } while(0)

                                         ;

   wpa_hexdump(ESP_LOG_DEBUG, "WPA: Key Data",
     buf, len);
   ret = -1;
   break;
  }
  if (*pos == 48) {
   ...
   wpa_hexdump(ESP_LOG_DEBUG, "WPA: RSN IE in EAPOL-Key",
   ...
   wpa_hexdump(ESP_LOG_DEBUG, "WPA: Unrecognized EAPOL-Key "
