# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/esp_ringbuf//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 2
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 2
# 36 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
typedef struct {
...
# 89 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
...
static size_t prvGetFreeSize(Ringbuffer_t *pxRingbuffer)
{
    ...
    if (!(xReturn <= pxRingbuffer->xSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 156, __FUNCTION__); abort(); };
    return xReturn;
}
...
static BaseType_t prvCheckItemFitsDefault( Ringbuffer_t *pxRingbuffer, size_t xItemSize)
{
    ...
    if (!(( ( ( UBaseType_t ) pxRingbuffer->pucWrite & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 163, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucWrite >= pxRingbuffer->pucHead && pxRingbuffer->pucWrite < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 164, __FUNCTION__); abort(); };
...
static BaseType_t prvCheckItemFitsByteBuffer( Ringbuffer_t *pxRingbuffer, size_t xItemSize)
{
    ...
    if (!(pxRingbuffer->pucWrite >= pxRingbuffer->pucHead && pxRingbuffer->pucWrite < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 191, __FUNCTION__); abort(); };
...
static void prvCopyItemNoSplit(Ringbuffer_t *pxRingbuffer, const uint8_t *pucItem, size_t xItemSize)
{
    ...
    if (!(( ( ( UBaseType_t ) pxRingbuffer->pucWrite & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 210, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucWrite >= pxRingbuffer->pucHead && pxRingbuffer->pucWrite < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 211, __FUNCTION__); abort(); };
    if (!(xRemLen >= sizeof(ItemHeader_t))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 212, __FUNCTION__); abort(); };
...
static void prvCopyItemAllowSplit(Ringbuffer_t *pxRingbuffer, const uint8_t *pucItem, size_t xItemSize)
{
    ...
    size_t xAlignedItemSize = ( ( xItemSize + ( 0x0003 ) ) & ~( 0x0003 ) );
    size_t xRemLen = pxRingbuffer->pucTail - pxRingbuffer->pucWrite;
    if (!(( ( ( UBaseType_t ) pxRingbuffer->pucWrite & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 247, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucWrite >= pxRingbuffer->pucHead && pxRingbuffer->pucWrite < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 248, __FUNCTION__); abort(); };
    if (!(xRemLen >= sizeof(ItemHeader_t))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 249, __FUNCTION__); abort(); };
...
static void prvCopyItemByteBuf(Ringbuffer_t *pxRingbuffer, const uint8_t *pucItem, size_t xItemSize)
{
    ...
    if (!(pxRingbuffer->pucWrite >= pxRingbuffer->pucHead && pxRingbuffer->pucWrite < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 297, __FUNCTION__); abort(); };
...
static void *prvGetItemDefault(Ringbuffer_t *pxRingbuffer, BaseType_t *pxIsSplit, size_t xUnusedParam, size_t *pxItemSize)
{
    ...
    if (!(pxIsSplit != 
# 340 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 340 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 340, __FUNCTION__); abort(); };
    if (!((pxRingbuffer->xItemsWaiting > 0) && ((pxRingbuffer->pucRead != pxRingbuffer->pucWrite) || (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 4 ))))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 341, __FUNCTION__); abort(); };
    if (!(( ( ( UBaseType_t ) pxRingbuffer->pucRead & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 342, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucRead >= pxRingbuffer->pucHead && pxRingbuffer->pucRead < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 343, __FUNCTION__); abort(); };
    if (!((pxHeader->xItemLen <= pxRingbuffer->xMaxItemSize) || (pxHeader->uxItemFlags & ( ( UBaseType_t ) 2 )))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 344, __FUNCTION__); abort(); };
    ...
    if (pxHeader->uxItemFlags & ( ( UBaseType_t ) 2 )) {
        ...
        if (!(pxHeader->xItemLen <= pxRingbuffer->xMaxItemSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 352, __FUNCTION__); abort(); };
    }
    pcReturn = pxRingbuffer->pucRead + sizeof(ItemHeader_t);
    if (pxHeader->xItemLen == 0) {

        if (!(pcReturn >= pxRingbuffer->pucHead && pcReturn <= pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 357, __FUNCTION__); abort(); };
    } else {

        if (!(pcReturn >= pxRingbuffer->pucHead && pcReturn < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 360, __FUNCTION__); abort(); };
    }
...
static void *prvGetItemByteBuf(Ringbuffer_t *pxRingbuffer, BaseType_t *pxUnusedParam ,size_t xMaxSize, size_t *pxItemSize)
{
    ...
    if (!((pxRingbuffer->xItemsWaiting > 0) && ((pxRingbuffer->pucRead != pxRingbuffer->pucWrite) || (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 4 ))))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 377, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucRead >= pxRingbuffer->pucHead && pxRingbuffer->pucRead < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 378, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucRead == pxRingbuffer->pucFree)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 379, __FUNCTION__); abort(); };
...
static void prvReturnItemDefault(Ringbuffer_t *pxRingbuffer, uint8_t *pucItem)
{
    ...
    if (!(( ( ( UBaseType_t ) pucItem & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 415, __FUNCTION__); abort(); };
    if (!(pucItem >= pxRingbuffer->pucHead)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 416, __FUNCTION__); abort(); };
    if (!(pucItem <= pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 417, __FUNCTION__); abort(); };


    ItemHeader_t *pxCurHeader = (ItemHeader_t *)(pucItem - sizeof(ItemHeader_t));
    if (!(pxCurHeader->xItemLen <= pxRingbuffer->xMaxItemSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 421, __FUNCTION__); abort(); };
    if (!((pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 2 )) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 422, __FUNCTION__); abort(); };
    if (!((pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 1 )) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 423, __FUNCTION__); abort(); };
    ...
    while (((pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 1 )) || (pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 2 ))) && pxRingbuffer->pucFree != pxRingbuffer->pucRead) {
        if (pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 2 )) {
            ...
            if (!(pxRingbuffer->pucFree <= pxRingbuffer->pucHead + pxRingbuffer->xSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 444, __FUNCTION__); abort(); };
        }
...
static void prvReturnItemByteBuf(Ringbuffer_t *pxRingbuffer, uint8_t *pucItem)
{
    ...
    if (!((uint8_t *)pucItem >= pxRingbuffer->pucHead)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 467, __FUNCTION__); abort(); };
    if (!((uint8_t *)pucItem < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 468, __FUNCTION__); abort(); };
...
# 563 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
           ((void *)0)
# 563 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
...
# 575 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                ((void *)0)
# 575 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                                    , xMaxSize, xItemSize1);
            } else {
...
# 581 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                                     ((void *)0)
# 581 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                                                         ) && (xItemSize2 != 
# 581 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                                                             ((void *)0)
# 581 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                ...
                if (xIsSplit == ( ( BaseType_t ) 1 )) {
                    *pvItem2 = pxRingbuffer->pvGetItem(pxRingbuffer, &xIsSplit, 0, xItemSize2);
                    if (!(*pvItem2 < *pvItem1)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 584, __FUNCTION__); abort(); };
                    if (!(xIsSplit == ( ( BaseType_t ) 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 585, __FUNCTION__); abort(); };
                } else {
                    *pvItem2 = 
# 587 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                              ((void *)0)
# 587 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                  ;
                }
            }
...
# 609 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 609 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
...
static BaseType_t prvReceiveGenericFromISR(Ringbuffer_t *pxRingbuffer, void **pvItem1, void **pvItem2, size_t *xItemSize1, size_t *xItemSize2, size_t xMaxSize)
{
    ...
    if(prvCheckItemAvail(pxRingbuffer) == ( ( BaseType_t ) 1 )) {
        ...
        if (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 )) {
            ...
            *pvItem1 = pxRingbuffer->pvGetItem(pxRingbuffer, 
# 624 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                            ((void *)0)
# 624 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                                , xMaxSize, xItemSize1);
        } else {
        ...
        if ((pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 1 )) && pvItem2 != 
# 630 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                                ((void *)0) 
# 630 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                                                     && xItemSize2 != 
# 630 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                                                      ((void *)0)
# 630 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
            ...
            if (xIsSplit == ( ( BaseType_t ) 1 )) {
                *pvItem2 = pxRingbuffer->pvGetItem(pxRingbuffer, &xIsSplit, 0, xItemSize2);
                if (!(*pvItem2 < *pvItem1)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 633, __FUNCTION__); abort(); };
                if (!(xIsSplit == ( ( BaseType_t ) 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 634, __FUNCTION__); abort(); };
            } else {
                *pvItem2 = 
# 636 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                          ((void *)0)
# 636 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                              ;
            }
        }
        xReturn = ( ( BaseType_t ) 1 );
...
# 647 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0) 
# 647 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
       ) );
    }
    return xReturn;
}
...
RingbufHandle_t xRingbufferCreate(size_t xBufferSize, ringbuf_type_t xBufferType)
{
    ...
    if (pxRingbuffer == 
# 658 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                       ((void *)0)
# 658 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                           ) {
        goto err;
    }
...
# 665 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                ((void *)0)
# 665 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                    ) {
        goto err;
    }
    ...
    if (xBufferType == RINGBUF_TYPE_NOSPLIT) {
        ...
        if (!(0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 713, __FUNCTION__); abort(); };
    }

    if (pxRingbuffer->xFreeSpaceSemaphore == 
# 716 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                            ((void *)0) 
# 716 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
...
# 719 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 719 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
...
err:
    ...
    free(pxRingbuffer);
    return 
# 736 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
          ((void *)0)
# 736 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
              ;
}
...
BaseType_t xRingbufferSend(RingbufHandle_t xRingbuffer, const void *pvItem, size_t xItemSize, TickType_t xTicksToWait)
{
    ...
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 748, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 749 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0) 
# 749 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
   || xItemSize == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 749, __FUNCTION__); abort(); };
...
# 764 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
           ((void *)0)
# 764 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
           , ( xTicksRemaining ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            xReturn = ( ( BaseType_t ) 0 );
            break;
        }
    ...
    if (xReturn == ( ( BaseType_t ) 1 )) {
        ...
        xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), 
# 794 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 794 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
    if (xReturnSemaphore == ( ( BaseType_t ) 1 )) {
        xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 797 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 797 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
    return xReturn;
}
...
BaseType_t xRingbufferSendFromISR(RingbufHandle_t xRingbuffer, const void *pvItem, size_t xItemSize, BaseType_t *pxHigherPriorityTaskWoken)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 806, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 807 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0) 
# 807 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
   || xItemSize == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 807, __FUNCTION__); abort(); };
    if (xItemSize > pxRingbuffer->xMaxItemSize) {
        return ( ( BaseType_t ) 0 );
    }
    if ((pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 )) && xItemSize == 0) {
...
void *xRingbufferReceive(RingbufHandle_t xRingbuffer, size_t *pxItemSize, TickType_t xTicksToWait)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 845, __FUNCTION__); abort(); };


    void *pvTempItem;
    size_t xTempSize;
    if (prvReceiveGeneric(pxRingbuffer, &pvTempItem, 
# 850 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                    ((void *)0)
# 850 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                        , &xTempSize, 
# 850 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                      ((void *)0)
# 850 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
        ...
        if (pxItemSize != 
# 851 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                         ((void *)0)
# 851 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                             ) {
        ...
        return 
# 856 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 856 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    }
}
...
void *xRingbufferReceiveFromISR(RingbufHandle_t xRingbuffer, size_t *pxItemSize)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 864, __FUNCTION__); abort(); };


    void *pvTempItem;
    size_t xTempSize;
    if (prvReceiveGenericFromISR(pxRingbuffer, &pvTempItem, 
# 869 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                           ((void *)0)
# 869 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                               , &xTempSize, 
# 869 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                             ((void *)0)
# 869 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                                                 , 0) == ( ( BaseType_t ) 1 )) {
        if (pxItemSize != 
# 870 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                         ((void *)0)
# 870 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                             ) {
            *pxItemSize = xTempSize;
        }
        return pvTempItem;
        ...
        return 
# 875 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 875 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    }
}
...
BaseType_t xRingbufferReceiveSplit(RingbufHandle_t xRingbuffer, void **ppvHeadItem, void **ppvTailItem, size_t *pxHeadItemSize, size_t *pxTailItemSize, TickType_t xTicksToWait)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 883, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 884, __FUNCTION__); abort(); };
    if (!(ppvHeadItem != 
# 885 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0) 
# 885 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
   && ppvTailItem != 
# 885 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 885 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 885, __FUNCTION__); abort(); };
    ...
    if (prvReceiveGeneric(pxRingbuffer, &pvTempHeadItem, &pvTempTailItem, &xTempHeadSize, &xTempTailSize, 0, xTicksToWait) == ( ( BaseType_t ) 1 )) {
        ...
        *ppvHeadItem = pvTempHeadItem;
        if(pxHeadItemSize != 
# 893 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                            ((void *)0)
# 893 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                ){
            *pxHeadItemSize = xTempHeadSize;
        }

        if (pvTempTailItem != 
# 897 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                             ((void *)0)
# 897 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                 ) {
            *ppvTailItem = pvTempTailItem;
            if (pxTailItemSize != 
# 899 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                 ((void *)0)
# 899 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                     ) {
                *pxTailItemSize = xTempTailSize;
            }
        } else {
            *ppvTailItem = 
# 903 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                          ((void *)0)
# 903 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                              ;
        }
        return ( ( BaseType_t ) 1 );
    } else {
        ...
        *ppvHeadItem = 
# 908 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                      ((void *)0)
# 908 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                          ;
        *ppvTailItem = 
# 909 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                      ((void *)0)
# 909 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                          ;
        return ( ( BaseType_t ) 0 );
    }
}
...
BaseType_t xRingbufferReceiveSplitFromISR(RingbufHandle_t xRingbuffer, void **ppvHeadItem, void **ppvTailItem, size_t *pxHeadItemSize, size_t *pxTailItemSize)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 918, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 919, __FUNCTION__); abort(); };
    if (!(ppvHeadItem != 
# 920 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0) 
# 920 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
   && ppvTailItem != 
# 920 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 920 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 920, __FUNCTION__); abort(); };


    void *pvTempHeadItem = 
# 923 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                          ((void *)0)
# 923 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                              , *pvTempTailItem = 
# 923 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                  ((void *)0)
# 923 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
    ...
    if (prvReceiveGenericFromISR(pxRingbuffer, &pvTempHeadItem, &pvTempTailItem, &xTempHeadSize, &xTempTailSize, 0) == ( ( BaseType_t ) 1 )) {
        ...
        *ppvHeadItem = pvTempHeadItem;
        if (pxHeadItemSize != 
# 928 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                             ((void *)0)
# 928 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                 ) {
            *pxHeadItemSize = xTempHeadSize;
        }

        if (pvTempTailItem != 
# 932 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                             ((void *)0)
# 932 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                 ) {
            *ppvTailItem = pvTempTailItem;
            if (pxTailItemSize != 
# 934 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                 ((void *)0)
# 934 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                     ) {
                *pxTailItemSize = xTempTailSize;
            }
        } else {
            *ppvTailItem = 
# 938 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                          ((void *)0)
# 938 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                              ;
        }
        return ( ( BaseType_t ) 1 );
    } else {
        *ppvHeadItem = 
# 942 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                      ((void *)0)
# 942 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                          ;
        *ppvTailItem = 
# 943 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                      ((void *)0)
# 943 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                          ;
        return ( ( BaseType_t ) 0 );
    }
}
...
void *xRingbufferReceiveUpTo(RingbufHandle_t xRingbuffer, size_t *pxItemSize, TickType_t xTicksToWait, size_t xMaxSize)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 952, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 953, __FUNCTION__); abort(); };
    if (xMaxSize == 0) {
        return 
# 955 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 955 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    }
    ...
    size_t xTempSize;
    if (prvReceiveGeneric(pxRingbuffer, &pvTempItem, 
# 961 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                    ((void *)0)
# 961 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                        , &xTempSize, 
# 961 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                      ((void *)0)
# 961 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
        ...
        if (pxItemSize != 
# 962 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                         ((void *)0)
# 962 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                             ) {
            *pxItemSize = xTempSize;
        }
        return pvTempItem;
        ...
        return 
# 967 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 967 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    }
}
...
void *xRingbufferReceiveUpToFromISR(RingbufHandle_t xRingbuffer, size_t *pxItemSize, size_t xMaxSize)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 975, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 976, __FUNCTION__); abort(); };
    if (xMaxSize == 0) {
        return 
# 978 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 978 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    }
    ...
    size_t xTempSize;
    if (prvReceiveGenericFromISR(pxRingbuffer, &pvTempItem, 
# 984 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                           ((void *)0)
# 984 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                               , &xTempSize, 
# 984 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                             ((void *)0)
# 984 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
        ...
        if (pxItemSize != 
# 985 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                         ((void *)0)
# 985 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                             ) {
            *pxItemSize = xTempSize;
        }
        return pvTempItem;
        ...
        return 
# 990 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 990 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    }
}
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 997, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 998 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 998 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 998, __FUNCTION__); abort(); };

    vTaskEnterCritical(&pxRingbuffer->mux);
    pxRingbuffer->vReturnItem(pxRingbuffer, (uint8_t *)pvItem);
    vTaskExitCritical(&pxRingbuffer->mux);
    xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 1003 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 1003 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1009, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 1010 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 1010 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1010, __FUNCTION__); abort(); };
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1021, __FUNCTION__); abort(); };
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1038, __FUNCTION__); abort(); };
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1045, __FUNCTION__); abort(); };
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1057, __FUNCTION__); abort(); };

    BaseType_t xReturn;
    vTaskEnterCritical(&pxRingbuffer->mux);

    BaseType_t xHoldSemaphore = xQueueGenericReceive( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), 
# 1062 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                               ((void *)0)
# 1062 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                               , ( 0 ), ( ( BaseType_t ) 0 ) );
...
# 1066 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 1066 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1066, __FUNCTION__); abort(); };
    }
    vTaskExitCritical(&pxRingbuffer->mux);
    return xReturn;
}
...
BaseType_t xRingbufferCanRead(RingbufHandle_t xRingbuffer, QueueSetMemberHandle_t xMember)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1076, __FUNCTION__); abort(); };
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1083, __FUNCTION__); abort(); };

    BaseType_t xReturn;
    vTaskEnterCritical(&pxRingbuffer->mux);

    BaseType_t xHoldSemaphore = xQueueGenericReceive( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), 
# 1088 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                               ((void *)0)
# 1088 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                               , ( 0 ), ( ( BaseType_t ) 0 ) );
    xReturn = xQueueRemoveFromSet(pxRingbuffer->xItemsBufferedSemaphore, xQueueSet);
    if (xHoldSemaphore == ( ( BaseType_t ) 1 )) {

        if (!(xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xItemsBufferedSemaphore ), 
# 1092 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 1092 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1092, __FUNCTION__); abort(); };
    }
    vTaskExitCritical(&pxRingbuffer->mux);
    return xReturn;
}
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1101, __FUNCTION__); abort(); };

    vTaskEnterCritical(&pxRingbuffer->mux);
    if (uxFree != 
# 1104 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                 ((void *)0)
# 1104 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                     ) {
        *uxFree = (UBaseType_t)(pxRingbuffer->pucFree - pxRingbuffer->pucHead);
    }
    if (uxRead != 
# 1107 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                 ((void *)0)
# 1107 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                     ) {
        *uxRead = (UBaseType_t)(pxRingbuffer->pucRead - pxRingbuffer->pucHead);
    }
    if (uxWrite != 
# 1110 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                  ((void *)0)
# 1110 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                      ) {
        *uxWrite = (UBaseType_t)(pxRingbuffer->pucWrite - pxRingbuffer->pucHead);
    }
    if (uxItemsWaiting != 
# 1113 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                         ((void *)0)
# 1113 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                             ) {
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1122, __FUNCTION__); abort(); };
...
# 1133 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
_Bool 
# 1133 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
    xRingbufferIsNextItemWrapped(RingbufHandle_t xRingbuffer)
{

    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1137, __FUNCTION__); abort(); };
    
# 1138 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   _Bool 
# 1138 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
        is_wrapped;
...
BaseType_t xRingbufferAddToQueueSetWrite(RingbufHandle_t xRingbuffer, QueueSetHandle_t xQueueSet)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1151, __FUNCTION__); abort(); };

    BaseType_t xReturn;
    vTaskEnterCritical(&pxRingbuffer->mux);

    BaseType_t xHoldSemaphore = xQueueGenericReceive( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 1156 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                               ((void *)0)
# 1156 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                               , ( 0 ), ( ( BaseType_t ) 0 ) );
...
# 1160 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 1160 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1160, __FUNCTION__); abort(); };
    }
    vTaskExitCritical(&pxRingbuffer->mux);
    return xReturn;
}
...
BaseType_t xRingbufferRemoveFromQueueSetWrite(RingbufHandle_t xRingbuffer, QueueSetHandle_t xQueueSet)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1170, __FUNCTION__); abort(); };

    BaseType_t xReturn;
    vTaskEnterCritical(&pxRingbuffer->mux);

    BaseType_t xHoldSemaphore = xQueueGenericReceive( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 1175 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                               ((void *)0)
# 1175 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
                               , ( 0 ), ( ( BaseType_t ) 0 ) );
    xReturn = xQueueRemoveFromSet(pxRingbuffer->xFreeSpaceSemaphore, xQueueSet);
    if (xHoldSemaphore == ( ( BaseType_t ) 1 )) {

        if (!(xQueueGenericSend( ( QueueHandle_t ) ( pxRingbuffer->xFreeSpaceSemaphore ), 
# 1179 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 1179 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_ringbuf/ringbuf.c", 1179, __FUNCTION__); abort(); };
    }
    vTaskExitCritical(&pxRingbuffer->mux);
    return xReturn;
}
