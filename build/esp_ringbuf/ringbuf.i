# 1 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_ringbuf//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
# 15 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
...
# 16 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 2
...
# 21 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 2
# 47 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
typedef struct {
...
# 101 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
    SemaphoreHandle_t xTransSemHandle;
    SemaphoreHandle_t xRecvSemHandle;

    portMUX_TYPE mux;
} Ringbuffer_t;
# 128 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                       ...
                                       uint8_t *pucRingbufferStorage)
{
    ...
    if (xBufferType == RINGBUF_TYPE_NOSPLIT) {
        ...
        pxNewRingbuffer->xMaxItemSize = ( ( pxNewRingbuffer->xSize / 2 + ( 0x0003 ) ) & ~( 0x0003 ) ) - sizeof(ItemHeader_t);
        pxNewRingbuffer->xGetCurMaxSize = prvGetCurMaxSizeNoSplit;
    } else if (xBufferType == RINGBUF_TYPE_ALLOWSPLIT) {
        pxNewRingbuffer->uxRingbufferFlags |= ( ( UBaseType_t ) 1 );
        pxNewRingbuffer->xCheckItemFits = prvCheckItemFitsDefault;
        ...
        pxNewRingbuffer->uxRingbufferFlags |= ( ( UBaseType_t ) 2 );
    ...
    xQueueGenericSend( ( QueueHandle_t ) ( ( pxNewRingbuffer->xTransSemHandle ) ), 
# 252 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 252 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
...
static size_t prvGetFreeSize(Ringbuffer_t *pxRingbuffer)
{
    ...
    if (!(xReturn <= pxRingbuffer->xSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 269, __FUNCTION__); abort(); };
    return xReturn;
}
...
static BaseType_t prvCheckItemFitsDefault( Ringbuffer_t *pxRingbuffer, size_t xItemSize)
{
    ...
    if (!(( ( ( UBaseType_t ) ( pxRingbuffer->pucAcquire ) & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 276, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucAcquire >= pxRingbuffer->pucHead && pxRingbuffer->pucAcquire < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 277, __FUNCTION__); abort(); };
    ...
    if (pxRingbuffer->pucFree > pxRingbuffer->pucAcquire) {
        ...
        return (xTotalItemSize <= pxRingbuffer->pucFree - pxRingbuffer->pucAcquire) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 );
    }
    ...
    if (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 1 )) {
        ...
        return (xTotalItemSize + sizeof(ItemHeader_t) <= pxRingbuffer->xSize - (pxRingbuffer->pucAcquire - pxRingbuffer->pucFree)) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 );
    } else {
...
static BaseType_t prvCheckItemFitsByteBuffer( Ringbuffer_t *pxRingbuffer, size_t xItemSize)
{
    ...
    if (!(pxRingbuffer->pucAcquire >= pxRingbuffer->pucHead && pxRingbuffer->pucAcquire < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 304, __FUNCTION__); abort(); };
    ...
    if (pxRingbuffer->pucFree > pxRingbuffer->pucAcquire) {
        ...
        return (xItemSize <= pxRingbuffer->pucFree - pxRingbuffer->pucAcquire) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 );
    }

    return (xItemSize <= pxRingbuffer->xSize - (pxRingbuffer->pucAcquire - pxRingbuffer->pucFree)) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 );
}
...
static uint8_t* prvAcquireItemNoSplit(Ringbuffer_t *pxRingbuffer, size_t xItemSize)
{
    ...
    if (!(( ( ( UBaseType_t ) ( pxRingbuffer->pucAcquire ) & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 323, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucAcquire >= pxRingbuffer->pucHead && pxRingbuffer->pucAcquire < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 324, __FUNCTION__); abort(); };
    if (!(xRemLen >= sizeof(ItemHeader_t))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 325, __FUNCTION__); abort(); };
    ...
    uint8_t* item_address = pxRingbuffer->pucAcquire + sizeof(ItemHeader_t);
    pxRingbuffer->pucAcquire += sizeof(ItemHeader_t) + xAlignedItemSize;



    if (pxRingbuffer->pucTail - pxRingbuffer->pucAcquire < sizeof(ItemHeader_t)) {
        pxRingbuffer->pucAcquire = pxRingbuffer->pucHead;
    }
...
static void prvSendItemDoneNoSplit(Ringbuffer_t *pxRingbuffer, uint8_t* pucItem)
{
    ...
    if (!(( ( ( UBaseType_t ) ( pucItem ) & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 360, __FUNCTION__); abort(); };
    if (!(pucItem >= pxRingbuffer->pucHead)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 361, __FUNCTION__); abort(); };
    if (!(pucItem <= pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 362, __FUNCTION__); abort(); };


    ItemHeader_t *pxCurHeader = (ItemHeader_t *)(pucItem - sizeof(ItemHeader_t));
    if (!(pxCurHeader->xItemLen <= pxRingbuffer->xMaxItemSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 366, __FUNCTION__); abort(); };
    if (!((pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 2 )) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 367, __FUNCTION__); abort(); };
    if (!((pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 8 )) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 368, __FUNCTION__); abort(); };
    pxCurHeader->uxItemFlags &= ~( ( UBaseType_t ) 4 );
    pxCurHeader->uxItemFlags |= ( ( UBaseType_t ) 8 );

    pxRingbuffer->xItemsWaiting++;
# 381 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
    pxCurHeader = (ItemHeader_t *)pxRingbuffer->pucWrite;

    while (((pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 8 )) || (pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 2 ))) && pxRingbuffer->pucWrite != pxRingbuffer->pucAcquire) {
        if (pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 2 )) {
            ...
            pxRingbuffer->pucWrite += xAlignedItemSize + sizeof(ItemHeader_t);

            if (!(pxRingbuffer->pucWrite <= pxRingbuffer->pucHead + pxRingbuffer->xSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 392, __FUNCTION__); abort(); };
        }
...
static void prvCopyItemAllowSplit(Ringbuffer_t *pxRingbuffer, const uint8_t *pucItem, size_t xItemSize)
{
    ...
    size_t xAlignedItemSize = ( ( xItemSize + ( 0x0003 ) ) & ~( 0x0003 ) );
    size_t xRemLen = pxRingbuffer->pucTail - pxRingbuffer->pucAcquire;
    if (!(( ( ( UBaseType_t ) ( pxRingbuffer->pucAcquire ) & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 414, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucAcquire >= pxRingbuffer->pucHead && pxRingbuffer->pucAcquire < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 415, __FUNCTION__); abort(); };
    if (!(xRemLen >= sizeof(ItemHeader_t))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 416, __FUNCTION__); abort(); };
    ...
    if (xRemLen < xAlignedItemSize + sizeof(ItemHeader_t)) {
        ...
        pxRingbuffer->pucAcquire += sizeof(ItemHeader_t);
...
static void prvCopyItemByteBuf(Ringbuffer_t *pxRingbuffer, const uint8_t *pucItem, size_t xItemSize)
{
    ...
    if (!(pxRingbuffer->pucAcquire >= pxRingbuffer->pucHead && pxRingbuffer->pucAcquire < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 467, __FUNCTION__); abort(); };
                               ...
                               size_t *pxItemSize)
{
    ...
    if (!(pxIsSplit != 
# 516 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 516 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 516, __FUNCTION__); abort(); };
    if (!((pxRingbuffer->xItemsWaiting > 0) && ((pxRingbuffer->pucRead != pxRingbuffer->pucWrite) || (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 4 ))))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 517, __FUNCTION__); abort(); };
    if (!(( ( ( UBaseType_t ) ( pxRingbuffer->pucRead ) & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 518, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucRead >= pxRingbuffer->pucHead && pxRingbuffer->pucRead < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 519, __FUNCTION__); abort(); };
    if (!((pxHeader->xItemLen <= pxRingbuffer->xMaxItemSize) || (pxHeader->uxItemFlags & ( ( UBaseType_t ) 2 )))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 520, __FUNCTION__); abort(); };
    ...
    if (pxHeader->uxItemFlags & ( ( UBaseType_t ) 2 )) {
        ...
        if (!(pxHeader->xItemLen <= pxRingbuffer->xMaxItemSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 528, __FUNCTION__); abort(); };
    }
    pcReturn = pxRingbuffer->pucRead + sizeof(ItemHeader_t);
    if (pxHeader->xItemLen == 0) {

        if (!(pcReturn >= pxRingbuffer->pucHead && pcReturn <= pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 533, __FUNCTION__); abort(); };
    } else {

        if (!(pcReturn >= pxRingbuffer->pucHead && pcReturn < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 536, __FUNCTION__); abort(); };
    }
                               ...
                               size_t *pxItemSize)
{
    ...
    if (!((pxRingbuffer->xItemsWaiting > 0) && ((pxRingbuffer->pucRead != pxRingbuffer->pucWrite) || (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 4 ))))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 556, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucRead >= pxRingbuffer->pucHead && pxRingbuffer->pucRead < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 557, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->pucRead == pxRingbuffer->pucFree)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 558, __FUNCTION__); abort(); };
...
static void prvReturnItemDefault(Ringbuffer_t *pxRingbuffer, uint8_t *pucItem)
{
    ...
    if (!(( ( ( UBaseType_t ) ( pucItem ) & ( 0x0003 ) ) == 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 594, __FUNCTION__); abort(); };
    if (!(pucItem >= pxRingbuffer->pucHead)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 595, __FUNCTION__); abort(); };
    if (!(pucItem <= pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 596, __FUNCTION__); abort(); };


    ItemHeader_t *pxCurHeader = (ItemHeader_t *)(pucItem - sizeof(ItemHeader_t));
    if (!(pxCurHeader->xItemLen <= pxRingbuffer->xMaxItemSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 600, __FUNCTION__); abort(); };
    if (!((pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 2 )) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 601, __FUNCTION__); abort(); };
    if (!((pxCurHeader->uxItemFlags & ( ( UBaseType_t ) 1 )) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 602, __FUNCTION__); abort(); };
    pxCurHeader->uxItemFlags &= ~( ( UBaseType_t ) 4 );
...
static void prvReturnItemByteBuf(Ringbuffer_t *pxRingbuffer, uint8_t *pucItem)
{
    ...
    if (!((uint8_t *)pucItem >= pxRingbuffer->pucHead)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 646, __FUNCTION__); abort(); };
    if (!((uint8_t *)pucItem < pxRingbuffer->pucTail)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 647, __FUNCTION__); abort(); };
...
static size_t prvGetCurMaxSizeAllowSplit(Ringbuffer_t *pxRingbuffer)
{
    ...
    if (pxRingbuffer->pucAcquire == pxRingbuffer->pucHead && pxRingbuffer->pucFree == pxRingbuffer->pucHead) {
        ...
        xFreeSize = (pxRingbuffer->pucFree - pxRingbuffer->pucAcquire) - sizeof(ItemHeader_t);
    } else {
                                    ...
                                    TickType_t xTicksToWait)
{
    ...
    while (xTicksRemaining <= xTicksToWait) {
        ...
        if (xQueueGenericReceive( ( QueueHandle_t ) ( ( pxRingbuffer->xRecvSemHandle ) ), 
# 748 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
           ((void *)0)
# 748 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
...
# 760 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                ((void *)0)
# 760 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                                    , xMaxSize, xItemSize1);
            } else {
...
# 766 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                                     ((void *)0)
# 766 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                                                         ) && (xItemSize2 != 
# 766 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                                                             ((void *)0)
# 766 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                ...
                if (xIsSplit == ( ( BaseType_t ) 1 )) {
                    *pvItem2 = pxRingbuffer->pvGetItem(pxRingbuffer, &xIsSplit, 0, xItemSize2);
                    if (!(*pvItem2 < *pvItem1)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 769, __FUNCTION__); abort(); };
                    if (!(xIsSplit == ( ( BaseType_t ) 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 770, __FUNCTION__); abort(); };
                } else {
                    *pvItem2 = 
# 772 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                              ((void *)0)
# 772 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                  ;
                }
            }
    ...
    if (xReturnSemaphore == ( ( BaseType_t ) 1 )) {
        xQueueGenericSend( ( QueueHandle_t ) ( ( pxRingbuffer->xRecvSemHandle ) ), 
# 794 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 794 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
    return xReturn;
}
                                           ...
                                           size_t xMaxSize)
{
    ...
    if(prvCheckItemAvail(pxRingbuffer) == ( ( BaseType_t ) 1 )) {
        ...
        if (pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 )) {
            ...
            *pvItem1 = pxRingbuffer->pvGetItem(pxRingbuffer, 
# 814 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                            ((void *)0)
# 814 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                                , xMaxSize, xItemSize1);
        } else {
        ...
        if ((pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 1 )) && pvItem2 != 
# 820 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                                ((void *)0) 
# 820 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                                                     && xItemSize2 != 
# 820 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                                                      ((void *)0)
# 820 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
            ...
            if (xIsSplit == ( ( BaseType_t ) 1 )) {
                *pvItem2 = pxRingbuffer->pvGetItem(pxRingbuffer, &xIsSplit, 0, xItemSize2);
                if (!(*pvItem2 < *pvItem1)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 823, __FUNCTION__); abort(); };
                if (!(xIsSplit == ( ( BaseType_t ) 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 824, __FUNCTION__); abort(); };
            } else {
                *pvItem2 = 
# 826 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                          ((void *)0)
# 826 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                              ;
            }
        }
        xReturn = ( ( BaseType_t ) 1 );
    ...
    if (xReturnSemaphore == ( ( BaseType_t ) 1 )) {
        xQueueGiveFromISR( ( QueueHandle_t ) ( ( pxRingbuffer->xRecvSemHandle ) ), ( 
# 837 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0) 
# 837 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
       ) );
    }
    return xReturn;
}
...
RingbufHandle_t xRingbufferCreate(size_t xBufferSize, RingbufferType_t xBufferType)
{
    if (!(xBufferSize > 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 846, __FUNCTION__); abort(); };
    if (!(xBufferType < RINGBUF_TYPE_MAX)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 847, __FUNCTION__); abort(); };
    ...
    if (pxNewRingbuffer == 
# 855 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                          ((void *)0) 
# 855 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
...
# 855 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
    ...
    pxNewRingbuffer->xTransSemHandle = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) );
    pxNewRingbuffer->xRecvSemHandle = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) );
    if (pxNewRingbuffer->xTransSemHandle == 
# 867 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                           ((void *)0) 
# 867 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                || pxNewRingbuffer->xRecvSemHandle == 
# 867 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                                      ((void *)0)
# 867 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                                                          ) {
        if (pxNewRingbuffer->xTransSemHandle != 
# 868 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                               ((void *)0)
# 868 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                   ) {
            vQueueDelete( ( QueueHandle_t ) ( pxNewRingbuffer->xTransSemHandle ) );
        }
        if (pxNewRingbuffer->xRecvSemHandle != 
# 871 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                              ((void *)0)
# 871 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                  ) {
            vQueueDelete( ( QueueHandle_t ) ( pxNewRingbuffer->xRecvSemHandle ) );
        }
        goto err;
    }
...
err:
    ...
    return 
# 885 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
          ((void *)0)
# 885 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
              ;
}
...
# 917 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
BaseType_t xRingbufferSendAcquire(RingbufHandle_t xRingbuffer, void **ppvItem, size_t xItemSize, TickType_t xTicksToWait)
{

    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 921, __FUNCTION__); abort(); };
    if (!(ppvItem != 
# 922 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0) 
# 922 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   || xItemSize == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 922, __FUNCTION__); abort(); };

    if (!((pxRingbuffer->uxRingbufferFlags & (( ( UBaseType_t ) 2 ) | ( ( UBaseType_t ) 1 ))) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 924, __FUNCTION__); abort(); };

    *ppvItem = 
# 926 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 926 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    ...
    while (xTicksRemaining <= xTicksToWait) {
        ...
        if (xQueueGenericReceive( ( QueueHandle_t ) ( ( pxRingbuffer->xTransSemHandle ) ), 
# 941 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
           ((void *)0)
# 941 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
           , ( xTicksRemaining ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            xReturn = ( ( BaseType_t ) 0 );
            break;
        }
    ...
    if (xReturnSemaphore == ( ( BaseType_t ) 1 )) {
        xQueueGenericSend( ( QueueHandle_t ) ( ( pxRingbuffer->xTransSemHandle ) ), 
# 971 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 971 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
    return xReturn;
}
...
BaseType_t xRingbufferSendComplete(RingbufHandle_t xRingbuffer, void *pvItem)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 980, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 981 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 981 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 981, __FUNCTION__); abort(); };
    if (!((pxRingbuffer->uxRingbufferFlags & (( ( UBaseType_t ) 2 ) | ( ( UBaseType_t ) 1 ))) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 982, __FUNCTION__); abort(); };
    ...
    xQueueGenericSend( ( QueueHandle_t ) ( ( pxRingbuffer->xRecvSemHandle ) ), 
# 988 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 988 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    return ( ( BaseType_t ) 1 );
}
                           ...
                           TickType_t xTicksToWait)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 999, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 1000 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0) 
# 1000 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   || xItemSize == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1000, __FUNCTION__); abort(); };
    if (xItemSize > pxRingbuffer->xMaxItemSize) {
        return ( ( BaseType_t ) 0 );
    }
    if ((pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 )) && xItemSize == 0) {
    ...
    while (xTicksRemaining <= xTicksToWait) {
        ...
        if (xQueueGenericReceive( ( QueueHandle_t ) ( ( pxRingbuffer->xTransSemHandle ) ), 
# 1015 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
           ((void *)0)
# 1015 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
           , ( xTicksRemaining ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            xReturn = ( ( BaseType_t ) 0 );
            break;
        }
    ...
    if (xReturn == ( ( BaseType_t ) 1 )) {
        ...
        xQueueGenericSend( ( QueueHandle_t ) ( ( pxRingbuffer->xRecvSemHandle ) ), 
# 1045 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 1045 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
    if (xReturnSemaphore == ( ( BaseType_t ) 1 )) {
        xQueueGenericSend( ( QueueHandle_t ) ( ( pxRingbuffer->xTransSemHandle ) ), 
# 1048 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 1048 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
    return xReturn;
}
                                  ...
                                  BaseType_t *pxHigherPriorityTaskWoken)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1060, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 1061 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0) 
# 1061 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   || xItemSize == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1061, __FUNCTION__); abort(); };
    if (xItemSize > pxRingbuffer->xMaxItemSize) {
        return ( ( BaseType_t ) 0 );
    }
    if ((pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 )) && xItemSize == 0) {
    ...
    if (xReturn == ( ( BaseType_t ) 1 )) {
        ...
        xQueueGiveFromISR( ( QueueHandle_t ) ( ( pxRingbuffer->xRecvSemHandle ) ), ( pxHigherPriorityTaskWoken ) );
    }
    if (xReturnSemaphore == ( ( BaseType_t ) 1 )) {
        xQueueGiveFromISR( ( QueueHandle_t ) ( ( pxRingbuffer->xTransSemHandle ) ), ( pxHigherPriorityTaskWoken ) );
    }
    return xReturn;
}
...
void *xRingbufferReceive(RingbufHandle_t xRingbuffer, size_t *pxItemSize, TickType_t xTicksToWait)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1099, __FUNCTION__); abort(); };


    void *pvTempItem;
    size_t xTempSize;
    if (prvReceiveGeneric(pxRingbuffer, &pvTempItem, 
# 1104 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                    ((void *)0)
# 1104 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                        , &xTempSize, 
# 1104 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                      ((void *)0)
# 1104 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
        ...
        if (pxItemSize != 
# 1105 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                         ((void *)0)
# 1105 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                             ) {
        ...
        return 
# 1110 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 1110 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    }
}
...
void *xRingbufferReceiveFromISR(RingbufHandle_t xRingbuffer, size_t *pxItemSize)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1118, __FUNCTION__); abort(); };


    void *pvTempItem;
    size_t xTempSize;
    if (prvReceiveGenericFromISR(pxRingbuffer, &pvTempItem, 
# 1123 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                           ((void *)0)
# 1123 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                               , &xTempSize, 
# 1123 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                             ((void *)0)
# 1123 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                                                 , 0) == ( ( BaseType_t ) 1 )) {
        if (pxItemSize != 
# 1124 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                         ((void *)0)
# 1124 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                             ) {
            *pxItemSize = xTempSize;
        }
        return pvTempItem;
        ...
        return 
# 1129 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 1129 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    }
}
                                   ...
                                   TickType_t xTicksToWait)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1142, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1143, __FUNCTION__); abort(); };
    if (!(ppvHeadItem != 
# 1144 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0) 
# 1144 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   && ppvTailItem != 
# 1144 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 1144 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1144, __FUNCTION__); abort(); };
    ...
    if (prvReceiveGeneric(pxRingbuffer, &pvTempHeadItem, &pvTempTailItem, &xTempHeadSize, &xTempTailSize, 0, xTicksToWait) == ( ( BaseType_t ) 1 )) {
        ...
        *ppvHeadItem = pvTempHeadItem;
        if(pxHeadItemSize != 
# 1152 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                            ((void *)0)
# 1152 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                ){
            *pxHeadItemSize = xTempHeadSize;
        }

        if (pvTempTailItem != 
# 1156 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                             ((void *)0)
# 1156 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                 ) {
            *ppvTailItem = pvTempTailItem;
            if (pxTailItemSize != 
# 1158 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                 ((void *)0)
# 1158 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                     ) {
                *pxTailItemSize = xTempTailSize;
            }
        } else {
            *ppvTailItem = 
# 1162 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                          ((void *)0)
# 1162 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                              ;
        }
        return ( ( BaseType_t ) 1 );
    } else {
        ...
        *ppvHeadItem = 
# 1167 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                      ((void *)0)
# 1167 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                          ;
        *ppvTailItem = 
# 1168 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                      ((void *)0)
# 1168 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                          ;
        return ( ( BaseType_t ) 0 );
    }
}
                                          ...
                                          size_t *pxTailItemSize)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1181, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1182, __FUNCTION__); abort(); };
    if (!(ppvHeadItem != 
# 1183 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0) 
# 1183 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   && ppvTailItem != 
# 1183 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 1183 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1183, __FUNCTION__); abort(); };


    void *pvTempHeadItem = 
# 1186 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                          ((void *)0)
# 1186 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                              , *pvTempTailItem = 
# 1186 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                  ((void *)0)
# 1186 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
    ...
    if (prvReceiveGenericFromISR(pxRingbuffer, &pvTempHeadItem, &pvTempTailItem, &xTempHeadSize, &xTempTailSize, 0) == ( ( BaseType_t ) 1 )) {
        ...
        *ppvHeadItem = pvTempHeadItem;
        if (pxHeadItemSize != 
# 1191 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                             ((void *)0)
# 1191 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                 ) {
            *pxHeadItemSize = xTempHeadSize;
        }

        if (pvTempTailItem != 
# 1195 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                             ((void *)0)
# 1195 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                 ) {
            *ppvTailItem = pvTempTailItem;
            if (pxTailItemSize != 
# 1197 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                 ((void *)0)
# 1197 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                     ) {
                *pxTailItemSize = xTempTailSize;
            }
        } else {
            *ppvTailItem = 
# 1201 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                          ((void *)0)
# 1201 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                              ;
        }
        return ( ( BaseType_t ) 1 );
    } else {
        *ppvHeadItem = 
# 1205 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                      ((void *)0)
# 1205 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                          ;
        *ppvTailItem = 
# 1206 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                      ((void *)0)
# 1206 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                          ;
        return ( ( BaseType_t ) 0 );
    }
}
                             ...
                             size_t xMaxSize)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1218, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1219, __FUNCTION__); abort(); };
    if (xMaxSize == 0) {
        return 
# 1221 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 1221 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    }
    ...
    size_t xTempSize;
    if (prvReceiveGeneric(pxRingbuffer, &pvTempItem, 
# 1227 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                    ((void *)0)
# 1227 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                        , &xTempSize, 
# 1227 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                      ((void *)0)
# 1227 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
        ...
        if (pxItemSize != 
# 1228 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                         ((void *)0)
# 1228 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                             ) {
            *pxItemSize = xTempSize;
        }
        return pvTempItem;
        ...
        return 
# 1233 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 1233 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    }
}
...
void *xRingbufferReceiveUpToFromISR(RingbufHandle_t xRingbuffer, size_t *pxItemSize, size_t xMaxSize)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1241, __FUNCTION__); abort(); };
    if (!(pxRingbuffer->uxRingbufferFlags & ( ( UBaseType_t ) 2 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1242, __FUNCTION__); abort(); };
    if (xMaxSize == 0) {
        return 
# 1244 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 1244 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    }
    ...
    size_t xTempSize;
    if (prvReceiveGenericFromISR(pxRingbuffer, &pvTempItem, 
# 1250 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                           ((void *)0)
# 1250 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                                                               , &xTempSize, 
# 1250 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                                                                             ((void *)0)
# 1250 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
        ...
        if (pxItemSize != 
# 1251 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                         ((void *)0)
# 1251 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                             ) {
            *pxItemSize = xTempSize;
        }
        return pvTempItem;
        ...
        return 
# 1256 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
              ((void *)0)
# 1256 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                  ;
    }
}
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1263, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 1264 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 1264 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1264, __FUNCTION__); abort(); };

    vTaskEnterCritical(&pxRingbuffer->mux);
    pxRingbuffer->vReturnItem(pxRingbuffer, (uint8_t *)pvItem);
    vTaskExitCritical(&pxRingbuffer->mux);
    xQueueGenericSend( ( QueueHandle_t ) ( ( pxRingbuffer->xTransSemHandle ) ), 
# 1269 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 1269 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1275, __FUNCTION__); abort(); };
    if (!(pvItem != 
# 1276 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
   ((void *)0)
# 1276 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1276, __FUNCTION__); abort(); };
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1287, __FUNCTION__); abort(); };

    vQueueDelete( ( QueueHandle_t ) ( ( pxRingbuffer->xTransSemHandle ) ) );
    vQueueDelete( ( QueueHandle_t ) ( ( pxRingbuffer->xRecvSemHandle ) ) );
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1305, __FUNCTION__); abort(); };
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1312, __FUNCTION__); abort(); };
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1324, __FUNCTION__); abort(); };

    BaseType_t xReturn;
    vTaskEnterCritical(&pxRingbuffer->mux);

    BaseType_t xHoldSemaphore = xQueueGenericReceive( ( QueueHandle_t ) ( ( pxRingbuffer->xRecvSemHandle ) ), 
# 1329 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                               ((void *)0)
# 1329 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                               , ( 0 ), ( ( BaseType_t ) 0 ) );
    xReturn = xQueueAddToSet(( pxRingbuffer->xRecvSemHandle ), xQueueSet);
    if (xHoldSemaphore == ( ( BaseType_t ) 1 )) {

        if (!(xQueueGenericSend( ( QueueHandle_t ) ( ( pxRingbuffer->xRecvSemHandle ) ), 
# 1333 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 1333 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1333, __FUNCTION__); abort(); };
    }
    vTaskExitCritical(&pxRingbuffer->mux);
    return xReturn;
}
...
BaseType_t xRingbufferCanRead(RingbufHandle_t xRingbuffer, QueueSetMemberHandle_t xMember)
{
    ...
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1343, __FUNCTION__); abort(); };
    return (( pxRingbuffer->xRecvSemHandle ) == xMember) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 );
}

BaseType_t xRingbufferRemoveFromQueueSetRead(RingbufHandle_t xRingbuffer, QueueSetHandle_t xQueueSet)
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1350, __FUNCTION__); abort(); };

    BaseType_t xReturn;
    vTaskEnterCritical(&pxRingbuffer->mux);

    BaseType_t xHoldSemaphore = xQueueGenericReceive( ( QueueHandle_t ) ( ( pxRingbuffer->xRecvSemHandle ) ), 
# 1355 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                               ((void *)0)
# 1355 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                               , ( 0 ), ( ( BaseType_t ) 0 ) );
    xReturn = xQueueRemoveFromSet(( pxRingbuffer->xRecvSemHandle ), xQueueSet);
    if (xHoldSemaphore == ( ( BaseType_t ) 1 )) {

        if (!(xQueueGenericSend( ( QueueHandle_t ) ( ( pxRingbuffer->xRecvSemHandle ) ), 
# 1359 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
       ((void *)0)
# 1359 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1359, __FUNCTION__); abort(); };
    }
    vTaskExitCritical(&pxRingbuffer->mux);
    return xReturn;
}
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1373, __FUNCTION__); abort(); };

    vTaskEnterCritical(&pxRingbuffer->mux);
    if (uxFree != 
# 1376 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                 ((void *)0)
# 1376 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                     ) {
        *uxFree = (UBaseType_t)(pxRingbuffer->pucFree - pxRingbuffer->pucHead);
    }
    if (uxRead != 
# 1379 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                 ((void *)0)
# 1379 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                     ) {
        *uxRead = (UBaseType_t)(pxRingbuffer->pucRead - pxRingbuffer->pucHead);
    }
    if (uxWrite != 
# 1382 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                  ((void *)0)
# 1382 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                      ) {
        *uxWrite = (UBaseType_t)(pxRingbuffer->pucWrite - pxRingbuffer->pucHead);
    }
    if (uxAcquire != 
# 1385 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                    ((void *)0)
# 1385 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                        ) {
        *uxAcquire = (UBaseType_t)(pxRingbuffer->pucAcquire - pxRingbuffer->pucHead);
    }
    if (uxItemsWaiting != 
# 1388 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c" 3 4
                         ((void *)0)
# 1388 "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c"
                             ) {
...
{
    Ringbuffer_t *pxRingbuffer = (Ringbuffer_t *)xRingbuffer;
    if (!(pxRingbuffer)) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/Development/esp-idf/components/esp_ringbuf/ringbuf.c", 1397, __FUNCTION__); abort(); };
