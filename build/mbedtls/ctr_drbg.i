# 1 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
# 1 "/home/dieter/Development/ProjektEi/build/mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
# 30 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
...
# 31 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 2
...
# 36 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 2
...
# 37 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 2
...
# 39 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 2
...
# 42 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 2
...
# 47 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 2
# 56 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
void mbedtls_ctr_drbg_init( mbedtls_ctr_drbg_context *ctx )
{
...
# 81 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
...
{
    if( ctx == 
# 129 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 3 4
              ((void *)0) 
# 129 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
                   )
        return;
...
# 181 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
    p = buf + 16;
    *p++ = ( data_len >> 24 ) & 0xff;
    *p++ = ( data_len >> 16 ) & 0xff;
    *p++ = ( data_len >> 8 ) & 0xff;
    ...
    *p++ = ( 32 + 16 );
    ...
    if( ( ret = esp_aes_setkey( &aes_ctx, key, ( 32 * 8 ) ) ) != 0 )
    {
        goto exit;
    }
    ...
    for( j = 0; j < ( 32 + 16 ); j += 16 )
    {
        ...
        while( use_len > 0 )
        {
            ...
            if( ( ret = esp_aes_crypt_ecb( &aes_ctx, 1, chain, chain ) ) != 0 )
            {
                goto exit;
            }
        }
    ...
    if( ( ret = esp_aes_setkey( &aes_ctx, tmp, ( 32 * 8 ) ) ) != 0 )
    {
        goto exit;
    }
    iv = tmp + 32;
    ...
    for( j = 0; j < ( 32 + 16 ); j += 16 )
    {
        if( ( ret = esp_aes_crypt_ecb( &aes_ctx, 1, iv, iv ) ) != 0 )
        {
            goto exit;
        }
        memcpy( p, iv, 16 );
...
# 279 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
...
# 334 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
int mbedtls_ctr_drbg_update_ret( mbedtls_ctr_drbg_context *ctx,
                                 const unsigned char *additional,
                                 size_t add_len )
{
...
# 379 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
int mbedtls_ctr_drbg_reseed( mbedtls_ctr_drbg_context *ctx,
                     const unsigned char *additional, size_t len )
{
...
# 449 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
int mbedtls_ctr_drbg_random_with_add( void *p_rng,
                              unsigned char *output, size_t output_len,
                              const unsigned char *additional, size_t add_len )
{
...
# 533 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 3 4
                                                                    ((void *)0)
# 533 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
                                                                        , 0 );
...
int mbedtls_ctr_drbg_write_seed_file( mbedtls_ctr_drbg_context *ctx, const char *path )
{
    ...
    if( ( f = fopen( path, "wb" ) ) == 
# 550 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 3 4
                                      ((void *)0) 
# 550 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
                                           )
        return( -0x003A );
...
int mbedtls_ctr_drbg_update_seed_file( mbedtls_ctr_drbg_context *ctx, const char *path )
{
    int ret = 0;
    FILE *f = 
# 571 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 3 4
             ((void *)0)
# 571 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
                 ;
    size_t n;
    unsigned char buf[ 256 ];
    unsigned char c;
    ...
    if( ( f = fopen( path, "rb" ) ) == 
# 576 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 3 4
                                      ((void *)0) 
# 576 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
                                           )
        return( -0x003A );
    ...
    fclose( f );
    f = 
# 591 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 3 4
       ((void *)0)
# 591 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
           ;
...
exit:
    mbedtls_platform_zeroize( buf, sizeof( buf ) );
    if( f != 
# 597 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 3 4
            ((void *)0) 
# 597 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
                 )
        fclose( f );
    if( ret != 0 )
        return( ret );
...
# 667 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
int mbedtls_ctr_drbg_self_test( int verbose )
{
    mbedtls_ctr_drbg_context ctx;
...
# 705 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c" 3 4
   ((void *)0)
# 705 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ctr_drbg.c"
