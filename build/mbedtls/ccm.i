# 1 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c"
# 1 "/home/dieter/Development/ProjektEi/build/mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c"
# 34 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c"
...
# 35 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c" 2
...
# 40 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c" 2
# 1 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/include/mbedtls/platform_util.h" 1
# 41 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c" 2
...
# 43 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c" 2
...
# 47 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c" 2
# 66 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c"
void mbedtls_ccm_init( mbedtls_ccm_context *ctx )
{
    do { } while( 0 );
                        ...
                        unsigned int keybits )
{
    ...
    if( cipher_info == 
# 84 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c" 3 4
                      ((void *)0) 
# 84 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c"
                           )
        return( -0x000D );
...
{
    if( ctx == 
# 109 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c" 3 4
              ((void *)0) 
# 109 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c"
                   )
        return;
    mbedtls_cipher_free( &ctx->cipher_ctx );
    mbedtls_platform_zeroize( ctx, sizeof( mbedtls_ccm_context ) );
}
# 152 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c"
                           ...
                           unsigned char *tag, size_t tag_len )
{
    ...
    unsigned char *dst;
# 175 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c"
...
# 199 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c"
    b[0] = 0;
    b[0] |= ( add_len > 0 ) << 6;
    b[0] |= ( ( tag_len - 2 ) / 2 ) << 3;
    b[0] |= q - 1;
...
# 261 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c"
    ctr[0] = q - 1;
    ...
    while( len_left > 0 )
    {
        ...
        do { if( ( ret = mbedtls_cipher_update( &ctx->cipher_ctx, ctr, 16, b, &olen ) ) != 0 ) { return( ret ); } for( i = 0; i < (use_len); i++ ) (dst)[i] = (src)[i] ^ b[i]; } while( 0 );
    ...
    do { if( ( ret = mbedtls_cipher_update( &ctx->cipher_ctx, ctr, 16, b, &olen ) ) != 0 ) { return( ret ); } for( i = 0; i < (16); i++ ) (y)[i] = (y)[i] ^ b[i]; } while( 0 );
...
# 432 "/home/dieter/Development/esp-idf/components/mbedtls/mbedtls/library/ccm.c"
...
static const unsigned char msg[24] = {
