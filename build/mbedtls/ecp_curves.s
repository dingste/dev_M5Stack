...
.LVL161:
.L55:
	.loc 1 1151 0 is_stmt 0 discriminator 3
	l32i	a10, sp, 64
	s32i.n	a10, a8, 0
	addi.n	a8, a8, 4
.LVL162:
...
.LVL163:
	bltu	a9, a10, .L55
	.loc 1 1151 0 discriminator 4
	bgez	a11, .L31
	.loc 1 1151 0 discriminator 5
	movi	a13, 0x180
	addi	a12, sp, 52
	mov.n	a10, a2
	call8	fix_negative
...
.LVL170:
	...
	l32i.n	a8, a2, 8
	.loc 1 1080 0 is_stmt 1 discriminator 1
	addi	a12, sp, 52
...
.LVL257:
.L75:
	.loc 1 1102 0 is_stmt 0 discriminator 3
	l32i.n	a10, sp, 48
	s32i.n	a10, a8, 0
	addi.n	a8, a8, 4
.LVL258:
...
.LVL266:
	...
	l32i.n	a8, a2, 8
	.loc 1 1059 0 is_stmt 1 discriminator 1
	addi	a12, sp, 48
...
.LVL372:
	...
	j	.L118
.L119:
	.loc 1 915 0 is_stmt 0 discriminator 3
	s32i.n	a2, a11, 0
.LVL373:
.L118:
...
.LFE4:
	...
	.section	.data.one$3566,"aw",@progbits
	.align	4
	.type	one$3566, @object
	.size	one$3566, 4
one$3566:
	.word	1
	.section	.data.Rp$3759,"aw",@progbits
	.align	4
	.type	Rp$3759, @object
	.size	Rp$3759, 8
Rp$3759:
	.word	4553
	.word	1
	.section	.data.Rp$3763,"aw",@progbits
	.align	4
	.type	Rp$3763, @object
	.size	Rp$3763, 8
Rp$3763:
	.word	6803
	.word	1
	.section	.data.Rp$3767,"aw",@progbits
	.align	4
	.type	Rp$3767, @object
	.size	Rp$3767, 8
Rp$3767:
