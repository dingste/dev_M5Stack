# 1 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp32-wifi-manager//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c"
# 34 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c"
...
# 35 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 2
...
# 39 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 2
...
# 41 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 2
...
# 42 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 2
...
# 43 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 2
...
# 45 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 2
...
# 49 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 50 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 2
...
# 115 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/include/lwip/dns.h"
                                       keep_fallback);
# 51 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 2

# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/port/include/byteswap.h" 1
# 53 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 2
...
# 55 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 2
...
# 56 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 2

static const char TAG[] = "dns_server";
static TaskHandle_t task_dns_server = 
# 58 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 3 4
                                     ((void *)0)
# 58 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c"
                                         ;
int socket_fd;

void dns_server_start() {
    xTaskCreate(&dns_server, "dns_server", 3072, 
# 62 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 3 4
                                                ((void *)0)
# 62 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c"
                                                    , 5 -1, &task_dns_server);
}
...
void dns_server_stop(){
 if(task_dns_server){
  ...
  close(socket_fd);
  task_dns_server = 
# 69 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 3 4
                   ((void *)0)
# 69 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c"
                       ;
 }
...
void dns_server(void *pvParameters) {
    ...
    lwip_inet_pton(2,"10.10.0.1",&ip_resolved);



    socket_fd = socket(2, 2, 0);
    if (socket_fd < 0){
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to create socket" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to create socket" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to create socket" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to create socket" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to create socket" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        exit(0);
    }
    ...
    ra.sin_port = lwip_htons(53);
    if (bind(socket_fd, (struct sockaddr *)&ra, sizeof(struct sockaddr_in)) == -1) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to bind to 53/udp" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to bind to 53/udp" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to bind to 53/udp" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to bind to 53/udp" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to bind to 53/udp" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        close(socket_fd);
        exit(1);
    }
    ...
    int length;
    uint8_t data[80];
    uint8_t response[(80 +16)];
    char ip_address[16];
    char *domain;
    int err;

    do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "DNS Server listening on 53/udp" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "DNS Server listening on 53/udp" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "DNS Server listening on 53/udp" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "DNS Server listening on 53/udp" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "DNS Server listening on 53/udp" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    ...
    for(;;) {
     ...
     memset(data, 0x00, sizeof(data));
        ...
        if ( length > 0 && ((length + sizeof(dns_answer_t)-1) < (80 +16)) ) {
         ...
         data[length] = '\0';
            ...
            lwip_inet_ntop(2,&(client.sin_addr),ip_address,16);
            domain = (char*) &data[sizeof(dns_header_t) + 1];
            for(char* c=domain; *c != '\0'; c++){
             if(*c < ' ' || *c > 'z') *c = '.';
            }
            do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Replying to DNS request for %s from %s" "\033[0m" "\n", esp_log_timestamp(), TAG, domain, ip_address); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Replying to DNS request for %s from %s" "\033[0m" "\n", esp_log_timestamp(), TAG, domain, ip_address); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Replying to DNS request for %s from %s" "\033[0m" "\n", esp_log_timestamp(), TAG, domain, ip_address); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Replying to DNS request for %s from %s" "\033[0m" "\n", esp_log_timestamp(), TAG, domain, ip_address); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Replying to DNS request for %s from %s" "\033[0m" "\n", esp_log_timestamp(), TAG, domain, ip_address); } } while(0); } while(0);



            dns_answer_t *dns_answer = (dns_answer_t*)&response[length];
            dns_answer->NAME = (__extension__ ({ unsigned short int __bsx = (0xC00C); ((((__bsx) >> 8) & 0xff) | (((__bsx) & 0xff) << 8)); }));
            dns_answer->TYPE = (__extension__ ({ unsigned short int __bsx = (DNS_ANSWER_TYPE_A); ((((__bsx) >> 8) & 0xff) | (((__bsx) & 0xff) << 8)); }));
            dns_answer->CLASS = (__extension__ ({ unsigned short int __bsx = (DNS_ANSWER_CLASS_IN); ((((__bsx) >> 8) & 0xff) | (((__bsx) & 0xff) << 8)); }));
            dns_answer->TTL = (uint32_t)0x00000000;
            dns_answer->RDLENGTH = (__extension__ ({ unsigned short int __bsx = (0x0004); ((((__bsx) >> 8) & 0xff) | (((__bsx) & 0xff) << 8)); }));
            ...
            if (err < 0) {
             do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "UDP sendto failed: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "UDP sendto failed: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "UDP sendto failed: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "UDP sendto failed: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "UDP sendto failed: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
            }
        }
    ...
    vTaskDelete ( 
# 178 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c" 3 4
                 ((void *)0) 
# 178 "/home/dieter/Development/ProjektEi/components/esp32-wifi-manager/src/dns_server.c"
                      );
}
