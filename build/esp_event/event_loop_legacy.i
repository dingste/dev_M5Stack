# 1 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_event//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c"
# 15 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c"
...
# 16 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c" 2
...
static 
# 26 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c" 3 4
      _Bool 
# 26 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c"
           s_initialized;

esp_event_base_t SYSTEM_EVENT = "SYSTEM_EVENT";
...
{
    if (!s_initialized) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "system event loop not initialized via esp_event_loop_init" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "system event loop not initialized via esp_event_loop_init" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "system event loop not initialized via esp_event_loop_init" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "system event loop not initialized via esp_event_loop_init" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "system event loop not initialized via esp_event_loop_init" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x103;
    }
...
{
    if (s_initialized) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "system event loop already initialized" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "system event loop already initialized" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "system event loop already initialized" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "system event loop already initialized" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "system event loop already initialized" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x103;
    }
    ...
    err = esp_event_handler_register(SYSTEM_EVENT, -1, esp_event_post_to_user, 
# 68 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c" 3 4
                                                                                            ((void *)0)
# 68 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c"
                                                                                                );
    if (err != 0) {
        return err;
    }
    ...
    s_initialized = 
# 73 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c" 3 4
                   1
# 73 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c"
                       ;
    s_event_handler_cb = cb;
    s_event_ctx = ctx;
    return 0;
...
{
    if (!s_initialized) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "system event loop not initialized" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "system event loop not initialized" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "system event loop not initialized" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "system event loop not initialized" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "system event loop not initialized" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 0x103;
    }

    esp_err_t err = esp_event_handler_unregister(SYSTEM_EVENT, -1, esp_event_post_to_user);
    if (err != 0) {
        return err;
    }
    ...
    s_initialized = 
# 96 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c" 3 4
                   0
# 96 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c"
                        ;
    s_event_handler_cb = 
# 97 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c" 3 4
                        ((void *)0)
# 97 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c"
                            ;
    s_event_ctx = 
# 98 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c" 3 4
                 ((void *)0)
# 98 "/home/dieter/Development/esp-idf/components/esp_event/event_loop_legacy.c"
                     ;
    return 0;
}
