...
# 24 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
                      ;
    xQueueGenericReceive( ( QueueHandle_t ) ( loop->mutex ), 
# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 3 4
   ((void *)0)
# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
   , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );

    esp_event_base_instance_t* base_it;
    for ((base_it) = (((&(loop->event_bases)))->slh_first); (base_it); (base_it) = (((base_it))->event_base_entry.sle_next)) {
        esp_event_id_instance_t* event_it;
        for ((event_it) = (((&(base_it->event_ids)))->slh_first); (event_it); (event_it) = (((event_it))->event_id_entry.sle_next)) {
            esp_event_handler_instance_t* handler_it;
            for ((handler_it) = (((&(event_it->handlers)))->slh_first); (handler_it); (handler_it) = (((handler_it))->handler_entry.sle_next)) {
                if (base_it->base == event_base && event_it->id == event_id && handler_it->handler == event_handler) {
                    result = 
# 34 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 3 4
                            1
# 34 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
                                ;
                    goto out;
                }
            }
...
# 42 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 3 4
   ((void *)0)
# 42 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
