# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/esp_event//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/private_include/esp_event_private.h"
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/private_include/esp_event_private.h" 2
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 2


# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 3 4
_Bool 
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
    esp_event_is_handler_registered(esp_event_loop_handle_t event_loop, esp_event_base_t event_base, int32_t event_id, esp_event_handler_t event_handler)
{
    esp_event_loop_instance_t* loop = (esp_event_loop_instance_t*) event_loop;

    
# 24 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 3 4
   _Bool 
# 24 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
        result = 
# 24 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 3 4
                 0
# 24 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
    ...
    for ((loop_node) = (((&(loop->loop_nodes)))->slh_first); (loop_node); (loop_node) = (((loop_node))->next.sle_next)) {
        for ((handler) = (((&(loop_node->handlers)))->slh_first); (handler); (handler) = (((handler))->next.sle_next)) {
            if(event_base == 
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 3 4
                            ((void *)0) 
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
                                               && event_id == -1 && handler->handler == event_handler)
            {
                result = 
# 35 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 3 4
                        1
# 35 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
                            ;
                goto out;
            }
        }

        for ((base_node) = (((&(loop_node->base_nodes)))->slh_first); (base_node); (base_node) = (((base_node))->next.sle_next)) {
            if (base_node->base == event_base) {
                for ((handler) = (((&(base_node->handlers)))->slh_first); (handler); (handler) = (((handler))->next.sle_next)) {
                    if(event_id == -1 && handler->handler == event_handler)
                    {
                        result = 
# 45 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 3 4
                                1
# 45 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
                                    ;
                        goto out;
                    }
                }

                for ((id_node) = (((&(base_node->id_nodes)))->slh_first); (id_node); (id_node) = (((id_node))->next.sle_next)) {
                    if(id_node->id == event_id) {
                        for ((handler) = (((&(id_node->handlers)))->slh_first); (handler); (handler) = (((handler))->next.sle_next)) {
                            if(handler->handler == event_handler)
                            {
                                result = 
# 55 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 3 4
                                        1
# 55 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
                                            ;
                                goto out;
                            }
                        }
...
out:
    xQueueGenericSend( ( QueueHandle_t ) ( loop->mutex ), 
# 66 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c" 3 4
   ((void *)0)
# 66 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event_private.c"
