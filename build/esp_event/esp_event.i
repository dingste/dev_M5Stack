# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/esp_event//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/include/esp_event.h"
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/include/esp_event.h" 2
...
# 24 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/private_include/esp_event_private.h" 1
# 39 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/private_include/esp_event_private.h"

# 39 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/private_include/esp_event_private.h" 3 4
_Bool 
# 39 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/private_include/esp_event_private.h"
...
# 387 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event.c"
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "created post for event %s:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, event_base, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "created post for event %s:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, event_base, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "created post for event %s:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, event_base, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "created post for event %s:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, event_base, event_id); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "created post for event %s:%d" "\033[0m" "\n", esp_log_timestamp(), TAG, event_base, event_id); } } while(0); } while(0);
...
# 578 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event.c"
        ...
        if (!exec) {
            ...
            do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "no handlers have been registered for event %s:%d posted to loop %p" "\033[0m" "\n", esp_log_timestamp(), TAG, post.base, post.id, event_loop); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "no handlers have been registered for event %s:%d posted to loop %p" "\033[0m" "\n", esp_log_timestamp(), TAG, post.base, post.id, event_loop); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "no handlers have been registered for event %s:%d posted to loop %p" "\033[0m" "\n", esp_log_timestamp(), TAG, post.base, post.id, event_loop); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "no handlers have been registered for event %s:%d posted to loop %p" "\033[0m" "\n", esp_log_timestamp(), TAG, post.base, post.id, event_loop); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "no handlers have been registered for event %s:%d posted to loop %p" "\033[0m" "\n", esp_log_timestamp(), TAG, post.base, post.id, event_loop); } } while(0); } while(0);
        }
    }
...
# 611 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event.c"
    ...
    xQueueGiveMutexRecursive( ( loop_profiling_mutex ) );
    vQueueDelete( ( QueueHandle_t ) ( loop_profiling_mutex ) );
...
# 805 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_event/esp_event.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "posted %s:%d to loop %p" "\033[0m" "\n", esp_log_timestamp(), TAG, post.base, post.id, event_loop); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "posted %s:%d to loop %p" "\033[0m" "\n", esp_log_timestamp(), TAG, post.base, post.id, event_loop); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "posted %s:%d to loop %p" "\033[0m" "\n", esp_log_timestamp(), TAG, post.base, post.id, event_loop); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "posted %s:%d to loop %p" "\033[0m" "\n", esp_log_timestamp(), TAG, post.base, post.id, event_loop); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "posted %s:%d to loop %p" "\033[0m" "\n", esp_log_timestamp(), TAG, post.base, post.id, event_loop); } } while(0); } while(0);
