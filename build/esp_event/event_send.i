# 1 "/home/dieter/Development/esp-idf/components/esp_event/event_send.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_event//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_event/event_send.c"
# 15 "/home/dieter/Development/esp-idf/components/esp_event/event_send.c"
...
# 16 "/home/dieter/Development/esp-idf/components/esp_event/event_send.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp_event/event_send.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_event/event_send.c" 2
...
static system_event_id_t esp_event_legacy_wifi_event_id(int32_t event_id)
{
    ...
    default:
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "event_send", "\033[0;" "31" "m" "E" " (%d) %s: " "invalid wifi event id %d" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_id); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "event_send", "\033[0;" "33" "m" "W" " (%d) %s: " "invalid wifi event id %d" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_id); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "event_send", "D" " (%d) %s: " "invalid wifi event id %d" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_id); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "event_send", "V" " (%d) %s: " "invalid wifi event id %d" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_id); } else { esp_log_write(ESP_LOG_INFO, "event_send", "\033[0;" "32" "m" "I" " (%d) %s: " "invalid wifi event id %d" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_id); } } while(0); } while(0);
...
static system_event_id_t esp_event_legacy_ip_event_id(int32_t event_id)
{
    ...
    default:
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "event_send", "\033[0;" "31" "m" "E" " (%d) %s: " "invalid ip event id %d" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_id); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "event_send", "\033[0;" "33" "m" "W" " (%d) %s: " "invalid ip event id %d" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_id); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "event_send", "D" " (%d) %s: " "invalid ip event id %d" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_id); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "event_send", "V" " (%d) %s: " "invalid ip event id %d" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_id); } else { esp_log_write(ESP_LOG_INFO, "event_send", "\033[0;" "32" "m" "I" " (%d) %s: " "invalid ip event id %d" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_id); } } while(0); } while(0);
        return SYSTEM_EVENT_MAX;
    }
}
...
static system_event_id_t esp_event_legacy_event_id(esp_event_base_t event_base, int32_t event_id)
{
    if (event_base == WIFI_EVENT) {
        ...
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "event_send", "\033[0;" "31" "m" "E" " (%d) %s: " "invalid event base %s" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_base); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "event_send", "\033[0;" "33" "m" "W" " (%d) %s: " "invalid event base %s" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_base); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "event_send", "D" " (%d) %s: " "invalid event base %s" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_base); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "event_send", "V" " (%d) %s: " "invalid event base %s" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_base); } else { esp_log_write(ESP_LOG_INFO, "event_send", "\033[0;" "32" "m" "I" " (%d) %s: " "invalid event base %s" "\033[0m" "\n", esp_log_timestamp(), "event_send", event_base); } } while(0); } while(0);
        return SYSTEM_EVENT_MAX;
    }
}
