# 1 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
# 15 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
...
# 16 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 2
...
# 104 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
void __attribute__((section(".iram1" "." "0"))) esp_reset_reason_set_hint(esp_reset_reason_t hint)
{
    
# 106 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 3 4
   ((
# 106 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
   (hint & (~0x7FFF)) == 0
# 106 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/esp32/reset_reason.c", 106, __func__, 
# 106 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
...
# 108 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 3 4
   ((
# 108 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
   "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff48000 + 0xb8))) >= 0x3ff00000) && (((0x3ff48000 + 0xb8))) <= 0x3ff13FFC))
# 108 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/esp32/reset_reason.c", 108, __func__, 
# 108 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
   "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff48000 + 0xb8))) >= 0x3ff00000) && (((0x3ff48000 + 0xb8))) <= 0x3ff13FFC))"
# 108 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 3 4
   ))
# 108 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
   ; } while(0);; (*(volatile uint32_t *)((0x3ff48000 + 0xb8))) = (val); });
}


esp_reset_reason_t __attribute__((section(".iram1" "." "1"))) esp_reset_reason_get_hint(void)
{
    uint32_t reset_reason_hint = ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0xb8))) >= 0x3ff00000) && (((0x3ff48000 + 0xb8))) <= 0x3ff13FFC)), (!(((((0x3ff48000 + 0xb8))) >= 0x3ff00000) && (((0x3ff48000 + 0xb8))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); 
# 114 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 3 4
                                ((
# 114 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
                                "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff48000 + 0xb8))) >= 0x3ff00000) && (((0x3ff48000 + 0xb8))) <= 0x3ff13FFC))
# 114 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 3 4
                                ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/esp32/reset_reason.c", 114, __func__, 
# 114 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
                                "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff48000 + 0xb8))) >= 0x3ff00000) && (((0x3ff48000 + 0xb8))) <= 0x3ff13FFC))"
# 114 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 3 4
                                ))
...
{
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0xb8))) >= 0x3ff00000) && (((0x3ff48000 + 0xb8))) <= 0x3ff13FFC)), (!(((((0x3ff48000 + 0xb8))) >= 0x3ff00000) && (((0x3ff48000 + 0xb8))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); 
# 124 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 3 4
   ((
# 124 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
   "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff48000 + 0xb8))) >= 0x3ff00000) && (((0x3ff48000 + 0xb8))) <= 0x3ff13FFC))
# 124 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/esp32/reset_reason.c", 124, __func__, 
# 124 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
   "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff48000 + 0xb8))) >= 0x3ff00000) && (((0x3ff48000 + 0xb8))) <= 0x3ff13FFC))"
# 124 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c" 3 4
   ))
# 124 "/home/dieter/Development/esp-idf/components/esp32/reset_reason.c"
   ; } while(0);; (*(volatile uint32_t *)((0x3ff48000 + 0xb8))) = (0); });
}
