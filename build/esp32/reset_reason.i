# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/reset_reason.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/reset_reason.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/reset_reason.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/reset_reason.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/reset_reason.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/reset_reason.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/rtc_cntl_reg.h" 1
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/reset_reason.c" 2
...
static void __attribute__((constructor)) esp_reset_reason_init(void)
{
    ...
    s_reset_reason = get_reset_reason(rtc_get_reset_reason((0)),
                                      hint);
...
# 104 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/reset_reason.c"
void __attribute__((section(".iram1" "." "0"))) esp_reset_reason_set_hint(esp_reset_reason_t hint)
{
    (((hint & (~0x7FFF)) == 0) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/reset_reason.c", 106, __func__, "(hint & (~RST_REASON_MASK)) == 0"));
    uint32_t val = hint | (hint << 16) | 0x80000000;
    ({ ; (*(volatile uint32_t *)((0x3ff48000 + 0xb8))) = (val); });
}


esp_reset_reason_t __attribute__((section(".iram1" "." "1"))) esp_reset_reason_get_hint(void)
{
    uint32_t reset_reason_hint = ({ ; (*(volatile uint32_t *)((0x3ff48000 + 0xb8))); });
    uint32_t high = (reset_reason_hint >> 16) & 0x7FFF;
    uint32_t low = reset_reason_hint & 0x7FFF;
    if ((reset_reason_hint & 0x80000000) == 0 || high != low) {
        return ESP_RST_UNKNOWN;
    }
...
static void esp_reset_reason_clear_hint()
{
    ({ ; (*(volatile uint32_t *)((0x3ff48000 + 0xb8))) = (0); });
}
