...
void __attribute__((section(".iram1"))) esp_reset_reason_set_hint(esp_reset_reason_t hint)
{
...
esp_reset_reason_t __attribute__((section(".iram1"))) esp_reset_reason_get_hint(void)
{
