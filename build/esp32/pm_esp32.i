...
void __attribute__((section(".iram1"))) esp_pm_impl_isr_hook()
{
    int core_id = xPortGetCoreID();
    do { (void) core_id; } while(0);;
# 468 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_esp32.c"
    leave_idle();
...
void esp_pm_impl_waiti()
{
# 487 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_esp32.c"
    asm("waiti 0");

}
# 592 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_esp32.c"
void esp_pm_impl_init()
{
...
# 597 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_esp32.c"
    , __func__, "esp_pm_lock_create(ESP_PM_CPU_FREQ_MAX, 0, \"rtos0\", &s_rtos_lock_handle[0])"); } } while(0);
                                    ;
    do { esp_err_t __err_rc = (esp_pm_lock_acquire(s_rtos_lock_handle[0])); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_esp32.c", 599, __func__, "esp_pm_lock_acquire(s_rtos_lock_handle[0])"); } } while(0);;
# 609 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_esp32.c"
    rtc_cpu_freq_config_t default_config;
    if (!rtc_clk_cpu_freq_mhz_to_config(160, &default_config)) {
        ((
# 611 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_esp32.c" 3 4
       0 
# 611 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_esp32.c"
       && "unsupported frequency") ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_esp32.c", 611, __func__, "false && \"unsupported frequency\""));
    }
