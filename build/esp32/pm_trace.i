# 1 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c"
# 16 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c"
# 1 "/home/dieter/Development/esp-idf/components/esp_common/include/esp_private/pm_trace.h" 1
# 15 "/home/dieter/Development/esp-idf/components/esp_common/include/esp_private/pm_trace.h"
...
# 18 "/home/dieter/Development/esp-idf/components/esp_common/include/esp_private/pm_trace.h" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c" 2
...
# 776 "/home/dieter/Development/esp-idf/components/driver/include/driver/gpio.h"
                                                    oen_inv);
# 18 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c" 2





static const int __attribute__((section(".dram1" "." "0"))) s_trace_io[] = {
        (1UL << (4)), (1UL << (5)),
        (1UL << (16)), (1UL << (17)),
        (1UL << (18)), (1UL << (18)),
        (1UL << (19)), (1UL << (19)),
...
void __attribute__((section(".iram1" "." "1"))) esp_pm_trace_enter(esp_pm_trace_event_t event, int core_id)
{
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff44000 + 0x0008))) >= 0x3ff00000) && (((0x3ff44000 + 0x0008))) <= 0x3ff13FFC)), (!(((((0x3ff44000 + 0x0008))) >= 0x3ff00000) && (((0x3ff44000 + 0x0008))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); 
# 45 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c" 3 4
   ((
# 45 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c"
   "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff44000 + 0x0008))) >= 0x3ff00000) && (((0x3ff44000 + 0x0008))) <= 0x3ff13FFC))
# 45 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/esp32/pm_trace.c", 45, __func__, 
# 45 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c"
   "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff44000 + 0x0008))) >= 0x3ff00000) && (((0x3ff44000 + 0x0008))) <= 0x3ff13FFC))"
# 45 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c" 3 4
   ))
# 45 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c"
   ; } while(0);; (*(volatile uint32_t *)((0x3ff44000 + 0x0008))) = (s_trace_io[2 * event + core_id]); });
}

void __attribute__((section(".iram1" "." "2"))) esp_pm_trace_exit(esp_pm_trace_event_t event, int core_id)
{
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff44000 + 0x000c))) >= 0x3ff00000) && (((0x3ff44000 + 0x000c))) <= 0x3ff13FFC)), (!(((((0x3ff44000 + 0x000c))) >= 0x3ff00000) && (((0x3ff44000 + 0x000c))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); 
# 50 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c" 3 4
   ((
# 50 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c"
   "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff44000 + 0x000c))) >= 0x3ff00000) && (((0x3ff44000 + 0x000c))) <= 0x3ff13FFC))
# 50 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/esp32/pm_trace.c", 50, __func__, 
# 50 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c"
   "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff44000 + 0x000c))) >= 0x3ff00000) && (((0x3ff44000 + 0x000c))) <= 0x3ff13FFC))"
# 50 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c" 3 4
   ))
# 50 "/home/dieter/Development/esp-idf/components/esp32/pm_trace.c"
   ; } while(0);; (*(volatile uint32_t *)((0x3ff44000 + 0x000c))) = (s_trace_io[2 * event + core_id]); });
}
