# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_trace.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_trace.c"
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_trace.c"
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_trace.c" 2
...
# 611 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/include/driver/gpio.h"
                                                    oen_inv);
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/pm_trace.c" 2
...
{
    ({ ; (*(volatile uint32_t *)((0x3ff44000 + 0x0008))) = (s_trace_io[2 * event + core_id]); });
}

void __attribute__((section(".iram1" "." "2"))) esp_pm_trace_exit(esp_pm_trace_event_t event, int core_id)
{
    ({ ; (*(volatile uint32_t *)((0x3ff44000 + 0x000c))) = (s_trace_io[2 * event + core_id]); });
}
