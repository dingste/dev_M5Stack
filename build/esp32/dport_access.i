# 1 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
# 22 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
...
# 23 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 24 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 26 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
# 1 "/home/dieter/Development/esp-idf/components/xtensa/include/esp_attr.h" 1
# 27 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 28 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 29 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 30 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 31 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 33 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 34 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 35 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
static inline uint32_t __attribute__((section(".iram1" "." "4"))) xPortGetCoreID(void) {
    uint32_t id;
    __asm__ __volatile__ (
        "rsr.prid %0\n"
        " extui %0,%0,13,1"
...
# 221 "/home/dieter/Development/esp-idf/components/freertos/include/freertos/portable.h"
                  __attribute__((section(".iram1" "." "5"))) xPortCanYield(void)
{
    uint32_t ps_reg = 0;
...
# 37 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 432 "/home/dieter/Development/esp-idf/components/freertos/include/freertos/task.h"
 static inline __attribute__((section(".iram1" "." "6"))) BaseType_t xTaskCreate(
   TaskFunction_t pvTaskCode,
   const char * const pcName,
   const uint32_t usStackDepth,
   void * const pvParameters,
...
# 38 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 39 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freertos/include/freertos/queue.h" 1
# 40 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freertos/include/freertos/portmacro.h" 1
# 41 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 43 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 2
...
# 66 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
static BaseType_t oldInterruptLevel[2];



void __attribute__((section(".iram1" "." "7"))) esp_dport_access_stall_other_cpu_start(void)
{
    ...
    if (dport_access_ref[cpu_id] == 0) {
        ...
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) >= 0x3ff00000) && ((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) <= 0x3ff13FFC)), (!((((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) >= 0x3ff00000) && ((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); 
# 102 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 3 4
       ((
# 102 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
       "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!((((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) >= 0x3ff00000) && ((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) <= 0x3ff13FFC))
# 102 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 3 4
       ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/esp32/dport_access.c", 102, __func__, 
# 102 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
       "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!((((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) >= 0x3ff00000) && ((((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))) <= 0x3ff13FFC))"
# 102 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 3 4
       ))
# 102 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
       ; } while(0);; (*(volatile uint32_t *)(((0x3ff42000 + (((3)>1) ? (((3)* 0x1000) + 0x20000) : (((~(3)) & 1)* 0x1000 ))) + 0x3FC))); });
    }
...
void __attribute__((section(".iram1" "." "8"))) esp_dport_access_stall_other_cpu_end(void)
{
...
# 126 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 3 4
       ((
# 126 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
       0
# 126 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 3 4
       ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/esp32/dport_access.c", 126, __func__, 
# 126 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
       "0"
# 126 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 3 4
       ))
...
void __attribute__((section(".iram1" "." "9"))) esp_dport_access_stall_other_cpu_start_wrap(void)
{
    esp_dport_access_stall_other_cpu_start();
}

void __attribute__((section(".iram1" "." "10"))) esp_dport_access_stall_other_cpu_end_wrap(void)
{
...
static void dport_access_init_core(void *arg)
{
    ...
    vTaskDelete(
# 178 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 3 4
               ((void *)0)
# 178 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
                   );
}
...
# 186 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 3 4
                                                                                                           ((void *)0)
# 186 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
                                                                                                               , 5, 
# 186 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 3 4
                                                                                                                    ((void *)0)
# 186 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
...
# 187 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 3 4
   ((
# 187 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
   res == ( ( BaseType_t ) 1 )
# 187 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/esp32/dport_access.c", 187, __func__, 
# 187 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
   "res == pdTRUE"
# 187 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c" 3 4
   ))
...
void __attribute__((section(".iram1" "." "11"))) esp_dport_access_int_pause(void)
{
...
void __attribute__((section(".iram1" "." "12"))) esp_dport_access_int_abort(void)
{
...
void __attribute__((section(".iram1" "." "13"))) esp_dport_access_int_resume(void)
{
...
# 231 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
void __attribute__((section(".iram1" "." "14"))) esp_dport_access_read_buffer(uint32_t *buff_out, uint32_t address, uint32_t num_words)
{
...
# 250 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
uint32_t __attribute__((section(".iram1" "." "15"))) esp_dport_access_reg_read(uint32_t reg)
{
...
# 296 "/home/dieter/Development/esp-idf/components/esp32/dport_access.c"
uint32_t __attribute__((section(".iram1" "." "16"))) esp_dport_access_sequence_reg_read(uint32_t reg)
{
