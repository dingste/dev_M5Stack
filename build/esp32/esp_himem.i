# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 2
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/include/sdkconfig.h" 1
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/include/esp_himem.h" 1
# 14 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/include/esp_himem.h"
       

# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/xtensa/lib/gcc/xtensa-esp32-elf/5.2.0/include/stddef.h" 1 3 4
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/include/esp_himem.h" 2
...
# 42 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/include/esp_himem.h"
esp_err_t esp_himem_alloc(size_t size, esp_himem_handle_t *handle_out);
# 58 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/include/esp_himem.h"
esp_err_t esp_himem_alloc_map_range(size_t size, esp_himem_rangehandle_t *handle_out);
# 81 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/include/esp_himem.h"
...
# 94 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/include/esp_himem.h"
esp_err_t esp_himem_free(esp_himem_handle_t handle);
# 108 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/include/esp_himem.h"
esp_err_t esp_himem_free_map_range(esp_himem_rangehandle_t handle);
# 120 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/include/esp_himem.h"
...
# 146 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/include/esp_himem.h"
size_t esp_himem_reserved_area_size();
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 2
...
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 2
# 70 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
typedef struct {
...
static ramblock_t *s_ram_descriptor = 
# 82 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
                                     ((void *)0)
# 82 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
                                         ;
static rangeblock_t *s_range_descriptor = 
# 83 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
                                         ((void *)0)
# 83 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
                                             ;
static int s_ramblockcnt = 0;
static const int s_rangeblockcnt = 0;
...
{
    int r;
    r = cache_sram_mmu_set( 0, 0, 0x3F800000 + (32*1024) * virt_bank, phys_bank * (32*1024), 32, ct );
    ((r == 0) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c", 115, __func__, "r == 0"));
    r = cache_sram_mmu_set( 1, 0, 0x3F800000 + (32*1024) * virt_bank, phys_bank * (32*1024), 32, ct );
    ((r == 0) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c", 117, __func__, "r == 0"));
}

size_t esp_himem_get_phys_size()
{
    int paddr_start = (4096 * 1024) - ((32*1024) * 0);
...
size_t esp_himem_get_free_size()
{
    ...
    for (int i = 0; i < s_ramblockcnt; i++) {
        if (!s_ram_descriptor[i].is_alloced) ret+=(32*1024);
    }
    return ret;
}
...
void __attribute__((constructor)) esp_himem_init()
{
    ...
    if (s_ram_descriptor != 
# 145 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
   ((void *)0)
# 145 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
   ) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "already initialized"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "already initialized"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "already initialized"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "already initialized"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "already initialized"); } } while(0); } while(0); return ; } while(0);
    if (s_range_descriptor != 
# 146 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
   ((void *)0)
# 146 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
   ) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "already initialized"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "already initialized"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "already initialized"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "already initialized"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "already initialized"); } } while(0); } while(0); return ; } while(0);

    if (0 == 0) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "No banks reserved for himem"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "No banks reserved for himem"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "No banks reserved for himem"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "No banks reserved for himem"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "No banks reserved for himem"); } } while(0); } while(0); return ; } while(0);



    int paddr_start = (4096 * 1024) - ((32*1024) * 0);
    int paddr_end = maxram;
    s_ramblockcnt = ((paddr_end - paddr_start) / (32*1024));

    s_ram_descriptor = calloc(sizeof(ramblock_t), s_ramblockcnt);
    s_range_descriptor = calloc(sizeof(rangeblock_t), 0);
    if (s_ram_descriptor == 
# 158 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
                           ((void *)0) 
# 158 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
                                || s_range_descriptor == 
# 158 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
                                                         ((void *)0)
# 158 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
                                                             ) {
        do { if (3 >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "Cannot allocate memory for meta info. Not initializing!" "\033[0m" "\n", esp_log_timestamp(), "esp_himem"); }} while(0);
        free(s_ram_descriptor);
        free(s_range_descriptor);
        return;
    }
    do { if (3 >= ESP_LOG_INFO) { ets_printf("\033[0;" "32" "m" "I" " (%d) %s: " "Initialized. Using last %d 32KB address blocks for bank switching on %d KB of physical memory." "\033[0m" "\n", esp_log_timestamp(), "esp_himem", 0, (paddr_end - paddr_start)/1024); }} while(0)
                                                                          ;
}
...
static 
# 171 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
      _Bool 
# 171 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
           allocate_blocks(int count, uint16_t *blocks_out)
{
    int n = 0;
    ...
    if (n == count) {
        ...
        for (int i = 0; i < count; i++) {
            s_ram_descriptor[blocks_out[i]].is_alloced = 
# 183 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
                                                        1
# 183 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
                                                            ;
            ((s_ram_descriptor[blocks_out[i]].is_mapped == 
# 184 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
           0
# 184 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
           ) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c", 184, __func__, "s_ram_descriptor[blocks_out[i]].is_mapped == false"));
        }
        return 
# 186 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
              1
# 186 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
                  ;
    } else {

        return 
# 189 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
              0
# 189 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
                   ;
    }
}
...
esp_err_t esp_himem_free(esp_himem_handle_t handle)
{
    ...
    for (int i = 0; i < handle->block_ct; i++) {
        ((ramblock_idx_valid(handle->block[i])) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c", 229, __func__, "ramblock_idx_valid(handle->block[i])"));
        if (s_ram_descriptor[handle->block[i]].is_mapped) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "block in range still mapped"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "block in range still mapped"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "block in range still mapped"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "block in range still mapped"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "block in range still mapped"); } } while(0); } while(0); return 0x102; } while(0);
    }

    vTaskEnterCritical(&spinlock);
    for (int i = 0; i < handle->block_ct; i++) {
        s_ram_descriptor[handle->block[i]].is_alloced = 
# 235 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
                                                       0
# 235 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
                                                            ;
    }
    vTaskExitCritical(&spinlock);
...
{
    if (s_ram_descriptor == 
# 248 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
   ((void *)0)
# 248 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
   ) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "Himem not available!"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "Himem not available!"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "Himem not available!"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "Himem not available!"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "Himem not available!"); } } while(0); } while(0); return 0x103; } while(0);
    if (size % (32*1024) != 0) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "requested size not aligned to blocksize"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "requested size not aligned to blocksize"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "requested size not aligned to blocksize"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "requested size not aligned to blocksize"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "requested size not aligned to blocksize"); } } while(0); } while(0); return 0x104; } while(0);
    int blocks = size / (32*1024);
...
esp_err_t esp_himem_free_map_range(esp_himem_rangehandle_t handle)
{
    ...
    for (int i = 0; i < handle->block_ct; i++) {
        ((rangeblock_idx_valid(handle->block_start + i)) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c", 289, __func__, "rangeblock_idx_valid(handle->block_start + i)"));
        ((s_range_descriptor[i + handle->block_start].is_alloced == 1) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c", 290, __func__, "s_range_descriptor[i + handle->block_start].is_alloced == 1"));
        if (s_range_descriptor[i + handle->block_start].is_mapped) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "memory still mapped to range"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "memory still mapped to range"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "memory still mapped to range"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "memory still mapped to range"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "memory still mapped to range"); } } while(0); } while(0); return 0x102; } while(0);
    }
...
esp_err_t esp_himem_map(esp_himem_handle_t handle, esp_himem_rangehandle_t range, size_t ram_offset, size_t range_offset, size_t len, int flags, void **out_ptr)
{
    int ram_block = ram_offset / (32*1024);
    int range_block = range_offset / (32*1024);
    int blockcount = len / (32*1024);
    if (s_ram_descriptor == 
# 309 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c" 3 4
   ((void *)0)
# 309 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c"
   ) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "Himem not available!"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "Himem not available!"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "Himem not available!"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "Himem not available!"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "Himem not available!"); } } while(0); } while(0); return 0x103; } while(0);

    if (ram_offset % (32*1024) != 0) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "ram offset not aligned to blocksize"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "ram offset not aligned to blocksize"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "ram offset not aligned to blocksize"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "ram offset not aligned to blocksize"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "ram offset not aligned to blocksize"); } } while(0); } while(0); return 0x102; } while(0);
    if (range_offset % (32*1024) != 0) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range not aligned to blocksize"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range not aligned to blocksize"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range not aligned to blocksize"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range not aligned to blocksize"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range not aligned to blocksize"); } } while(0); } while(0); return 0x102; } while(0);
    if (len % (32*1024) != 0) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "length not aligned to blocksize"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "length not aligned to blocksize"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "length not aligned to blocksize"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "length not aligned to blocksize"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "length not aligned to blocksize"); } } while(0); } while(0); return 0x102; } while(0);

    if (ram_block + blockcount > handle->block_ct) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "args not in range of phys ram handle"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "args not in range of phys ram handle"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "args not in range of phys ram handle"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "args not in range of phys ram handle"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "args not in range of phys ram handle"); } } while(0); } while(0); return 0x104; } while(0);
    if (range_block + blockcount > range->block_ct) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "args not in range of range handle"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "args not in range of range handle"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "args not in range of range handle"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "args not in range of range handle"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "args not in range of range handle"); } } while(0); } while(0); return 0x104; } while(0);


    for (int i = 0; i < blockcount; i++) {
        if (s_ram_descriptor[handle->block[i + ram_block]].is_mapped) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "ram already mapped"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "ram already mapped"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "ram already mapped"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "ram already mapped"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "ram already mapped"); } } while(0); } while(0); return 0x103; } while(0);
        if (s_range_descriptor[range->block_start + i + range_block].is_mapped) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range already mapped"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range already mapped"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range already mapped"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range already mapped"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range already mapped"); } } while(0); } while(0); return 0x103; } while(0);
    }


    vTaskEnterCritical(&spinlock);
    for (int i = 0; i < blockcount; i++) {
        ((ramblock_idx_valid(handle->block[i + ram_block])) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c", 327, __func__, "ramblock_idx_valid(handle->block[i + ram_block])"));
    ...
    vTaskExitCritical(&spinlock);
    for (int i = 0; i < blockcount; i++) {
        set_bank((128-0) + range->block_start + i + range_block, handle->block[i + ram_block] + (128-0), 1);
    }


    *out_ptr = (void *)((0x3F800000 +(128-0)*(32*1024)) + (range->block_start + range_offset) * (32*1024));
    return 0;
}
...
esp_err_t esp_himem_unmap(esp_himem_rangehandle_t range, void *ptr, size_t len)
{
    ...
    int range_offset = (uint32_t)ptr - (0x3F800000 +(128-0)*(32*1024));
    int range_block = (range_offset / (32*1024)) - range->block_start;
    int blockcount = len / (32*1024);
    if (range_offset % (32*1024) != 0) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range offset not block-aligned"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range offset not block-aligned"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range offset not block-aligned"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range offset not block-aligned"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range offset not block-aligned"); } } while(0); } while(0); return 0x102; } while(0);
    if (len % (32*1024) != 0) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "map length not block-aligned"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "map length not block-aligned"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "map length not block-aligned"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "map length not block-aligned"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "map length not block-aligned"); } } while(0); } while(0); return 0x102; } while(0);
    if (range_block + blockcount > range->block_ct) do {do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "esp_himem", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range out of bounds for handle"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "esp_himem", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range out of bounds for handle"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "esp_himem", "D" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range out of bounds for handle"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "esp_himem", "V" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range out of bounds for handle"); } else { esp_log_write(ESP_LOG_INFO, "esp_himem", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: %s" "\033[0m" "\n", esp_log_timestamp(), "esp_himem", __FUNCTION__, "range out of bounds for handle"); } } while(0); } while(0); return 0x102; } while(0);

    vTaskEnterCritical(&spinlock);
    for (int i = 0; i < blockcount; i++) {
        int ramblock = s_range_descriptor[range->block_start + i + range_block].ram_block;
        ((ramblock_idx_valid(ramblock)) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/esp_himem.c", 357, __func__, "ramblock_idx_valid(ramblock)"));
