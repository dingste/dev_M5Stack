# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/cache_sram_mmu.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/cache_sram_mmu.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/cache_sram_mmu.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/cache_sram_mmu.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/cache_sram_mmu.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/cache_sram_mmu.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/cache_sram_mmu.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/include/esp_spi_flash.h" 1
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/include/esp_spi_flash.h"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/xtensa/lib/gcc/xtensa-esp32-elf/5.2.0/include/stdbool.h" 1 3 4
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/include/esp_spi_flash.h" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/xtensa/lib/gcc/xtensa-esp32-elf/5.2.0/include/stddef.h" 1 3 4
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/spi_flash/include/esp_spi_flash.h" 2
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/include/sdkconfig.h" 1
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/cache_sram_mmu.c" 2
# 50 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/cache_sram_mmu.c"
unsigned int cache_sram_mmu_set_rom(int cpu_no, int pid, unsigned int vaddr, unsigned int paddr, int psize, int num);
# 61 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/cache_sram_mmu.c"
unsigned int __attribute__((section(".iram1" "." "3"))) cache_sram_mmu_set(int cpu_no, int pid, unsigned int vaddr, unsigned int paddr, int psize, int num)
{
    ...
    if( ((((vaddr) & (0xFFFF >>((64/(psize))-1))) != 0)) || ((((paddr) & (0xFFFF >>((64/(psize))-1))) != 0)) ){
        return 1;
    }
    ...
    if(pid == 0 || pid == 1){
        if(vaddr >= 0x3F800000 && vaddr < (0x3F800000 + ((psize) << 17))){
    ...
    for ( i = 0; i < num; i++){
        *(volatile unsigned int *)(((cpu_no) ? (0x3FF12000) : (0x3FF10000)) + mmu_addr * 4) = mmu_table_val + i;
        mmu_addr++;
    }

    if(cpu_no == 0){
        (*(volatile uint32_t *)((((0x3ff00000 + 0x044))))) = ((((DPORT_REG_READ((0x3ff00000 + 0x044)) & (~((0x7) << (6))))|(((mask_s) & (0x7))<<(6)))));
    } else {
        (*(volatile uint32_t *)((((0x3ff00000 + 0x05C))))) = ((((DPORT_REG_READ((0x3ff00000 + 0x05C)) & (~((0x7) << (6))))|(((mask_s) & (0x7))<<(6)))));
    }
