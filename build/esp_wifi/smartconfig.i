# 1 "/home/dieter/Development/esp-idf/components/esp_wifi/src/smartconfig.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_wifi//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_wifi/src/smartconfig.c"
# 15 "/home/dieter/Development/esp-idf/components/esp_wifi/src/smartconfig.c"
...
# 16 "/home/dieter/Development/esp-idf/components/esp_wifi/src/smartconfig.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp_wifi/src/smartconfig.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_wifi/src/smartconfig.c" 2
...
typedef void (*esp_event_handler_t)(void* event_handler_arg,
                                        ...
                                        int32_t event_id,
                                        void* event_data);
# 19 "/home/dieter/Development/esp-idf/components/esp_wifi/src/smartconfig.c" 2
# 1 "/home/dieter/Development/esp-idf/components/esp_wifi/include/esp_private/wifi.h" 1
# 32 "/home/dieter/Development/esp-idf/components/esp_wifi/include/esp_private/wifi.h"
...
# 33 "/home/dieter/Development/esp-idf/components/esp_wifi/include/esp_private/wifi.h" 2
...
# 20 "/home/dieter/Development/esp-idf/components/esp_wifi/src/smartconfig.c" 2

# 1 "/home/dieter/Development/esp-idf/components/esp_wifi/include/smartconfig_ack.h" 1
# 34 "/home/dieter/Development/esp-idf/components/esp_wifi/include/smartconfig_ack.h"
...
# 22 "/home/dieter/Development/esp-idf/components/esp_wifi/src/smartconfig.c" 2
...
static void handler_got_ssid_passwd(void *arg, esp_event_base_t base, int32_t event_id, void *data)
{
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SSID:%s" "\033[0m" "\n", esp_log_timestamp(), TAG, ssid); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SSID:%s" "\033[0m" "\n", esp_log_timestamp(), TAG, ssid); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SSID:%s" "\033[0m" "\n", esp_log_timestamp(), TAG, ssid); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SSID:%s" "\033[0m" "\n", esp_log_timestamp(), TAG, ssid); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SSID:%s" "\033[0m" "\n", esp_log_timestamp(), TAG, ssid); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "PASSWORD:%s" "\033[0m" "\n", esp_log_timestamp(), TAG, password); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "PASSWORD:%s" "\033[0m" "\n", esp_log_timestamp(), TAG, password); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PASSWORD:%s" "\033[0m" "\n", esp_log_timestamp(), TAG, password); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "PASSWORD:%s" "\033[0m" "\n", esp_log_timestamp(), TAG, password); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "PASSWORD:%s" "\033[0m" "\n", esp_log_timestamp(), TAG, password); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Phone ip: %d.%d.%d.%d\n" "\033[0m" "\n", esp_log_timestamp(), TAG, cellphone_ip[0], cellphone_ip[1], cellphone_ip[2], cellphone_ip[3]); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Phone ip: %d.%d.%d.%d\n" "\033[0m" "\n", esp_log_timestamp(), TAG, cellphone_ip[0], cellphone_ip[1], cellphone_ip[2], cellphone_ip[3]); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Phone ip: %d.%d.%d.%d\n" "\033[0m" "\n", esp_log_timestamp(), TAG, cellphone_ip[0], cellphone_ip[1], cellphone_ip[2], cellphone_ip[3]); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Phone ip: %d.%d.%d.%d\n" "\033[0m" "\n", esp_log_timestamp(), TAG, cellphone_ip[0], cellphone_ip[1], cellphone_ip[2], cellphone_ip[3]); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Phone ip: %d.%d.%d.%d\n" "\033[0m" "\n", esp_log_timestamp(), TAG, cellphone_ip[0], cellphone_ip[1], cellphone_ip[2], cellphone_ip[3]); } } while(0); } while(0);

    err = sc_send_ack_start(evt->type, evt->token, evt->cellphone_ip);
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Send smartconfig ACK error: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Send smartconfig ACK error: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Send smartconfig ACK error: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Send smartconfig ACK error: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Send smartconfig ACK error: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
    }
}
...
# 54 "/home/dieter/Development/esp-idf/components/esp_wifi/src/smartconfig.c" 3 4
                                                                                               ((void *)0)
# 54 "/home/dieter/Development/esp-idf/components/esp_wifi/src/smartconfig.c"
                                                                                                   );
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Register smartconfig default event handler fail!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Register smartconfig default event handler fail!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Register smartconfig default event handler fail!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Register smartconfig default event handler fail!" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Register smartconfig default event handler fail!" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return err;
    }
