# 1 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_wifi//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c"
# 14 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c"
...
# 15 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c" 2
# 28 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c"
...
static esp_netif_receive_t s_wifi_rxcbs[(2)] = { 
# 38 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c" 3 4
                                                         ((void *)0) 
# 38 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c"
                                                              };
static esp_netif_t *s_wifi_netifs[(2)] = { 
# 39 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c" 3 4
                                                   ((void *)0) 
# 39 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c"
                                                        };
...
{
    return s_wifi_rxcbs[ESP_IF_WIFI_STA](s_wifi_netifs[ESP_IF_WIFI_STA], buffer, len, eb);
}

static esp_err_t wifi_ap_receive(void *buffer, uint16_t len, void *eb)
{
    return s_wifi_rxcbs[ESP_IF_WIFI_AP](s_wifi_netifs[ESP_IF_WIFI_AP], buffer, len, eb);
}
...
wifi_netif_driver_t esp_wifi_create_if_driver(wifi_interface_t wifi_if)
{
    ...
    if (driver == 
# 87 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c" 3 4
                 ((void *)0)
# 87 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c"
                     ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "No memory to create a wifi interface handle" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "No memory to create a wifi interface handle" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "No memory to create a wifi interface handle" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "No memory to create a wifi interface handle" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "No memory to create a wifi interface handle" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 
# 89 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c" 3 4
              ((void *)0)
# 89 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c"
                  ;
    }
...
# 103 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c" 3 4
_Bool 
# 103 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c"
    esp_wifi_is_if_ready_when_started(wifi_netif_driver_t ifx)
{

    return (ifx->wifi_if == ESP_IF_WIFI_AP);
}

esp_err_t esp_wifi_register_if_rxcb(wifi_netif_driver_t ifx, esp_netif_receive_t fn, void * arg)
{
    if (ifx->base.netif != arg) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid argument: supplied netif=%p does not equal to interface netif=%p" "\033[0m" "\n", esp_log_timestamp(), TAG, arg, ifx->base.netif); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Invalid argument: supplied netif=%p does not equal to interface netif=%p" "\033[0m" "\n", esp_log_timestamp(), TAG, arg, ifx->base.netif); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Invalid argument: supplied netif=%p does not equal to interface netif=%p" "\033[0m" "\n", esp_log_timestamp(), TAG, arg, ifx->base.netif); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Invalid argument: supplied netif=%p does not equal to interface netif=%p" "\033[0m" "\n", esp_log_timestamp(), TAG, arg, ifx->base.netif); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Invalid argument: supplied netif=%p does not equal to interface netif=%p" "\033[0m" "\n", esp_log_timestamp(), TAG, arg, ifx->base.netif); } } while(0); } while(0);
        return 0x102;
    }
    wifi_interface_t wifi_interface = ifx->wifi_if;
    s_wifi_rxcbs[wifi_interface] = fn;
    wifi_rxcb_t rxcb = 
# 117 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c" 3 4
                      ((void *)0)
# 117 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c"
                          ;
    esp_err_t ret;
    ...
    if (rxcb == 
# 134 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c" 3 4
               ((void *)0)
# 134 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_netif.c"
                   ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Unknown wifi interface id if=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, wifi_interface); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Unknown wifi interface id if=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, wifi_interface); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Unknown wifi interface id if=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, wifi_interface); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Unknown wifi interface id if=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, wifi_interface); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Unknown wifi interface id if=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, wifi_interface); } } while(0); } while(0);
        return 0x106;
    }

    if ((ret = esp_wifi_internal_reg_rxcb(wifi_interface, rxcb)) != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_wifi_internal_reg_rxcb for if=%d failed with %d" "\033[0m" "\n", esp_log_timestamp(), TAG, wifi_interface, ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_wifi_internal_reg_rxcb for if=%d failed with %d" "\033[0m" "\n", esp_log_timestamp(), TAG, wifi_interface, ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_wifi_internal_reg_rxcb for if=%d failed with %d" "\033[0m" "\n", esp_log_timestamp(), TAG, wifi_interface, ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_wifi_internal_reg_rxcb for if=%d failed with %d" "\033[0m" "\n", esp_log_timestamp(), TAG, wifi_interface, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_wifi_internal_reg_rxcb for if=%d failed with %d" "\033[0m" "\n", esp_log_timestamp(), TAG, wifi_interface, ret); } } while(0); } while(0);
        return 0x103;
    }
