# 1 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_wifi//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c"
# 15 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c"
...
# 16 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c" 2

# 1 "/home/dieter/Development/esp-idf/components/wpa_supplicant/include/esp_supplicant/esp_wpa.h" 1
# 44 "/home/dieter/Development/esp-idf/components/wpa_supplicant/include/esp_supplicant/esp_wpa.h"
const wpa_crypto_funcs_t g_wifi_default_wpa_crypto_funcs;

const mesh_crypto_funcs_t g_wifi_default_mesh_crypto_funcs;
# 55 "/home/dieter/Development/esp-idf/components/wpa_supplicant/include/esp_supplicant/esp_wpa.h"
esp_err_t esp_supplicant_init(void);
# 64 "/home/dieter/Development/esp-idf/components/wpa_supplicant/include/esp_supplicant/esp_wpa.h"
esp_err_t esp_supplicant_deinit(void);
# 22 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c" 2
...
esp_err_t tcpip_adapter_clear_default_wifi_handlers(void);
# 24 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c" 2
# 33 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c"
...
# 41 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c" 3 4
                                                     ((void *)0)
# 41 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c"
                                                         ;
...
static void __attribute__((constructor)) s_set_default_wifi_log_level(void)
{
    ...
    esp_log_level_set("mesh", 3);
}

static void esp_wifi_set_debug_log(void)
{
# 101 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c"
}
...
esp_err_t esp_wifi_deinit(void)
{
    ...
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to deinit Wi-Fi driver (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to deinit Wi-Fi driver (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to deinit Wi-Fi driver (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to deinit Wi-Fi driver (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to deinit Wi-Fi driver (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
    }
...
esp_err_t esp_wifi_init(const wifi_init_config_t *config)
{
# 132 "/home/dieter/Development/esp-idf/components/esp_wifi/src/wifi_init.c"
    esp_err_t err = tcpip_adapter_set_default_wifi_handlers();
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to set default Wi-Fi event handlers (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to set default Wi-Fi event handlers (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to set default Wi-Fi event handlers (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to set default Wi-Fi event handlers (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to set default Wi-Fi event handlers (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
    }
    ...
    if (result == 0) {
        ...
        if (result != 0) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to init supplicant (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to init supplicant (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to init supplicant (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to init supplicant (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to init supplicant (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, result); } } while(0); } while(0);
            esp_err_t deinit_ret = esp_wifi_deinit();
            if (deinit_ret != 0) {
                do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to deinit Wi-Fi (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, deinit_ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to deinit Wi-Fi (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, deinit_ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to deinit Wi-Fi (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, deinit_ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to deinit Wi-Fi (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, deinit_ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to deinit Wi-Fi (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, deinit_ret); } } while(0); } while(0);
            }
