# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/ulp//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c" 2

# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp32/include/esp_attr.h" 1
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c" 2
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c" 2
...
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c" 2
...
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/xtensa/lib/gcc/xtensa-esp32-elf/5.2.0/include/stddef.h" 1 3 4
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/include/esp32/ulp.h" 2
# 127 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/include/esp32/ulp.h"
typedef union {
...
# 296 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/include/esp32/ulp.h"
static inline uint32_t SOC_REG_TO_ULP_PERIPH_SEL(uint32_t reg) {
    uint32_t ret = 3;
    if (reg < 0x3ff48000) {
        ((0 && "invalid register base") ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/include/esp32/ulp.h", 299, __func__, "0 && \"invalid register base\""));
        ...
        ((0 && "invalid register base") ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/include/esp32/ulp.h", 309, __func__, "0 && \"invalid register base\""));
    }
    return ret;
}
# 854 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/include/esp32/ulp.h"
esp_err_t ulp_process_macros_and_load(uint32_t load_addr, const ulp_insn_t* program, size_t* psize);
# 882 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/include/esp32/ulp.h"
...
# 24 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c" 2
...
# 27 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c" 2
...
# 28 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/sens_reg.h" 1
# 29 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c" 2

# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/include/sdkconfig.h" 1
# 31 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/ulp/ulp.c" 2
...
esp_err_t ulp_run(uint32_t entry_point)
{
    ...
    ({ ; ({ ; (*((volatile uint32_t *)(((0x3ff48000 + 0x18))))) = (uint32_t)((({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x18)))); })&(~(((1UL << (24))))))); }); });

    ets_delay_us(10);

    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48800 + 0x002c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48800 + 0x002c))); }) & ~((0x7FF) << (11)))|(((entry_point) & (0x7FF))<<(11)))); })); });
...
esp_err_t ulp_load_binary(uint32_t load_addr, const uint8_t* program_binary, size_t program_size)
{
    ...
    if (load_addr_bytes > 512) {
        return 0x102;
    }
    if (load_addr_bytes + program_size_bytes > 512) {
        return 0x104;
    }
...
esp_err_t ulp_set_wakeup_period(size_t period_index, uint32_t period_us)
{
    ...
    uint64_t min_sleep_period_cycles = 2
                                    + 2
                                    + ({ ; ((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x20))); }) >> (15)) & (0x1FF)); });
    if (period_cycles < min_sleep_period_cycles) {
        period_cycles = 0;
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Sleep period clipped to minimum of %d cycles" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint32_t) min_sleep_period_cycles); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Sleep period clipped to minimum of %d cycles" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint32_t) min_sleep_period_cycles); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Sleep period clipped to minimum of %d cycles" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint32_t) min_sleep_period_cycles); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Sleep period clipped to minimum of %d cycles" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint32_t) min_sleep_period_cycles); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Sleep period clipped to minimum of %d cycles" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint32_t) min_sleep_period_cycles); } } while(0); } while(0);
    } else {
        period_cycles -= min_sleep_period_cycles;
    }
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48800 + 0x0018) + period_index * sizeof(uint32_t)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48800 + 0x0018) + period_index * sizeof(uint32_t))); }) & ~((0xFFFFFFFF) << (0)))|((((uint32_t) period_cycles) & (0xFFFFFFFF))<<(0)))); })); })
                                                           ;
    return 0;
}
