# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/protocomm//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c"
...
# 78 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/include/freertos/FreeRTOS.h" 2
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 2
...
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/include/esp_bt.h" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 2
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/api/include/api/esp_bt_main.h" 1
# 27 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/api/include/api/esp_bt_main.h"
typedef enum {
...
# 48 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/api/include/api/esp_bt_main.h"
esp_err_t esp_bluedroid_enable(void);
# 57 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/api/include/api/esp_bt_main.h"
esp_err_t esp_bluedroid_disable(void);
# 66 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/api/include/api/esp_bt_main.h"
esp_err_t esp_bluedroid_init(void);
# 75 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/api/include/api/esp_bt_main.h"
esp_err_t esp_bluedroid_deinit(void);
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 2
...
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 2
...
# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 2
...
static uint16_t g_gatt_table_map[20];
...
const uint8_t *simple_ble_get_uuid128(uint16_t handle)
{
    ...
    return 
# 47 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 3 4
          ((void *)0)
# 47 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c"
              ;
}
...
{
    static esp_gatt_if_t gatts_if = 0xff;
    esp_err_t ret;
    ...
    if (event == ESP_GATTS_REG_EVT) {
        if (param->reg.status == ESP_GATT_OK) {
            ...
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "reg app failed, app_id 0x0x%x, status %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->reg.app_id, param->reg.status); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "reg app failed, app_id 0x0x%x, status %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->reg.app_id, param->reg.status); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "reg app failed, app_id 0x0x%x, status %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->reg.app_id, param->reg.status); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "reg app failed, app_id 0x0x%x, status %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->reg.app_id, param->reg.status); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "reg app failed, app_id 0x0x%x, status %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->reg.app_id, param->reg.status); } } while(0); } while(0)
    ...
    if (gatts_if != 0xff && gatts_if != p_gatts_if) {
        return;
    }
    ...
    case ESP_GATTS_REG_EVT:
        ...
        if (ret) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "create attr table failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "create attr table failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "create attr table failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "create attr table failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "create attr table failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } } while(0); } while(0);
            return;
        }
        ret = esp_ble_gap_set_device_name(g_ble_cfg_p->device_name);
        if (ret) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "set device name failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "set device name failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "set device name failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "set device name failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "set device name failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } } while(0); } while(0);
            return;
        }
        ret = esp_ble_gap_config_adv_data_raw(g_ble_cfg_p->raw_adv_data_p,
                                              g_ble_cfg_p->raw_adv_data_len);
        if (ret) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "config raw adv data failed, error code = 0x%x " "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "config raw adv data failed, error code = 0x%x " "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "config raw adv data failed, error code = 0x%x " "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "config raw adv data failed, error code = 0x%x " "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "config raw adv data failed, error code = 0x%x " "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } } while(0); } while(0);
            return;
        }
        adv_config_done |= (1 << 0);
        ...
        if (ret) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "config raw scan rsp data failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "config raw scan rsp data failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "config raw scan rsp data failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "config raw scan rsp data failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "config raw scan rsp data failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } } while(0); } while(0);
            return;
        }
        adv_config_done |= (1 << 1);
        break;
    ...
    case ESP_GATTS_MTU_EVT:
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ESP_GATTS_MTU_EVT, MTU %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->mtu.mtu); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ESP_GATTS_MTU_EVT, MTU %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->mtu.mtu); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ESP_GATTS_MTU_EVT, MTU %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->mtu.mtu); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ESP_GATTS_MTU_EVT, MTU %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->mtu.mtu); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ESP_GATTS_MTU_EVT, MTU %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->mtu.mtu); } } while(0); } while(0);
        if (g_ble_cfg_p->set_mtu_fn) {
            g_ble_cfg_p->set_mtu_fn(event, gatts_if, param);
        }
        break;
    case ESP_GATTS_CONF_EVT:
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ESP_GATTS_CONF_EVT, status = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->conf.status); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ESP_GATTS_CONF_EVT, status = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->conf.status); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ESP_GATTS_CONF_EVT, status = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->conf.status); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ESP_GATTS_CONF_EVT, status = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->conf.status); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ESP_GATTS_CONF_EVT, status = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->conf.status); } } while(0); } while(0);
        break;
    case ESP_GATTS_START_EVT:
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SERVICE_START_EVT, status %d, service_handle %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->start.status, param->start.service_handle); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SERVICE_START_EVT, status %d, service_handle %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->start.status, param->start.service_handle); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SERVICE_START_EVT, status %d, service_handle %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->start.status, param->start.service_handle); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SERVICE_START_EVT, status %d, service_handle %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->start.status, param->start.service_handle); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SERVICE_START_EVT, status %d, service_handle %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->start.status, param->start.service_handle); } } while(0); } while(0);
        break;
    case ESP_GATTS_CONNECT_EVT:
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ESP_GATTS_CONNECT_EVT, conn_id = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->connect.conn_id); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ESP_GATTS_CONNECT_EVT, conn_id = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->connect.conn_id); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ESP_GATTS_CONNECT_EVT, conn_id = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->connect.conn_id); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ESP_GATTS_CONNECT_EVT, conn_id = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->connect.conn_id); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ESP_GATTS_CONNECT_EVT, conn_id = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->connect.conn_id); } } while(0); } while(0);
    ...
    case ESP_GATTS_DISCONNECT_EVT:
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ESP_GATTS_DISCONNECT_EVT, reason = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->disconnect.reason); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ESP_GATTS_DISCONNECT_EVT, reason = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->disconnect.reason); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ESP_GATTS_DISCONNECT_EVT, reason = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->disconnect.reason); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ESP_GATTS_DISCONNECT_EVT, reason = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->disconnect.reason); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ESP_GATTS_DISCONNECT_EVT, reason = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->disconnect.reason); } } while(0); } while(0);
        g_ble_cfg_p->disconnect_fn(event, gatts_if, param);
        esp_ble_gap_start_advertising(&g_ble_cfg_p->adv_params);
        break;
    case ESP_GATTS_CREAT_ATTR_TAB_EVT: {
        if (param->add_attr_tab.status != ESP_GATT_OK) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "creating the attribute table failed, error code=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, param->add_attr_tab.status); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "creating the attribute table failed, error code=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, param->add_attr_tab.status); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "creating the attribute table failed, error code=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, param->add_attr_tab.status); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "creating the attribute table failed, error code=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, param->add_attr_tab.status); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "creating the attribute table failed, error code=0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, param->add_attr_tab.status); } } while(0); } while(0);
        } else if (param->add_attr_tab.num_handle != g_ble_cfg_p->gatt_db_count) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "created attribute table abnormally " "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "created attribute table abnormally " "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "created attribute table abnormally " "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "created attribute table abnormally " "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "created attribute table abnormally " "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        } else {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "created attribute table successfully, the number handle = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->add_attr_tab.num_handle); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "created attribute table successfully, the number handle = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->add_attr_tab.num_handle); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "created attribute table successfully, the number handle = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->add_attr_tab.num_handle); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "created attribute table successfully, the number handle = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->add_attr_tab.num_handle); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "created attribute table successfully, the number handle = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, param->add_attr_tab.num_handle); } } while(0); } while(0);
...
simple_ble_cfg_t *simple_ble_init()
{
    ...
    if (ble_cfg_p == 
# 184 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 3 4
                    ((void *)0)
# 184 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c"
                        ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "No memory for simple_ble_cfg_t" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "No memory for simple_ble_cfg_t" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "No memory for simple_ble_cfg_t" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "No memory for simple_ble_cfg_t" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "No memory for simple_ble_cfg_t" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return 
# 186 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 3 4
              ((void *)0)
# 186 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c"
                  ;
    }
    return ble_cfg_p;
}
...
esp_err_t simple_ble_deinit()
{
    ...
    free(g_ble_cfg_p);
    g_ble_cfg_p = 
# 195 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 3 4
                 ((void *)0)
# 195 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c"
                     ;
    return 0;
}
...
{
    g_ble_cfg_p = cfg;
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Free mem at start of simple_ble_init %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Free mem at start of simple_ble_init %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Free mem at start of simple_ble_init %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Free mem at start of simple_ble_init %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Free mem at start of simple_ble_init %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } } while(0); } while(0);
    esp_err_t ret;

    esp_bt_controller_config_t bt_cfg = { .controller_task_stack_size = (3584 + (512)), .controller_task_prio = ((( 25 )) - 2), .hci_uart_no = 1, .hci_uart_baudrate = 921600, .scan_duplicate_mode = 0, .scan_duplicate_type = 0, .normal_adv_size = 200, .mesh_adv_size = 0, .send_adv_reserved_size = 1000, .controller_debug_flag = (0<<0), .mode = ESP_BT_MODE_BLE, .ble_max_conn = 3, .bt_max_acl_conn = 0, .bt_sco_datapath = 0, .auto_latency = 
# 206 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c" 3 4
                                       0
# 206 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/simple_ble/simple_ble.c"
                                       , .bt_max_sync_conn = 0, .magic = 0x20200106, };;
    ret = esp_bt_controller_init(&bt_cfg);
    if (ret) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s enable controller failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s enable controller failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s enable controller failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s enable controller failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s enable controller failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } } while(0); } while(0);
        return ret;
    }
    ...
    if (ret) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s init bluetooth failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s init bluetooth failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s init bluetooth failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s init bluetooth failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s init bluetooth failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } } while(0); } while(0);
        return ret;
    }

    ret = esp_bluedroid_enable();
    if (ret) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s enable bluetooth failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s enable bluetooth failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s enable bluetooth failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s enable bluetooth failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s enable bluetooth failed %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } } while(0); } while(0);
        return ret;
    }

    ret = esp_ble_gatts_register_callback(gatts_profile_event_handler);
    if (ret) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "gatts register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "gatts register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "gatts register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "gatts register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "gatts register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } } while(0); } while(0);
        return ret;
    }

    ret = esp_ble_gap_register_callback(gap_event_handler);
    if (ret) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "gap register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "gap register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "gap register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "gap register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "gap register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } } while(0); } while(0);
        return ret;
    }
    ...
    if (ret) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "gatts app register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "gatts app register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "gatts app register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "gatts app register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "gatts app register error, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, ret); } } while(0); } while(0);
        return ret;
    }

    esp_err_t local_mtu_ret = esp_ble_gatt_set_local_mtu(500);
    if (local_mtu_ret) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "set local  MTU failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, local_mtu_ret); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "set local  MTU failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, local_mtu_ret); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "set local  MTU failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, local_mtu_ret); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "set local  MTU failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, local_mtu_ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "set local  MTU failed, error code = 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, local_mtu_ret); } } while(0); } while(0);
    }
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Free mem at end of simple_ble_init %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Free mem at end of simple_ble_init %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Free mem at end of simple_ble_init %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Free mem at end of simple_ble_init %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Free mem at end of simple_ble_init %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } } while(0); } while(0);
    return 0;
}
...
{
    esp_err_t err;
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Free mem at start of simple_ble_stop %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Free mem at start of simple_ble_stop %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Free mem at start of simple_ble_stop %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Free mem at start of simple_ble_stop %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Free mem at start of simple_ble_stop %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } } while(0); } while(0);
    err = esp_bluedroid_disable();
    if (err != 0) {
        return -1;
    }
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_bluedroid_disable called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_bluedroid_disable called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_bluedroid_disable called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_bluedroid_disable called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_bluedroid_disable called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    err = esp_bluedroid_deinit();
    if (err != 0) {
        return err;
    }
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_bluedroid_deinit called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_bluedroid_deinit called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_bluedroid_deinit called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_bluedroid_deinit called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_bluedroid_deinit called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_bt_controller_disable called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_bt_controller_disable called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_bt_controller_disable called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_bt_controller_disable called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_bt_controller_disable called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    err = esp_bt_controller_deinit();
    if (err != 0) {
        return -1;
    }
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_bt_controller_deinit called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_bt_controller_deinit called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_bt_controller_deinit called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_bt_controller_deinit called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_bt_controller_deinit called successfully" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);

    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Free mem at end of simple_ble_stop %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Free mem at end of simple_ble_stop %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Free mem at end of simple_ble_stop %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Free mem at end of simple_ble_stop %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Free mem at end of simple_ble_stop %d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_get_free_heap_size()); } } while(0); } while(0);
    return 0;
}
