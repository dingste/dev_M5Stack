    ...
    if (cur_session_id != session_id) {
        ...
        if (session_id != 0xffffffffUL) {
            ...
            if (pc_httpd->sec && pc_httpd->sec->close_transport_session) {
                ...
                if (ret != 0) {
                    do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to close session with ID: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, session_id); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to close session with ID: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, session_id); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to close session with ID: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, session_id); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to close session with ID: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, session_id); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to close session with ID: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, session_id); } } while(0); } while(0);
                    ret = -1;
                    goto out;
                }
            }
...
{
    if (pc_httpd == 
# 132 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c" 3 4
                   ((void *)0)
# 132 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c"
                       ) {
        return 0x103;
    }
    ...
    httpd_uri_t config_handler = {
        ...
        .user_ctx = 
# 151 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c" 3 4
                   ((void *)0)
    
# 152 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c"
   };
...
{
    if (pc_httpd == 
# 169 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c" 3 4
                   ((void *)0)
# 169 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c"
                       ) {
        return 0x103;
    }
...
esp_err_t protocomm_httpd_start(protocomm_t *pc, const protocomm_httpd_config_t *config)
{
    ...
    if (config->ext_handle_provided) {
        if (config->data.handle) {
            ...
            pc_ext_httpd_handle_provided = 
# 214 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c" 3 4
                                          1
# 214 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c"
                                              ;
        } else {
            return 0x102;
        }
...
# 227 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c" 3 4
                                        0
# 227 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c"
...
# 231 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c" 3 4
                                        1
# 231 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c"
                                            ;
...
{
    if ((pc != 
# 249 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c" 3 4
              ((void *)0)
# 249 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c"
                  ) && (pc == pc_httpd)) {
        if (!pc_ext_httpd_handle_provided) {
            ...
            pc_ext_httpd_handle_provided = 
# 255 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c" 3 4
                                          0
# 255 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c"
                                               ;
        }
        pc_httpd->priv = 
...
# 257 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c"
                            ;
        pc_httpd = 
# 258 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c" 3 4
                  ((void *)0)
# 258 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/protocomm/src/transports/protocomm_httpd.c"
                      ;
        return 0;
    }
    return 0x102;
