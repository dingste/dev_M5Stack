# 1 "/home/dieter/Development/esp-idf/components/soc/src/hal/spi_flash_hal.c"
# 1 "/home/dieter/Development/ProjektEi/build/soc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/soc/src/hal/spi_flash_hal.c"
# 15 "/home/dieter/Development/esp-idf/components/soc/src/hal/spi_flash_hal.c"
...
# 16 "/home/dieter/Development/esp-idf/components/soc/src/hal/spi_flash_hal.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/soc/src/hal/spi_flash_hal.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/soc/src/hal/spi_flash_hal.c" 2
...
static const spi_flash_hal_clock_config_t spi_flash_clk_cfg_reg[ESP_FLASH_SPEED_MAX] = {
    {5e6, ((spi_flash_ll_clock_reg_t){.val=0x0000F1CF})},
    {10e6, ((spi_flash_ll_clock_reg_t){.val=0x000070C7})},
    {20e6, ((spi_flash_ll_clock_reg_t){.val=0x00003043})},
    {26e6, ((spi_flash_ll_clock_reg_t){.val=0x00002002})},
    {40e6, ((spi_flash_ll_clock_reg_t){.val=0x00001001})},
    {80e6, ((spi_flash_ll_clock_reg_t){.val=0x80000000})},
};

static inline int get_dummy_n(
# 39 "/home/dieter/Development/esp-idf/components/soc/src/hal/spi_flash_hal.c" 3 4
                             _Bool 
# 39 "/home/dieter/Development/esp-idf/components/soc/src/hal/spi_flash_hal.c"
                                  gpio_is_used, int input_delay_ns, int eff_clk)
{
    const int apbclk_kHz = ( 80*1000000 ) / 1000;

    const int apbclk_n = ( 80*1000000 ) / eff_clk;
    const int gpio_delay_ns = gpio_is_used ? ((1000*1000*1000LL/( 80*1000000 )) * 2) : 0;
...
esp_err_t spi_flash_hal_init(spi_flash_memspi_data_t *data_out, const spi_flash_memspi_config_t *cfg)
{
    ...
    *data_out = (spi_flash_memspi_data_t) {
        .spi = ((cfg->host_id)==SPI1_HOST? &SPI1:((cfg->host_id)==SPI2_HOST?&SPI2:((cfg->host_id)==SPI3_HOST?&SPI3:({abort();(spi_dev_t*)0;})))),
        .cs_num = cfg->cs_num,
    ...
    do { if (3 >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "extra_dummy: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, data_out->extra_dummy); }} while(0);
    return 0;
}
