# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/soc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/rtc.h" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/xtensa/lib/gcc/xtensa-esp32-elf/5.2.0/include/stddef.h" 1 3 4
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c" 2
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c" 2

# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/i2s_reg.h" 1
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/timer_group_reg.h" 1
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/bb_reg.h" 1
# 24 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/nrx_reg.h" 1
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/nrx_reg.h"
       
# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/fe_reg.h" 1
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/fe_reg.h"
       
# 26 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c" 2
...
# 28 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c" 2
# 56 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c"
typedef struct {
    uint32_t dig_pd : 1;
    uint32_t rtc_pd : 1;
    uint32_t cpu_pd : 1;
...
# 83 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_sleep.c"
...
void rtc_sleep_init(rtc_sleep_config_t cfg)
{
    ...
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x1c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x1c))); }) & ~((0xFF) << (24)))|(((2) & (0xFF))<<(24)))); })); });
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x1c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x1c))); }) & ~((0x3FF) << (14)))|(((2) & (0x3FF))<<(14)))); })); });
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x1c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x1c))); }) & ~((0xFF) << (6)))|(((4) & (0xFF))<<(6)))); })); });


    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x2c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x2c))); }) & ~((0xFF) << (8)))|(((2) & (0xFF))<<(8)))); })); });


    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x24)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x24))); }) & ~((0x7F) << (25)))|(((1) & (0x7F))<<(25)))); })); });
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x24)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x24))); }) & ~((0x1FF) << (16)))|(((1) & (0x1FF))<<(16)))); })); });

    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x24)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x24))); }) & ~((0x7F) << (9)))|(((1) & (0x7F))<<(9)))); })); });
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x24)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x24))); }) & ~((0x1FF) << (0)))|(((1) & (0x1FF))<<(0)))); })); });

    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x28)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x28))); }) & ~((0x7F) << (9)))|(((1) & (0x7F))<<(9)))); })); });
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x28)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x28))); }) & ~((0x1FF) << (0)))|(((1) & (0x1FF))<<(0)))); })); });

    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x28)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x28))); }) & ~((0x7F) << (25)))|(((1) & (0x7F))<<(25)))); })); });
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x28)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x28))); }) & ~((0x1FF) << (16)))|(((1) & (0x1FF))<<(16)))); })); });

    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x2c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x2c))); }) & ~((0x7F) << (25)))|(((1) & (0x7F))<<(25)))); })); });
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x2c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x2c))); }) & ~((0x1FF) << (16)))|(((1) & (0x1FF))<<(16)))); })); });

    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x84)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x84))); }) & ~((0x1) << (4)))|(((cfg.lslp_mem_inf_fpu) & (0x1))<<(4)))); })); });
    ...
    if (cfg.deep_slp) {
        ...
        ({ ; ({ ; (*((volatile uint32_t *)(((0x3ff48000 + 0x84))))) = (uint32_t)((({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x84)))); })&(~(((1UL << (31))))))); }); });
        ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x78)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x78))); }) & ~((0x3) << (24)))|(((0) & (0x3))<<(24)))); })); });
    }

    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x0)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x0))); }) & ~((0x1) << (13)))|(((cfg.xtal_fpu) & (0x1))<<(13)))); })); });

    if (({ ; ((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x70))); }) >> (30)) & (0x3)); }) == RTC_SLOW_FREQ_8MD256) {
        ({ ; (*(volatile uint32_t*)((0x3ff48000 + 0x70)) |= (((1UL << (26))))); });
    } else {
        ({ ; (*(volatile uint32_t*)((0x3ff48000 + 0x70)) &= ~(((1UL << (26))))); });
    }


    ({ ; (*(volatile uint32_t*)((0x3ff48000 + 0x74)) &= ~(((1UL << (22))))); });
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x74)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x74))); }) & ~((0x1) << (21)))|(((cfg.vddsdio_pd_en) & (0x1))<<(21)))); })); });
...
uint32_t rtc_sleep_start(uint32_t wakeup_opt, uint32_t reject_opt)
{
    ...
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x78)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x78))); }) & ~((0x3) << (24)))|(((3) & (0x3))<<(24)))); })); });
    return reject;
}
