# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_time.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/soc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_time.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_time.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_time.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_time.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_time.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_time.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/timer_group_reg.h" 1
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_time.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_time.c" 2



static const char* TAG = "rtc_time";
# 44 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_time.c"
static uint32_t rtc_clk_cal_internal(rtc_cal_sel_t cal_clk, uint32_t slowclk_cycles)
{
    ((slowclk_cycles < 32767) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_time.c", 46, __func__, "slowclk_cycles < 32767"));

    int dig_32k_xtal_state = ({ ; ((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x70))); }) >> (8)) & (0x1)); });
    if (cal_clk == RTC_CAL_32K_XTAL && !dig_32k_xtal_state) {
        ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x70)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x70))); }) & ~((0x1) << (8)))|(((1) & (0x1))<<(8)))); })); });
    }
    ...
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x70)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x70))); }) & ~((0x1) << (8)))|(((dig_32k_xtal_state) & (0x1))<<(8)))); })); });
...
void rtc_clk_wait_for_slow_cycle()
{
    ({ ; (*(volatile uint32_t*)(((0x3ff5F000 + 0*0x1000) + 0x0068)) &= ~(((1UL << (12))) | ((1UL << (31))))); });
    ({ ; (*(volatile uint32_t*)(((0x3ff5F000 + 0*0x1000) + 0x0068)) &= ~(((1UL << (15))))); });
    ({ ; (({ ; (*(volatile uint32_t *)((((0x3ff5F000 + 0*0x1000) + 0x0068)))) = (((({ ; (*(volatile uint32_t *)(((0x3ff5F000 + 0*0x1000) + 0x0068))); }) & ~((0x3) << (13)))|(((RTC_CAL_RTC_MUX) & (0x3))<<(13)))); })); });



    ({ ; (({ ; (*(volatile uint32_t *)((((0x3ff5F000 + 0*0x1000) + 0x0068)))) = (((({ ; (*(volatile uint32_t *)(((0x3ff5F000 + 0*0x1000) + 0x0068))); }) & ~((0x7FFF) << (16)))|(((0) & (0x7FFF))<<(16)))); })); });
    ({ ; (*(volatile uint32_t*)(((0x3ff5F000 + 0*0x1000) + 0x0068)) |= (((1UL << (31))))); });
    ets_delay_us(1);
    while (!({ ; (({ ; (*((volatile uint32_t *)(((0x3ff5F000 + 0*0x1000) + 0x0068)))); }) & (((1UL << (15))))); })) {
        ets_delay_us(1);
    }
