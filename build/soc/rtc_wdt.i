# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/soc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/include/soc/rtc_wdt.h" 1
# 53 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/include/soc/rtc_wdt.h"
...
# 54 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/include/soc/rtc_wdt.h" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/xtensa/lib/gcc/xtensa-esp32-elf/5.2.0/include/stdbool.h" 1 3 4
# 55 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/include/soc/rtc_wdt.h" 2
...
# 196 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/include/soc/rtc_wdt.h"
    rtc_wdt_is_on();
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c" 2



# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c" 3 4
_Bool 
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c"
    rtc_wdt_get_protect_status()
{
    return ({ ; (*((volatile uint32_t *)((0x3ff48000 + 0xa4)))); }) != 0x50D83AA1;
}
...
void rtc_wdt_enable()
{
    ({ ; (*(volatile uint32_t*)((0x3ff48000 + 0xa0)) |= (((1UL << (31))))); });
    ({ ; ({ ; (*((volatile uint32_t *)(((0x3ff48000 + 0x8c))))) = (uint32_t)((({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x8c)))); })|(((1UL << (31))) | ((1UL << (7)))))); }); });
}
...
# 48 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c" 3 4
   _Bool 
# 48 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c"
...
# 66 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c" 3 4
   _Bool 
# 66 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c"
        protect = rtc_wdt_get_protect_status();
    if (protect) {
        rtc_wdt_protect_off();
    }
...
esp_err_t rtc_wdt_set_time(rtc_wdt_stage_t stage, unsigned int timeout_ms)
{
    ...
    if (stage == RTC_WDT_STAGE0) {
        ({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x90)))) = (uint32_t)(timeout); });
    } else if (stage == RTC_WDT_STAGE1) {
        ({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x94)))) = (uint32_t)(timeout); });
    } else if (stage == RTC_WDT_STAGE2) {
        ({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x98)))) = (uint32_t)(timeout); });
    } else {
        ({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x9c)))) = (uint32_t)(timeout); });
    }
...
esp_err_t rtc_wdt_get_timeout(rtc_wdt_stage_t stage, unsigned int* timeout_ms)
{
    ...
    uint32_t time_tick;
    if (stage == RTC_WDT_STAGE0) {
        time_tick = ({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x90)))); });
    } else if (stage == RTC_WDT_STAGE1) {
        time_tick = ({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x94)))); });
    } else if (stage == RTC_WDT_STAGE2) {
        time_tick = ({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x98)))); });
    } else {
        time_tick = ({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x9c)))); });
    }
...
esp_err_t rtc_wdt_set_stage(rtc_wdt_stage_t stage, rtc_wdt_stage_action_t stage_sel)
{
    ...
    if (stage == RTC_WDT_STAGE0) {
        ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x8c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x8c))); }) & ~((0x7) << (28)))|(((stage_sel) & (0x7))<<(28)))); })); });
    } else if (stage == RTC_WDT_STAGE1) {
        ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x8c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x8c))); }) & ~((0x7) << (25)))|(((stage_sel) & (0x7))<<(25)))); })); });
    } else if (stage == RTC_WDT_STAGE2) {
        ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x8c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x8c))); }) & ~((0x7) << (22)))|(((stage_sel) & (0x7))<<(22)))); })); });
    } else {
        ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x8c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x8c))); }) & ~((0x7) << (19)))|(((stage_sel) & (0x7))<<(19)))); })); });
    }
...
esp_err_t rtc_wdt_set_length_of_reset_signal(rtc_wdt_reset_sig_t reset_src, rtc_wdt_length_sig_t reset_signal_length)
{
    ...
    if (reset_src == 0) {
        ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x8c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x8c))); }) & ~((0x7) << (11)))|(((reset_signal_length) & (0x7))<<(11)))); })); });
    } else {
        ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x8c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x8c))); }) & ~((0x7) << (14)))|(((reset_signal_length) & (0x7))<<(14)))); })); });
    }
...
# 148 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c" 3 4
_Bool 
# 148 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_wdt.c"
    rtc_wdt_is_on()
{
    return (({ ; (*(volatile uint32_t*)((0x3ff48000 + 0x8c)) & (((1UL << (31))))); }) != 0) || (({ ; (*(volatile uint32_t*)((0x3ff48000 + 0x8c)) & (((1UL << (10))))); }) != 0);
}
