# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/soc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/xtensa/lib/gcc/xtensa-esp32-elf/5.2.0/include/stdbool.h" 1 3 4
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
# 24 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/rtc_cntl_reg.h" 1
# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/rtc_io_reg.h" 1
# 26 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/sens_reg.h" 1
# 27 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
# 28 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/efuse_reg.h" 1
# 29 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/apb_ctrl_reg.h" 1
# 30 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
# 31 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/include/sdkconfig.h" 1
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
# 34 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_clk.c" 2
...
void rtc_clk_32k_enable_external()
{
    rtc_clk_32k_enable_common(2, 3, 1);
}
                             ...
                             enable, uint32_t sdm0, uint32_t sdm1, uint32_t sdm2, uint32_t o_div)
{
    ...
    if (!enable &&
        ...
        ({ ; (*(volatile uint32_t*)((0x3ff48000 + 0x0)) |= (((1UL << (18))))); });
    } else {
        ({ ; (*(volatile uint32_t*)((0x3ff48000 + 0x0)) &= ~(((1UL << (18))))); });
    }
...
void rtc_clk_slow_freq_set(rtc_slow_freq_t slow_freq)
{
    ...
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x70)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x70))); }) & ~((0x1) << (8)))|((((slow_freq == RTC_SLOW_FREQ_32K_XTAL) ? 1 : 0) & (0x1))<<(8)))); })); })
                                                          ;
...
void rtc_clk_cpu_freq_to_xtal(int freq, int div)
{
    ...
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff66000 + 0x0)))) = (((({ ; (*(volatile uint32_t *)((0x3ff66000 + 0x0))); }) & ~((0x3FF) << (0)))|(((div - 1) & (0x3FF))<<(0)))); })); });

    ({ ; (*(volatile uint32_t *)((0x3ff66000 + 0x4))) = (freq * (1000000) / ( 1000000 ) - 1); });

    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x70)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x70))); }) & ~((0x3) << (27)))|(((0) & (0x3))<<(27)))); })); });
    rtc_clk_apb_freq_update(freq * (1000000));
...
static void rtc_clk_cpu_freq_to_8m()
{
    ...
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x70)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x70))); }) & ~((0x3) << (27)))|(((2) & (0x3))<<(27)))); })); });
    rtc_clk_apb_freq_update(8500000);
}
...
static void rtc_clk_bbpll_enable()
{
    ...
    rom_i2c_writeReg(0x66, 4, 0, 0x18);
    rom_i2c_writeReg(0x66, 4, 1, 0x20);
    rom_i2c_writeReg(0x66, 4, 4, 0x9a);
    rom_i2c_writeReg(0x66, 4, 10, 0x00);
    rom_i2c_writeReg(0x66, 4, 12, 0x00);
}
...
static void rtc_clk_cpu_freq_to_pll_mhz(int cpu_freq_mhz)
{
    ...
    (*(volatile uint32_t *)(((0x3ff00000 + 0x03C)))) = ((per_conf));
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x7c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x7c))); }) & ~((0x7) << (11)))|(((dbias) & (0x7))<<(11)))); })); });
...
uint32_t rtc_clk_cpu_freq_value(rtc_cpu_freq_t cpu_freq)
{
    switch (cpu_freq) {
        ...
        case RTC_CPU_FREQ_240M:
            return 240 * (1000000);
        default:
            do { if (3 >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "invalid rtc_cpu_freq_t value" "\033[0m" "\n", esp_log_timestamp(), TAG); }} while(0);
            return 0;
    }
}
    ...
    rtc_clk_cpu_freq_mhz_to_config(uint32_t freq_mhz, rtc_cpu_freq_config_t* out_config)
{
    ...
    if (freq_mhz <= xtal_freq) {
        ...
        real_freq_mhz = (xtal_freq + divider / 2) / divider;
...
void rtc_clk_cpu_freq_get_config(rtc_cpu_freq_config_t* out_config)
{
    ...
    switch (soc_clk_sel) {
        case 0: {
            source = RTC_CPU_FREQ_SRC_XTAL;
            div = ({ ; ((({ ; (*(volatile uint32_t *)((0x3ff66000 + 0x0))); }) >> (0)) & (0x3FF)); }) + 1;
        ...
        case 1: {
            ...
            if (cpuperiod_sel == 0) {
                ...
                do { if (3 >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "unsupported frequency configuration" "\033[0m" "\n", esp_log_timestamp(), TAG); }} while(0);
                abort();
            }
            break;
        }
...
rtc_xtal_freq_t rtc_clk_xtal_freq_get()
{
    ...
    return reg_val_to_clk_val(xtal_freq_reg & ~((1 << 0) | (1 << 16)));
}

void rtc_clk_xtal_freq_update(rtc_xtal_freq_t xtal_freq)
{
    uint32_t reg = ({ ; (*((volatile uint32_t *)((0x3ff48000 + 0xb0)))); }) & ((1 << 0) | (1 << 16));
    if (reg == ((1 << 0) | (1 << 16))) {
        xtal_freq |= 1;
    }
