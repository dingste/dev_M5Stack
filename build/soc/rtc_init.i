# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_init.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/soc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_init.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_init.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_init.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_init.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_init.c" 2
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_init.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_init.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/efuse_reg.h" 1
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_init.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/gpio_reg.h" 1
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/rtc_init.c" 2
...
rtc_vddsdio_config_t rtc_vddsdio_get_config()
{
    ...
    uint32_t sdio_conf_reg = ({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x74))); });
    ...
    uint32_t efuse_reg = ({ ; (*(volatile uint32_t *)((0x3ff5A000 + 0x010))); });
    if (efuse_reg & ((1UL << (16)))) {
        ...
        if(({ ; ((({ ; (*(volatile uint32_t *)((0x3ff5A000 + 0x00c))); }) >> (14)) & (0x1)); }) == 0){
    ...
    uint32_t strap_reg = ({ ; (*(volatile uint32_t *)((0x3ff44000 + 0x0038))); });
    result.force = 0;
...
void rtc_vddsdio_set_config(rtc_vddsdio_config_t config)
{
    ...
    val |= (config.tieh << 23);
    val |= ((1UL << (21)));
    ({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x74))) = (val); });
}
