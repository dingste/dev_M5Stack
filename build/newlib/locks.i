# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/newlib//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/cpu.h" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/xtensa/lib/gcc/xtensa-esp32-elf/5.2.0/include/stdbool.h" 1 3 4
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/cpu.h" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/xtensa/lib/gcc/xtensa-esp32-elf/5.2.0/include/stddef.h" 1 3 4
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 2
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/include/freertos/portmacro.h" 1
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 2
...
# 24 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freertos/include/freertos/portable.h" 1
# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 2
# 42 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
...
static void __attribute__((section(".iram1" "." "14"))) lock_init_generic(_lock_t *lock, uint8_t mutex_type) {
    ...
    {
# 79 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
...
void __attribute__((section(".iram1" "." "15"))) _lock_init(_lock_t *lock) {
    *lock = 0;
    lock_init_generic(lock, ( ( uint8_t ) 1U ));
}

void __attribute__((section(".iram1" "." "16"))) _lock_init_recursive(_lock_t *lock) {
    *lock = 0;
    lock_init_generic(lock, ( ( uint8_t ) 4U ));
}
# 108 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
void __attribute__((section(".iram1" "." "17"))) _lock_close(_lock_t *lock) {
    vTaskEnterCritical(&lock_init_spinlock);
    if (*lock) {
        SemaphoreHandle_t h = (SemaphoreHandle_t)(*lock);

        if (!(xQueueGetMutexHolder( ( h ) ) == 
# 113 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 3 4
       ((void *)0)
# 113 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
       )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c", 113, __FUNCTION__); abort(); };
...
static int __attribute__((section(".iram1" "." "18"))) lock_acquire_generic(_lock_t *lock, uint32_t delay, uint8_t mutex_type) {
    SemaphoreHandle_t h = (SemaphoreHandle_t)(*lock);
    if (!h) {
        if (xTaskGetSchedulerState() == ( ( BaseType_t ) 1 )) {
            return 0;
        ...
        if (!(h != 
# 136 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 3 4
       ((void *)0)
# 136 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
       )) { ets_printf("%s:%d (%s)- assert failed!\n", "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c", 136, __FUNCTION__); abort(); };
    }
...
# 145 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 3 4
                                      0
# 145 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
                                           ;
        success = xQueueReceiveFromISR( ( QueueHandle_t ) ( h ), 
# 146 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 3 4
                 ((void *)0)
# 146 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
                 , ( &higher_task_woken ) );
        if (!success && delay > 0) {
            abort();
        }
...
# 159 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 3 4
                     ((void *)0)
# 159 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
                     , ( delay ), ( ( BaseType_t ) 0 ) );
        }
    }
...
void __attribute__((section(".iram1" "." "19"))) _lock_acquire(_lock_t *lock) {
    lock_acquire_generic(lock, ( TickType_t ) 0xffffffffUL, ( ( uint8_t ) 1U ));
}

void __attribute__((section(".iram1" "." "20"))) _lock_acquire_recursive(_lock_t *lock) {
    lock_acquire_generic(lock, ( TickType_t ) 0xffffffffUL, ( ( uint8_t ) 4U ));
}

int __attribute__((section(".iram1" "." "21"))) _lock_try_acquire(_lock_t *lock) {
    return lock_acquire_generic(lock, 0, ( ( uint8_t ) 1U ));
}

int __attribute__((section(".iram1" "." "22"))) _lock_try_acquire_recursive(_lock_t *lock) {
...
static void __attribute__((section(".iram1" "." "23"))) lock_release_generic(_lock_t *lock, uint8_t mutex_type) {
    SemaphoreHandle_t h = (SemaphoreHandle_t)(*lock);
    if (h == 
# 187 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 3 4
            ((void *)0)
# 187 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
                ) {
    ...
    if (!xPortCanYield()) {
        ...
        BaseType_t higher_task_woken = 
# 198 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 3 4
                                      0
# 198 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
                                           ;
...
# 207 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c" 3 4
           ((void *)0)
# 207 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/locks.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        }
    }
}

void __attribute__((section(".iram1" "." "24"))) _lock_release(_lock_t *lock) {
    lock_release_generic(lock, ( ( uint8_t ) 1U ));
}

void __attribute__((section(".iram1" "." "25"))) _lock_release_recursive(_lock_t *lock) {
