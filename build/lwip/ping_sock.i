# 1 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
# 1 "/home/dieter/Development/ProjektEi/build/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
# 15 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
...
# 16 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
# 1 "/home/dieter/Development/xtensa-esp32-elf/lib/gcc/xtensa-esp32-elf/8.2.0/include/stdbool.h" 1 3 4
# 17 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
# 1 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/include/lwip/init.h" 1
# 94 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/include/lwip/init.h"

# 94 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/include/lwip/init.h"
void lwip_init(void);
# 21 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
# 1 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/include/lwip/icmp.h" 1
# 41 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/include/lwip/icmp.h"
...
# 42 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/include/lwip/icmp.h" 2
...
# 43 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/include/lwip/icmp.h" 2
...
# 44 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/include/lwip/icmp.h" 2
...
# 23 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
...
# 25 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
...
# 26 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
...
# 27 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
...
# 28 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
...
# 29 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
# 1 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/include/lwip/netdb.h" 1
# 43 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/include/lwip/netdb.h"
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 30 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
...
# 32 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2
# 1 "/home/dieter/Development/esp-idf/components/lwip/include/apps/ping/ping_sock.h" 1
# 15 "/home/dieter/Development/esp-idf/components/lwip/include/apps/ping/ping_sock.h"
       
# 29 "/home/dieter/Development/esp-idf/components/lwip/include/apps/ping/ping_sock.h"
...
# 98 "/home/dieter/Development/esp-idf/components/lwip/include/apps/ping/ping_sock.h"
typedef enum {
    ESP_PING_PROF_SEQNO,
    ESP_PING_PROF_TTL,
...
# 121 "/home/dieter/Development/esp-idf/components/lwip/include/apps/ping/ping_sock.h"
esp_err_t esp_ping_new_session(const esp_ping_config_t *config, const esp_ping_callbacks_t *cbs, esp_ping_handle_t *hdl_out);
# 131 "/home/dieter/Development/esp-idf/components/lwip/include/apps/ping/ping_sock.h"
esp_err_t esp_ping_delete_session(esp_ping_handle_t hdl);
# 141 "/home/dieter/Development/esp-idf/components/lwip/include/apps/ping/ping_sock.h"
esp_err_t esp_ping_start(esp_ping_handle_t hdl);
# 151 "/home/dieter/Development/esp-idf/components/lwip/include/apps/ping/ping_sock.h"
esp_err_t esp_ping_stop(esp_ping_handle_t hdl);
# 165 "/home/dieter/Development/esp-idf/components/lwip/include/apps/ping/ping_sock.h"
esp_err_t esp_ping_get_profile(esp_ping_handle_t hdl, esp_ping_profile_t profile, void *data, uint32_t size);
# 33 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 2

const static char *TAG = "ping_sock";
# 55 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
typedef struct {
    int sock;
...
static esp_err_t esp_ping_send(esp_ping_t *ep)
{
    ...
    if (sent != ep->icmp_pkt_size) {
        ...
        getsockopt(ep->sock, 0xfff, 0x1007, &opt_val, &opt_len);
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "send error=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, opt_val); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "send error=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, opt_val); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "send error=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, opt_val); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "send error=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, opt_val); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "send error=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, opt_val); } } while(0); } while(0);
        ret = -1;
    } else {
        ep->transmitted++;
    }
    ...
    while ((len = recvfrom(ep->sock, buf, sizeof(buf), 0, (struct sockaddr *)&from, (socklen_t *)&fromlen)) > 0) {
        if (len >= (int)(sizeof(struct ip_hdr) + sizeof(struct icmp_echo_hdr))) {
            ...
            if (from.ss_family == 2) {
                ...
                ((((&((&ep->recv_addr)->u_addr.ip4)))->addr = ((&from4->sin_addr)->s_addr)));
                do { (ep->recv_addr).type = (IPADDR_TYPE_V4); }while(0);
            } else {

                struct sockaddr_in6 *from6 = (struct sockaddr_in6 *)&from;
                {((&((&ep->recv_addr)->u_addr.ip6)))->addr[0] = (&from6->sin6_addr)->un.u32_addr[0]; ((&((&ep->recv_addr)->u_addr.ip6)))->addr[1] = (&from6->sin6_addr)->un.u32_addr[1]; ((&((&ep->recv_addr)->u_addr.ip6)))->addr[2] = (&from6->sin6_addr)->un.u32_addr[2]; ((&((&ep->recv_addr)->u_addr.ip6)))->addr[3] = (&from6->sin6_addr)->un.u32_addr[3]; (((&((&ep->recv_addr)->u_addr.ip6)))->zone = 0);};
                do { (ep->recv_addr).type = (IPADDR_TYPE_V6); }while(0);
            }


            if ((((&ep->recv_addr)->type) == IPADDR_TYPE_V4)) {
                struct ip_hdr *iphdr = (struct ip_hdr *)buf;
                struct icmp_echo_hdr *iecho = (struct icmp_echo_hdr *)(buf + (((iphdr)->_v_hl & 0x0f) * 4));
...
static void esp_ping_thread(void *args)
{
    ...
    while (1) {
        ...
        if (ulTaskNotifyTake(( ( BaseType_t ) 1 ), ( ( ( TickType_t ) ( (1000) ) * ( 100 ) ) / ( TickType_t ) 1000 ))) {
            ...
            while ((ep->flags & (1 << 1)) && ((ep->count == 0) || (ep->packet_hdr->seqno < ep->count))) {
                esp_ping_send(ep);
                gettimeofday(&start_time, 
# 158 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 3 4
                                         ((void *)0)
# 158 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
                                             );
                recv_ret = esp_ping_receive(ep);
                gettimeofday(&end_time, 
# 160 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 3 4
                                       ((void *)0)
# 160 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
                                           );
                ep->elapsed_time_ms = ((uint32_t)(((end_time).tv_sec - (start_time).tv_sec) * 1000 + ((end_time).tv_usec - (start_time).tv_usec) / 1000));
                ...
                vTaskDelayUntil(&last_wake, ( ( ( TickType_t ) ( ep->interval_ms ) * ( 100 ) ) / ( TickType_t ) 1000 ));
            }
    ...
    free(ep);
    vTaskDelete(
# 193 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 3 4
               ((void *)0)
# 193 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
                   );
}
...
esp_err_t esp_ping_new_session(const esp_ping_config_t *config, const esp_ping_callbacks_t *cbs, esp_ping_handle_t *hdl_out)
{
    esp_err_t ret = 0;
    esp_ping_t *ep = 
# 199 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 3 4
                    ((void *)0)
# 199 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
                        ;
    do { if (!(config)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ping config can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 200); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ping config can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 200); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ping config can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 200); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ping config can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 200); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ping config can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 200); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
    do { if (!(hdl_out)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 201); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 201); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 201); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 201); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 201); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);

    ep = mem_calloc(1, sizeof(esp_ping_t));
    do { if (!(ep)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "no memory for esp_ping object" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 204); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "no memory for esp_ping object" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 204); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "no memory for esp_ping object" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 204); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "no memory for esp_ping object" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 204); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "no memory for esp_ping object" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 204); } } while(0); } while(0); ret = 0x101; goto err; } } while (0);
    ...
    do { if (!(xReturned == ( ( BaseType_t ) 1 ))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "create ping task failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 212); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "create ping task failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 212); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "create ping task failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 212); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "create ping task failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 212); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "create ping task failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 212); } } while(0); } while(0); ret = 0x101; goto err; } } while (0);
    ...
    do { if (!(ep->packet_hdr)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "no memory for echo packet" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 227); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "no memory for echo packet" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 227); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "no memory for echo packet" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 227); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "no memory for echo packet" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 227); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "no memory for echo packet" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 227); } } while(0); } while(0); ret = 0x101; goto err; } } while (0);

    ep->packet_hdr->type = 8;
...
# 240 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 3 4
       ((void *)0)
# 240 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
       ) || (((&*(&config->target_addr))->type) == IPADDR_TYPE_V4)) || ((((&((&config->target_addr)->u_addr.ip6)))->addr[0] == 0) && (((&((&config->target_addr)->u_addr.ip6)))->addr[1] == 0) && ((((&((&config->target_addr)->u_addr.ip6)))->addr[2]) == ((((0x0000FFFFUL) & (u32_t)0x000000ffUL) << 24) | (((0x0000FFFFUL) & (u32_t)0x0000ff00UL) << 8) | (((0x0000FFFFUL) & (u32_t)0x00ff0000UL) >> 8) | (((0x0000FFFFUL) & (u32_t)0xff000000UL) >> 24))))) {
        ep->sock = socket(2, 3, 1);
    } else {
        ep->sock = socket(10, 3, 58);
    }
    do { if (!(ep->sock > 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "create socket failed: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 245, ep->sock); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "create socket failed: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 245, ep->sock); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "create socket failed: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 245, ep->sock); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "create socket failed: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 245, ep->sock); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "create socket failed: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 245, ep->sock); } } while(0); } while(0); ret = -1; goto err; } } while (0);

    struct timeval timeout;
    timeout.tv_sec = config->timeout_ms / 1000;
    timeout.tv_usec = (config->timeout_ms % 1000) * 1000;

    setsockopt(ep->sock, 0xfff, 0x1006, &timeout, sizeof(timeout));


    setsockopt(ep->sock, 0, 1, &config->tos, sizeof(config->tos));


    if ((((&config->target_addr) == 
# 257 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 3 4
       ((void *)0)
# 257 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
       ) || (((&*(&config->target_addr))->type) == IPADDR_TYPE_V4))) {
        struct sockaddr_in *to4 = (struct sockaddr_in *)&ep->target_addr;
        to4->sin_family = 2;
        ((&to4->sin_addr)->s_addr = (((&((&config->target_addr)->u_addr.ip4)))->addr));
    }
    if ((((&config->target_addr) != 
# 262 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 3 4
       ((void *)0)
# 262 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
       ) && (((&*(&config->target_addr))->type) == IPADDR_TYPE_V6))) {
        struct sockaddr_in6 *to6 = (struct sockaddr_in6 *)&ep->target_addr;
        to6->sin6_family = 10;
        {(&to6->sin6_addr)->un.u32_addr[0] = ((&((&config->target_addr)->u_addr.ip6)))->addr[0]; (&to6->sin6_addr)->un.u32_addr[1] = ((&((&config->target_addr)->u_addr.ip6)))->addr[1]; (&to6->sin6_addr)->un.u32_addr[2] = ((&((&config->target_addr)->u_addr.ip6)))->addr[2]; (&to6->sin6_addr)->un.u32_addr[3] = ((&((&config->target_addr)->u_addr.ip6)))->addr[3];};
    }
...
esp_err_t esp_ping_delete_session(esp_ping_handle_t hdl)
{
    ...
    do { if (!(ep)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
...
esp_err_t esp_ping_start(esp_ping_handle_t hdl)
{
    esp_err_t ret = 0;
    esp_ping_t *ep = (esp_ping_t *)hdl;
    do { if (!(ep)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
    ep->flags |= (1 << 1);
    xTaskNotify( ( ep->ping_task_hdl ), 0, eIncrement );
    return 0;
err:
    return ret;
}
...
esp_err_t esp_ping_stop(esp_ping_handle_t hdl)
{
    esp_err_t ret = 0;
    esp_ping_t *ep = (esp_ping_t *)hdl;
    do { if (!(ep)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 314); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 314); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 314); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 314); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 314); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
    ep->flags &= ~(1 << 1);
    return 0;
err:
    return ret;
...
esp_err_t esp_ping_get_profile(esp_ping_handle_t hdl, esp_ping_profile_t profile, void *data, uint32_t size)
{
    ...
    esp_ping_t *ep = (esp_ping_t *)hdl;
    const void *from = 
# 325 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 3 4
                      ((void *)0)
# 325 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
                          ;
    uint32_t copy_size = 0;
    do { if (!(ep)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 327); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 327); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 327); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 327); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ping handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 327); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
    do { if (!(data)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "profile data can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 328); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "profile data can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 328); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "profile data can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 328); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "profile data can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 328); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "profile data can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 328); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
    switch (profile) {
    ...
    default:
        do { if (!(
# 363 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c" 3 4
       0
# 363 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/ping_sock.c"
       )) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "unknow profile: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 363, profile); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "unknow profile: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 363, profile); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "unknow profile: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 363, profile); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "unknow profile: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 363, profile); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "unknow profile: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 363, profile); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
        break;
    }
    do { if (!(size >= copy_size)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "unmatched data size for profile %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 366, profile); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "unmatched data size for profile %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 366, profile); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "unmatched data size for profile %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 366, profile); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "unmatched data size for profile %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 366, profile); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "unmatched data size for profile %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 366, profile); } } while(0); } while(0); ret = 0x104; goto err; } } while (0);
