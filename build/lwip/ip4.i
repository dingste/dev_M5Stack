...
struct netif * __attribute__((section(".iram1")))
...
# 1030 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/ip4.c"
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("ip4_output_if: call netif->output()\n");} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  return netif->output(netif, p, dest);
}
# 1051 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/ip4.c"
err_t
          ...
          u8_t ttl, u8_t tos, u8_t proto)
{
  ...
  do { if (!((p)->ref == 1)) { __assert_func("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/ip4.c", 1057, __func__, "p->ref == 1"); }} while(0);

  if ((netif = ip4_route_src(dest, src)) == 
# 1059 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/ip4.c" 3 4
                                           ((void *)0)
# 1059 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/ip4.c"
                                               ) {
