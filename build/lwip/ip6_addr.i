# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
# 43 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
...
# 44 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c" 2
...
# 48 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c" 2



const ip_addr_t ip6_addr_any = { { { { 0ul, 0ul, 0ul, 0ul } } }, IPADDR_TYPE_V6 };
# 72 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
int
  ...
  for (s = cp; *s != 0; s++) {
    if (*s == ':') {
      ...
      current_block_value = (current_block_value << 4) +
          (((u8_t)*s >= '0' && (u8_t)*s <= '9') ? (u32_t)(*s - '0') :
          (u32_t)(10 + (((u8_t)*s >= 'a' && (u8_t)*s <= 'z') ? *s - 'a' : *s - 'A')));
    } else {
...
# 174 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
char *
...
# 190 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
char *
  ...
  for (current_block_index = 0; current_block_index < 8; current_block_index++) {
    ...
    if (current_block_value == 0) {
      if (current_block_index == 7 && empty_block_flag == 1) {
        ...
        if (i >= buflen) {
          return 
# 214 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c" 3 4
                ((void *)0)
# 214 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
                    ;
        }
        break;
      }
      if (empty_block_flag == 0) {
        ...
        if (next_block_value == 0) {
          ...
          if (i >= buflen) {
            return 
# 230 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c" 3 4
                  ((void *)0)
# 230 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
                      ;
          }
          continue;
        }
    ...
    if (current_block_index > 0) {
      ...
      if (i >= buflen) {
        return 
# 246 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c" 3 4
              ((void *)0)
# 246 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
                  ;
      }
    }
    ...
    if ((current_block_value & 0xf000) == 0) {
      ...
      if (i >= buflen) {
        return 
# 256 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c" 3 4
              ((void *)0)
# 256 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
                  ;
      }
    }
    ...
    if (((current_block_value & 0xf00) == 0) && (zero_flag)) {
      ...
      if (i >= buflen) {
        return 
# 266 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c" 3 4
              ((void *)0)
# 266 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
                  ;
      }
    }
    ...
    if (((current_block_value & 0xf0) == 0) && (zero_flag)) {
      ...
      if (i >= buflen) {
        return 
# 277 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c" 3 4
              ((void *)0)
# 277 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
                  ;
      }
    }
    ...
    if (i >= buflen) {
      return 
# 283 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c" 3 4
            ((void *)0)
# 283 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv6/ip6_addr.c"
                ;
    }
  }
