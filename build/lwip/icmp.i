# 1 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
# 1 "/home/dieter/Development/ProjektEi/build/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
# 42 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
...
# 43 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 2
...
# 47 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 2
...
# 48 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 2
...
# 49 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 2
...
# 53 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 2
# 68 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"

# 68 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
static void icmp_send_response(struct pbuf *p, u8_t type, u8_t code);
# 79 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
void
  ...
  switch (type) {
    ...
    case 8:
      ...
      if (pbuf_add_header(p, hlen + (14 + 0) + 0)) {
        ...
        if (r == 
# 169 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
                ((void *)0)
# 169 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
                    ) {
        ...
        if (pbuf_remove_header(r, hlen)) {
          do { if (!(0)) { __assert_func("/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c", 182, 
# 182 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
         __func__
# 182 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
        ...
        if (pbuf_remove_header(p, hlen + (14 + 0) + 0)) {
          do { if (!(0)) { __assert_func("/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c", 199, 
# 199 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
         __func__
# 199 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
...
# 235 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
        (iphdr)->_ttl = (u8_t)(255);
        (iphdr)->_chksum = (0);
...
# 250 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
                                   ((void *)0)
# 250 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
                                                  ,
                            255, 0, 1, inp);
        if (ret != ERR_OK) {
...
# 307 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
void
...
# 339 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
static void
icmp_send_response(struct pbuf *p, u8_t type, u8_t code)
{
  ...
  q = pbuf_alloc(PBUF_IP, sizeof(struct icmp_echo_hdr) + 20 + 8,
                 PBUF_RAM);
  if (q == 
# 355 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
          ((void *)0)
# 355 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
              ) {
  ...
  do { if (!((q->len >= (sizeof(struct icmp_echo_hdr) + 20 + 8)))) { __assert_func(
                                                                                               "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
# 360 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
  ,
                                                                                               361
# 360 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
  , 
# 360 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
 __func__
# 360 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
 , "check that first pbuf can hold icmp message"); }} while(0)
                                                                                                ;
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("%" "d" ".%" "d" ".%" "d" ".%" "d", ((u16_t)((u8_t)(((iphdr->src).addr >> (0 * 8)) & 0xff))), ((u16_t)((u8_t)(((iphdr->src).addr >> (1 * 8)) & 0xff))), ((u16_t)((u8_t)(((iphdr->src).addr >> (2 * 8)) & 0xff))), ((u16_t)((u8_t)(((iphdr->src).addr >> (3 * 8)) & 0xff))));} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf (" to ");} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("%" "d" ".%" "d" ".%" "d" ".%" "d", ((u16_t)((u8_t)(((iphdr->dest).addr >> (0 * 8)) & 0xff))), ((u16_t)((u8_t)(((iphdr->dest).addr >> (1 * 8)) & 0xff))), ((u16_t)((u8_t)(((iphdr->dest).addr >> (2 * 8)) & 0xff))), ((u16_t)((u8_t)(((iphdr->dest).addr >> (3 * 8)) & 0xff))));} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  if (netif != 
# 390 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
              ((void *)0)
# 390 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
                  ) {
    ...
    ;
    ip4_output_if(q, 
# 399 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
                    ((void *)0)
# 399 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
