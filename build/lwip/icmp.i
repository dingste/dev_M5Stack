# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
# 42 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
...
# 43 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 2



# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/include/lwip/icmp.h" 1
# 41 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/include/lwip/icmp.h"
...
# 42 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/include/lwip/icmp.h" 2
...
# 43 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/include/lwip/icmp.h" 2
...
# 44 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/include/lwip/icmp.h" 2
...
# 47 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 2
...
# 48 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 2
...
# 49 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 2
...
# 53 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 2
# 68 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
static void icmp_send_response(struct pbuf *p, u8_t type, u8_t code);
# 79 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
void
icmp_input(struct pbuf *p, struct netif *inp)
{
  ...
  if (hlen < 20) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("icmp_input: short IP header (%""d"" bytes) received\n", hlen);} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    goto lenerr;
  }
  ...
  case 8:
    ...
    if (pbuf_header(p, (s16_t)(hlen + (14 + 0) + 0u))) {
      ...
      if (r == 
# 162 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
              ((void *)0)
# 162 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
                  ) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("icmp_input: allocating new pbuf failed\n");} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        goto icmperr;
      }
      if (r->len < hlen + sizeof(struct icmp_echo_hdr)) {
        do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {printf ("first pbuf cannot hold the ICMP header");} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
        pbuf_free(r);
        goto icmperr;
      }
      ...
      if (pbuf_header(r, (s16_t)-hlen)) {
        do { if (!(0)) { __assert_func("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c", 175, __func__, "icmp_input: moving r->payload to icmp header failed\n"); }} while(0);
        pbuf_free(r);
        goto icmperr;
      }

      if (pbuf_copy(r, p) != ERR_OK) {
        do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {printf ("icmp_input: copying to new pbuf failed");} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
        pbuf_free(r);
        goto icmperr;
      }
      ...
      if (pbuf_header(p, -(s16_t)(hlen + (14 + 0) + 0u))) {
        do { if (!(0)) { __assert_func("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c", 192, __func__, "icmp_input: restoring original p->payload failed\n"); }} while(0);
        goto icmperr;
      }
    }
    ...
    if (pbuf_header(p, (s16_t)hlen)) {
      do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {printf ("Can't move over header in packet");} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
    } else {
      err_t ret;
...

      {
        ...
        if (iecho->chksum > ((((0xffffU - (8 << 8)) & 0x00ffUL) << 8) | (((0xffffU - (8 << 8)) & 0xff00UL) >> 8))) {
          iecho->chksum += ((((8 << 8) & 0x00ffUL) << 8) | (((8 << 8) & 0xff00UL) >> 8)) + 1;
        } else {
          iecho->chksum += ((((8 << 8) & 0x00ffUL) << 8) | (((8 << 8) & 0xff00UL) >> 8));
        }
      }
# 228 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
      (iphdr)->_ttl = (u8_t)((255));
      (iphdr)->_chksum = (0);
...
# 243 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
                                 ((void *)0)
# 243 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
                                                ,
                   (255), 0, 1, inp);
      if (ret != ERR_OK) {
...
# 300 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
void
...
# 332 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
static void
icmp_send_response(struct pbuf *p, u8_t type, u8_t code)
{
  ...
  q = pbuf_alloc(PBUF_IP, sizeof(struct icmp_echo_hdr) + 20 + 8,
                 PBUF_RAM);
  if (q == 
# 348 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
          ((void *)0)
# 348 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
              ) {
  ...
  do { if (!((q->len >= (sizeof(struct icmp_echo_hdr) + 20 + 8)))) { __assert_func(
                                                                                              "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
# 353 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
  ,
                                                                                              354
# 353 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
  ...
  if (netif != 
# 383 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
              ((void *)0)
# 383 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
                  ) {
    ...
    ;
    ip4_output_if(q, 
# 392 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c" 3 4
                    ((void *)0)
# 392 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/core/ipv4/icmp.c"
