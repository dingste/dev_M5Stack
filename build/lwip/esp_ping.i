# 1 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/esp_ping.c"
# 1 "/home/dieter/Development/ProjektEi/build/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/esp_ping.c"
# 15 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/esp_ping.c"
...
# 16 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/esp_ping.c" 2
# 1 "/home/dieter/Development/esp-idf/components/lwip/include/apps/esp_ping.h" 1
# 18 "/home/dieter/Development/esp-idf/components/lwip/include/apps/esp_ping.h"
...
# 19 "/home/dieter/Development/esp-idf/components/lwip/include/apps/esp_ping.h" 2
...
# 17 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/esp_ping.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/esp_ping.c" 2
...
esp_err_t esp_ping_set_target(ping_target_id_t opt_id, void *opt_val, uint32_t opt_len)
{
    ...
    if (opt_val == 
# 39 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/esp_ping.c" 3 4
                  ((void *)0)
# 39 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/esp_ping.c"
                      ) {
        return 0xa000 + 0x01;
    }
    ...
    case PING_TARGET_IP_ADDRESS:
        do { if ((opt_len) < sizeof(uint32_t)) { return 0xa000 + 0x01; }}while(0);
    ...
    case PING_TARGET_DATA_LEN:
        do { if ((opt_len) < sizeof(size_t)) { return 0xa000 + 0x01; }}while(0);
        ping_option_info->ping_data_len = (*(size_t *)opt_val);
        break;
    case PING_TARGET_ID:
        do { if ((opt_len) < sizeof(uint16_t)) { return 0xa000 + 0x01; }}while(0);
        ping_option_info->ping_id = *(uint16_t *)opt_val;
        break;
    case PING_TARGET_IP_TOS:
        do { if ((opt_len) < sizeof(u8_t)) { return 0xa000 + 0x01; }}while(0);
...
esp_err_t esp_ping_get_target(ping_target_id_t opt_id, void *opt_val, uint32_t opt_len)
{
    ...
    if (opt_val == 
# 90 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/esp_ping.c" 3 4
                  ((void *)0)
# 90 "/home/dieter/Development/esp-idf/components/lwip/apps/ping/esp_ping.c"
                      ) {
        return 0xa000 + 0x01;
    }
