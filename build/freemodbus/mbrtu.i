# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c"
# 32 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c"
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c" 2
...
# 34 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c" 2
...
# 37 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c" 2
...
eMBErrorCode eMBRegDiscreteCB( UCHAR * pucRegBuffer, USHORT usAddress,
                                  USHORT usNDiscrete );
# 40 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c" 2
...
# 41 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c" 2
...
# 42 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c" 2

# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbcrc.h" 1
# 34 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbcrc.h"
USHORT usMBCRC16( UCHAR * pucFrame, USHORT usLen );
# 44 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/include/mbport.h" 1
# 45 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c" 2
# 54 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c"
typedef enum
{
    STATE_RX_INIT,
    STATE_RX_IDLE,
...
eMBRTUInit( UCHAR ucSlaveAddress, UCHAR ucPort, ULONG ulBaudRate, eMBParity eParity )
{
    ...
    else
    {
        ...
        {
# 113 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c"
...
eMBRTUReceive( UCHAR * pucRcvAddress, UCHAR ** pucFrame, USHORT * pusLength )
{
    ...
    { do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Port enter critical." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: Port enter critical." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT", "D" " (%d) %s: " "%s: Port enter critical." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT", "V" " (%d) %s: " "%s: Port enter critical." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: Port enter critical." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __func__); } } while(0); } while(0); vMBPortEnterCritical(); };
    ((usRcvBufferPos < 256) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c", 161, __func__, "usRcvBufferPos < MB_SER_PDU_SIZE_MAX"));
...
xMBRTUReceiveFSM( void )
{
    ...
    ((eSndState == STATE_TX_IDLE) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c", 236, __func__, "eSndState == STATE_TX_IDLE"));
...
xMBRTUTransmitFSM( void )
{
    ...
    ((eRcvState == STATE_RX_IDLE) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c", 295, __func__, "eRcvState == STATE_RX_IDLE"));
...
xMBRTUTimerT35Expired( void )
{
    ...
    default:
        ((( eRcvState == STATE_RX_INIT ) || ( eRcvState == STATE_RX_RCV ) || ( eRcvState == STATE_RX_ERROR )) ? (void)0 : __assert_func (
                                                                                 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c"
# 352 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c"
        ,
                                                                                 353
# 352 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/rtu/mbrtu.c"
        , __func__, "( eRcvState == STATE_RX_INIT ) || ( eRcvState == STATE_RX_RCV ) || ( eRcvState == STATE_RX_ERROR )"))
                                                                                  ;
    }
