	.file	"mbfuncinput_m.c"
	.text
.Ltext0:
	.section	.text.eMBMasterReqReadInputRegister,"ax",@progbits
	.align	4
	.global	eMBMasterReqReadInputRegister
	.type	eMBMasterReqReadInputRegister, @function
eMBMasterReqReadInputRegister:
.LVL0:
.LFB15:
	.file 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncinput_m.c"
	.loc 1 73 1 view -0
...
.LVL6:
	...
	.loc 1 86 24 is_stmt 0 view .LVU27
	l32i.n	a3, sp, 0
.LVL7:
	.loc 1 86 24 view .LVU28
	srli	a6, a4, 8
	s8i	a6, a3, 3
...
.L1:
	...
	retw.n
.LFE15:
	.size	eMBMasterReqReadInputRegister, .-eMBMasterReqReadInputRegister
	.section	.text.eMBMasterFuncReadInputRegister,"ax",@progbits
	.align	4
	.global	eMBMasterFuncReadInputRegister
	.type	eMBMasterFuncReadInputRegister, @function
...
.LVL13:
	...
	.loc 1 106 2 view .LVU44
	.loc 1 106 7 is_stmt 0 view .LVU45
	call8	xMBMasterRequestIsBroadcast
.LVL14:
	.loc 1 106 5 view .LVU46
	beqz.n	a10, .L7
.L11:
	.loc 1 108 11 view .LVU47
	movi.n	a2, 0
.LVL15:
	.loc 1 108 11 view .LVU48
	j	.L6
.LVL16:
.L7:
	.loc 1 110 7 is_stmt 1 view .LVU49
	.loc 1 110 9 is_stmt 0 view .LVU50
	l16ui	a8, a3, 0
	bgeui	a8, 2, .L9
.L10:
	.loc 1 141 17 view .LVU51
	movi.n	a2, 3
.LVL17:
	.loc 1 141 17 view .LVU52
	j	.L6
.LVL18:
.L9:
	.loc 1 112 3 is_stmt 1 view .LVU53
	mov.n	a10, sp
	call8	vMBMasterGetPDUSndBuf
.LVL19:
	.loc 1 113 9 view .LVU54
	.loc 1 113 45 is_stmt 0 view .LVU55
	l32i.n	a9, sp, 0
.LVL20:
	.loc 1 114 9 is_stmt 1 view .LVU56
	.loc 1 115 9 view .LVU57
	.loc 1 117 9 view .LVU58
	...
	extui	a12, a8, 0, 16
.LVL21:
	.loc 1 123 9 view .LVU60
	.loc 1 123 11 is_stmt 0 view .LVU61
	beqz.n	a12, .L10
	.loc 1 123 64 discriminator 1 view .LVU62
	l8ui	a10, a2, 1
	.loc 1 123 40 discriminator 1 view .LVU63
	slli	a8, a12, 1
	.loc 1 123 33 discriminator 1 view .LVU64
	bne	a8, a10, .L10
	...
	srli	a8, a8, 8
	or	a8, a11, a8
	.loc 1 115 21 is_stmt 0 view .LVU66
	addi.n	a11, a8, 1
	.loc 1 126 26 view .LVU67
	extui	a11, a11, 0, 16
	addi.n	a10, a2, 2
	call8	eMBMasterRegInputCB
.LVL22:
	.loc 1 128 13 is_stmt 1 view .LVU68
	.loc 1 128 15 is_stmt 0 view .LVU69
	beqz.n	a10, .L11
	.loc 1 130 17 is_stmt 1 view .LVU70
	.loc 1 130 27 is_stmt 0 view .LVU71
	call8	prveMBError2Exception
.LVL23:
	.loc 1 130 27 view .LVU72
	mov.n	a2, a10
.LVL24:
	.loc 1 143 5 is_stmt 1 view .LVU73
.L6:
	.loc 1 144 1 is_stmt 0 view .LVU74
	retw.n
.LFE16:
	.size	eMBMasterFuncReadInputRegister, .-eMBMasterFuncReadInputRegister
...
.LASF312:
	.string	"eMBMasterFuncReadInputRegister"
.LASF208:
...
.LASF332:
	.string	"/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncinput_m.c"
.LASF120:
	.string	"suboptarg"
.LASF40:
	.string	"_fntypes"
