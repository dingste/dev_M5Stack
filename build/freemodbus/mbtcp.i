# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/tcp/mbtcp.c"
# 1 "/home/dieter/Development/ProjektEi/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/tcp/mbtcp.c"
# 32 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/tcp/mbtcp.c"
...
# 33 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/tcp/mbtcp.c" 2
...
# 34 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/tcp/mbtcp.c" 2
...
# 37 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/tcp/mbtcp.c" 2
...
eMBErrorCode eMBRegDiscreteCB( UCHAR * pucRegBuffer, USHORT usAddress,
                                  USHORT usNDiscrete );
# 40 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/tcp/mbtcp.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbconfig.h" 1
# 41 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/tcp/mbtcp.c" 2
...
eMBErrorCode eMBTCPSend( UCHAR _unused, const UCHAR * pucFrame,
                            USHORT usLength );
# 42 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/tcp/mbtcp.c" 2
...
# 43 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/tcp/mbtcp.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbport.h" 1
# 44 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/tcp/mbtcp.c" 2
# 80 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/tcp/mbtcp.c"
eMBErrorCode
eMBTCPDoInit( USHORT ucTCPPort )
{
    eMBErrorCode eStatus = MB_ENOERR;

    if( xMBTCPPortInit( ucTCPPort ) == 0 )
    {
        eStatus = MB_EPORTERR;
    }
    return eStatus;
...
eMBTCPReceive( UCHAR * pucRcvAddress, UCHAR ** ppucFrame, USHORT * pusLength )
{
    ...
    if( xMBTCPPortGetRequest( &pucMBTCPFrame, &usLength ) != 0 )
    {
        usPID = pucMBTCPFrame[2] << 8U;
        usPID |= pucMBTCPFrame[2 + 1];

        if( usPID == 0 )
        {
            *ppucFrame = &pucMBTCPFrame[7];
...
{
    eMBErrorCode eStatus = MB_ENOERR;
    UCHAR *pucMBTCPFrame = ( UCHAR * ) pucFrame - 7;
    USHORT usTCPLength = usLength + 7;
    ...
    pucMBTCPFrame[4] = ( usLength + 1 ) >> 8U;
    pucMBTCPFrame[4 + 1] = ( usLength + 1 ) & 0xFF;
    if( xMBTCPPortSendResponse( pucMBTCPFrame, usTCPLength ) == 0 )
    {
        eStatus = MB_EIO;
    }
    return eStatus;
