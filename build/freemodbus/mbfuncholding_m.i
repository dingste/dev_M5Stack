# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c"
# 1 "/home/dieter/Development/ProjektEi/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c"
# 32 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c"
...
# 33 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c" 2
...
# 34 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c" 2
...
# 37 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c" 2
...
# 41 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c" 2
...
# 42 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbproto.h" 1
# 43 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbconfig.h" 1
# 44 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c" 2
# 83 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c"
eMBException prveMBError2Exception( eMBErrorCode eErrorCode );
# 99 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c"
eMBMasterReqErrCode
eMBMasterReqWriteHoldingRegister( UCHAR ucSndAddr, USHORT usRegAddr, USHORT usRegData, LONG lTimeOut )
{
    UCHAR *ucMBFrame;
    ...
    if ( ucSndAddr > ( 247 ) ) eErrStatus = MB_MRE_ILL_ARG;
    else if ( xMBMasterRunResTake( lTimeOut ) == 0 ) eErrStatus = MB_MRE_MASTER_BUSY;
    else
    {
  vMBMasterGetPDUSndBuf(&ucMBFrame);
  vMBMasterSetDestAddress(ucSndAddr);
  ucMBFrame[0] = ( 6 );
  ucMBFrame[( 1 + 0)] = usRegAddr >> 8;
  ucMBFrame[( 1 + 0) + 1] = usRegAddr;
  ucMBFrame[( 1 + 2 )] = usRegData >> 8;
  ucMBFrame[( 1 + 2 ) + 1] = usRegData ;
  vMBMasterSetPDUSndLength( 1 + ( 4 ) );
...
eMBMasterFuncWriteHoldingRegister( UCHAR * pucFrame, USHORT * usLen )
{
    ...
    if( *usLen == ( 1 + ( 4 ) ) )
    {
        ...
        eRegStatus = eMBMasterRegHoldingCB( &pucFrame[( 1 + 2 )],
...
# 168 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c"
eMBMasterReqErrCode
  ...
  USHORT usRegAddr, USHORT usNRegs, USHORT * pusDataBuffer, LONG lTimeOut )
{
  ...
  ucMBFrame[( 1 + 0 )] = usRegAddr >> 8;
  ucMBFrame[( 1 + 0 ) + 1] = usRegAddr;
  ucMBFrame[( 1 + 2 )] = usNRegs >> 8;
  ucMBFrame[( 1 + 2 ) + 1] = usNRegs ;
  ucMBFrame[( 1 + 4 )] = usNRegs * 2;
  ucMBFrame += ( 1 + 5 );
  ...
  vMBMasterSetPDUSndLength( 1 + ( 5 ) + 2*usNRegs );
  ( void ) xMBMasterPortEventPost( EV_MASTER_FRAME_SENT );
  eErrStatus = eMBMasterWaitRequestFinish( );
    }
    return eErrStatus;
...
eMBMasterFuncWriteMultipleHoldingRegister( UCHAR * pucFrame, USHORT * usLen )
{
    ...
    if( ( *usLen == 1 + ( 4 ) ) || xMBMasterRequestIsBroadcast() )
    {
  vMBMasterGetPDUSndBuf(&ucMBFrame);
        usRegAddress = ( USHORT )( ucMBFrame[( 1 + 0 )] << 8 );
        usRegAddress |= ( USHORT )( ucMBFrame[( 1 + 0 ) + 1] );
        usRegAddress++;

        usRegCount = ( USHORT )( ucMBFrame[( 1 + 2 )] << 8 );
        usRegCount |= ( USHORT )( ucMBFrame[( 1 + 2 ) + 1] );

        ucRegByteCount = ucMBFrame[( 1 + 4 )];

        if( ucRegByteCount == 2 * usRegCount )
        {

            eRegStatus = eMBMasterRegHoldingCB( &ucMBFrame[( 1 + 5 )],
...
# 263 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c"
eMBMasterReqErrCode
eMBMasterReqReadHoldingRegister( UCHAR ucSndAddr, USHORT usRegAddr, USHORT usNRegs, LONG lTimeOut )
{
    UCHAR *ucMBFrame;
...
eMBMasterFuncReadHoldingRegister( UCHAR * pucFrame, USHORT * usLen )
{
  ...
  vMBMasterGetPDUSndBuf(&ucMBFrame);
        ...
        if( ( usRegCount >= 1 ) && ( 2 * usRegCount == pucFrame[( 1 + 0 )] ) )
        {

            eRegStatus = eMBMasterRegHoldingCB( &pucFrame[( 1 + 1 )], usRegAddress, usRegCount, MB_REG_READ );
...
# 355 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfuncholding_m.c"
eMBMasterReqErrCode
eMBMasterReqReadWriteMultipleHoldingRegister( UCHAR ucSndAddr,
  USHORT usReadRegAddr, USHORT usNReadRegs, USHORT * pusDataBuffer,
  USHORT usWriteRegAddr, USHORT usNWriteRegs, LONG lTimeOut )
{
  ...
  vMBMasterSetDestAddress(ucSndAddr);
  ucMBFrame[0] = ( 23 );
  ucMBFrame[( 1 + 0 )] = usReadRegAddr >> 8;
  ucMBFrame[( 1 + 0 ) + 1] = usReadRegAddr;
  ucMBFrame[( 1 + 2 )] = usNReadRegs >> 8;
  ucMBFrame[( 1 + 2 ) + 1] = usNReadRegs ;
  ucMBFrame[( 1 + 4 )] = usWriteRegAddr >> 8;
  ucMBFrame[( 1 + 4 ) + 1] = usWriteRegAddr;
  ucMBFrame[( 1 + 6 )] = usNWriteRegs >> 8;
  ucMBFrame[( 1 + 6 ) + 1] = usNWriteRegs ;
  ucMBFrame[( 1 + 8 )] = usNWriteRegs * 2;
  ucMBFrame += ( 1 + 9 );
  ...
  vMBMasterSetPDUSndLength( 1 + ( 9 ) + 2*usNWriteRegs );
  ( void ) xMBMasterPortEventPost( EV_MASTER_FRAME_SENT );
  eErrStatus = eMBMasterWaitRequestFinish( );
    }
    return eErrStatus;
...
eMBMasterFuncReadWriteMultipleHoldingRegister( UCHAR * pucFrame, USHORT * usLen )
{
    ...
    {
     vMBMasterGetPDUSndBuf(&ucMBFrame);
        usRegReadAddress = ( USHORT )( ucMBFrame[( 1 + 0 )] << 8U );
        usRegReadAddress |= ( USHORT )( ucMBFrame[( 1 + 0 ) + 1] );
        usRegReadAddress++;

        usRegReadCount = ( USHORT )( ucMBFrame[( 1 + 2 )] << 8U );
        usRegReadCount |= ( USHORT )( ucMBFrame[( 1 + 2 ) + 1] );

        usRegWriteAddress = ( USHORT )( ucMBFrame[( 1 + 4 )] << 8U );
        usRegWriteAddress |= ( USHORT )( ucMBFrame[( 1 + 4 ) + 1] );
        usRegWriteAddress++;

        usRegWriteCount = ( USHORT )( ucMBFrame[( 1 + 6 )] << 8U );
        usRegWriteCount |= ( USHORT )( ucMBFrame[( 1 + 6 ) + 1] );

        if( ( 2 * usRegReadCount ) == pucFrame[( 1 + 0 )] )
        {

            eRegStatus = eMBMasterRegHoldingCB( &ucMBFrame[( 1 + 9 )],
                                           usRegWriteAddress, usRegWriteCount, MB_REG_WRITE );

            if( eRegStatus == MB_ENOERR )
            {

    eRegStatus = eMBMasterRegHoldingCB(&pucFrame[( 1 + 1 )],
