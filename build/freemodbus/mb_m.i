# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c"
# 1 "/home/dieter/Development/ProjektEi/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c"
# 32 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c"
...
# 33 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 2
...
# 34 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 2
...
# 37 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 2
...
# 41 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbconfig.h" 1
# 42 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbframe.h" 1
# 70 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbframe.h"
...
# 43 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbproto.h" 1
# 44 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbfunc.h" 1
# 38 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbfunc.h"
...
# 45 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 2

# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbport.h" 1
# 47 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 2

# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu.h" 1
# 38 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu.h"
...
# 49 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 2
# 65 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c"
static UCHAR ucMBMasterDestAddress;
static BOOL xMBRunInMasterMode = 0;
...
static xMBFunctionHandler xMasterFuncHandlers[( 16 )] = {




    {( 4 ), eMBMasterFuncReadInputRegister},


    {( 3 ), eMBMasterFuncReadHoldingRegister},


    {( 16 ), eMBMasterFuncWriteMultipleHoldingRegister},


    {( 6 ), eMBMasterFuncWriteHoldingRegister},


    {( 23 ), eMBMasterFuncReadWriteMultipleHoldingRegister},


    {( 1 ), eMBMasterFuncReadCoils},


    {( 5 ), eMBMasterFuncWriteCoil},


    {( 15 ), eMBMasterFuncWriteMultipleCoils},


    {( 2 ), eMBMasterFuncReadDiscreteInputs},
...
eMBMasterInit( eMBMode eMode, UCHAR ucPort, ULONG ulBaudRate, eMBParity eParity )
{
    ...
    case MB_RTU:
        ...
        pvMBMasterFrameCloseCur = 1 ? vMBMasterPortClose : 
# 151 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 3 4
                                                                          ((void *)0)
# 151 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c"
                                                                              ;
        ...
        break;
# 173 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c"
    default:
        eStatus = MB_EINVAL;
        break;
    }
...
eMBMasterClose( void )
{
    ...
    {
        if( pvMBMasterFrameCloseCur != 
# 202 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 3 4
                                      ((void *)0) 
# 202 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c"
                                           )
        {
...
eMBMasterPoll( void )
{
    ...
    if( xMBMasterPortEventGet( &eEvent ) == 1 ) {
        switch ( eEvent )
        {
        case EV_MASTER_NO_EVENT:
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:EV_MASTER_NO_EVENT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:EV_MASTER_NO_EVENT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:EV_MASTER_NO_EVENT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:EV_MASTER_NO_EVENT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:EV_MASTER_NO_EVENT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);

            
# 283 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 3 4
           ((
# 283 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c"
           0
# 283 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 3 4
           ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c", 283, __func__, 
# 283 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c"
           "0"
# 283 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c" 3 4
           ))
# 283 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/mb_m.c"
        ...
        case EV_MASTER_PROCESS_SUCCESS:
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:EV_MASTER_PROCESS_SUCCESS" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:EV_MASTER_PROCESS_SUCCESS" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:EV_MASTER_PROCESS_SUCCESS" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:EV_MASTER_PROCESS_SUCCESS" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:EV_MASTER_PROCESS_SUCCESS" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
            break;
        case EV_MASTER_ERROR_RESPOND_TIMEOUT:
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:EV_MASTER_ERROR_RESPOND_TIMEOUT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:EV_MASTER_ERROR_RESPOND_TIMEOUT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:EV_MASTER_ERROR_RESPOND_TIMEOUT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:EV_MASTER_ERROR_RESPOND_TIMEOUT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:EV_MASTER_ERROR_RESPOND_TIMEOUT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
            break;
        case EV_MASTER_ERROR_RECEIVE_DATA:
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:EV_MASTER_ERROR_RECEIVE_DATA" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:EV_MASTER_ERROR_RECEIVE_DATA" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:EV_MASTER_ERROR_RECEIVE_DATA" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:EV_MASTER_ERROR_RECEIVE_DATA" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:EV_MASTER_ERROR_RECEIVE_DATA" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
            break;
        case EV_MASTER_ERROR_EXECUTE_FUNCTION:
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:EV_MASTER_ERROR_EXECUTE_FUNCTION" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:EV_MASTER_ERROR_EXECUTE_FUNCTION" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:EV_MASTER_ERROR_EXECUTE_FUNCTION" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:EV_MASTER_ERROR_EXECUTE_FUNCTION" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:EV_MASTER_ERROR_EXECUTE_FUNCTION" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
            break;
        case EV_MASTER_READY:
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:EV_MASTER_READY" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:EV_MASTER_READY" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:EV_MASTER_READY" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:EV_MASTER_READY" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:EV_MASTER_READY" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
            break;
        case EV_MASTER_FRAME_RECEIVED:
            eStatus = peMBMasterFrameReceiveCur( &ucRcvAddress, &ucMBFrame, &usLength );

            if ( ( eStatus == MB_ENOERR ) && ( ucRcvAddress == ucMBMasterGetDestAddress() ) ) {
                do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Packet data received successfully (%u)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, eStatus); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: Packet data received successfully (%u)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, eStatus); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s: Packet data received successfully (%u)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, eStatus); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s: Packet data received successfully (%u)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, eStatus); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: Packet data received successfully (%u)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, eStatus); } } while(0); } while(0);
                ( void ) xMBMasterPortEventPost( EV_MASTER_EXECUTE );
            } else {
                vMBMasterSetErrorType(EV_ERROR_RECEIVE_DATA);
                do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Packet data receive failed (addr=%u)(%u)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, ucRcvAddress, eStatus); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: Packet data receive failed (addr=%u)(%u)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, ucRcvAddress, eStatus); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s: Packet data receive failed (addr=%u)(%u)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, ucRcvAddress, eStatus); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s: Packet data receive failed (addr=%u)(%u)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, ucRcvAddress, eStatus); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: Packet data receive failed (addr=%u)(%u)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, ucRcvAddress, eStatus); } } while(0); } while(0);
                ( void ) xMBMasterPortEventPost( EV_MASTER_ERROR_PROCESS );
            }
            break;
        case EV_MASTER_EXECUTE:
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:EV_MASTER_EXECUTE" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:EV_MASTER_EXECUTE" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:EV_MASTER_EXECUTE" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:EV_MASTER_EXECUTE" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:EV_MASTER_EXECUTE" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
            ucFunctionCode = ucMBFrame[0];
            eException = MB_EX_ILLEGAL_FUNCTION;

            if(ucFunctionCode >> 7) {
                eException = (eMBException)ucMBFrame[1];
            } else {
                for (i = 0; i < ( 16 ); i++) {
                    ...
                    if (xMasterFuncHandlers[i].ucFunctionCode == 0) {
                        ...
                        vMBMasterSetCBRunInMasterMode(1);
                        ...
                        vMBMasterSetCBRunInMasterMode(0);
                        break;
                    }
                }
            }
        ...
        case EV_MASTER_FRAME_SENT:
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:EV_MASTER_FRAME_SENT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:EV_MASTER_FRAME_SENT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:EV_MASTER_FRAME_SENT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:EV_MASTER_FRAME_SENT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:EV_MASTER_FRAME_SENT" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);

            vMBMasterGetPDUSndBuf( &ucMBFrame );
            eStatus = peMBMasterFrameSendCur( ucMBMasterGetDestAddress(), ucMBFrame, usMBMasterGetPDUSndLength() );
            if (eStatus != MB_ENOERR) {
                do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:Frame send error. %d" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, eStatus); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:Frame send error. %d" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, eStatus); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:Frame send error. %d" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, eStatus); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:Frame send error. %d" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, eStatus); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:Frame send error. %d" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, eStatus); } } while(0); } while(0);
            }

            break;
        case EV_MASTER_FRAME_TRANSMITTED:
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:EV_MASTER_FRAME_TRANSMITTED" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:EV_MASTER_FRAME_TRANSMITTED" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:EV_MASTER_FRAME_TRANSMITTED" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:EV_MASTER_FRAME_TRANSMITTED" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:EV_MASTER_FRAME_TRANSMITTED" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
            break;
        case EV_MASTER_ERROR_PROCESS:
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:EV_MASTER_ERROR_PROCESS" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:EV_MASTER_ERROR_PROCESS" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:EV_MASTER_ERROR_PROCESS" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:EV_MASTER_ERROR_PROCESS" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:EV_MASTER_ERROR_PROCESS" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
            ...
            case EV_ERROR_EXECUTE_FUNCTION:
                ...
                break;
            default:
                do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: incorrect error type." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: incorrect error type." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s: incorrect error type." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s: incorrect error type." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: incorrect error type." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
                break;
            }
            vMBMasterRunResRelease();
            break;
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: task event wait failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: task event wait failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s: task event wait failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s: task event wait failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: task event wait failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
    }
    return MB_ENOERR;
}
...
void __attribute__((section(".iram1" "." "2"))) vMBMasterSetErrorType( eMBMasterErrorEventType errorType )
{
