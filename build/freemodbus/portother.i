# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/portother.c"
# 1 "/home/dieter/Development/ProjektEi/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/portother.c"
# 46 "/home/dieter/Development/esp-idf/components/freemodbus/port/portother.c"
...
# 47 "/home/dieter/Development/esp-idf/components/freemodbus/port/portother.c" 2
...
# 48 "/home/dieter/Development/esp-idf/components/freemodbus/port/portother.c" 2
...
# 49 "/home/dieter/Development/esp-idf/components/freemodbus/port/portother.c" 2
...
eMBErrorCode eMBRegDiscreteCB( UCHAR * pucRegBuffer, USHORT usAddress,
                                  USHORT usNDiscrete );
# 52 "/home/dieter/Development/esp-idf/components/freemodbus/port/portother.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbport.h" 1
# 53 "/home/dieter/Development/esp-idf/components/freemodbus/port/portother.c" 2
...
# 54 "/home/dieter/Development/esp-idf/components/freemodbus/port/portother.c" 2
...
{
    { do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Port enter critical." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: Port enter critical." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s: Port enter critical." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s: Port enter critical." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: Port enter critical." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0); vMBPortEnterCritical(); };
    ucPortMode = ucMode;
    { vMBPortExitCritical(); do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Port exit critical" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: Port exit critical" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s: Port exit critical" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s: Port exit critical" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: Port exit critical" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0); };
}
