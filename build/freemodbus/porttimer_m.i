# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
# 1 "/home/dieter/Development/ProjektEi/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
# 37 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
...
# 38 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 2
...
# 41 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbport.h" 1
# 42 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 2
...
# 43 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 2
# 58 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
static USHORT usT35TimeOut50us;

static const USHORT usTimerIndex = (0);
static const USHORT usTimerGroupIndex = (0);
static timer_isr_handle_t xTimerIntHandle;



static void __attribute__((section(".iram1" "." "3"))) vTimerGroupIsr(void *param)
{
    
# 68 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 3 4
   ((
# 68 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
   (int)param == usTimerIndex
# 68 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c", 68, __func__, 
# 68 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
   "(int)param == usTimerIndex"
# 68 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 3 4
   ))
...
BOOL xMBMasterPortTimersInit(USHORT usTimeOut50us)
{
    if (!((usTimeOut50us > 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "Modbus timeout discreet is incorrect." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 80
# 79 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "Modbus timeout discreet is incorrect." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 80
# 79 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "Modbus timeout discreet is incorrect." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 80
# 79 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "Modbus timeout discreet is incorrect." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 80
# 79 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    ); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "Modbus timeout discreet is incorrect." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 80
# 79 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    ...
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "timer init failure, timer_init() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 94
# 93 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "timer init failure, timer_init() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 94
# 93 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "timer init failure, timer_init() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 94
# 93 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "timer init failure, timer_init() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 94
# 93 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "timer init failure, timer_init() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 94
# 93 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    ...
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "stop timer failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 98
# 97 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "stop timer failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 98
# 97 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "stop timer failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 98
# 97 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "stop timer failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 98
# 97 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "stop timer failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 98
# 97 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } } while(0); } while(0); return 0; }
                                                                                         ;
    ...
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "timer set value failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 103
# 101 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "timer set value failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 103
# 101 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "timer set value failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 103
# 101 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "timer set value failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 103
# 101 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "timer set value failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
...
# 101 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    ...
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "failure to set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 109
# 107 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "failure to set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 109
# 107 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "failure to set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 109
# 107 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "failure to set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 109
# 107 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "failure to set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
...
# 107 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    ...
    xErr = timer_isr_register(usTimerGroupIndex, usTimerIndex,
                                vTimerGroupIsr, (void*)(uint32_t)usTimerIndex, ((1<<1)|(1<<2)|(1<<3)), &xTimerIntHandle);
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "timer set value failure, timer_isr_register() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 115
# 113 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "timer set value failure, timer_isr_register() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 115
# 113 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "timer set value failure, timer_isr_register() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 115
# 113 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "timer set value failure, timer_isr_register() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 115
# 113 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "timer set value failure, timer_isr_register() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
...
{
    if (!((usTimerTics50us > 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "incorrect tick value for timer = (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 124
# 122 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)usTimerTics50us); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "incorrect tick value for timer = (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 124
# 122 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)usTimerTics50us); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "incorrect tick value for timer = (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 124
# 122 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)usTimerTics50us); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "incorrect tick value for timer = (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 124
# 122 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)usTimerTics50us); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "incorrect tick value for timer = (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 124
# 122 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)usTimerTics50us); } } while(0); } while(0); return 0; }

                                                      ;
    esp_err_t xErr;
    xErr = timer_pause(usTimerGroupIndex, usTimerIndex);
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "timer pause failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 129
# 127 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "timer pause failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 129
# 127 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "timer pause failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 129
# 127 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "timer pause failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 129
# 127 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "timer pause failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
...
# 127 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } } while(0); } while(0); return 0; }
                                       ...
                                       ;
    xErr = timer_set_counter_value(usTimerGroupIndex, usTimerIndex, 0ULL);
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "timer set counter failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 133
# 131 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "timer set counter failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 133
# 131 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "timer set counter failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 133
# 131 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "timer set counter failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 133
# 131 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "timer set counter failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
...
# 131 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    ...
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "timer set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 139
# 137 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "timer set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 139
# 137 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "timer set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 139
# 137 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "timer set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 139
# 137 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "timer set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
...
# 137 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    ...
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "timer enable interrupt failure, timer_enable_intr() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 143
# 141 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "timer enable interrupt failure, timer_enable_intr() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 143
# 141 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "timer enable interrupt failure, timer_enable_intr() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 143
# 141 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "timer enable interrupt failure, timer_enable_intr() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 143
# 141 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "timer enable interrupt failure, timer_enable_intr() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
...
# 141 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } } while(0); } while(0); return 0; }
                                           ...
                                           ;
    xErr = timer_start(usTimerGroupIndex, usTimerIndex);
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "timer start failure, timer_start() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 147
# 145 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "timer start failure, timer_start() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 147
# 145 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "timer start failure, timer_start() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 147
# 145 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "timer start failure, timer_start() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 147
# 145 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "timer start failure, timer_start() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
...
# 145 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
    , (uint32_t)xErr); } } while(0); } while(0); return 0; }
                                           ...
                                           ;
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s Init timer." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s Init timer." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s Init timer." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s Init timer." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s Init timer." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
    return 1;
}
...
void vMBMasterPortTimersConvertDelayEnable(void)
{
    ...
    USHORT usTimerTicks = ((( 200 ) * 1000) / (50));


    vMBMasterSetCurTimerMode(MB_TMODE_CONVERT_DELAY);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s Convert delay enable." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s Convert delay enable." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s Convert delay enable." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s Convert delay enable." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s Convert delay enable." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
    (void)xMBMasterPortTimersEnable(usTimerTicks);
}

void vMBMasterPortTimersRespondTimeoutEnable(void)
{
    USHORT usTimerTicks = (( 150 ) * 1000 / (50));

    vMBMasterSetCurTimerMode(MB_TMODE_RESPOND_TIMEOUT);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s Respond enable timeout." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s Respond enable timeout." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s Respond enable timeout." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s Respond enable timeout." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s Respond enable timeout." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
    (void)xMBMasterPortTimersEnable(usTimerTicks);
}
...
vMBMasterPortTimersDisable()
{
    if( (BOOL)xPortInIsrContext() ) {
        ...
        do { esp_err_t __err_rc = (timer_pause(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c", 189, 
# 189 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 3 4
       __func__
# 189 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
       , "timer_pause(usTimerGroupIndex, usTimerIndex)"); } } while(0);
        do { esp_err_t __err_rc = (timer_set_counter_value(usTimerGroupIndex, usTimerIndex, 0ULL)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c", 190, 
# 190 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 3 4
       __func__
# 190 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
       , "timer_set_counter_value(usTimerGroupIndex, usTimerIndex, 0ULL)"); } } while(0);

        do { esp_err_t __err_rc = (timer_disable_intr(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c", 192, 
# 192 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 3 4
       __func__
# 192 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
       , "timer_disable_intr(usTimerGroupIndex, usTimerIndex)"); } } while(0);
    }
}

void vMBMasterPortTimerClose(void)
{
    do { esp_err_t __err_rc = (timer_pause(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c", 198, 
# 198 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 3 4
   __func__
# 198 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
   , "timer_pause(usTimerGroupIndex, usTimerIndex)"); } } while(0);
    do { esp_err_t __err_rc = (timer_disable_intr(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c", 199, 
# 199 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 3 4
   __func__
# 199 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
   , "timer_disable_intr(usTimerGroupIndex, usTimerIndex)"); } } while(0);
    do { esp_err_t __err_rc = (esp_intr_free(xTimerIntHandle)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c", 200, 
# 200 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c" 3 4
   __func__
# 200 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer_m.c"
   , "esp_intr_free(xTimerIntHandle)"); } } while(0);
}
