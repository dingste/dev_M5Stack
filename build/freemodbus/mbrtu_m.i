# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
# 1 "/home/dieter/Development/ProjektEi/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
# 32 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
...
# 33 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 2
...
# 34 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 2
...
# 35 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 2
...
# 38 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 2
...
# 42 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 2
...
# 43 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 2
...
# 44 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 2

# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbcrc.h" 1
# 34 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbcrc.h"
USHORT usMBCRC16( UCHAR * pucFrame, USHORT usLen );
# 46 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbport.h" 1
# 47 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 2
# 57 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
typedef enum
{
    STATE_M_RX_INIT,
    STATE_M_RX_IDLE,
...
volatile UCHAR ucMasterRTUSndBuf[253];
volatile UCHAR ucMasterRTURcvBuf[256];
...
static volatile BOOL xFrameIsBroadcast = 0;
...
eMBMasterRTUInit(UCHAR ucPort, ULONG ulBaudRate, eMBParity eParity )
{
    ...
    if( xMBMasterPortSerialInit( ucPort, ulBaudRate, 8, eParity ) != 1 )
    {
        eStatus = MB_EPORTERR;
    }
    else
    {
        ...
        {
# 124 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
            usTimerT35_50us = ( 7UL * 220000UL ) / ( 2UL * ulBaudRate );
        }
        if( xMBMasterPortTimersInit( ( USHORT ) usTimerT35_50us ) != 1 )
        {
            eStatus = MB_EPORTERR;
        }
    }
...
# 167 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
   ((
# 167 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
   usMasterRcvBufferPos < 256
# 167 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c", 167, __func__, 
# 167 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
   "usMasterRcvBufferPos < MB_SER_PDU_SIZE_MAX"
# 167 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
   ))
# 167 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
                                                       ;
    ...
    if( ( usMasterRcvBufferPos >= 4 )
        && ( usMBCRC16( ( UCHAR * ) ucMasterRTURcvBuf, usMasterRcvBufferPos ) == 0 ) )
    {



        *pucRcvAddress = ucMasterRTURcvBuf[0];




        *pusLength = ( USHORT )( usMasterRcvBufferPos - 1 - 2 );


        *pucFrame = ( UCHAR * ) & ucMasterRTURcvBuf[1];
    }
    else
    {
        eStatus = MB_EIO;
...
eMBMasterRTUSend( UCHAR ucSlaveAddress, const UCHAR * pucFrame, USHORT usLength )
{
    ...
    if ( ucSlaveAddress > ( 247 ) ) return MB_EINVAL;
    ...
    if( eRcvState == STATE_M_RX_IDLE )
    {
        ...
        pucMasterSndBufferCur[0] = ucSlaveAddress;
...
# 243 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
   ((
# 243 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
   ( eSndState == STATE_M_TX_IDLE ) || ( eSndState == STATE_M_TX_XFWR )
# 243 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c", 243, __func__, 
# 243 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
   "( eSndState == STATE_M_TX_IDLE ) || ( eSndState == STATE_M_TX_XFWR )"
# 243 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
   ))
...
# 309 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
   ((
# 309 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
   eRcvState == STATE_M_RX_IDLE
# 309 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c", 309, __func__, 
# 309 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
   "eRcvState == STATE_M_RX_IDLE"
# 309 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
   ))
# 309 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
    ...
    case STATE_M_TX_XMIT:
        ...
        {
            xFrameIsBroadcast = ( ucMasterRTUSndBuf[0] == ( 0 ) ) ? 1 : 0;
            eSndState = STATE_M_TX_XFWR;


            if ( xFrameIsBroadcast == 1 )
            {
...
# 376 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
 ((
# 376 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
...
# 376 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
                                                                              ...
                                                                              "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
# 376 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
  ,
                                                                              377
# 376 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
...
# 377 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
                                                                              ;
  break;
 }
 eRcvState = STATE_M_RX_IDLE;
...
# 395 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
 ((
# 395 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
 ( eSndState == STATE_M_TX_XFWR ) || ( eSndState == STATE_M_TX_IDLE )
# 395 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
 ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c", 395, __func__, 
# 395 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c"
 "( eSndState == STATE_M_TX_XFWR ) || ( eSndState == STATE_M_TX_IDLE )"
# 395 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu_m.c" 3 4
 ))
...
void vMBMasterGetPDUSndBuf( UCHAR ** pucFrame )
{
 *pucFrame = ( UCHAR * ) &ucMasterRTUSndBuf[1];
}
