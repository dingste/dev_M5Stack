# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
# 1 "/home/dieter/Development/ProjektEi/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
# 36 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
...
# 37 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 2
...
# 40 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbport.h" 1
# 41 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu.h" 1
# 30 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu.h"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbconfig.h" 1
# 31 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/rtu/mbrtu.h" 2
...
# 42 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 2
...
# 45 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 2
...
# 46 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 2
...
static inline uint32_t __attribute__((section(".iram1" "." "3"))) DPORT_REG_READ(uint32_t reg)
{
...
static inline uint32_t __attribute__((section(".iram1" "." "4"))) DPORT_SEQUENCE_REG_READ(uint32_t reg)
{
...
static inline uint32_t __attribute__((section(".iram1" "." "5"))) DPORT_READ_PERI_REG(uint32_t reg)
{
...
# 47 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 2
...
# 49 "/home/dieter/Development/esp-idf/components/freemodbus/serial_master/port/port_serial_master.h"
# 1 "/home/dieter/Development/esp-idf/components/driver/include/driver/timer.h" 1
# 19 "/home/dieter/Development/esp-idf/components/driver/include/driver/timer.h"
# 1 "/home/dieter/Development/esp-idf/components/soc/esp32/include/soc/soc.h" 1
...
# 53 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 2
# 69 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
...
static void vMBMasterPortSerialRxPoll(size_t xEventSize)
{
    ...
    if (bRxStateEnabled) {
        if (xEventSize > 0) {
            ...
            usLength = uart_read_bytes(ucUartNumber, &ucBuffer[0], xEventSize, ( TickType_t ) 0xffffffffUL);
            uiRxBufferPos = 0;
            ...
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Receive: %d(bytes in buffer)\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint32_t)usLength); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Receive: %d(bytes in buffer)\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint32_t)usLength); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Receive: %d(bytes in buffer)\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint32_t)usLength); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Receive: %d(bytes in buffer)\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint32_t)usLength); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Receive: %d(bytes in buffer)\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint32_t)usLength); } } while(0); } while(0);
        }
    } else {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: bRxState disabled but junk data (%d bytes) received. " "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (uint16_t)xEventSize); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: bRxState disabled but junk data (%d bytes) received. " "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (uint16_t)xEventSize); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: bRxState disabled but junk data (%d bytes) received. " "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (uint16_t)xEventSize); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: bRxState disabled but junk data (%d bytes) received. " "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (uint16_t)xEventSize); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: bRxState disabled but junk data (%d bytes) received. " "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (uint16_t)xEventSize); } } while(0); } while(0);
    }
}
...
BOOL xMBMasterPortSerialTxPoll(void)
{
    ...
    if( bTxStateEnabled ) {
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "MB_TX_buffer sent: (%d) bytes." "\033[0m" "\n", esp_log_timestamp(), TAG, (uint16_t)(usCount - 1)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "MB_TX_buffer sent: (%d) bytes." "\033[0m" "\n", esp_log_timestamp(), TAG, (uint16_t)(usCount - 1)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "MB_TX_buffer sent: (%d) bytes." "\033[0m" "\n", esp_log_timestamp(), TAG, (uint16_t)(usCount - 1)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "MB_TX_buffer sent: (%d) bytes." "\033[0m" "\n", esp_log_timestamp(), TAG, (uint16_t)(usCount - 1)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "MB_TX_buffer sent: (%d) bytes." "\033[0m" "\n", esp_log_timestamp(), TAG, (uint16_t)(usCount - 1)); } } while(0); } while(0);

        esp_err_t xTxStatus = uart_wait_tx_done(ucUartNumber, ( ( ( TickType_t ) ( (100) ) * ( 100 ) ) / ( TickType_t ) 1000 ));
        bTxStateEnabled = 0;
        vMBMasterPortSerialEnable( 1, 0 );
        if (!((xTxStatus == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "mb serial sent buffer failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 140); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "mb serial sent buffer failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 140); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "mb serial sent buffer failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 140); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "mb serial sent buffer failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 140); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "mb serial sent buffer failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 140); } } while(0); } while(0); return 0; };
        return 1;
    }
    return 0;
}
    ...
    for(;;) {
        if (xQueueGenericReceive( ( xMbUartQueue ), ( (void*)&xEvent ), ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 )) {
            ...
            switch(xEvent.type) {
                ...
                case UART_FIFO_OVF:
                    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "hw fifo overflow." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "hw fifo overflow." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "hw fifo overflow." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "hw fifo overflow." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "hw fifo overflow." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
                    xQueueGenericReset( xMbUartQueue, ( ( BaseType_t ) 0 ) );
                    break;

                case UART_BUFFER_FULL:
                    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ring buffer full." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ring buffer full." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ring buffer full." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ring buffer full." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ring buffer full." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
                    xQueueGenericReset( xMbUartQueue, ( ( BaseType_t ) 0 ) );
                    uart_flush_input(ucUartNumber);
                    break;

                case UART_BREAK:
                    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "uart rx break." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "uart rx break." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "uart rx break." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "uart rx break." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "uart rx break." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
                    break;

                case UART_PARITY_ERR:
                    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "uart parity error." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "uart parity error." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "uart parity error." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "uart parity error." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "uart parity error." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
                    break;

                case UART_FRAME_ERR:
                    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "uart frame error." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "uart frame error." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "uart frame error." "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "uart frame error." "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "uart frame error." "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
                    break;
                default:
                    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "uart event type: %d." "\033[0m" "\n", esp_log_timestamp(), TAG, xEvent.type); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "uart event type: %d." "\033[0m" "\n", esp_log_timestamp(), TAG, xEvent.type); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "uart event type: %d." "\033[0m" "\n", esp_log_timestamp(), TAG, xEvent.type); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "uart event type: %d." "\033[0m" "\n", esp_log_timestamp(), TAG, xEvent.type); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "uart event type: %d." "\033[0m" "\n", esp_log_timestamp(), TAG, xEvent.type); } } while(0); } while(0);
                    break;
            }
        }
    }
    vTaskDelete(
# 189 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 3 4
               ((void *)0)
# 189 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
                   );
}
...
{
    esp_err_t xErr = 0;
    if (!((eParity <= MB_PAR_EVEN))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 196); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 196); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 196); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 196); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 196); } } while(0); } while(0); return 0; };
    ...
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "mb config failure, uart_param_config() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 241
# 240 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "mb config failure, uart_param_config() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 241
# 240 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "mb config failure, uart_param_config() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 241
# 240 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "mb config failure, uart_param_config() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 241
# 240 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "mb config failure, uart_param_config() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 241
# 240 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    ...
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "mb serial driver failure, uart_driver_install() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 246
# 245 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "mb serial driver failure, uart_driver_install() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 246
# 245 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "mb serial driver failure, uart_driver_install() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 246
# 245 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "mb serial driver failure, uart_driver_install() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 246
# 245 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "mb serial driver failure, uart_driver_install() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 246
# 245 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } } while(0); } while(0); return 0; }
                                                                                               ;
    ...
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "mb serial set rx timeout failure, uart_set_rx_timeout() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 250
# 249 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "mb serial set rx timeout failure, uart_set_rx_timeout() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 250
# 249 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "mb serial set rx timeout failure, uart_set_rx_timeout() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 250
# 249 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "mb serial set rx timeout failure, uart_set_rx_timeout() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 250
# 249 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "mb serial set rx timeout failure, uart_set_rx_timeout() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 250
# 249 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    , (uint32_t)xErr); } } while(0); } while(0); return 0; }
                                                                                                       ;
...
# 253 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 3 4
                                       ((void *)0)
# 253 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
                                           , (10), &xMbTaskHandle);
    if (xStatus != ( ( ( BaseType_t ) 1 ) )) {
        vTaskDelete(xMbTaskHandle);

        if (!(0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "mb stack serial task creation error. xTaskCreate() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 259
# 257 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
        , (uint32_t)xStatus); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "mb stack serial task creation error. xTaskCreate() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 259
# 257 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
        , (uint32_t)xStatus); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "mb stack serial task creation error. xTaskCreate() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 259
# 257 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
        , (uint32_t)xStatus); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "mb stack serial task creation error. xTaskCreate() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,

 259
# 257 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
        , (uint32_t)xStatus); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "mb stack serial task creation error. xTaskCreate() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
...
# 257 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    ...
    uiRxBufferPos = 0;
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s Init serial." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s Init serial." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s Init serial." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s Init serial." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s Init serial." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
    return 1;
}
...
void vMBMasterPortSerialClose(void)
{
    ...
    do { esp_err_t __err_rc = (uart_driver_delete(ucUartNumber)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c", 271, 
# 271 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 3 4
   __func__
# 271 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
   , "uart_driver_delete(ucUartNumber)"); } } while(0);
}
...
# 285 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 3 4
   ((
# 285 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
   pucByte != 
# 285 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 3 4
   ((void *)0)) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c", 285, __func__, 
# 285 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
   "pucByte != NULL"
# 285 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c" 3 4
   ))
# 285 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
                          ;
    if (!((uiRxBufferPos < (256)))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "mb stack serial get byte failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 287
# 286 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "mb stack serial get byte failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 287
# 286 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "mb stack serial get byte failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 287
# 286 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "mb stack serial get byte failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 287
# 286 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
    ); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "mb stack serial get byte failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 287
# 286 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial_m.c"
