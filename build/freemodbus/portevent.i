# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
# 1 "/home/dieter/Development/ProjektEi/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
# 46 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
...
# 47 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 2
...
# 48 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 2
...
# 49 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 2
...
eMBErrorCode eMBRegDiscreteCB( UCHAR * pucRegBuffer, USHORT usAddress,
                                  USHORT usNDiscrete );
# 52 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbport.h" 1
# 53 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/port.h" 1
# 54 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 2
...
# 56 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 2
...
{
    BOOL bStatus = 0;
    if((xQueueHdl = xQueueGenericCreate( ( (6) ), ( sizeof(eMBEventType) ), ( ( ( uint8_t ) 0U ) ) )) != 
# 67 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 3 4
                                                                               ((void *)0)
# 67 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
                                                                                   )
    {
        ;
        bStatus = 1;
...
{
    if(xQueueHdl != 
# 78 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 3 4
                   ((void *)0)
# 78 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
                       )
    {
        vQueueDelete(xQueueHdl);
        xQueueHdl = 
# 81 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 3 4
                   ((void *)0)
# 81 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
                       ;
    }
}
...
{
    BaseType_t xStatus, xHigherPriorityTaskWoken = ( ( BaseType_t ) 0 );
    
# 89 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 3 4
   ((
# 89 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
   xQueueHdl != 
# 89 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 3 4
   ((void *)0)) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c", 89, __func__, 
# 89 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
   "xQueueHdl != NULL"
# 89 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 3 4
   ))
# 89 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
    ...
    {
        xStatus = xQueueGenericSendFromISR( ( xQueueHdl ), ( (const void*)&eEvent ), ( &xHigherPriorityTaskWoken ), ( ( BaseType_t ) 0 ) );
        if (!((xStatus == ( ( BaseType_t ) 1 )))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "%s: Post message failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 94, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "%s: Post message failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 94, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "%s: Post message failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 94, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "%s: Post message failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 94, __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "%s: Post message failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 94, __func__); } } while(0); } while(0); return 0; };
    ...
    {
        xStatus = xQueueGenericSend( ( xQueueHdl ), ( (const void*)&eEvent ), ( (( ( ( TickType_t ) ( 20 ) * ( 100 ) ) / ( TickType_t ) 1000 )) ), ( ( BaseType_t ) 0 ) );
        if (!((xStatus == ( ( BaseType_t ) 1 )))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "%s: Post message failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 103, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "%s: Post message failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 103, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "%s: Post message failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 103, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "%s: Post message failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 103, __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "%s: Post message failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 103, __func__); } } while(0); } while(0); return 0; };
    }
    return 1;
}
...
# 111 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 3 4
   ((
# 111 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
   xQueueHdl != 
# 111 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 3 4
   ((void *)0)) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c", 111, __func__, 
# 111 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
   "xQueueHdl != NULL"
# 111 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 3 4
   ))
...
{
    if(xQueueHdl != 
# 123 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 3 4
                   ((void *)0)
# 123 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
                       )
    {
        return xQueueHdl;
    }
    return 
# 127 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c" 3 4
          ((void *)0)
# 127 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent.c"
              ;
}
