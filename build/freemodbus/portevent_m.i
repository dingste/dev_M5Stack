# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
# 1 "/home/dieter/Development/ProjektEi/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
# 37 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
...
# 35 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbconfig.h"
...
# 36 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbconfig.h" 2
...
# 23 "/home/dieter/Development/esp-idf/components/freemodbus/port/port.h" 2
...
# 38 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbport.h" 1
# 39 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbconfig.h" 1
# 40 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 2
...
# 43 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 2
...
# 44 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/port.h" 1
# 45 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 2
...
# 47 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/serial_master/port/port_serial_master.h" 1
# 48 "/home/dieter/Development/esp-idf/components/freemodbus/serial_master/port/port_serial_master.h"
...
# 49 "/home/dieter/Development/esp-idf/components/freemodbus/serial_master/port/port_serial_master.h" 2
...
# 50 "/home/dieter/Development/esp-idf/components/freemodbus/serial_master/port/port_serial_master.h" 2
# 59 "/home/dieter/Development/esp-idf/components/freemodbus/serial_master/port/port_serial_master.h"
void vMBPortSetMode( UCHAR ucMode );
# 48 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 2
# 68 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
...
# 77 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 3 4
   ((void *)0)
# 77 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
   ))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "mb stack event group creation error." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 78
# 77 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "mb stack event group creation error." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 78
# 77 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "mb stack event group creation error." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 78
# 77 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "mb stack event group creation error." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 78
# 77 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
    ); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "mb stack event group creation error." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 78
# 77 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
...
xMBMasterPortEventPost( eMBMasterEventType eEvent )
{
    ...
    if( (BOOL)xPortInIsrContext() == 1 )
    {
        BaseType_t xHigherPriorityTaskWoken = ( ( BaseType_t ) 0 );
        BaseType_t xResult = xTimerPendFunctionCallFromISR( vEventGroupSetBitsCallback, ( void * ) xEventGroupMasterHdl, ( uint32_t ) (EventBits_t) eTempEvent, &xHigherPriorityTaskWoken )
...
xMBMasterPortEventGet( eMBMasterEventType * eEvent)
{
    ...
    uxBits = xEventGroupWaitBits(
            ...
            (EventBits_t)( EV_MASTER_READY | EV_MASTER_FRAME_RECEIVED | EV_MASTER_EXECUTE | EV_MASTER_FRAME_SENT | EV_MASTER_FRAME_TRANSMITTED | EV_MASTER_ERROR_PROCESS ),
            ( ( BaseType_t ) 1 ),
            ( ( BaseType_t ) 0 ),
            ( TickType_t ) 0xffffffffUL);


    if (uxBits & (EventBits_t)( EV_MASTER_READY | EV_MASTER_FRAME_RECEIVED | EV_MASTER_EXECUTE | EV_MASTER_FRAME_SENT | EV_MASTER_FRAME_TRANSMITTED | EV_MASTER_ERROR_PROCESS )) {
        *eEvent = (eMBMasterEventType)(uxBits);
        xEventHappened = 1;
    } else {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Incorrect event triggered." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: Incorrect event triggered." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s: Incorrect event triggered." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s: Incorrect event triggered." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: Incorrect event triggered." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
        xEventHappened = 0;
    }
...
void vMBMasterOsResInit( void )
{
    xSemaphorMasterHdl = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) );
    if (!((xSemaphorMasterHdl != 
# 143 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 3 4
   ((void *)0)
# 143 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
   ))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "%s: OS semaphore create error." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 143, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "%s: OS semaphore create error." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 143, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "%s: OS semaphore create error." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 143, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "%s: OS semaphore create error." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 143, __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "%s: OS semaphore create error." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 143, __func__); } } while(0); } while(0); return ;; };
}
# 154 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
BOOL xMBMasterRunResTake( LONG lTimeOut )
{
    BaseType_t xStatus = ( ( BaseType_t ) 1 );


    xStatus = xQueueGenericReceive( ( QueueHandle_t ) ( xSemaphorMasterHdl ), 
# 159 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 3 4
             ((void *)0)
# 159 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
             , ( lTimeOut ), ( ( BaseType_t ) 0 ) );
    if (!((xStatus == ( ( BaseType_t ) 1 )))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "%s:Take resource failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 160, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "%s:Take resource failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 160, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "%s:Take resource failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 160, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "%s:Take resource failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 160, __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "%s:Take resource failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 160, __func__); } } while(0); } while(0); return 0; };
    do { if ( 3 >= ESP_LOG_VERBOSE ) do { if (ESP_LOG_VERBOSE==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:Take resource (%lu ticks)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, lTimeOut); } else if (ESP_LOG_VERBOSE==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:Take resource (%lu ticks)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, lTimeOut); } else if (ESP_LOG_VERBOSE==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:Take resource (%lu ticks)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, lTimeOut); } else if (ESP_LOG_VERBOSE==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:Take resource (%lu ticks)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, lTimeOut); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:Take resource (%lu ticks)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, lTimeOut); } } while(0); } while(0);
    return 1;
}
...
void vMBMasterRunResRelease( void )
{
    BaseType_t xStatus = ( ( BaseType_t ) 0 );
    xStatus = xQueueGenericSend( ( QueueHandle_t ) ( xSemaphorMasterHdl ), 
# 172 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 3 4
             ((void *)0)
# 172 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
             , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    if (!((xStatus == ( ( BaseType_t ) 1 )))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "%s: resource release failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 173, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "%s: resource release failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 173, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "%s: resource release failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 173, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "%s: resource release failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 173, __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "%s: resource release failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 173, __func__); } } while(0); } while(0); return ;; };
}
# 185 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
void vMBMasterErrorCBRespondTimeout(UCHAR ucDestAddress, const UCHAR* pucPDUData, USHORT ucPDULength)
{
    ...
    if (!((ret == 1))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_RESPOND_TIMEOUT' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 188, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_RESPOND_TIMEOUT' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 188, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_RESPOND_TIMEOUT' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 188, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_RESPOND_TIMEOUT' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 188, __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_RESPOND_TIMEOUT' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 188, __func__); } } while(0); } while(0); return ;; };
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:Callback respond timeout." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:Callback respond timeout." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:Callback respond timeout." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:Callback respond timeout." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:Callback respond timeout." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
}
# 200 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
void vMBMasterErrorCBReceiveData(UCHAR ucDestAddress, const UCHAR* pucPDUData, USHORT ucPDULength)
{
    ...
    if (!((ret == 1))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_RECEIVE_DATA' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 203, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_RECEIVE_DATA' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 203, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_RECEIVE_DATA' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 203, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_RECEIVE_DATA' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 203, __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_RECEIVE_DATA' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 203, __func__); } } while(0); } while(0); return ;; };
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:Callback receive data timeout failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:Callback receive data timeout failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:Callback receive data timeout failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:Callback receive data timeout failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:Callback receive data timeout failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
}
# 217 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
void vMBMasterErrorCBExecuteFunction(UCHAR ucDestAddress, const UCHAR* pucPDUData, USHORT ucPDULength)
{
    ...
    if (!((ret == 1))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_EXECUTE_FUNCTION' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 220, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_EXECUTE_FUNCTION' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 220, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_EXECUTE_FUNCTION' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 220, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_EXECUTE_FUNCTION' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 220, __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_ERROR_EXECUTE_FUNCTION' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 220, __func__); } } while(0); } while(0); return ;; };
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s:Callback execute data timeout failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s:Callback execute data timeout failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s:Callback execute data timeout failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s:Callback execute data timeout failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s:Callback execute data timeout failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
}
...
void vMBMasterCBRequestSuccess( void ) {
    ...
    if (!((ret == 1))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_PROCESS_SUCCESS' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 235, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_PROCESS_SUCCESS' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 235, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_PROCESS_SUCCESS' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 235, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_PROCESS_SUCCESS' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 235, __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "%s: Post event 'EV_MASTER_PROCESS_SUCCESS' failed!" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 235, __func__); } } while(0); } while(0); return ;; };
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Callback request success." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: Callback request success." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s: Callback request success." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s: Callback request success." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: Callback request success." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__); } } while(0); } while(0);
}
# 248 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
eMBMasterReqErrCode eMBMasterWaitRequestFinish( void ) {
    eMBMasterReqErrCode eErrStatus = MB_MRE_NO_ERR;
    eMBMasterEventType xRecvedEvent;

    EventBits_t uxBits = xEventGroupWaitBits( xEventGroupMasterHdl,
                                                (EventBits_t)( EV_MASTER_PROCESS_SUCCESS | EV_MASTER_ERROR_RESPOND_TIMEOUT | EV_MASTER_ERROR_RECEIVE_DATA | EV_MASTER_ERROR_EXECUTE_FUNCTION ),
                                                ( ( BaseType_t ) 1 ),
                                                ( ( BaseType_t ) 0 ),
                                                ( TickType_t ) 0xffffffffUL );
    xRecvedEvent = (eMBMasterEventType)(uxBits);
    if (xRecvedEvent) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: returned event = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, xRecvedEvent); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: returned event = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, xRecvedEvent); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s: returned event = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, xRecvedEvent); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s: returned event = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, xRecvedEvent); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: returned event = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, xRecvedEvent); } } while(0); } while(0);
        if (!(xRecvedEvent & (EventBits_t)( EV_MASTER_PROCESS_SUCCESS | EV_MASTER_ERROR_RESPOND_TIMEOUT | EV_MASTER_ERROR_RECEIVE_DATA | EV_MASTER_ERROR_EXECUTE_FUNCTION ))) {

            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: incorrect event set = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, xRecvedEvent); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: incorrect event set = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, xRecvedEvent); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s: incorrect event set = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, xRecvedEvent); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s: incorrect event set = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, xRecvedEvent); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: incorrect event set = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, xRecvedEvent); } } while(0); } while(0);
        }
        if (xRecvedEvent & EV_MASTER_PROCESS_SUCCESS) {
        ...
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Incorrect event or timeout xRecvedEvent = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, uxBits); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s: Incorrect event or timeout xRecvedEvent = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, uxBits); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s: Incorrect event or timeout xRecvedEvent = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, uxBits); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s: Incorrect event or timeout xRecvedEvent = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, uxBits); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s: Incorrect event or timeout xRecvedEvent = 0x%x" "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __func__, uxBits); } } while(0); } while(0);
        
# 275 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 3 4
       ((
# 275 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
       0
# 275 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 3 4
       ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c", 275, __func__, 
# 275 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c"
       "0"
# 275 "/home/dieter/Development/esp-idf/components/freemodbus/port/portevent_m.c" 3 4
       ))
...
void vMBMasterPortEventClose(void)
{
    ...
    vQueueDelete( ( QueueHandle_t ) ( xSemaphorMasterHdl ) );
}
