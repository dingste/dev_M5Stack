# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
# 1 "/home/dieter/Development/ProjektEi/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
# 44 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
...
# 45 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c" 2
...
# 46 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c" 2
...
# 776 "/home/dieter/Development/esp-idf/components/driver/include/driver/gpio.h"
                                                    oen_inv);
# 49 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c" 2
...
eMBErrorCode eMBRegDiscreteCB( UCHAR * pucRegBuffer, USHORT usAddress,
                                  USHORT usNDiscrete );
# 54 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbport.h" 1
# 55 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c" 2
...
# 57 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c" 2
# 78 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
...
BOOL xMBPortSerialTxPoll(void)
{
    ...
    if( bTxStateEnabled ) {
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "MB_TX_buffer send: (%d) bytes\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint16_t)usCount); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "MB_TX_buffer send: (%d) bytes\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint16_t)usCount); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "MB_TX_buffer send: (%d) bytes\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint16_t)usCount); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "MB_TX_buffer send: (%d) bytes\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint16_t)usCount); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "MB_TX_buffer send: (%d) bytes\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (uint16_t)usCount); } } while(0); } while(0);

        esp_err_t xTxStatus = uart_wait_tx_done(ucUartNumber, ( ( ( TickType_t ) ( (100) ) * ( 100 ) ) / ( TickType_t ) 1000 ));
        vMBPortSerialEnable(1, 0);
        if (!((xTxStatus == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "mb serial sent buffer failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 150); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "mb serial sent buffer failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 150); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "mb serial sent buffer failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 150); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "mb serial sent buffer failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 150); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "mb serial sent buffer failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 150); } } while(0); } while(0); return 0; };
        return 1;
    }
    return 0;
}
...
static void vUartTask(void *pvParameters)
{
    ...
    vTaskDelete(
# 198 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c" 3 4
               ((void *)0)
# 198 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
                   );
}
...
{
    esp_err_t xErr = 0;
    if (!((eParity <= MB_PAR_EVEN))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 205); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT_COMMON", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 205); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT_COMMON", "D" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 205); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT_COMMON", "V" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 205); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT_COMMON", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__, 205); } } while(0); } while(0); return 0; };
 ...
 250
# 249 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
...
# 249 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
 ...
 255
# 254 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
...
# 254 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
 ...
 260
# 259 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
...
# 264 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c" 3 4
                                       ((void *)0)
# 264 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
                                           , (10), &xMbTaskHandle);
 ...
 270
# 268 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
...
void vMBPortSerialClose(void)
{
    ...
    do { esp_err_t __err_rc = (uart_driver_delete(ucUartNumber)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c", 282, 
# 282 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c" 3 4
   __func__
# 282 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
...
# 296 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c" 3 4
   ((
# 296 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
   pucByte != 
# 296 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c" 3 4
   ((void *)0)) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c", 296, __func__, 
# 296 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
   "pucByte != NULL"
# 296 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c" 3 4
   ))
# 296 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
 ...
 298
# 297 "/home/dieter/Development/esp-idf/components/freemodbus/port/portserial.c"
