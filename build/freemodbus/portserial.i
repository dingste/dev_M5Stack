...
# 66 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/port.h"
typedef char BOOL;
...
typedef unsigned long ULONG;
typedef long LONG;
# 85 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/port.h"
...
static void vUartTask(void *pvParameters)
{
    ...
    vTaskDelete(
# 181 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c" 3 4
               ((void *)0)
# 181 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c"
                   );
}
...
{
    esp_err_t xErr = 0;
    if (!((eParity <= MB_PAR_EVEN))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__, 188); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__, 188); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT", "D" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__, 188); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT", "V" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__, 188); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "mb serial set parity failure." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__, 188); } } while(0); } while(0); return (0); };
 ...
 233
# 232 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c"
...
# 232 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c"
 ...
 238
# 237 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c"
...
# 237 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c"
 ...
 243
# 242 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c"
...
# 247 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c" 3 4
                                       ((void *)0)
# 247 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c"
                                           , (10), &xMbTaskHandle);
 ...
 253
# 251 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c"
...
void vMBPortSerialClose()
{
    ...
    do { esp_err_t __err_rc = (uart_driver_delete(ucUartNumber)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c", 265, __func__, "uart_driver_delete(ucUartNumber)"); } } while(0);;
}
...
{
    ((pucByte != 
# 279 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c" 3 4
   ((void *)0)
# 279 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c"
   ) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c", 279, __func__, "pucByte != NULL"));
 ...
 281
# 280 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/portserial.c"
