# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
# 1 "/home/dieter/Development/ProjektEi/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
# 45 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
...
# 46 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 2
...
eMBErrorCode eMBRegDiscreteCB( UCHAR * pucRegBuffer, USHORT usAddress,
                                  USHORT usNDiscrete );
# 50 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbport.h" 1
# 51 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/driver/include/driver/timer.h" 2
...
# 52 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/serial_slave/port/port_serial_slave.h" 1
# 49 "/home/dieter/Development/esp-idf/components/freemodbus/serial_slave/port/port_serial_slave.h"
...
# 50 "/home/dieter/Development/esp-idf/components/freemodbus/serial_slave/port/port_serial_slave.h" 2
...
# 53 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 2
# 65 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
...
# 72 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
   ((
# 72 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
   (int)param == usTimerIndex
# 72 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c", 72, __func__, 
# 72 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
   "(int)param == usTimerIndex"
# 72 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
   ))
...
BOOL xMBPortTimersInit(USHORT usTim1Timerout50us)
{
    ...
    if (!((usTim1Timerout50us > 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT_COMMON", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "Modbus timeout discreet is incorrect." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT_COMMON", __FUNCTION__,
 85
# 84 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
...
# 84 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
 ...
 97
# 96 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
...
# 96 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
 ...
 101
# 100 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
...
# 100 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
 ...
 106
# 104 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
...
# 104 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
 ...
 112
# 110 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
...
# 110 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
    ...
    xErr = timer_isr_register(usTimerGroupIndex, usTimerIndex, vTimerGroupIsr,
                                (void*)(uint32_t)usTimerIndex, ((1<<1)|(1<<2)|(1<<3)), &xTimerIntHandle);
 ...
 118
# 116 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
...
void vMBPortTimersEnable(void)
{
    ...
    do { esp_err_t __err_rc = (timer_pause(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c", 126, 
# 126 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
   __func__
# 126 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
   , "timer_pause(usTimerGroupIndex, usTimerIndex)"); } } while(0);
    do { esp_err_t __err_rc = (timer_set_counter_value(usTimerGroupIndex, usTimerIndex, 0ULL)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c", 127, 
# 127 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
   __func__
# 127 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
   , "timer_set_counter_value(usTimerGroupIndex, usTimerIndex, 0ULL)"); } } while(0);
    do { esp_err_t __err_rc = (timer_enable_intr(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c", 128, 
# 128 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
   __func__
# 128 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
   , "timer_enable_intr(usTimerGroupIndex, usTimerIndex)"); } } while(0);
    do { esp_err_t __err_rc = (timer_start(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c", 129, 
# 129 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
   __func__
# 129 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
   , "timer_start(usTimerGroupIndex, usTimerIndex)"); } } while(0);
...
vMBPortTimersDisable(void)
{
    ...
    if( (BOOL)xPortInIsrContext() ) {
        ...
        do { esp_err_t __err_rc = (timer_pause(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c", 140, 
# 140 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
       __func__
# 140 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
       , "timer_pause(usTimerGroupIndex, usTimerIndex)"); } } while(0);
        do { esp_err_t __err_rc = (timer_set_counter_value(usTimerGroupIndex, usTimerIndex, 0ULL)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c", 141, 
# 141 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
       __func__
# 141 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
       , "timer_set_counter_value(usTimerGroupIndex, usTimerIndex, 0ULL)"); } } while(0);

        do { esp_err_t __err_rc = (timer_disable_intr(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c", 143, 
# 143 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
       __func__
# 143 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
...
void vMBPortTimerClose(void)
{
    ...
    do { esp_err_t __err_rc = (timer_pause(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c", 151, 
# 151 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
   __func__
# 151 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
   , "timer_pause(usTimerGroupIndex, usTimerIndex)"); } } while(0);
    do { esp_err_t __err_rc = (timer_disable_intr(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c", 152, 
# 152 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
   __func__
# 152 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
   , "timer_disable_intr(usTimerGroupIndex, usTimerIndex)"); } } while(0);
    do { esp_err_t __err_rc = (esp_intr_free(xTimerIntHandle)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c", 153, 
# 153 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c" 3 4
   __func__
# 153 "/home/dieter/Development/esp-idf/components/freemodbus/port/porttimer.c"
