# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
# 31 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
...
# 32 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c" 2
...
eMBErrorCode eMBRegDiscreteCB( UCHAR * pucRegBuffer, USHORT usAddress,
                                  USHORT usNDiscrete );
# 35 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/modbus/include/mbport.h" 1
# 36 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c" 2

# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/include/sdkconfig.h" 1
# 38 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c" 2
# 49 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
static const USHORT usTimerIndex = 0;
static const USHORT usTimerGroupIndex = 0;

static timg_dev_t *MB_TG[2] = {&TIMERG0, &TIMERG1};


static void __attribute__((section(".iram1" "." "17"))) vTimerGroupIsr(void *param)
{


    uint32_t intr_status = MB_TG[usTimerGroupIndex]->int_st_timers.val;
    if (intr_status & (1UL << (usTimerIndex))) {
        MB_TG[usTimerGroupIndex]->int_clr_timers.val |= (1UL << (usTimerIndex));
...
BOOL xMBPortTimersInit(USHORT usTim1Timerout50us)
{
    ...
    if (!((usTim1Timerout50us > 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "Modbus timeout discreet is incorrect." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 72
# 71 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "Modbus timeout discreet is incorrect." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 72
# 71 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT", "D" " (%d) %s: " "%s(%u): " "Modbus timeout discreet is incorrect." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 72
# 71 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT", "V" " (%d) %s: " "%s(%u): " "Modbus timeout discreet is incorrect." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 72
# 71 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    ); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "Modbus timeout discreet is incorrect." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 72
# 71 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    ...
    config.divider = (((( 80*1000000 )) / (20000)) - 1);;
    config.intr_type = TIMER_INTR_LEVEL;
    config.counter_en = TIMER_PAUSE;

    xErr = timer_init(usTimerGroupIndex, usTimerIndex, &config);
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "timer init failure, timer_init() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 84
# 83 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "timer init failure, timer_init() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 84
# 83 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT", "D" " (%d) %s: " "%s(%u): " "timer init failure, timer_init() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 84
# 83 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT", "V" " (%d) %s: " "%s(%u): " "timer init failure, timer_init() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 84
# 83 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "timer init failure, timer_init() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 84
# 83 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    ...
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "stop timer failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 88
# 87 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "stop timer failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 88
# 87 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT", "D" " (%d) %s: " "%s(%u): " "stop timer failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 88
# 87 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT", "V" " (%d) %s: " "%s(%u): " "stop timer failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 88
# 87 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "stop timer failure, timer_pause() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
 88
# 87 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } } while(0); } while(0); return (0); }
                                                                                         ;
    ...
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "timer set value failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,

 93
# 91 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "timer set value failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,

 93
# 91 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT", "D" " (%d) %s: " "%s(%u): " "timer set value failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,

 93
# 91 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT", "V" " (%d) %s: " "%s(%u): " "timer set value failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,

 93
# 91 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "timer set value failure, timer_set_counter_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
...
# 91 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    ...
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "failure to set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,

 99
# 97 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "failure to set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,

 99
# 97 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT", "D" " (%d) %s: " "%s(%u): " "failure to set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,

 99
# 97 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT", "V" " (%d) %s: " "%s(%u): " "failure to set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,

 99
# 97 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "failure to set alarm failure, timer_set_alarm_value() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
...
# 101 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c" 3 4
                                                                              ((void *)0)
# 101 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
                                                                                  , (1<<10), 
# 101 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c" 3 4
                                                                                                        ((void *)0)
# 101 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
                                                                                                            );
    if (!((xErr == 0))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "MB_PORT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%u): " "timer set value failure, timer_isr_register() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,

 104
# 102 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "MB_PORT", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%u): " "timer set value failure, timer_isr_register() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,

 104
# 102 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "MB_PORT", "D" " (%d) %s: " "%s(%u): " "timer set value failure, timer_isr_register() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,

 104
# 102 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "MB_PORT", "V" " (%d) %s: " "%s(%u): " "timer set value failure, timer_isr_register() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,

 104
# 102 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c"
    , (uint32_t)xErr); } else { esp_log_write(ESP_LOG_INFO, "MB_PORT", "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%u): " "timer set value failure, timer_isr_register() returned (0x%x)." "\033[0m" "\n", esp_log_timestamp(), "MB_PORT", __FUNCTION__,
...
void vMBPortTimersEnable()
{
    ...
    do { esp_err_t __err_rc = (timer_pause(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c", 112, __func__, "timer_pause(usTimerGroupIndex, usTimerIndex)"); } } while(0);;
    do { esp_err_t __err_rc = (timer_set_counter_value(usTimerGroupIndex, usTimerIndex, 0ULL)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c", 113, __func__, "timer_set_counter_value(usTimerGroupIndex, usTimerIndex, 0ULL)"); } } while(0);;
    do { esp_err_t __err_rc = (timer_enable_intr(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c", 114, __func__, "timer_enable_intr(usTimerGroupIndex, usTimerIndex)"); } } while(0);;
    do { esp_err_t __err_rc = (timer_start(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c", 115, __func__, "timer_start(usTimerGroupIndex, usTimerIndex)"); } } while(0);;
...
void vMBPortTimersDisable()
{
    ...
    do { esp_err_t __err_rc = (timer_pause(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c", 122, __func__, "timer_pause(usTimerGroupIndex, usTimerIndex)"); } } while(0);;
    do { esp_err_t __err_rc = (timer_set_counter_value(usTimerGroupIndex, usTimerIndex, 0ULL)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c", 123, __func__, "timer_set_counter_value(usTimerGroupIndex, usTimerIndex, 0ULL)"); } } while(0);;

    do { esp_err_t __err_rc = (timer_disable_intr(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c", 125, __func__, "timer_disable_intr(usTimerGroupIndex, usTimerIndex)"); } } while(0);;
...
void vMBPortTimerClose()
{
    ...
    do { esp_err_t __err_rc = (timer_pause(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c", 132, __func__, "timer_pause(usTimerGroupIndex, usTimerIndex)"); } } while(0);;
    do { esp_err_t __err_rc = (timer_disable_intr(usTimerGroupIndex, usTimerIndex)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/freemodbus/port/porttimer.c", 133, __func__, "timer_disable_intr(usTimerGroupIndex, usTimerIndex)"); } } while(0);;
