# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c"
# 1 "/home/dieter/Development/ProjektEi/build/freemodbus//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c"
# 32 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c"
...
# 33 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c" 2
...
# 34 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c" 2
...
# 37 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c" 2
...
# 41 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c" 2
...
# 42 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbproto.h" 1
# 43 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c" 2
# 1 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/include/mbconfig.h" 1
# 44 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c" 2
...
UCHAR xMBUtilGetBits( UCHAR * ucByteBuf, USHORT usBitOffset,
                                UCHAR ucNBits );
# 45 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c" 2
# 72 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c"
eMBException prveMBError2Exception( eMBErrorCode eErrorCode );
# 88 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c"
eMBMasterReqErrCode
eMBMasterReqReadCoils( UCHAR ucSndAddr, USHORT usCoilAddr, USHORT usNCoils, LONG lTimeOut )
{
    UCHAR *ucMBFrame;
    ...
    else
    {
        ...
        ucMBFrame[0] = ( 1 );
        ucMBFrame[( 1 + 0 )] = usCoilAddr >> 8;
        ucMBFrame[( 1 + 0 ) + 1] = usCoilAddr;
        ucMBFrame[( 1 + 2 ) ] = usNCoils >> 8;
        ucMBFrame[( 1 + 2 ) + 1] = usNCoils;
...
eMBMasterFuncReadCoils( UCHAR * pucFrame, USHORT * usLen )
{
    ...
    else if ( *usLen >= 1 + ( 1 ) )
    {
        ...
        usCoilCount = ( USHORT )( ucMBFrame[( 1 + 2 )] << 8 );
        usCoilCount |= ( USHORT )( ucMBFrame[( 1 + 2 ) + 1] );
        ...
        if( ( usCoilCount >= 1 ) &&
            ( ucByteCount == pucFrame[( 1 + 0 )] ) )
        {

            eRegStatus = eMBMasterRegCoilsCB( &pucFrame[( 1 + 1 )], usRegAddress, usCoilCount, MB_REG_READ );
...
# 194 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c"
eMBMasterReqErrCode
eMBMasterReqWriteCoil( UCHAR ucSndAddr, USHORT usCoilAddr, USHORT usCoilData, LONG lTimeOut )
{
    UCHAR *ucMBFrame;
    ...
    else
    {
        ...
        vMBMasterSetDestAddress(ucSndAddr);
        ucMBFrame[0] = ( 5 );
        ucMBFrame[( 1 )] = usCoilAddr >> 8;
        ucMBFrame[( 1 ) + 1] = usCoilAddr;
        ucMBFrame[( 1 + 2 ) ] = usCoilData >> 8;
        ucMBFrame[( 1 + 2 ) + 1] = usCoilData;
        vMBMasterSetPDUSndLength( 1 + ( 4 ) );
        ( void ) xMBMasterPortEventPost( EV_MASTER_FRAME_SENT );
        eErrStatus = eMBMasterWaitRequestFinish( );
    }
...
# 287 "/home/dieter/Development/esp-idf/components/freemodbus/modbus/functions/mbfunccoils_m.c"
eMBMasterReqErrCode
eMBMasterReqWriteMultipleCoils( UCHAR ucSndAddr,
        USHORT usCoilAddr, USHORT usNCoils, UCHAR * pucDataBuffer, LONG lTimeOut)
{
    ...
    if ( ucSndAddr > ( 247 ) ) eErrStatus = MB_MRE_ILL_ARG;
    else if ( usNCoils > ( 0x07B0 ) ) eErrStatus = MB_MRE_ILL_ARG;
    else if ( xMBMasterRunResTake( lTimeOut ) == 0 ) eErrStatus = MB_MRE_MASTER_BUSY;
    else
    {
        vMBMasterGetPDUSndBuf(&ucMBFrame);
        ...
        ucMBFrame[( 1 + 4 )] = ucByteCount;
        ucMBFrame += ( 1 + 5 );
        while( ucByteCount > usRegIndex)
        {
            *ucMBFrame++ = pucDataBuffer[usRegIndex++];
        }
        vMBMasterSetPDUSndLength( 1 + ( 5 ) + ucByteCount );
        ( void ) xMBMasterPortEventPost( EV_MASTER_FRAME_SENT );
        eErrStatus = eMBMasterWaitRequestFinish( );
    }
    return eErrStatus;
...
eMBMasterFuncWriteMultipleCoils( UCHAR * pucFrame, USHORT * usLen )
{
    ...
    if( ( *usLen == ( 5 ) ) || xMBMasterRequestIsBroadcast() )
    {
        vMBMasterGetPDUSndBuf(&ucMBFrame);
        usRegAddress = ( USHORT )( pucFrame[( 1 )] << 8 );
        usRegAddress |= ( USHORT )( pucFrame[( 1 ) + 1] );
        ...
        {
            eRegStatus =
                eMBMasterRegCoilsCB( &ucMBFrame[( 1 + 5 )],
