# 1 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
# 1 "/home/dieter/Development/ProjektEi/build/tft//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
# 11 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
...
# 12 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 2
...
# 776 "/home/dieter/Development/esp-idf/components/driver/include/driver/gpio.h"
                                                    oen_inv);
# 14 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 2
...
# 15 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 2
...
# 18 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 2

# 1 "/home/dieter/Development/esp-idf/components/soc/esp32/include/soc/spi_reg.h" 1
# 20 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 2
...
# 38 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
                                   ((void *)0)
# 38 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
                                       ;
spi_lobo_device_handle_t ts_spi = 
# 39 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
                                 ((void *)0)
# 39 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
                                     ;
...
# 44 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
                             ((void *)0)
# 44 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
                                 ;
static uint8_t _dma_sending = 0;
# 58 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
esp_err_t __attribute__((section(".iram1" "." "3"))) wait_trans_finish(uint8_t free_line)
{
 ...
 if ((free_line) && (trans_cline)) {
  free(trans_cline);
  trans_cline = 
# 64 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
               ((void *)0)
# 64 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
                   ;
 }
 if (_dma_sending) {
...
esp_err_t __attribute__((section(".iram1" "." "4"))) disp_select()
{
 wait_trans_finish(1);
...
esp_err_t __attribute__((section(".iram1" "." "5"))) disp_deselect()
{
 wait_trans_finish(1);
...
static void __attribute__((section(".iram1" "." "6"))) _spi_transfer_start(spi_lobo_device_handle_t spi_dev, int wrbits, int rdbits) {
...
void __attribute__((section(".iram1" "." "7"))) disp_spi_transfer_cmd(int8_t cmd) {
...
void __attribute__((section(".iram1" "." "8"))) disp_spi_transfer_cmd_data(int8_t cmd, uint8_t *data, uint32_t len) {
 ...
 if ((len == 0) || (data == 
# 140 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
                           ((void *)0)
# 140 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
                               )) return;
...
static void __attribute__((section(".iram1" "." "9"))) disp_spi_transfer_addrwin(uint16_t x1, uint16_t x2, uint16_t y1, uint16_t y2) {
 uint32_t wd;
...
static color_t __attribute__((section(".iram1" "." "10"))) color2gs(color_t color)
{
 color_t _color;
...
void __attribute__((section(".iram1" "." "11"))) drawPixel(int16_t x, int16_t y, color_t color, uint8_t sel)
{
...
static void __attribute__((section(".iram1" "." "12"))) _dma_send(uint8_t *data, uint32_t size)
{
...
# 289 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
                                                                         0
# 289 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
                                                                              );
    disp_spi->host->hw->user.usr_mosi_highpart=0;
...
static void __attribute__((section(".iram1" "." "13"))) _direct_send(color_t *color, uint32_t len, uint8_t rep)
{
 uint32_t cidx = 0;
 uint32_t wd = 0;
 int idx = 0;
...
# 364 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
static void __attribute__((section(".iram1" "." "14"))) _TFT_pushColorRep(color_t *color, uint32_t len, uint8_t rep, uint8_t wait)
{
 if (len == 0) return;
 if (!(disp_spi->cfg.flags & (1<<4))) return;
...
# 410 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
  ...
  if (trans_cline == 
# 415 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
                    ((void *)0)
# 415 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
                        ) return;
...
void __attribute__((section(".iram1" "." "15"))) TFT_pushColorRep(int x1, int y1, int x2, int y2, color_t color, uint32_t len)
{
...
void __attribute__((section(".iram1" "." "16"))) send_data(int x1, int y1, int x2, int y2, uint32_t len, color_t *buf)
{
...
int __attribute__((section(".iram1" "." "17"))) read_data(int x1, int y1, int x2, int y2, int len, uint8_t *buf, uint8_t set_sp)
{
 ...
 disp_spi_transfer_cmd(0x2E);
    ...
    t.length=0;
    t.tx_buffer=
# 490 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
               ((void *)0)
# 490 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
                   ;
...
color_t __attribute__((section(".iram1" "." "18"))) readPixel(int16_t x, int16_t y)
{
...
int __attribute__((section(".iram1" "." "19"))) touch_get_data(uint8_t type)
{
# 543 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
...
# 561 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
static void __attribute__((section(".iram1" "." "20"))) stmpe610_write_reg(uint8_t reg, uint8_t val) {
...
static uint8_t __attribute__((section(".iram1" "." "21"))) stmpe610_read_byte(uint8_t reg) {
    spi_lobo_device_select(ts_spi, 0);
...
static uint16_t __attribute__((section(".iram1" "." "22"))) stmpe610_read_word(uint8_t reg) {
    spi_lobo_device_select(ts_spi, 0);
...
uint32_t find_rd_speed()
{
 ...
 uint32_t max_speed = 1000000;
    ...
    int line_check;
    color_t *color_line = 
# 678 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
                         ((void *)0)
# 678 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
                             ;
    uint8_t *line_rdbuf = 
# 679 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
                         ((void *)0)
# 679 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
                             ;
 ...
 color_line = malloc(_width*3);
    if (color_line == 
# 686 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
                     ((void *)0)
# 686 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
                         ) goto exit;

    line_rdbuf = malloc((_width*3)+1);
 if (line_rdbuf == 
# 689 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
                  ((void *)0)
# 689 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
                      ) goto exit;
...
# 822 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
    switch (rotation) {
        case 0:
...
# 852 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
 if (send) {
  if (disp_select() == 0) {
...
# 910 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
   ((
# 910 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
   ret==0
# 910 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/ProjektEi/components/tft/tftspi.c", 910, __func__, 
# 910 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
   "ret==ESP_OK"
# 910 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
   ))
...
# 936 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
     ((
# 936 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
     0
# 936 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
     ) ? (void)0 : __assert_func ("/home/dieter/Development/ProjektEi/components/tft/tftspi.c", 936, __func__, 
# 936 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
     "0"
# 936 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
     ))
...
# 939 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
((
# 939 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
ret==0
# 939 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
) ? (void)0 : __assert_func ("/home/dieter/Development/ProjektEi/components/tft/tftspi.c", 939, __func__, 
# 939 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c"
"ret==ESP_OK"
# 939 "/home/dieter/Development/ProjektEi/components/tft/tftspi.c" 3 4
))
