...
.LVL0:
.LFB1:
	.file 1 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_d_pcf8812.c"
	.loc 1 184 1 view -0
	.loc 1 184 1 is_stmt 0 view .LVU1
	entry	sp, 32
.LCFI0:
	.loc 1 185 5 is_stmt 1 view .LVU2
	.loc 1 184 1 is_stmt 0 view .LVU3
	extui	a3, a3, 0, 8
	.loc 1 185 8 view .LVU4
	movi.n	a8, 9
	.loc 1 184 1 view .LVU5
	extui	a4, a4, 0, 8
	.loc 1 185 8 view .LVU6
	bne	a3, a8, .L2
	.loc 1 187 7 is_stmt 1 view .LVU7
	l32r	a11, .LC0
	mov.n	a10, a2
	call8	u8x8_d_helper_display_setup_memory
.LVL1:
	.loc 1 188 7 view .LVU8
	j	.L14
.L2:
	.loc 1 190 5 view .LVU9
.LVL2:
.LBB4:
.LBI4:
...
.L5:
	...
	beq	a3, a8, .L8
.L12:
	.loc 1 153 14 is_stmt 0 view .LVU14
	movi.n	a2, 0
.LVL3:
	.loc 1 153 14 view .LVU15
	j	.L3
.LVL4:
.L6:
	.loc 1 93 7 is_stmt 1 view .LVU16
	mov.n	a10, a2
	call8	u8x8_d_helper_display_init
.LVL5:
	.loc 1 94 7 view .LVU17
	l32r	a11, .LC1
	j	.L15
.L4:
	.loc 1 97 7 view .LVU18
	.loc 1 98 2 is_stmt 0 view .LVU19
	l32r	a11, .LC2
	.loc 1 97 10 view .LVU20
	beqz.n	a4, .L15
.L9:
	.loc 1 100 2 is_stmt 1 view .LVU21
	l32r	a11, .LC3
.L15:
	.loc 1 100 2 is_stmt 0 view .LVU22
	mov.n	a10, a2
	call8	u8x8_cad_SendSequence
.LVL6:
	j	.L14
.L7:
	.loc 1 118 7 is_stmt 1 view .LVU23
	mov.n	a10, a2
	call8	u8x8_cad_StartTransfer
.LVL7:
	.loc 1 119 7 view .LVU24
	movi.n	a11, 0x21
	mov.n	a10, a2
	call8	u8x8_cad_SendCmd
.LVL8:
	.loc 1 120 7 view .LVU25
	srli	a4, a4, 1
.LVL9:
	.loc 1 120 7 is_stmt 0 view .LVU26
	movi	a11, 0x80
	or	a11, a4, a11
	mov.n	a10, a2
	call8	u8x8_cad_SendArg
.LVL10:
	.loc 1 121 7 is_stmt 1 view .LVU27
	j	.L13
.LVL11:
.L8:
	.loc 1 125 7 view .LVU28
	mov.n	a10, a2
	call8	u8x8_cad_StartTransfer
.LVL12:
	.loc 1 126 7 view .LVU29
	.loc 1 126 9 is_stmt 0 view .LVU30
	l8ui	a3, a5, 5
.LVL13:
	.loc 1 127 7 is_stmt 1 view .LVU31
	.loc 1 128 9 is_stmt 0 view .LVU32
	l8ui	a8, a2, 34
	.loc 1 130 7 view .LVU33
	movi.n	a11, 0x20
	.loc 1 127 9 view .LVU34
	slli	a3, a3, 3
.LVL14:
	.loc 1 128 7 is_stmt 1 view .LVU35
	.loc 1 130 7 is_stmt 0 view .LVU36
	mov.n	a10, a2
	.loc 1 128 9 view .LVU37
	add.n	a3, a3, a8
.LVL15:
	.loc 1 130 7 view .LVU38
	call8	u8x8_cad_SendCmd
.LVL16:
	.loc 1 128 9 view .LVU39
	extui	a3, a3, 0, 8
.LVL17:
	.loc 1 130 7 is_stmt 1 view .LVU40
	.loc 1 131 7 view .LVU41
	movi	a11, 0x80
	or	a11, a3, a11
	mov.n	a10, a2
	call8	u8x8_cad_SendCmd
.LVL18:
	.loc 1 132 7 view .LVU42
	l8ui	a11, a5, 6
	movi.n	a3, 0x40
.LVL19:
	.loc 1 132 7 is_stmt 0 view .LVU43
	or	a11, a11, a3
	mov.n	a10, a2
	call8	u8x8_cad_SendCmd
.LVL20:
.L10:
	.loc 1 134 7 is_stmt 1 view .LVU44
	.loc 1 136 2 view .LVU45
	.loc 1 137 2 view .LVU46
	.loc 1 138 2 view .LVU47
	l8ui	a11, a5, 4
	l32i.n	a12, a5, 0
	slli	a11, a11, 3
	.loc 1 147 9 is_stmt 0 view .LVU48
	addi.n	a4, a4, -1
.LVL21:
	.loc 1 138 2 view .LVU49
	extui	a11, a11, 0, 8
	mov.n	a10, a2
	.loc 1 147 9 view .LVU50
	extui	a4, a4, 0, 8
.LVL22:
	.loc 1 138 2 view .LVU51
	call8	u8x8_cad_SendData
.LVL23:
	.loc 1 147 2 is_stmt 1 view .LVU52
	.loc 1 148 7 is_stmt 0 view .LVU53
	bnez.n	a4, .L10
.LVL24:
.L13:
...
.L14:
	...
	.loc 1 155 10 is_stmt 0 view .LVU56
	movi.n	a2, 1
.LVL26:
.L3:
	.loc 1 155 10 view .LVU57
.LBE5:
.LBE4:
	.loc 1 191 1 view .LVU58
	retw.n
.LFE1:
	.size	u8x8_d_pcf8812_96x65, .-u8x8_d_pcf8812_96x65
	.section	.rodata.u8x8_pcf8812_96x65_display_info,"a"
	.align	4
...
u8x8_pcf8812_96x65_display_info:
	...
	.short	96
	.short	65
	.section	.rodata.u8x8_d_pcf8812_96x65_powersave1_seq,"a"
...
u8x8_d_pcf8812_96x65_powersave1_seq:
	...
	.byte	25
	.byte	-1
	.section	.rodata.u8x8_d_pcf8812_96x65_powersave0_seq,"a"
...
u8x8_d_pcf8812_96x65_powersave0_seq:
	...
	.byte	25
	.byte	-1
	.section	.rodata.u8x8_d_pcf8812_96x65_init_seq,"a"
...
.LASF209:
	.string	"/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_d_pcf8812.c"
.LASF104:
