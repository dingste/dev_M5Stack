# 1 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c"
# 1 "/home/dieter/Development/ProjektEi/build/u8g2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c"
# 38 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c"
...
# 39 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c" 2
...
uint8_t u8x8_GetStringLineCnt(const char *str)
{
  ...
  uint8_t line_cnt = 1;
  if ( str == 
# 44 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c" 3 4
             ((void *)0) 
# 44 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c"
                  )
    return 0;
  for(;;)
  {
...
# 66 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c"
const char *u8x8_GetStringLineStart(uint8_t line_idx, const char *str )
{
  char e;
  uint8_t line_cnt = 1;
 ...
 return str;
  ...
  return 
# 87 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c" 3 4
        ((void *)0)
# 87 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c"
            ;
}
...
{
  if ( dest == 
# 95 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c" 3 4
              ((void *)0) 
# 95 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c"
                   )
    return;
  str = u8x8_GetStringLineStart( line_idx, str );
  if ( str != 
# 98 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c" 3 4
             ((void *)0) 
# 98 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c"
                  )
  {
    for(;;)
    {
...
# 119 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c"
uint8_t u8x8_DrawUTF8Line(u8x8_t *u8x8, uint8_t x, uint8_t y, uint8_t w, const char *s)
{
  uint8_t d, lw;
  uint8_t cx, dx;
...
# 159 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_string.c"
uint8_t u8x8_DrawUTF8Lines(u8x8_t *u8x8, uint8_t x, uint8_t y, uint8_t w, const char *s)
{
  uint8_t i;
  uint8_t cnt;
