...
.LVL0:
.LFB0:
	.file 1 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_d_uc1604.c"
	.loc 1 77 1 view -0
...
.LCFI0:
	...
	extui	a3, a3, 0, 8
	.loc 1 77 1 view .LVU6
	movi.n	a8, 0xd
	extui	a4, a4, 0, 8
	.loc 1 77 1 view .LVU7
	beq	a3, a8, .L2
	bltu	a8, a3, .L3
	movi.n	a5, 0xb
.LVL1:
	.loc 1 142 14 view .LVU8
	movi.n	a8, 0
	bne	a3, a5, .L5
	j	.L4
.LVL2:
.L3:
	.loc 1 142 14 view .LVU9
	movi.n	a8, 0xe
	beq	a3, a8, .L6
	movi.n	a9, 0xf
	movi.n	a8, 0
	bne	a3, a9, .L5
	.loc 1 83 7 is_stmt 1 view .LVU10
	mov.n	a10, a2
	call8	u8x8_cad_StartTransfer
.LVL3:
	.loc 1 85 7 view .LVU11
	.loc 1 85 9 is_stmt 0 view .LVU12
	l8ui	a3, a5, 5
.LVL4:
	.loc 1 86 7 is_stmt 1 view .LVU13
	.loc 1 88 7 is_stmt 0 view .LVU14
	mov.n	a10, a2
	.loc 1 86 9 view .LVU15
	slli	a3, a3, 3
	extui	a3, a3, 0, 8
.LVL5:
	.loc 1 88 7 is_stmt 1 view .LVU16
	extui	a11, a3, 0, 4
	call8	u8x8_cad_SendCmd
.LVL6:
	.loc 1 89 7 view .LVU17
	srli	a3, a3, 4
.LVL7:
	.loc 1 89 7 is_stmt 0 view .LVU18
	movi.n	a11, 0x10
	or	a11, a3, a11
	mov.n	a10, a2
	call8	u8x8_cad_SendCmd
.LVL8:
	.loc 1 91 7 is_stmt 1 view .LVU19
	.loc 1 92 9 is_stmt 0 view .LVU20
	l8ui	a11, a2, 34
	.loc 1 91 9 view .LVU21
	l8ui	a3, a5, 6
.LVL9:
	.loc 1 92 7 is_stmt 1 view .LVU22
	.loc 1 93 7 view .LVU23
	mov.n	a10, a2
	.loc 1 92 9 is_stmt 0 view .LVU24
	add.n	a3, a3, a11
.LVL10:
	.loc 1 93 40 view .LVU25
	extui	a3, a3, 0, 4
	.loc 1 93 7 view .LVU26
	movi	a11, 0xb0
	or	a11, a3, a11
	call8	u8x8_cad_SendCmd
.LVL11:
	.loc 1 95 7 is_stmt 1 view .LVU27
	.loc 1 95 9 is_stmt 0 view .LVU28
	l8ui	a3, a5, 4
.LVL12:
	.loc 1 96 7 is_stmt 1 view .LVU29
	.loc 1 97 11 is_stmt 0 view .LVU30
	l32i.n	a5, a5, 0
.LVL13:
	.loc 1 96 9 view .LVU31
	slli	a3, a3, 3
.LVL14:
	.loc 1 96 9 view .LVU32
	extui	a3, a3, 0, 8
.LVL15:
	.loc 1 97 7 is_stmt 1 view .LVU33
.L7:
	.loc 1 98 7 discriminator 1 view .LVU34
	.loc 1 100 2 discriminator 1 view .LVU35
	.loc 1 101 9 is_stmt 0 discriminator 1 view .LVU36
	addi.n	a4, a4, -1
.LVL16:
	.loc 1 100 2 discriminator 1 view .LVU37
	mov.n	a12, a5
	mov.n	a11, a3
	mov.n	a10, a2
	.loc 1 101 9 discriminator 1 view .LVU38
	extui	a4, a4, 0, 8
.LVL17:
	.loc 1 100 2 discriminator 1 view .LVU39
	call8	u8x8_cad_SendData
.LVL18:
	.loc 1 101 2 is_stmt 1 discriminator 1 view .LVU40
	.loc 1 102 7 is_stmt 0 discriminator 1 view .LVU41
	bnez.n	a4, .L7
	.loc 1 104 7 is_stmt 1 view .LVU42
	j	.L13
.LVL19:
.L4:
	.loc 1 116 7 view .LVU43
	.loc 1 117 2 is_stmt 0 view .LVU44
	l32r	a11, .LC0
	.loc 1 116 10 view .LVU45
	beqz.n	a4, .L15
.L8:
	.loc 1 119 2 is_stmt 1 view .LVU46
	l32r	a11, .LC1
.L15:
	mov.n	a10, a2
...
.LVL21:
.L2:
	.loc 1 122 7 view .LVU47
	.loc 1 122 10 is_stmt 0 view .LVU48
	bnez.n	a4, .L9
	.loc 1 124 2 is_stmt 1 view .LVU49
	l32r	a11, .LC2
	mov.n	a10, a2
	call8	u8x8_cad_SendSequence
.LVL22:
	.loc 1 125 2 view .LVU50
	.loc 1 125 37 is_stmt 0 view .LVU51
	l32i.n	a3, a2, 0
	.loc 1 125 17 view .LVU52
	l8ui	a3, a3, 18
	j	.L14
.L9:
	.loc 1 129 2 is_stmt 1 view .LVU53
	l32r	a11, .LC3
	mov.n	a10, a2
	call8	u8x8_cad_SendSequence
.LVL23:
	.loc 1 130 2 view .LVU54
	.loc 1 130 37 is_stmt 0 view .LVU55
	l32i.n	a3, a2, 0
	.loc 1 130 17 view .LVU56
	l8ui	a3, a3, 19
.L14:
	.loc 1 130 17 view .LVU57
	s8i	a3, a2, 34
	j	.L12
.L6:
	.loc 1 135 7 is_stmt 1 view .LVU58
	mov.n	a10, a2
	call8	u8x8_cad_StartTransfer
.LVL24:
	.loc 1 136 7 view .LVU59
	movi	a11, 0x81
	mov.n	a10, a2
	call8	u8x8_cad_SendCmd
.LVL25:
	.loc 1 137 7 view .LVU60
	mov.n	a11, a4
	mov.n	a10, a2
	call8	u8x8_cad_SendArg
.LVL26:
.L13:
	.loc 1 138 7 view .LVU61
	mov.n	a10, a2
	call8	u8x8_cad_EndTransfer
.LVL27:
.L12:
	.loc 1 139 7 view .LVU62
	.loc 1 144 10 is_stmt 0 view .LVU63
	movi.n	a8, 1
.L5:
	.loc 1 145 1 view .LVU64
	mov.n	a2, a8
.LVL28:
	.loc 1 145 1 view .LVU65
	retw.n
.LFE0:
...
.LFB1:
	...
	.loc 1 219 1 is_stmt 0 view .LVU67
	entry	sp, 32
.LCFI1:
	.loc 1 221 3 is_stmt 1 view .LVU68
	.loc 1 219 1 is_stmt 0 view .LVU69
	extui	a3, a3, 0, 8
	.loc 1 221 8 view .LVU70
	mov.n	a13, a5
	extui	a12, a4, 0, 8
	mov.n	a11, a3
	mov.n	a10, a2
...
.LVL30:
	.loc 1 221 6 view .LVU71
	bnez.n	a10, .L20
	.loc 1 224 5 is_stmt 1 view .LVU72
	movi.n	a8, 9
	beq	a3, a8, .L18
	beqi	a3, 10, .L19
	j	.L17
...
.LVL31:
	.loc 1 228 2 view .LVU74
	j	.L20
.L19:
	.loc 1 230 2 view .LVU75
	mov.n	a10, a2
	call8	u8x8_d_helper_display_init
.LVL32:
	.loc 1 231 2 view .LVU76
	l32r	a11, .LC5
	mov.n	a10, a2
	call8	u8x8_cad_SendSequence
.LVL33:
	.loc 1 232 2 view .LVU77
.L20:
	.loc 1 237 10 is_stmt 0 view .LVU78
	movi.n	a10, 1
.L17:
	.loc 1 238 1 view .LVU79
	mov.n	a2, a10
.LVL34:
	.loc 1 238 1 view .LVU80
	retw.n
.LFE1:
	.size	u8x8_d_uc1604_jlx19264, .-u8x8_d_uc1604_jlx19264
	.section	.rodata.u8x8_d_uc1604_jlx19264_init_seq,"a"
...
u8x8_d_uc1604_jlx19264_init_seq:
	...
	.byte	25
	.byte	-1
	.section	.rodata.u8x8_uc1604_192x64_display_info,"a"
	.align	4
...
u8x8_uc1604_192x64_display_info:
	...
	.short	192
	.short	64
	.section	.rodata.u8x8_d_uc1604_flip1_seq,"a"
...
u8x8_d_uc1604_flip1_seq:
	...
	.byte	25
	.byte	-1
	.section	.rodata.u8x8_d_uc1604_flip0_seq,"a"
...
u8x8_d_uc1604_flip0_seq:
	...
	.byte	25
	.byte	-1
	.section	.rodata.u8x8_d_uc1604_powersave1_seq,"a"
...
u8x8_d_uc1604_powersave1_seq:
	...
	.byte	25
	.byte	-1
	.section	.rodata.u8x8_d_uc1604_powersave0_seq,"a"
...
.LASF213:
	.string	"/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_d_uc1604.c"
.LASF96:
