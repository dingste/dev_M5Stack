...
.LVL0:
.LFB0:
	.file 1 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_d_uc1601.c"
	.loc 1 123 1 view -0
...
.LCFI0:
	...
	addi	a3, a3, -9
.LVL1:
	.loc 1 126 3 is_stmt 0 view .LVU5
	extui	a3, a3, 0, 8
	.loc 1 123 1 view .LVU6
	extui	a4, a4, 0, 8
	.loc 1 126 3 view .LVU7
	bgeui	a3, 7, .L13
	l32r	a8, .LC0
	slli	a3, a3, 2
	add.n	a3, a8, a3
...
.L9:
	.loc 1 129 7 is_stmt 1 view .LVU8
	l32r	a11, .LC1
	mov.n	a10, a2
	call8	u8x8_d_helper_display_setup_memory
.LVL2:
	.loc 1 130 7 view .LVU9
	j	.L15
.L8:
	.loc 1 132 7 view .LVU10
	mov.n	a10, a2
...
.L7:
	...
	.loc 1 137 2 is_stmt 0 view .LVU13
	l32r	a11, .LC3
	.loc 1 136 10 view .LVU14
	beqz.n	a4, .L17
.L10:
	.loc 1 139 2 is_stmt 1 view .LVU15
	l32r	a11, .LC4
.L17:
	mov.n	a10, a2
...
.L6:
	...
	.loc 1 142 10 is_stmt 0 view .LVU17
	bnez.n	a4, .L11
	.loc 1 144 2 is_stmt 1 view .LVU18
	l32r	a11, .LC5
	mov.n	a10, a2
	call8	u8x8_cad_SendSequence
.LVL5:
	.loc 1 145 2 view .LVU19
	.loc 1 145 37 is_stmt 0 view .LVU20
	l32i.n	a3, a2, 0
	.loc 1 145 17 view .LVU21
	l8ui	a3, a3, 18
	j	.L18
.L11:
	.loc 1 149 2 is_stmt 1 view .LVU22
	l32r	a11, .LC6
	mov.n	a10, a2
	call8	u8x8_cad_SendSequence
.LVL6:
	.loc 1 150 2 view .LVU23
	.loc 1 150 37 is_stmt 0 view .LVU24
	l32i.n	a3, a2, 0
	.loc 1 150 17 view .LVU25
	l8ui	a3, a3, 19
.L18:
	.loc 1 150 17 view .LVU26
	s8i	a3, a2, 34
	j	.L15
.L5:
	.loc 1 155 7 is_stmt 1 view .LVU27
	mov.n	a10, a2
	call8	u8x8_cad_StartTransfer
.LVL7:
	.loc 1 156 7 view .LVU28
	movi	a11, 0x81
	mov.n	a10, a2
	call8	u8x8_cad_SendCmd
.LVL8:
	.loc 1 157 7 view .LVU29
	mov.n	a11, a4
	mov.n	a10, a2
	call8	u8x8_cad_SendArg
.LVL9:
.L16:
	.loc 1 158 7 view .LVU30
	mov.n	a10, a2
	call8	u8x8_cad_EndTransfer
.LVL10:
.L15:
	.loc 1 159 7 view .LVU31
	.loc 1 185 10 is_stmt 0 view .LVU32
	movi.n	a2, 1
.LVL11:
	.loc 1 159 7 view .LVU33
	j	.L2
.LVL12:
.L3:
	.loc 1 162 7 is_stmt 1 view .LVU34
	mov.n	a10, a2
	call8	u8x8_cad_StartTransfer
.LVL13:
	.loc 1 164 7 view .LVU35
	.loc 1 164 9 is_stmt 0 view .LVU36
	l8ui	a3, a5, 5
.LVL14:
	.loc 1 165 7 is_stmt 1 view .LVU37
	.loc 1 166 9 is_stmt 0 view .LVU38
	l8ui	a8, a2, 34
	.loc 1 165 9 view .LVU39
	slli	a3, a3, 3
.LVL15:
	.loc 1 166 7 is_stmt 1 view .LVU40
	.loc 1 166 9 is_stmt 0 view .LVU41
	add.n	a3, a3, a8
.LVL16:
	.loc 1 166 9 view .LVU42
	extui	a3, a3, 0, 8
.LVL17:
	.loc 1 167 7 is_stmt 1 view .LVU43
	movi.n	a8, 0x10
	srli	a11, a3, 4
	or	a11, a11, a8
	mov.n	a10, a2
	call8	u8x8_cad_SendCmd
.LVL18:
	.loc 1 168 7 view .LVU44
	extui	a11, a3, 0, 4
	mov.n	a10, a2
	call8	u8x8_cad_SendCmd
.LVL19:
	.loc 1 169 7 view .LVU45
	l8ui	a3, a5, 6
.LVL20:
	.loc 1 169 7 is_stmt 0 view .LVU46
	movi	a11, 0xb0
	or	a11, a11, a3
	mov.n	a10, a2
	call8	u8x8_cad_SendCmd
.LVL21:
	...
	.loc 1 171 9 is_stmt 0 view .LVU48
	l8ui	a3, a5, 4
.LVL22:
	.loc 1 172 7 is_stmt 1 view .LVU49
	.loc 1 173 11 is_stmt 0 view .LVU50
	l32i.n	a5, a5, 0
.LVL23:
	.loc 1 172 9 view .LVU51
	slli	a3, a3, 3
.LVL24:
	.loc 1 172 9 view .LVU52
	extui	a3, a3, 0, 8
.LVL25:
	.loc 1 173 7 is_stmt 1 view .LVU53
.L12:
	.loc 1 174 7 discriminator 1 view .LVU54
	.loc 1 176 2 discriminator 1 view .LVU55
	.loc 1 177 9 is_stmt 0 discriminator 1 view .LVU56
	addi.n	a4, a4, -1
.LVL26:
	.loc 1 176 2 discriminator 1 view .LVU57
	mov.n	a12, a5
	mov.n	a11, a3
	mov.n	a10, a2
	.loc 1 177 9 discriminator 1 view .LVU58
	extui	a4, a4, 0, 8
.LVL27:
	.loc 1 176 2 discriminator 1 view .LVU59
	call8	u8x8_cad_SendData
.LVL28:
	.loc 1 177 2 is_stmt 1 discriminator 1 view .LVU60
	.loc 1 178 7 is_stmt 0 discriminator 1 view .LVU61
	bnez.n	a4, .L12
	.loc 1 180 7 is_stmt 1 view .LVU62
	j	.L16
.LVL29:
.L13:
	.loc 1 183 14 is_stmt 0 view .LVU63
	movi.n	a2, 0
.LVL30:
.L2:
	.loc 1 186 1 view .LVU64
	retw.n
.LFE0:
	.size	u8x8_d_uc1601_128x32, .-u8x8_d_uc1601_128x32
	.section	.rodata.u8x8_d_uc1601_128x32_init_seq,"a"
...
u8x8_d_uc1601_128x32_init_seq:
	...
	.byte	25
	.byte	-1
	.section	.rodata.u8x8_uc1601_128x32_display_info,"a"
	.align	4
...
u8x8_uc1601_128x32_display_info:
	...
	.short	128
	.short	32
	.section	.rodata.u8x8_d_uc1601_128x32_flip1_seq,"a"
...
u8x8_d_uc1601_128x32_flip1_seq:
	...
	.byte	25
	.byte	-1
	.section	.rodata.u8x8_d_uc1601_128x32_flip0_seq,"a"
...
u8x8_d_uc1601_128x32_flip0_seq:
	...
	.byte	25
	.byte	-1
	.section	.rodata.u8x8_d_uc1601_128x32_powersave1_seq,"a"
...
u8x8_d_uc1601_128x32_powersave1_seq:
	...
	.byte	25
	.byte	-1
	.section	.rodata.u8x8_d_uc1601_128x32_powersave0_seq,"a"
...
.LASF211:
	.string	"/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_d_uc1601.c"
.LASF138:
