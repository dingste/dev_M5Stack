...
.LVL0:
.LFB0:
	.file 1 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_d_ls013b7dh03.c"
	.loc 1 71 1 view -0
...
.LCFI0:
	...
	.loc 1 71 1 is_stmt 0 view .LVU5
	extui	a3, a3, 0, 8
...
.L3:
	movi.n	a6, 0xb
	.loc 1 121 10 view .LVU8
	movi.n	a4, 1
	beq	a3, a6, .L5
	movi.n	a4, 0xf
	beq	a3, a4, .L6
.L12:
	.loc 1 119 14 view .LVU9
	movi.n	a4, 0
	j	.L5
.L4:
	.loc 1 77 7 is_stmt 1 view .LVU10
	l32r	a11, .LC0
	mov.n	a10, a2
	call8	u8x8_d_helper_display_setup_memory
.LVL2:
	.loc 1 78 7 view .LVU11
	j	.L10
.LVL3:
.L2:
	.loc 1 80 7 view .LVU12
	mov.n	a10, a2
	call8	u8x8_d_helper_display_init
.LVL4:
	.loc 1 83 7 view .LVU13
	mov.n	a10, a2
	call8	u8x8_cad_StartTransfer
.LVL5:
	.loc 1 84 7 view .LVU14
	movi.n	a11, 0x20
	mov.n	a10, a2
	call8	u8x8_cad_SendCmd
.LVL6:
	.loc 1 85 7 view .LVU15
	j	.L11
.LVL7:
.L6:
.LBB4:
.LBB5:
	.loc 1 94 7 view .LVU16
	.loc 1 94 51 is_stmt 0 view .LVU17
	l8ui	a7, a5, 6
	.loc 1 100 7 view .LVU18
	mov.n	a10, a2
	.loc 1 94 51 view .LVU19
	slli	a7, a7, 3
	extui	a7, a7, 0, 8
	.loc 1 96 9 view .LVU20
	l8ui	a6, a5, 4
	.loc 1 97 11 view .LVU21
	l32i.n	a4, a5, 0
	.loc 1 100 7 view .LVU22
	call8	u8x8_cad_StartTransfer
.LVL8:
	.loc 1 94 9 view .LVU23
	addi.n	a3, a7, 1
.LVL9:
	.loc 1 94 9 view .LVU24
	addi.n	a5, a7, 9
.LVL10:
	...
	extui	a3, a3, 0, 8
.LVL11:
	.loc 1 96 7 is_stmt 1 view .LVU27
	.loc 1 97 7 view .LVU28
	.loc 1 100 7 view .LVU29
	.loc 1 101 7 view .LVU30
	call8	u8x8_cad_SendCmd
.LVL12:
	.loc 1 104 7 view .LVU31
	.loc 1 104 7 is_stmt 0 view .LVU32
	extui	a5, a5, 0, 8
	.loc 1 106 155 view .LVU33
	movi.n	a7, 0x10
.LVL13:
.L7:
	.loc 1 106 9 is_stmt 1 view .LVU34
	.loc 1 106 155 is_stmt 0 view .LVU35
	slli	a11, a3, 1
	and	a11, a11, a7
	.loc 1 106 51 view .LVU36
	srli	a8, a3, 7
	.loc 1 106 213 view .LVU37
	or	a8, a11, a8
	slli	a11, a3, 7
	or	a11, a11, a8
	.loc 1 106 181 view .LVU38
	movi.n	a9, 0x20
	slli	a8, a3, 3
	and	a8, a8, a9
	.loc 1 106 213 view .LVU39
	or	a11, a11, a8
	.loc 1 106 207 view .LVU40
	movi.n	a9, 0x40
	slli	a8, a3, 5
	and	a8, a8, a9
	.loc 1 106 213 view .LVU41
	or	a11, a11, a8
	.loc 1 106 77 view .LVU42
	movi.n	a9, 2
	srai	a8, a3, 5
	and	a8, a8, a9
	.loc 1 106 213 view .LVU43
	or	a11, a11, a8
	.loc 1 106 103 view .LVU44
	movi.n	a9, 4
	srai	a8, a3, 3
	and	a8, a8, a9
	.loc 1 106 213 view .LVU45
	or	a11, a11, a8
	.loc 1 106 129 view .LVU46
	movi.n	a9, 8
	srai	a8, a3, 1
	and	a8, a8, a9
	.loc 1 106 213 view .LVU47
	or	a11, a11, a8
	...
	call8	u8x8_cad_SendCmd
.LVL14:
	.loc 1 107 9 is_stmt 1 view .LVU49
	mov.n	a12, a4
	mov.n	a11, a6
	mov.n	a10, a2
	call8	u8x8_cad_SendData
.LVL15:
	.loc 1 108 9 view .LVU50
	addi.n	a3, a3, 1
	movi.n	a11, 0
	mov.n	a10, a2
	extui	a3, a3, 0, 8
...
.LVL16:
	...
	.loc 1 110 13 is_stmt 0 view .LVU52
	add.n	a4, a4, a6
.LVL17:
	.loc 1 104 7 view .LVU53
	bne	a5, a3, .L7
.LVL18:
.L11:
	.loc 1 114 7 is_stmt 1 view .LVU54
	movi.n	a11, 0
	mov.n	a10, a2
	call8	u8x8_cad_SendCmd
.LVL19:
	.loc 1 115 7 view .LVU55
	mov.n	a10, a2
	call8	u8x8_cad_EndTransfer
.LVL20:
.L10:
	.loc 1 117 7 view .LVU56
	.loc 1 115 7 is_stmt 0 view .LVU57
	movi.n	a4, 1
.L5:
.LBE5:
.LBE4:
...
.LFB1:
	...
	.loc 1 149 1 is_stmt 0 view .LVU61
	entry	sp, 32
.LCFI1:
	.loc 1 150 3 is_stmt 1 view .LVU62
	.loc 1 149 1 is_stmt 0 view .LVU63
	extui	a11, a3, 0, 8
	.loc 1 150 3 view .LVU64
	movi.n	a8, 9
	.loc 1 149 1 view .LVU65
	mov.n	a10, a2
	mov.n	a13, a5
	extui	a12, a4, 0, 8
	.loc 1 150 3 view .LVU66
	bne	a11, a8, .L14
	.loc 1 153 7 is_stmt 1 view .LVU67
	l32r	a11, .LC1
	call8	u8x8_d_helper_display_setup_memory
.LVL23:
	.loc 1 154 7 view .LVU68
	.loc 1 158 3 view .LVU69
	.loc 1 158 10 is_stmt 0 view .LVU70
	movi.n	a10, 1
	j	.L15
.L14:
	.loc 1 156 7 is_stmt 1 view .LVU71
	.loc 1 156 14 is_stmt 0 view .LVU72
	call8	u8x8_d_ls013b7dh03_128x128
.LVL24:
.L15:
	.loc 1 159 1 view .LVU73
	mov.n	a2, a10
.LVL25:
	.loc 1 159 1 view .LVU74
	retw.n
.LFE1:
...
.LFB2:
	...
	.loc 1 185 1 is_stmt 0 view .LVU76
	entry	sp, 32
.LCFI2:
	.loc 1 186 3 is_stmt 1 view .LVU77
	.loc 1 185 1 is_stmt 0 view .LVU78
	extui	a11, a3, 0, 8
	.loc 1 186 3 view .LVU79
	movi.n	a8, 9
	.loc 1 185 1 view .LVU80
	mov.n	a10, a2
	mov.n	a13, a5
	extui	a12, a4, 0, 8
	.loc 1 186 3 view .LVU81
	bne	a11, a8, .L17
	.loc 1 189 7 is_stmt 1 view .LVU82
	l32r	a11, .LC2
	call8	u8x8_d_helper_display_setup_memory
.LVL27:
	.loc 1 190 7 view .LVU83
	.loc 1 194 3 view .LVU84
	.loc 1 194 10 is_stmt 0 view .LVU85
	movi.n	a10, 1
	j	.L18
.L17:
	.loc 1 192 7 is_stmt 1 view .LVU86
	.loc 1 192 14 is_stmt 0 view .LVU87
	call8	u8x8_d_ls013b7dh03_128x128
.LVL28:
.L18:
	...
	mov.n	a2, a10
.LVL29:
	.loc 1 195 1 view .LVU89
	retw.n
.LFE2:
	.size	u8x8_d_ls013b7dh05_144x168, .-u8x8_d_ls013b7dh05_144x168
	.section	.rodata.u8x8_ls013b7dh05_144x168_display_info,"a"
	.align	4
...
u8x8_ls013b7dh05_144x168_display_info:
	...
	.short	144
	.short	168
	.section	.rodata.u8x8_ls027b7dh01_400x240_display_info,"a"
	.align	4
...
u8x8_ls027b7dh01_400x240_display_info:
	...
	.short	400
	.short	240
	.section	.rodata.u8x8_ls013b7dh03_128x128_display_info,"a"
	.align	4
...
.LASF208:
	.string	"/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8x8_d_ls013b7dh03.c"
.LASF126:
