...
.LVL0:
.LFB0:
	.file 1 "/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8g2_kerning.c"
	.loc 1 48 1 view -0
	.loc 1 48 1 is_stmt 0 view .LVU1
	entry	sp, 32
.LCFI0:
	.loc 1 49 3 is_stmt 1 view .LVU2
	.loc 1 50 3 view .LVU3
	.loc 1 48 1 is_stmt 0 view .LVU4
	extui	a4, a4, 0, 16
	.loc 1 48 1 view .LVU5
	extui	a5, a5, 0, 16
	.loc 1 51 12 view .LVU6
	mov.n	a2, a3
.LVL1:
	.loc 1 50 6 view .LVU7
	beqz.n	a3, .L10
	.loc 1 54 3 is_stmt 1 view .LVU8
	.loc 1 54 7 is_stmt 0 view .LVU9
	l16ui	a9, a3, 0
.LVL2:
	.loc 1 55 3 is_stmt 1 view .LVU10
	.loc 1 56 3 is_stmt 0 view .LVU11
	movi.n	a8, 0
	.loc 1 55 6 view .LVU12
	addi.n	a9, a9, -1
	extui	a9, a9, 0, 16
.LVL3:
	.loc 1 56 3 is_stmt 1 view .LVU13
	.loc 1 56 3 is_stmt 0 view .LVU14
	j	.L3
.LVL4:
.L5:
	.loc 1 58 5 is_stmt 1 view .LVU15
	.loc 1 58 39 is_stmt 0 view .LVU16
	l32i.n	a10, a3, 4
	slli	a11, a8, 1
	add.n	a10, a10, a11
	.loc 1 58 8 view .LVU17
	l16ui	a2, a10, 0
	addi.n	a8, a8, 1
.LVL5:
	.loc 1 58 8 view .LVU18
	beq	a2, a4, .L4
.LVL6:
.L3:
	.loc 1 56 3 discriminator 1 view .LVU19
	extui	a2, a8, 0, 16
	bltu	a2, a9, .L5
	j	.L11
.LVL7:
.L7:
	...
	.loc 1 68 40 is_stmt 0 view .LVU21
	l32i.n	a2, a3, 12
	slli	a11, a8, 1
	add.n	a2, a2, a11
	.loc 1 68 8 view .LVU22
	l16ui	a2, a2, 0
	addi.n	a10, a8, 1
	beq	a2, a5, .L6
	.loc 1 68 8 view .LVU23
	mov.n	a8, a10
.LVL8:
.L8:
	.loc 1 66 3 discriminator 1 view .LVU24
	extui	a2, a8, 0, 16
	bltu	a2, a9, .L7
.LVL9:
.L11:
	.loc 1 51 12 view .LVU25
	movi.n	a2, 0
	j	.L10
.LVL10:
.L6:
	.loc 1 72 3 is_stmt 1 view .LVU26
	.loc 1 75 3 view .LVU27
	.loc 1 75 33 is_stmt 0 view .LVU28
	l32i.n	a2, a3, 16
	add.n	a8, a2, a8
.LVL11:
	.loc 1 75 33 view .LVU29
	l8ui	a2, a8, 0
	j	.L10
.LVL12:
.L4:
	...
	.loc 1 65 16 is_stmt 0 view .LVU32
	l32i.n	a2, a3, 8
	.loc 1 65 7 view .LVU33
	slli	a8, a8, 1
.LVL13:
	.loc 1 65 7 view .LVU34
	add.n	a8, a2, a8
	.loc 1 66 11 view .LVU35
	add.n	a2, a2, a11
	.loc 1 65 7 view .LVU36
	l16ui	a9, a8, 0
.LVL14:
	.loc 1 66 3 is_stmt 1 view .LVU37
	l16ui	a8, a2, 0
.LVL15:
	.loc 1 66 3 is_stmt 0 view .LVU38
	j	.L8
.LVL16:
.L10:
	.loc 1 76 1 view .LVU39
	retw.n
.LFE0:
...
.LVL18:
	...
	extui	a4, a4, 0, 16
	.loc 1 79 1 view .LVU46
	extui	a5, a5, 0, 16
	.loc 1 83 12 view .LVU47
	mov.n	a2, a3
.LVL19:
	.loc 1 82 6 view .LVU48
	beqz.n	a3, .L13
	.loc 1 86 8 view .LVU49
	l32r	a10, .LC0
	.loc 1 81 5 view .LVU50
	movi.n	a8, 0
.LVL20:
.L15:
	.loc 1 84 3 is_stmt 1 view .LVU51
	.loc 1 86 5 view .LVU52
	.loc 1 86 12 is_stmt 0 view .LVU53
	slli	a9, a8, 1
	add.n	a9, a3, a9
	l16ui	a2, a9, 0
	.loc 1 86 8 view .LVU54
	beq	a2, a10, .L17
	.loc 1 88 5 is_stmt 1 view .LVU55
	.loc 1 88 8 is_stmt 0 view .LVU56
	bne	a2, a4, .L14
	.loc 1 88 22 discriminator 1 view .LVU57
	l16ui	a2, a9, 2
	bne	a2, a5, .L14
	...
	addi.n	a8, a8, 2
.LVL21:
	.loc 1 89 16 view .LVU60
	slli	a8, a8, 1
.LVL22:
	.loc 1 89 16 view .LVU61
	add.n	a8, a3, a8
	l8ui	a2, a8, 0
	j	.L13
.LVL23:
.L14:
	...
	.loc 1 90 6 is_stmt 0 view .LVU63
	addi.n	a8, a8, 3
.LVL24:
	.loc 1 90 6 view .LVU64
	extui	a8, a8, 0, 16
.LVL25:
	.loc 1 86 8 view .LVU65
	j	.L15
.L17:
	.loc 1 83 12 view .LVU66
	movi.n	a2, 0
.LVL26:
.L13:
	.loc 1 93 1 view .LVU67
	retw.n
.LFE1:
...
.LASF1973:
	.string	"/home/dieter/Development/ProjektEi/components/u8g2/csrc/u8g2_kerning.c"
.LASF305:
