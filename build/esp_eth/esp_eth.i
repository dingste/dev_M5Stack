# 1 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_eth//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
# 14 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
...
# 15 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 2
...
# 21 "/home/dieter/Development/esp-idf/components/esp_eth/include/esp_eth_com.h" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 2
...
# 21 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 2

# 1 "/home/dieter/Development/esp-idf/components/tcpip_adapter/include/tcpip_adapter_compatible/tcpip_adapter_compat.h" 1
# 29 "/home/dieter/Development/esp-idf/components/tcpip_adapter/include/tcpip_adapter_compatible/tcpip_adapter_compat.h"
esp_err_t tcpip_adapter_compat_start_eth(void* h);
# 42 "/home/dieter/Development/esp-idf/components/tcpip_adapter/include/tcpip_adapter_compatible/tcpip_adapter_compat.h"
esp_err_t tcpip_adapter_set_default_wifi_handlers(void);
# 55 "/home/dieter/Development/esp-idf/components/tcpip_adapter/include/tcpip_adapter_compatible/tcpip_adapter_compat.h"
esp_err_t tcpip_adapter_clear_default_wifi_handlers(void);
# 23 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 2

static const char *TAG = "esp_eth";
# 36 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
esp_event_base_t ETH_EVENT = "ETH_EVENT";
# 48 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
typedef struct {
...
# 71 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
static esp_err_t eth_phy_reg_read(esp_eth_mediator_t *eth, uint32_t phy_addr, uint32_t phy_reg, uint32_t *reg_value)
{
    esp_eth_driver_t *eth_driver = 
# 73 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
                                  ({ const volatile __typeof(((
# 73 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
                                  esp_eth_driver_t 
# 73 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
                                  *)0)->
# 73 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
...
{
    esp_eth_driver_t *eth_driver = 
# 80 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
                                  ({ const volatile __typeof(((
# 80 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
                                  esp_eth_driver_t 
# 80 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
                                  *)0)->
# 80 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
...
{
    esp_eth_driver_t *eth_driver = 
# 87 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
                                  ({ const volatile __typeof(((
# 87 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
                                  esp_eth_driver_t 
# 87 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
                                  *)0)->
# 87 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
...
# 87 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
    ...
    if (!eth_driver->stack_input) {
        return esp_netif_receive(eth_driver->base.netif, buffer, length, 
# 89 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
                                                                        ((void *)0)
# 89 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
                                                                            );
    } else {
...
static esp_err_t eth_on_state_changed(esp_eth_mediator_t *eth, esp_eth_state_t state, void *args)
{
    esp_err_t ret = 0;
    esp_eth_driver_t *eth_driver = 
# 98 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
                                  ({ const volatile __typeof(((
# 98 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
                                  esp_eth_driver_t 
# 98 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
                                  *)0)->
# 98 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
...
# 98 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
    ...
    case ETH_STATE_LLINIT: {
        if (eth_driver->on_lowlevel_init_done) {
            do { if (!(eth_driver->on_lowlevel_init_done(eth_driver) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "extra lowlevel init failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 103); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "extra lowlevel init failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 103); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "extra lowlevel init failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 103); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "extra lowlevel init failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 103); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "extra lowlevel init failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 103); } } while(0); } while(0); ret = -1; goto err; } } while (0);
        }
        break;
    }
    case ETH_STATE_DEINIT: {
        if (eth_driver->on_lowlevel_deinit_done) {
            do { if (!(eth_driver->on_lowlevel_deinit_done(eth_driver) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "extra lowlevel deinit failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 109); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "extra lowlevel deinit failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 109); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "extra lowlevel deinit failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 109); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "extra lowlevel deinit failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 109); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "extra lowlevel deinit failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 109); } } while(0); } while(0); ret = -1; goto err; } } while (0);
        }
        break;
    }
    case ETH_STATE_LINK: {
        eth_link_t link = (eth_link_t)args;
        do { if (!(mac->set_link(mac, link) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ethernet mac set link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 115); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ethernet mac set link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 115); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ethernet mac set link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 115); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ethernet mac set link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 115); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ethernet mac set link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 115); } } while(0); } while(0); ret = -1; goto err; } } while (0);
        eth_driver->link = link;
        if (link == ETH_LINK_UP) {
            do { if (!(esp_event_post(ETH_EVENT, ETHERNET_EVENT_CONNECTED, &eth_driver, sizeof(eth_driver), 0) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_CONNECTED event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 119
# 118 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_CONNECTED event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 119
# 118 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_CONNECTED event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 119
# 118 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_CONNECTED event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 119
# 118 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
            ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_CONNECTED event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 119
# 118 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
            ); } } while(0); } while(0); ret = -1; goto err; } } while (0)
                                                                                  ;
        } else if (link == ETH_LINK_DOWN) {
            do { if (!(esp_event_post(ETH_EVENT, ETHERNET_EVENT_DISCONNECTED, &eth_driver, sizeof(eth_driver), 0) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_DISCONNECTED event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 122
# 121 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_DISCONNECTED event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 122
# 121 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_DISCONNECTED event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 122
# 121 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_DISCONNECTED event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 122
# 121 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
            ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_DISCONNECTED event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 122
# 121 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
            ); } } while(0); } while(0); ret = -1; goto err; } } while (0)
                                                                                     ;
    ...
    case ETH_STATE_SPEED: {
        ...
        do { if (!(mac->set_speed(mac, speed) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ethernet mac set speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 128); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ethernet mac set speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 128); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ethernet mac set speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 128); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ethernet mac set speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 128); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ethernet mac set speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 128); } } while(0); } while(0); ret = -1; goto err; } } while (0);
        eth_driver->speed = speed;
        break;
    }
    case ETH_STATE_DUPLEX: {
        eth_duplex_t duplex = (eth_duplex_t)args;
        do { if (!(mac->set_duplex(mac, duplex) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ethernet mac set duplex failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 134); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ethernet mac set duplex failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 134); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ethernet mac set duplex failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 134); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ethernet mac set duplex failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 134); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ethernet mac set duplex failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 134); } } while(0); } while(0); ret = -1; goto err; } } while (0);
        eth_driver->duplex = duplex;
        break;
    }
    default:
        do { if (!(
# 139 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
       0
# 139 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
       )) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "unknown ethernet state: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 139, state); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "unknown ethernet state: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 139, state); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "unknown ethernet state: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 139, state); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "unknown ethernet state: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 139, state); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "unknown ethernet state: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 139, state); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
        break;
    }
    return 0;
err:
...
# 164 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
                                    ((void *)0)
    
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
   };

    do { esp_err_t __err_rc = (esp_netif_set_driver_config(esp_netif, &driver_ifconfig)); if (__err_rc != 0) { _esp_error_check_failed(__err_rc, "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c", 167, 
# 167 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
   __func__
# 167 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
   , "esp_netif_set_driver_config(esp_netif, &driver_ifconfig)"); } } while(0);
    esp_eth_ioctl(eth_driver, ETH_CMD_G_MAC_ADDR, eth_mac);
    do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%x %x %x %x %x %x" "\033[0m" "\n", esp_log_timestamp(), TAG, eth_mac[0], eth_mac[1], eth_mac[2], eth_mac[3], eth_mac[4], eth_mac[5]); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%x %x %x %x %x %x" "\033[0m" "\n", esp_log_timestamp(), TAG, eth_mac[0], eth_mac[1], eth_mac[2], eth_mac[3], eth_mac[4], eth_mac[5]); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%x %x %x %x %x %x" "\033[0m" "\n", esp_log_timestamp(), TAG, eth_mac[0], eth_mac[1], eth_mac[2], eth_mac[3], eth_mac[4], eth_mac[5]); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%x %x %x %x %x %x" "\033[0m" "\n", esp_log_timestamp(), TAG, eth_mac[0], eth_mac[1], eth_mac[2], eth_mac[3], eth_mac[4], eth_mac[5]); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%x %x %x %x %x %x" "\033[0m" "\n", esp_log_timestamp(), TAG, eth_mac[0], eth_mac[1], eth_mac[2], eth_mac[3], eth_mac[4], eth_mac[5]); } } while(0); } while(0);

    esp_netif_set_mac(esp_netif, eth_mac);
    do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ETH netif started" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ETH netif started" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ETH netif started" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ETH netif started" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ETH netif started" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
...
esp_err_t esp_eth_driver_start(esp_eth_handle_t eth_handle)
{
    ...
    do { if (!(xTimerGenericCommand( ( eth_driver->check_link_timer ), ( ( BaseType_t ) 1 ), ( xTaskGetTickCount() ), 
# 185 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
   ((void *)0)
# 185 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
   , ( 0 ) ) == ( ( ( BaseType_t ) 1 ) ))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "start eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 185); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "start eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 185); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "start eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 185); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "start eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 185); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "start eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 185); } } while(0); } while(0); ret = -1; goto err_start_timer; } } while (0);

    do { if (!(esp_event_post(ETH_EVENT, ETHERNET_EVENT_START, &eth_driver, sizeof(eth_driver), 0) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_START event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 188
# 187 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_START event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 188
# 187 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_START event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 188
# 187 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_START event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 188
# 187 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
    ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_START event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 188
# 187 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
    ); } } while(0); } while(0); ret = -1; goto err_event; } } while (0)
                                                                            ;
    return ret;
err_start_timer:
    xTimerGenericCommand( ( eth_driver->check_link_timer ), ( ( BaseType_t ) 5 ), 0U, 
# 191 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
   ((void *)0)
# 191 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
   , ( 0 ) );
err_event:
...
{
    esp_err_t ret = 0;
    do { if (!(config)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "eth config can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 200); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "eth config can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 200); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "eth config can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 200); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "eth config can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 200); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "eth config can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 200); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
    do { if (!(out_hdl)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "eth handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 201); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "eth handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 201); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "eth handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 201); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "eth handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 201); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "eth handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 201); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
    esp_eth_mac_t *mac = config->mac;
    esp_eth_phy_t *phy = config->phy;
    do { if (!(mac && phy)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set eth->mac or eth->phy to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 204); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set eth->mac or eth->phy to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 204); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set eth->mac or eth->phy to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 204); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set eth->mac or eth->phy to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 204); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set eth->mac or eth->phy to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 204); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
    esp_eth_driver_t *eth_driver = calloc(1, sizeof(esp_eth_driver_t));
    do { if (!(eth_driver)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "request memory for eth_driver failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 206); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "request memory for eth_driver failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 206); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "request memory for eth_driver failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 206); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "request memory for eth_driver failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 206); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "request memory for eth_driver failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 206); } } while(0); } while(0); ret = 0x101; goto err; } } while (0);
    eth_driver->mac = mac;
    eth_driver->phy = phy;
    ...
    do { if (!(mac->set_mediator(mac, &eth_driver->mediator) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "set mediator for mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 219); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "set mediator for mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 219); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "set mediator for mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 219); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "set mediator for mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 219); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "set mediator for mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 219); } } while(0); } while(0); ret = -1; goto err_mediator; } } while (0);
    do { if (!(phy->set_mediator(phy, &eth_driver->mediator) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "set mediator for phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 220); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "set mediator for phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 220); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "set mediator for phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 220); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "set mediator for phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 220); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "set mediator for phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 220); } } while(0); } while(0); ret = -1; goto err_mediator; } } while (0);
    do { if (!(mac->init(mac) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "init mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 221); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "init mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 221); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "init mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 221); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "init mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 221); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "init mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 221); } } while(0); } while(0); ret = -1; goto err_init_mac; } } while (0);
    do { if (!(phy->init(phy) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "init phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 222); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "init phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 222); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "init phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 222); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "init phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 222); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "init phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 222); } } while(0); } while(0); ret = -1; goto err_init_phy; } } while (0);
    eth_driver->check_link_timer = xTimerCreate("eth_link_timer", ( ( ( TickType_t ) ( config->check_link_period_ms ) * ( 100 ) ) / ( TickType_t ) 1000 ), ( ( BaseType_t ) 1 ),
                                   eth_driver, eth_check_link_timer_cb);
    do { if (!(eth_driver->check_link_timer)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "create eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 225); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "create eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 225); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "create eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 225); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "create eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 225); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "create eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 225); } } while(0); } while(0); ret = -1; goto err_create_timer; } } while (0);
...
esp_err_t esp_eth_driver_uninstall(esp_eth_handle_t hdl)
{
    ...
    do { if (!(eth_driver)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 245); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 245); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 245); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 245); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 245); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
    esp_eth_mac_t *mac = eth_driver->mac;
    esp_eth_phy_t *phy = eth_driver->phy;
    do { if (!(xTimerGenericCommand( ( eth_driver->check_link_timer ), ( ( BaseType_t ) 5 ), 0U, 
# 248 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
   ((void *)0)
# 248 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
   , ( 0 ) ) == ( ( ( BaseType_t ) 1 ) ))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "delete eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 248); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "delete eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 248); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "delete eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 248); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "delete eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 248); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "delete eth_link_timer failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 248); } } while(0); } while(0); ret = -1; goto err; } } while (0);
    do { if (!(esp_event_post(ETH_EVENT, ETHERNET_EVENT_STOP, &eth_driver, sizeof(eth_driver), 0) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_STOP event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 250
# 249 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_STOP event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 250
# 249 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_STOP event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 250
# 249 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_STOP event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 250
# 249 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
    ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "send ETHERNET_EVENT_STOP event failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 250
# 249 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
    ); } } while(0); } while(0); ret = -1; goto err; } } while (0)
                                                                     ;
    do { if (!(phy->deinit(phy) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "deinit phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 251); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "deinit phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 251); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "deinit phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 251); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "deinit phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 251); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "deinit phy failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 251); } } while(0); } while(0); ret = -1; goto err; } } while (0);
    do { if (!(mac->deinit(mac) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "deinit mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 252); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "deinit mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 252); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "deinit mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 252); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "deinit mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 252); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "deinit mac failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 252); } } while(0); } while(0); ret = -1; goto err; } } while (0);
    free(eth_driver);
    return 0;
err:
    return ret;
...
esp_err_t esp_eth_transmit(void* hdl, void *buf, uint32_t length)
{
    esp_err_t ret = 0;
    esp_eth_driver_t *eth_driver = (esp_eth_driver_t *)hdl;
    do { if (!(eth_driver)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 263); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 263); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 263); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 263); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 263); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
    esp_eth_mac_t *mac = eth_driver->mac;
...
esp_err_t esp_eth_receive(esp_eth_handle_t hdl, uint8_t *buf, uint32_t *length)
{
    esp_err_t ret = 0;
    esp_eth_driver_t *eth_driver = (esp_eth_driver_t *)hdl;
    do { if (!(eth_driver)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 274); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 274); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 274); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 274); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 274); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
    esp_eth_mac_t *mac = eth_driver->mac;
...
esp_err_t esp_eth_ioctl(esp_eth_handle_t hdl, esp_eth_io_cmd_t cmd, void *data)
{
    esp_err_t ret = 0;
    esp_eth_driver_t *eth_driver = (esp_eth_driver_t *)hdl;
    do { if (!(eth_driver)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 285); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 285); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 285); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 285); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "ethernet driver handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 285); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
    esp_eth_mac_t *mac = eth_driver->mac;
    esp_eth_phy_t *phy = eth_driver->phy;
    switch (cmd) {
    case ETH_CMD_S_MAC_ADDR:
        do { if (!(data)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set mac addr to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set mac addr to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set mac addr to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set mac addr to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set mac addr to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
        do { if (!(mac->set_addr(mac, (uint8_t *)data) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "set mac address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 291); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "set mac address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 291); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "set mac address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 291); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "set mac address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 291); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "set mac address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 291); } } while(0); } while(0); ret = -1; goto err; } } while (0);
        break;
    case ETH_CMD_G_MAC_ADDR:
        do { if (!(data)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "no mem to store mac addr" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 294); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "no mem to store mac addr" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 294); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "no mem to store mac addr" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 294); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "no mem to store mac addr" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 294); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "no mem to store mac addr" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 294); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
        do { if (!(mac->get_addr(mac, (uint8_t *)data) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "get mac address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 295); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "get mac address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 295); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "get mac address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 295); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "get mac address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 295); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "get mac address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 295); } } while(0); } while(0); ret = -1; goto err; } } while (0);
        break;
    case ETH_CMD_S_PHY_ADDR:
        do { if (!(data)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set phy addr to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 298); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set phy addr to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 298); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set phy addr to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 298); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set phy addr to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 298); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set phy addr to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 298); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
        do { if (!(phy->set_addr(phy, (uint32_t)data) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "set phy address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 299); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "set phy address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 299); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "set phy address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 299); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "set phy address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 299); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "set phy address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 299); } } while(0); } while(0); ret = -1; goto err; } } while (0);
        break;
    case ETH_CMD_G_PHY_ADDR:
        do { if (!(data)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "no mem to store phy addr" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "no mem to store phy addr" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "no mem to store phy addr" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "no mem to store phy addr" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "no mem to store phy addr" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
        do { if (!(phy->get_addr(phy, (uint32_t *)data) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "get phy address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 303); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "get phy address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 303); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "get phy address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 303); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "get phy address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 303); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "get phy address failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 303); } } while(0); } while(0); ret = -1; goto err; } } while (0);
        break;
    case ETH_CMD_G_SPEED:
        do { if (!(data)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "no mem to store speed value" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 306); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "no mem to store speed value" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 306); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "no mem to store speed value" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 306); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "no mem to store speed value" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 306); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "no mem to store speed value" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 306); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
        *(eth_speed_t *)data = eth_driver->speed;
        break;
    case ETH_CMD_S_PROMISCUOUS:
        do { if (!(mac->set_promiscuous(mac, (
# 310 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
       _Bool
# 310 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
       )data) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "set promiscuous mode failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 310); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "set promiscuous mode failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 310); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "set promiscuous mode failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 310); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "set promiscuous mode failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 310); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "set promiscuous mode failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 310); } } while(0); } while(0); ret = -1; goto err; } } while (0);
        break;
    default:
        do { if (!(
# 313 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c" 3 4
       0
# 313 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth.c"
       )) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "unknown io command: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 313, cmd); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "unknown io command: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 313, cmd); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "unknown io command: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 313, cmd); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "unknown io command: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 313, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "unknown io command: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 313, cmd); } } while(0); } while(0); ret = 0x102; goto err; } } while (0);
        break;
    }
    return 0;
err:
...
{
    esp_err_t ret;
    do { if (!(esp_netif)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "esp-netif handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 324); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "esp-netif handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 324); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "esp-netif handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 324); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "esp-netif handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 324); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "esp-netif handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 324); } } while(0); } while(0); ret = 0x102; goto fail; } } while (0);
...
{
    esp_err_t ret;
    do { if (!(esp_netif)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "esp-netif handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 339); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "esp-netif handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 339); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "esp-netif handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 339); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "esp-netif handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 339); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "esp-netif handle can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 339); } } while(0); } while(0); ret = 0x102; goto fail; } } while (0);
