# 1 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_eth//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
# 14 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 15 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 2

static const char *TAG = "lan8720";
# 40 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
typedef union {
    struct {
        uint32_t reserved1 : 1;
...
typedef union {
    struct {
        ...
        uint32_t parallel_detect_falut : 1;
...
static esp_err_t lan8720_update_link_duplex_speed(phy_lan8720_t *lan8720)
{
    ...
    bmsr_reg_t bmsr;
    pscsr_reg_t pscsr;
    do { if (!(eth->phy_reg_read(eth, lan8720->addr, (0x01), &(bmsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 174
# 173 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 173 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ...
    if (lan8720->link_status != link) {
        ...
        if (link == ETH_LINK_UP) {
            do { if (!(eth->phy_reg_read(eth, lan8720->addr, (0x1F), &(pscsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read PSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 181
# 180 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read PSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 181
# 180 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read PSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 181
# 180 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "read PSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 181
# 180 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
            ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "read PSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 181
# 180 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
            ); } } while(0); } while(0); goto err; } } while (0)
                                               ;
 ...
 203
# 202 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 202 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
 ...
 205
# 204 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 204 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
 ...
 208
# 207 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
{
    do { if (!(eth)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 218); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 218); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 218); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 218); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 218); } } while(0); } while(0); goto err; } } while (0);
    phy_lan8720_t *lan8720 = 
# 219 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            ({ const volatile __typeof(((
# 219 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                            phy_lan8720_t 
# 219 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            *)0)->
# 219 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
{
    phy_lan8720_t *lan8720 = 
# 228 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            ({ const volatile __typeof(((
# 228 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                            phy_lan8720_t 
# 228 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            *)0)->
# 228 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 228 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ...
    do { if (!(lan8720_update_link_duplex_speed(lan8720) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 230); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 230); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 230); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 230); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 230); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
{
    phy_lan8720_t *lan8720 = 
# 238 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            ({ const volatile __typeof(((
# 238 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                            phy_lan8720_t 
# 238 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            *)0)->
# 238 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 238 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ...
    do { if (!(eth->phy_reg_write(eth, lan8720->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 242
# 241 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 241 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ...
    for (to = 0; to < lan8720->reset_timeout_ms / 10; to++) {
        ...
        do { if (!(eth->phy_reg_read(eth, lan8720->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 248
# 247 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 247 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ...
    do { if (!(to < lan8720->reset_timeout_ms / 10)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 253); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 253); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 253); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 253); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 253); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
{
    phy_lan8720_t *lan8720 = 
# 261 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            ({ const volatile __typeof(((
# 261 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                            phy_lan8720_t 
# 261 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            *)0)->
# 261 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 261 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ...
    do { if (!(eth->phy_reg_write(eth, lan8720->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 270); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 270); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 270); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 270); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 270); } } while(0); } while(0); goto err; } } while (0);
    ...
    for (to = 0; to < lan8720->autonego_timeout_ms / 10; to++) {
        ...
        do { if (!(eth->phy_reg_read(eth, lan8720->addr, (0x01), &(bmsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 278
# 277 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 278
# 277 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 277 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
        ...
        do { if (!(eth->phy_reg_read(eth, lan8720->addr, (0x1F), &(pscsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read PSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 280
# 279 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read PSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 280
# 279 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read PSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 279 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ...
    do { if (!(lan8720_update_link_duplex_speed(lan8720) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}

static esp_err_t lan8720_pwrctl(esp_eth_phy_t *phy, 
# 296 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                                                   _Bool 
# 296 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                                                        enable)
{
    phy_lan8720_t *lan8720 = 
# 298 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            ({ const volatile __typeof(((
# 298 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                            phy_lan8720_t 
# 298 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            *)0)->
# 298 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 298 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ...
    do { if (!(eth->phy_reg_read(eth, lan8720->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 302
# 301 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 302
# 301 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 301 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ...
    do { if (!(eth->phy_reg_write(eth, lan8720->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 311
# 310 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 311
# 310 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 310 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ...
    do { if (!(eth->phy_reg_read(eth, lan8720->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 313
# 312 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 313
# 312 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 312 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                                      ...
                                      ;
    if (!enable) {
        do { if (!(bmcr.power_down == 1)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 315); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 315); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 315); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 315); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 315); } } while(0); } while(0); goto err; } } while (0);
    } else {
        do { if (!(bmcr.power_down == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 317); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 317); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 317); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 317); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 317); } } while(0); } while(0); goto err; } } while (0);
    }
    return 0;
err:
    return -1;
...
{
    phy_lan8720_t *lan8720 = 
# 326 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            ({ const volatile __typeof(((
# 326 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                            phy_lan8720_t 
# 326 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            *)0)->
# 326 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
{
    do { if (!(addr)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 333); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 333); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 333); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 333); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 333); } } while(0); } while(0); goto err; } } while (0);
    phy_lan8720_t *lan8720 = 
# 334 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            ({ const volatile __typeof(((
# 334 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                            phy_lan8720_t 
# 334 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            *)0)->
# 334 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
{
    phy_lan8720_t *lan8720 = 
# 343 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            ({ const volatile __typeof(((
# 343 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                            phy_lan8720_t 
# 343 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            *)0)->
# 343 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
{
    phy_lan8720_t *lan8720 = 
# 350 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            ({ const volatile __typeof(((
# 350 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                            phy_lan8720_t 
# 350 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
                            *)0)->
# 350 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 350 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
    ...
    do { if (!(lan8720_pwrctl(phy, 
# 353 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
   1
# 353 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
   ) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 353); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 353); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 353); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 353); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 353); } } while(0); } while(0); goto err; } } while (0);

    do { if (!(lan8720_reset(phy) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 355); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 355); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 355); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 355); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 355); } } while(0); } while(0); goto err; } } while (0);

    phyidr1_reg_t id1;
    phyidr2_reg_t id2;
    do { if (!(eth->phy_reg_read(eth, lan8720->addr, (0x02), &(id1.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 360
# 359 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 359 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                                     ...
                                     ;
    do { if (!(eth->phy_reg_read(eth, lan8720->addr, (0x03), &(id2.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 362
# 361 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
...
# 361 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
                                     ...
                                     ;
    do { if (!(id1.oui_msb == 0x7 && id2.oui_lsb == 0x30 && id2.vendor_model == 0xF)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 363); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 363); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 363); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 363); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 363); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
static esp_err_t lan8720_deinit(esp_eth_phy_t *phy)
{
    ...
    do { if (!(lan8720_pwrctl(phy, 
# 372 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
   0
# 372 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
   ) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 372); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 372); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 372); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 372); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 372); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
esp_eth_phy_t *esp_eth_phy_new_lan8720(const eth_phy_config_t *config)
{
    do { if (!(config)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 380); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 380); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 380); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 380); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 380); } } while(0); } while(0); goto err; } } while (0);
    phy_lan8720_t *lan8720 = calloc(1, sizeof(phy_lan8720_t));
    do { if (!(lan8720)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "calloc lan8720 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 382); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "calloc lan8720 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 382); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "calloc lan8720 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 382); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "calloc lan8720 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 382); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "calloc lan8720 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 382); } } while(0); } while(0); goto err; } } while (0);
...
err:
    return 
# 400 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c" 3 4
          ((void *)0)
# 400 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_lan8720.c"
              ;
}
