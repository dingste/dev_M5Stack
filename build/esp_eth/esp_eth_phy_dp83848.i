# 1 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_eth//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
# 14 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 15 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 2

static const char *TAG = "dp83848";
# 40 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
typedef union {
    struct {
        uint32_t link_status : 1;
        uint32_t speed_status : 1;
        uint32_t duplex_status : 1;
        uint32_t loopback_status : 1;
        uint32_t auto_nego_complete : 1;
        uint32_t jabber_detect : 1;
        uint32_t remote_fault : 1;
        uint32_t mii_interrupt : 1;
        uint32_t page_received : 1;
        uint32_t descrambler_lock : 1;
        uint32_t signal_detect : 1;
        uint32_t false_carrier_sense_latch : 1;
        uint32_t polarity_status : 1;
        uint32_t receive_error_latch : 1;
        uint32_t mdix_mode : 1;
        uint32_t reserved : 1;
    };
    uint32_t val;
} physts_reg_t;
...
typedef union {
    struct {
        uint32_t phy_addr : 5;
        uint32_t led_cfg : 2;
        uint32_t bypass_led_stretching : 1;
        uint32_t bist_start : 1;
        uint32_t bist_status : 1;
        uint32_t psr_15 : 1;
        uint32_t bist_force_error : 1;
        uint32_t pause_trans_negotiate : 1;
        uint32_t pause_receive_negotiat : 1;
        uint32_t force_mdix : 1;
        uint32_t en_auto_mdix : 1;
    };
    uint32_t val;
} phycr_reg_t;
...
static esp_err_t dp83848_update_link_duplex_speed(phy_dp83848_t *dp83848)
{
    ...
    bmsr_reg_t bmsr;
    physts_reg_t physts;
    do { if (!(eth->phy_reg_read(eth, dp83848->addr, (0x01), &(bmsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 102
# 101 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 101 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ...
    if (dp83848->link_status != link) {
        ...
        if (link == ETH_LINK_UP) {
            do { if (!(eth->phy_reg_read(eth, dp83848->addr, (0x10), &(physts.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read PHYSTS failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 109
# 108 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read PHYSTS failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 109
# 108 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read PHYSTS failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 109
# 108 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "read PHYSTS failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 109
# 108 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
            ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "read PHYSTS failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 109
# 108 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
            ); } } while(0); } while(0); goto err; } } while (0)
                                                ;
 ...
 121
# 120 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 120 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
 ...
 123
# 122 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 122 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
 ...
 126
# 125 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
{
    do { if (!(eth)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 136); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 136); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 136); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 136); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 136); } } while(0); } while(0); goto err; } } while (0);
    phy_dp83848_t *dp83848 = 
# 137 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            ({ const volatile __typeof(((
# 137 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                            phy_dp83848_t 
# 137 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            *)0)->
# 137 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
{
    phy_dp83848_t *dp83848 = 
# 146 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            ({ const volatile __typeof(((
# 146 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                            phy_dp83848_t 
# 146 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            *)0)->
# 146 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 146 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ...
    do { if (!(dp83848_update_link_duplex_speed(dp83848) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 148); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 148); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 148); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 148); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 148); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
{
    phy_dp83848_t *dp83848 = 
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            ({ const volatile __typeof(((
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                            phy_dp83848_t 
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            *)0)->
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ...
    do { if (!(eth->phy_reg_write(eth, dp83848->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 160
# 159 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 159 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ...
    for (to = 0; to < dp83848->reset_timeout_ms / 10; to++) {
        ...
        do { if (!(eth->phy_reg_read(eth, dp83848->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 166
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ...
    do { if (!(to < dp83848->reset_timeout_ms / 10)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 171); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 171); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 171); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 171); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 171); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
{
    phy_dp83848_t *dp83848 = 
# 179 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            ({ const volatile __typeof(((
# 179 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                            phy_dp83848_t 
# 179 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            *)0)->
# 179 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 179 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ...
    do { if (!(eth->phy_reg_write(eth, dp83848->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 189
# 188 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 189
# 188 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 188 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ...
    for (to = 0; to < dp83848->autonego_timeout_ms / 10; to++) {
        ...
        do { if (!(eth->phy_reg_read(eth, dp83848->addr, (0x01), &(bmsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 197
# 196 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 197
# 196 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 196 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
        ...
        do { if (!(eth->phy_reg_read(eth, dp83848->addr, (0x10), &(physts.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read PHYSTS failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 199
# 198 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read PHYSTS failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 199
# 198 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read PHYSTS failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 198 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ...
    do { if (!(dp83848_update_link_duplex_speed(dp83848) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 209); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 209); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 209); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 209); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 209); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}

static esp_err_t dp83848_pwrctl(esp_eth_phy_t *phy, 
# 215 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                                                   _Bool 
# 215 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                                                        enable)
{
    phy_dp83848_t *dp83848 = 
# 217 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            ({ const volatile __typeof(((
# 217 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                            phy_dp83848_t 
# 217 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            *)0)->
# 217 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 217 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ...
    do { if (!(eth->phy_reg_read(eth, dp83848->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 221
# 220 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 221
# 220 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 220 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ...
    do { if (!(eth->phy_reg_write(eth, dp83848->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 230
# 229 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 230
# 229 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 229 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ...
    do { if (!(eth->phy_reg_read(eth, dp83848->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 232
# 231 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 232
# 231 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 231 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                                      ...
                                      ;
    if (!enable) {
        do { if (!(bmcr.power_down == 1)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 234); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 234); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 234); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 234); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 234); } } while(0); } while(0); goto err; } } while (0);
    } else {
        do { if (!(bmcr.power_down == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 236); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 236); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 236); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 236); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 236); } } while(0); } while(0); goto err; } } while (0);
    }
    return 0;
err:
    return -1;
...
{
    phy_dp83848_t *dp83848 = 
# 245 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            ({ const volatile __typeof(((
# 245 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                            phy_dp83848_t 
# 245 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            *)0)->
# 245 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
{
    do { if (!(addr)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 252); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 252); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 252); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 252); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 252); } } while(0); } while(0); goto err; } } while (0);
    phy_dp83848_t *dp83848 = 
# 253 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            ({ const volatile __typeof(((
# 253 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                            phy_dp83848_t 
# 253 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            *)0)->
# 253 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
{
    phy_dp83848_t *dp83848 = 
# 262 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            ({ const volatile __typeof(((
# 262 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                            phy_dp83848_t 
# 262 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            *)0)->
# 262 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
{
    phy_dp83848_t *dp83848 = 
# 269 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            ({ const volatile __typeof(((
# 269 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                            phy_dp83848_t 
# 269 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
                            *)0)->
# 269 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 269 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
    ...
    do { if (!(dp83848_pwrctl(phy, 
# 272 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
   1
# 272 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
   ) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 272); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 272); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 272); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 272); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 272); } } while(0); } while(0); goto err; } } while (0);

    do { if (!(dp83848_reset(phy) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 274); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 274); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 274); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 274); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 274); } } while(0); } while(0); goto err; } } while (0);

    phyidr1_reg_t id1;
    phyidr2_reg_t id2;
    do { if (!(eth->phy_reg_read(eth, dp83848->addr, (0x02), &(id1.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 279
# 278 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 278 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                                     ...
                                     ;
    do { if (!(eth->phy_reg_read(eth, dp83848->addr, (0x03), &(id2.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 281
# 280 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
# 280 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
                                     ...
                                     ;
    do { if (!(id1.oui_msb == 0x2000 && id2.oui_lsb == 0x17 && id2.vendor_model == 0x09)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 283
# 282 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
...
static esp_err_t dp83848_deinit(esp_eth_phy_t *phy)
{
    ...
    do { if (!(dp83848_pwrctl(phy, 
# 292 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
   0
# 292 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
   ) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 292); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 292); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 292); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 292); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 292); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
esp_eth_phy_t *esp_eth_phy_new_dp83848(const eth_phy_config_t *config)
{
    do { if (!(config)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 300); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 300); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 300); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 300); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 300); } } while(0); } while(0); goto err; } } while (0);
    phy_dp83848_t *dp83848 = calloc(1, sizeof(phy_dp83848_t));
    do { if (!(dp83848)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "calloc dp83848 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "calloc dp83848 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "calloc dp83848 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "calloc dp83848 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "calloc dp83848 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } } while(0); } while(0); goto err; } } while (0);
...
err:
    return 
# 320 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c" 3 4
          ((void *)0)
# 320 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dp83848.c"
              ;
}
