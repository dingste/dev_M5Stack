# 1 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_eth//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
# 14 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
# 15 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 2

static const char *TAG = "ip101";
# 40 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
typedef union {
    struct {
...
static esp_err_t ip101_page_select(phy_ip101_t *ip101, uint32_t page)
{
    ...
    do { if (!(eth->phy_reg_write(eth, ip101->addr, (0x14), pcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write PCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 117); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write PCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 117); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write PCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 117); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "write PCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 117); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "write PCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 117); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
static esp_err_t ip101_update_link_duplex_speed(phy_ip101_t *ip101)
{
    ...
    cssr_reg_t cssr;
    bmsr_reg_t bmsr;
    do { if (!(ip101_page_select(ip101, 16) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "select page 16 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 130); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "select page 16 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 130); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "select page 16 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 130); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "select page 16 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 130); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "select page 16 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 130); } } while(0); } while(0); goto err; } } while (0);
    do { if (!(eth->phy_reg_read(eth, ip101->addr, (0x01), &(bmsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 132
# 131 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
# 131 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ...
    if (ip101->link_status != link) {
        ...
        if (link == ETH_LINK_UP) {
            do { if (!(eth->phy_reg_read(eth, ip101->addr, (0x1E), &(cssr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read CSSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 139
# 138 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read CSSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 139
# 138 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read CSSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 139
# 138 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "read CSSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 139
# 138 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
            ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "read CSSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 139
# 138 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
            ); } } while(0); } while(0); goto err; } } while (0)
                                              ;
 ...
 161
# 160 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
# 160 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
 ...
 163
# 162 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
# 162 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
        ...
        do { if (!(eth->on_state_changed(eth, ETH_STATE_LINK, (void *)link) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "chagne link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 166
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "chagne link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 166
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "chagne link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 166
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "chagne link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 166
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
        ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "chagne link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 166
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
        ); } } while(0); } while(0); goto err; } } while (0)
                                            ;
...
{
    do { if (!(eth)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 176); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 176); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 176); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 176); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 176); } } while(0); } while(0); goto err; } } while (0);
    phy_ip101_t *ip101 = 
# 177 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        ({ const volatile __typeof(((
# 177 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
                        phy_ip101_t 
# 177 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        *)0)->
# 177 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
{
    phy_ip101_t *ip101 = 
# 186 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        ({ const volatile __typeof(((
# 186 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
                        phy_ip101_t 
# 186 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        *)0)->
# 186 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
# 186 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ...
    do { if (!(ip101_update_link_duplex_speed(ip101) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 188); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 188); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 188); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 188); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 188); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
{
    phy_ip101_t *ip101 = 
# 196 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        ({ const volatile __typeof(((
# 196 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
                        phy_ip101_t 
# 196 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        *)0)->
# 196 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
# 196 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ...
    do { if (!(eth->phy_reg_write(eth, ip101->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 200
# 199 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
# 199 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ...
    for (to = 0; to < ip101->reset_timeout_ms / 10; to++) {
        ...
        do { if (!(eth->phy_reg_read(eth, ip101->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 206
# 205 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
# 205 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ...
    do { if (!(to < ip101->reset_timeout_ms / 10)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 211); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 211); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 211); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 211); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 211); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
{
    phy_ip101_t *ip101 = 
# 219 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        ({ const volatile __typeof(((
# 219 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
                        phy_ip101_t 
# 219 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        *)0)->
# 219 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
# 219 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ...
    do { if (!(eth->phy_reg_write(eth, ip101->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 229
# 228 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 229
# 228 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 228 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ...
    for (to = 0; to < ip101->autonego_timeout_ms / 10; to++) {
        ...
        do { if (!(eth->phy_reg_read(eth, ip101->addr, (0x01), &(bmsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 236
# 235 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 236
# 235 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 235 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ...
    if (to >= ip101->autonego_timeout_ms / 10) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "auto negotiation timeout" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "auto negotiation timeout" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "auto negotiation timeout" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "auto negotiation timeout" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "auto negotiation timeout" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    }

    do { if (!(ip101_update_link_duplex_speed(ip101) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 246); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 246); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 246); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 246); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 246); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}

static esp_err_t ip101_pwrctl(esp_eth_phy_t *phy, 
# 252 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                                                 _Bool 
# 252 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
                                                      enable)
{
    phy_ip101_t *ip101 = 
# 254 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        ({ const volatile __typeof(((
# 254 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
                        phy_ip101_t 
# 254 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        *)0)->
# 254 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
# 254 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ...
    do { if (!(eth->phy_reg_read(eth, ip101->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 258
# 257 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 258
# 257 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 257 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ...
    do { if (!(eth->phy_reg_write(eth, ip101->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 267
# 266 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 267
# 266 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 266 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ...
    do { if (!(eth->phy_reg_read(eth, ip101->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 269
# 268 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 269
# 268 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 268 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
                                      ...
                                      ;
    if (!enable) {
        do { if (!(bmcr.power_down == 1)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 271); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 271); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 271); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 271); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 271); } } while(0); } while(0); goto err; } } while (0);
    } else {
        do { if (!(bmcr.power_down == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 273); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 273); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 273); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 273); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 273); } } while(0); } while(0); goto err; } } while (0);
    }
    return 0;
err:
    return -1;
...
{
    phy_ip101_t *ip101 = 
# 282 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        ({ const volatile __typeof(((
# 282 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
                        phy_ip101_t 
# 282 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        *)0)->
# 282 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
{
    do { if (!(addr)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 289); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 289); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 289); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 289); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 289); } } while(0); } while(0); goto err; } } while (0);
    phy_ip101_t *ip101 = 
# 290 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        ({ const volatile __typeof(((
# 290 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
                        phy_ip101_t 
# 290 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        *)0)->
# 290 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
{
    phy_ip101_t *ip101 = 
# 299 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        ({ const volatile __typeof(((
# 299 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
                        phy_ip101_t 
# 299 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        *)0)->
# 299 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
{
    phy_ip101_t *ip101 = 
# 306 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        ({ const volatile __typeof(((
# 306 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
                        phy_ip101_t 
# 306 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
                        *)0)->
# 306 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
...
# 306 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
    ...
    do { if (!(ip101_pwrctl(phy, 
# 309 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
   1
# 309 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
   ) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 309); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 309); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 309); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 309); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 309); } } while(0); } while(0); goto err; } } while (0);

    do { if (!(ip101_reset(phy) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 311); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 311); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 311); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 311); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 311); } } while(0); } while(0); goto err; } } while (0);

    phyidr1_reg_t id1;
    phyidr2_reg_t id2;
    do { if (!(eth->phy_reg_read(eth, ip101->addr, (0x02), &(id1.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 315); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 315); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 315); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 315); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 315); } } while(0); } while(0); goto err; } } while (0);
    do { if (!(eth->phy_reg_read(eth, ip101->addr, (0x03), &(id2.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 316); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 316); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 316); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 316); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 316); } } while(0); } while(0); goto err; } } while (0);
    do { if (!(id1.oui_msb == 0x243 && id2.oui_lsb == 0x3 && id2.vendor_model == 0x5)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 317); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 317); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 317); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 317); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 317); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
static esp_err_t ip101_deinit(esp_eth_phy_t *phy)
{
    ...
    do { if (!(ip101_pwrctl(phy, 
# 326 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
   0
# 326 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
   ) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 326); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 326); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 326); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 326); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 326); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
esp_eth_phy_t *esp_eth_phy_new_ip101(const eth_phy_config_t *config)
{
    do { if (!(config)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 334); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 334); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 334); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 334); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 334); } } while(0); } while(0); goto err; } } while (0);
    phy_ip101_t *ip101 = calloc(1, sizeof(phy_ip101_t));
    do { if (!(ip101)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "calloc ip101 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 336); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "calloc ip101 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 336); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "calloc ip101 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 336); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "calloc ip101 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 336); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "calloc ip101 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 336); } } while(0); } while(0); goto err; } } while (0);
...
err:
    return 
# 354 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c" 3 4
          ((void *)0)
# 354 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_ip101.c"
              ;
}
