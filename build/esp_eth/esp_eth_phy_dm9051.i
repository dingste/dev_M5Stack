# 1 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_eth//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
# 14 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
...
# 15 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 2
# 1 "/home/dieter/Development/esp-idf/components/esp_eth/include/eth_phy_regs_struct.h" 1
# 14 "/home/dieter/Development/esp-idf/components/esp_eth/include/eth_phy_regs_struct.h"
       
# 28 "/home/dieter/Development/esp-idf/components/esp_eth/include/eth_phy_regs_struct.h"
typedef union {
    struct {
        uint32_t reserved : 7;
...
typedef union {
    struct {
        ...
        uint32_t mf_preamble_suppress : 1;
        uint32_t reserved : 1;
        uint32_t ext_status : 1;
        uint32_t base100_t2_hdx : 1;
        uint32_t base100_t2_fdx : 1;
        uint32_t base10_t_hdx : 1;
        uint32_t base10_t_fdx : 1;
        uint32_t base100_tx_hdx : 1;
        uint32_t base100_tx_fdx : 1;
        uint32_t based100_t4 : 1;
    };
    uint32_t val;
} bmsr_reg_t;
...
typedef union {
    struct {
        uint32_t protocol_select : 5;
        uint32_t base10_t : 1;
        uint32_t base10_t_fd : 1;
        uint32_t base100_tx : 1;
        uint32_t base100_tx_fd : 1;
        uint32_t base100_t4 : 1;
        uint32_t symmetric_pause : 1;
        uint32_t asymmetric_pause : 1;
        uint32_t reserved1 : 1;
        uint32_t remote_fault : 1;
        uint32_t acknowledge : 1;
...
typedef union {
    struct {
        uint32_t link_partner_auto_nego_able : 1;
        uint32_t link_page_received : 1;
        uint32_t next_page_able : 1;
        uint32_t link_partner_next_page_able : 1;
        uint32_t parallel_detection_fault : 1;
        uint32_t reserved : 11;
    };
    uint32_t val;
} aner_reg_t;
# 20 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 2

static const char *TAG = "dm9051";
# 40 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
typedef union {
    struct {
        uint32_t reserved1 : 1;
        uint32_t sleep : 1;
...
static esp_err_t dm9051_update_link_duplex_speed(phy_dm9051_t *dm9051)
{
    ...
    bmsr_reg_t bmsr;
    dscsr_reg_t dscsr;
    do { if (!(eth->phy_reg_read(eth, dm9051->addr, (0x01), &(bmsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 96
# 95 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 96
# 95 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 96
# 95 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 96
# 95 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 96
# 95 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } } while(0); } while(0); goto err; } } while (0)
                                      ;
    ...
    if (dm9051->link_status != link) {
        ...
        if (link == ETH_LINK_UP) {
            do { if (!(eth->phy_reg_read(eth, dm9051->addr, (0x11), &(dscsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read DSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 103
# 102 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read DSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 103
# 102 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read DSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 103
# 102 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "read DSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 103
# 102 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "read DSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 103
# 102 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } } while(0); } while(0); goto err; } } while (0)
                                               ;
            ...
            do { if (!(eth->on_state_changed(eth, ETH_STATE_SPEED, (void *)speed) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "change speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 115
# 114 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "change speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 115
# 114 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "change speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 115
# 114 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "change speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 115
# 114 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "change speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 115
# 114 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } } while(0); } while(0); goto err; } } while (0)
                                                 ;
            do { if (!(eth->on_state_changed(eth, ETH_STATE_DUPLEX, (void *)duplex) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "change duplex failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 117
# 116 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "change duplex failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 117
# 116 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "change duplex failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 117
# 116 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "change duplex failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 117
# 116 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "change duplex failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 117
# 116 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
            ); } } while(0); } while(0); goto err; } } while (0)
                                                  ;
        }
        do { if (!(eth->on_state_changed(eth, ETH_STATE_LINK, (void *)link) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "change link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 120
# 119 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "change link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 120
# 119 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "change link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 120
# 119 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "change link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 120
# 119 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "change link failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 120
# 119 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } } while(0); } while(0); goto err; } } while (0)
                                            ;
...
{
    do { if (!(eth)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 130); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 130); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 130); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 130); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 130); } } while(0); } while(0); goto err; } } while (0);
    phy_dm9051_t *dm9051 = 
# 131 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          ({ const volatile __typeof(((
# 131 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
                          phy_dm9051_t 
# 131 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          *)0)->
# 131 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
...
{
    phy_dm9051_t *dm9051 = 
# 140 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          ({ const volatile __typeof(((
# 140 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
                          phy_dm9051_t 
# 140 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          *)0)->
# 140 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
...
# 140 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ...
    do { if (!(dm9051_update_link_duplex_speed(dm9051) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 142); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 142); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 142); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 142); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 142); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
{
    phy_dm9051_t *dm9051 = 
# 150 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          ({ const volatile __typeof(((
# 150 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
                          phy_dm9051_t 
# 150 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          *)0)->
# 150 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
...
# 150 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ...
    esp_eth_mediator_t *eth = dm9051->eth;
    dscr_reg_t dscr;
    do { if (!(eth->phy_reg_read(eth, dm9051->addr, (0x10), &(dscr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 154
# 153 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 154
# 153 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 154
# 153 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "read DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 154
# 153 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "read DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 154
# 153 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } } while(0); } while(0); goto err; } } while (0)
                                      ;
    dscr.smrst = 1;
    do { if (!(eth->phy_reg_write(eth, dm9051->addr, (0x10), dscr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 157
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 157
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 157
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "write DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 157
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "write DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 157
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } } while(0); } while(0); goto err; } } while (0)
                                       ;
    bmcr_reg_t bmcr = {.reset = 1};
    do { if (!(eth->phy_reg_write(eth, dm9051->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 160
# 159 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 160
# 159 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 160
# 159 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 160
# 159 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 160
# 159 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } } while(0); } while(0); goto err; } } while (0)
                                       ;
    ...
    for (to = 0; to < dm9051->reset_timeout_ms / 10; to++) {
        ...
        do { if (!(eth->phy_reg_read(eth, dm9051->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 166
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 166
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 166
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 166
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 166
# 165 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } } while(0); } while(0); goto err; } } while (0)
                                          ;
        do { if (!(eth->phy_reg_read(eth, dm9051->addr, (0x10), &(dscr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 168
# 167 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 168
# 167 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read DSCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 167 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ...
    do { if (!(to < dm9051->reset_timeout_ms / 10)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "PHY reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 173); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "PHY reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 173); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "PHY reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 173); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "PHY reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 173); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "PHY reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 173); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
{
    phy_dm9051_t *dm9051 = 
# 181 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          ({ const volatile __typeof(((
# 181 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
                          phy_dm9051_t 
# 181 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          *)0)->
# 181 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
...
# 181 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ...
    do { if (!(eth->phy_reg_write(eth, dm9051->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 191
# 190 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 191
# 190 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 190 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ...
    for (to = 0; to < dm9051->autonego_timeout_ms / 10; to++) {
        ...
        do { if (!(eth->phy_reg_read(eth, dm9051->addr, (0x01), &(bmsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 199
# 198 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 199
# 198 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 198 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ...
        do { if (!(eth->phy_reg_read(eth, dm9051->addr, (0x11), &(dscsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read DSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 201
# 200 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read DSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 201
# 200 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read DSCSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 200 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ...
    if (to >= dm9051->autonego_timeout_ms / 10) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Ethernet PHY auto negotiation timeout" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Ethernet PHY auto negotiation timeout" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Ethernet PHY auto negotiation timeout" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Ethernet PHY auto negotiation timeout" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Ethernet PHY auto negotiation timeout" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    }

    do { if (!(dm9051_update_link_duplex_speed(dm9051) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 210); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 210); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 210); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 210); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 210); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}

static esp_err_t dm9051_pwrctl(esp_eth_phy_t *phy, 
# 216 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                                                  _Bool 
# 216 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
                                                       enable)
{
    phy_dm9051_t *dm9051 = 
# 218 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          ({ const volatile __typeof(((
# 218 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
                          phy_dm9051_t 
# 218 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          *)0)->
# 218 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
...
# 218 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ...
    do { if (!(eth->phy_reg_read(eth, dm9051->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 222
# 221 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 222
# 221 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 221 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ...
    do { if (!(eth->phy_reg_write(eth, dm9051->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 231
# 230 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 231
# 230 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 230 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ...
    do { if (!(eth->phy_reg_read(eth, dm9051->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 233
# 232 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 233
# 232 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 232 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
                                      ...
                                      ;
    if (!enable) {
        do { if (!(bmcr.power_down == 1)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 235); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 235); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 235); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 235); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 235); } } while(0); } while(0); goto err; } } while (0);
    } else {
        do { if (!(bmcr.power_down == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 237); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 237); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 237); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 237); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 237); } } while(0); } while(0); goto err; } } while (0);
    }
    return 0;
err:
    return -1;
...
{
    phy_dm9051_t *dm9051 = 
# 246 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          ({ const volatile __typeof(((
# 246 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
                          phy_dm9051_t 
# 246 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          *)0)->
# 246 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
...
{
    do { if (!(addr)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 253); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 253); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 253); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 253); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 253); } } while(0); } while(0); goto err; } } while (0);
    phy_dm9051_t *dm9051 = 
# 254 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          ({ const volatile __typeof(((
# 254 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
                          phy_dm9051_t 
# 254 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          *)0)->
# 254 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
...
{
    phy_dm9051_t *dm9051 = 
# 263 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          ({ const volatile __typeof(((
# 263 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
                          phy_dm9051_t 
# 263 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          *)0)->
# 263 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
...
{
    phy_dm9051_t *dm9051 = 
# 270 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          ({ const volatile __typeof(((
# 270 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
                          phy_dm9051_t 
# 270 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
                          *)0)->
# 270 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
...
# 270 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ...
    do { if (!(dm9051_pwrctl(phy, 
# 273 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
   1
# 273 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
   ) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 273); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 273); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 273); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 273); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 273); } } while(0); } while(0); goto err; } } while (0);

    do { if (!(dm9051_reset(phy) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 275); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 275); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 275); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 275); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 275); } } while(0); } while(0); goto err; } } while (0);

    phyidr1_reg_t id1;
    phyidr2_reg_t id2;
    do { if (!(eth->phy_reg_read(eth, dm9051->addr, (0x02), &(id1.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 280
# 279 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 280
# 279 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 280
# 279 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 280
# 279 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 280
# 279 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } } while(0); } while(0); goto err; } } while (0)
                                     ;
    do { if (!(eth->phy_reg_read(eth, dm9051->addr, (0x03), &(id2.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 282
# 281 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 282
# 281 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 282
# 281 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 282
# 281 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 282
# 281 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } } while(0); } while(0); goto err; } } while (0)
                                     ;
    do { if (!(id1.oui_msb == 0x0181 && id2.oui_lsb == 0x2E && id2.vendor_model == 0x0A)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 284
# 283 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 284
# 283 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 284
# 283 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 284
# 283 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 284
# 283 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
    ); } } while(0); } while(0); goto err; } } while (0)
                                   ;
...
static esp_err_t dm9051_deinit(esp_eth_phy_t *phy)
{
    ...
    do { if (!(dm9051_pwrctl(phy, 
# 293 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
   0
# 293 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
   ) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 293); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 293); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 293); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 293); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 293); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
esp_eth_phy_t *esp_eth_phy_new_dm9051(const eth_phy_config_t *config)
{
    do { if (!(config)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 301); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 301); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 301); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 301); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 301); } } while(0); } while(0); goto err; } } while (0);
    do { if (!(config->phy_addr == 1)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "dm9051's phy address can only set to 1" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "dm9051's phy address can only set to 1" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "dm9051's phy address can only set to 1" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "dm9051's phy address can only set to 1" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "dm9051's phy address can only set to 1" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 302); } } while(0); } while(0); goto err; } } while (0);
    phy_dm9051_t *dm9051 = calloc(1, sizeof(phy_dm9051_t));
    do { if (!(dm9051)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "calloc dm9051 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 304); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "calloc dm9051 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 304); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "calloc dm9051 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 304); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "calloc dm9051 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 304); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "calloc dm9051 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 304); } } while(0); } while(0); goto err; } } while (0);
...
err:
    return 
# 321 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c" 3 4
          ((void *)0)
# 321 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_dm9051.c"
              ;
}
