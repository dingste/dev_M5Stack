# 1 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_eth//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
# 15 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 16 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 2
...
# 21 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 2
...
# 23 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 2

static const char *TAG = "rtl8201";
# 41 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
typedef union {
    struct {
        uint16_t reserved : 15;
        uint16_t en_pwr_save : 1;
    };
    uint16_t val;
} psmr_reg_t;
...
static esp_err_t rtl8201_page_select(phy_rtl8201_t *rtl8201, uint32_t page)
{
    ...
    do { if (!(eth->phy_reg_write(eth, rtl8201->addr, (0x1F), psr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write PSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 78); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write PSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 78); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write PSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 78); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "write PSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 78); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "write PSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 78); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
static esp_err_t rtl8201_update_link_duplex_speed(phy_rtl8201_t *rtl8201)
{
    ...
    bmcr_reg_t bmcr;
    bmsr_reg_t bmsr;
    do { if (!(rtl8201_page_select(rtl8201, 0) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "select page 0 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 91); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "select page 0 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 91); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "select page 0 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 91); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "select page 0 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 91); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "select page 0 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 91); } } while(0); } while(0); goto err; } } while (0);
    do { if (!(eth->phy_reg_read(eth, rtl8201->addr, (0x01), &(bmsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 93
# 92 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 92 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ...
    if (rtl8201->link_status != link) {
        ...
        if (link == ETH_LINK_UP) {
            do { if (!(eth->phy_reg_read(eth, rtl8201->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 100
# 99 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 99 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
 ...
 112
# 111 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 111 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
 ...
 114
# 113 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 113 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
 ...
 117
# 116 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
{
    do { if (!(eth)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 127); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 127); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 127); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 127); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set mediator to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 127); } } while(0); } while(0); goto err; } } while (0);
    phy_rtl8201_t *rtl8201 = 
# 128 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            ({ const volatile __typeof(((
# 128 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                            phy_rtl8201_t 
# 128 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            *)0)->
# 128 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
{
    phy_rtl8201_t *rtl8201 = 
# 137 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            ({ const volatile __typeof(((
# 137 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                            phy_rtl8201_t 
# 137 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            *)0)->
# 137 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 137 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ...
    do { if (!(rtl8201_update_link_duplex_speed(rtl8201) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 139); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 139); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 139); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 139); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 139); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
{
    phy_rtl8201_t *rtl8201 = 
# 147 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            ({ const volatile __typeof(((
# 147 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                            phy_rtl8201_t 
# 147 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            *)0)->
# 147 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 147 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ...
    do { if (!(eth->phy_reg_write(eth, rtl8201->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 151
# 150 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 150 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ...
    for (to = 0; to < rtl8201->reset_timeout_ms / 10; to++) {
        ...
        do { if (!(eth->phy_reg_read(eth, rtl8201->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 157
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 157
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 156 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ...
    do { if (!(to < rtl8201->reset_timeout_ms / 10)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 162); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 162); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 162); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 162); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "reset timeout" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 162); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
{
    phy_rtl8201_t *rtl8201 = 
# 170 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            ({ const volatile __typeof(((
# 170 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                            phy_rtl8201_t 
# 170 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            *)0)->
# 170 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 170 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ...
    do { if (!(eth->phy_reg_write(eth, rtl8201->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 180
# 179 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 180
# 179 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 179 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ...
    for (to = 0; to < rtl8201->autonego_timeout_ms / 10; to++) {
        ...
        do { if (!(eth->phy_reg_read(eth, rtl8201->addr, (0x01), &(bmsr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 187
# 186 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 187
# 186 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
        ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMSR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 186 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ...
    do { if (!(rtl8201_update_link_duplex_speed(rtl8201) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 197); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 197); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 197); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 197); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "update link duplex speed failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 197); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}

static esp_err_t rtl8201_pwrctl(esp_eth_phy_t *phy, 
# 203 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                                                   _Bool 
# 203 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                                                        enable)
{
    phy_rtl8201_t *rtl8201 = 
# 205 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            ({ const volatile __typeof(((
# 205 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                            phy_rtl8201_t 
# 205 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            *)0)->
# 205 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 205 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ...
    do { if (!(eth->phy_reg_read(eth, rtl8201->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 209
# 208 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 209
# 208 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 208 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ...
    do { if (!(eth->phy_reg_write(eth, rtl8201->addr, (0x00), bmcr.val) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 218
# 217 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 218
# 217 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "write BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 217 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ...
    do { if (!(eth->phy_reg_read(eth, rtl8201->addr, (0x00), &(bmcr.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 220
# 219 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 220
# 219 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "read BMCR failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
...
# 219 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                                      ...
                                      ;
    if (!enable) {
        do { if (!(bmcr.power_down == 1)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 222); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 222); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 222); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 222); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power down failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 222); } } while(0); } while(0); goto err; } } while (0);
    } else {
        do { if (!(bmcr.power_down == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 224); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 224); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 224); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 224); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power up failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 224); } } while(0); } while(0); goto err; } } while (0);
    }
    return 0;
err:
    return -1;
...
{
    phy_rtl8201_t *rtl8201 = 
# 233 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            ({ const volatile __typeof(((
# 233 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                            phy_rtl8201_t 
# 233 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            *)0)->
# 233 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
{
    do { if (!(addr)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 240); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 240); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 240); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 240); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "addr can't be null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 240); } } while(0); } while(0); goto err; } } while (0);
    phy_rtl8201_t *rtl8201 = 
# 241 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            ({ const volatile __typeof(((
# 241 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                            phy_rtl8201_t 
# 241 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            *)0)->
# 241 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
{
    phy_rtl8201_t *rtl8201 = 
# 250 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            ({ const volatile __typeof(((
# 250 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                            phy_rtl8201_t 
# 250 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            *)0)->
# 250 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
{
    phy_rtl8201_t *rtl8201 = 
# 257 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            ({ const volatile __typeof(((
# 257 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                            phy_rtl8201_t 
# 257 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
                            *)0)->
# 257 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 257 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
    ...
    do { if (!(rtl8201_pwrctl(phy, 
# 260 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
   1
# 260 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
   ) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 260); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 260); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 260); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 260); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 260); } } while(0); } while(0); goto err; } } while (0);

    do { if (!(rtl8201_reset(phy) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 262); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 262); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 262); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 262); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "reset failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 262); } } while(0); } while(0); goto err; } } while (0);

    phyidr1_reg_t id1;
    phyidr2_reg_t id2;
    do { if (!(eth->phy_reg_read(eth, rtl8201->addr, (0x02), &(id1.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read ID1 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 267
# 266 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 266 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                                     ...
                                     ;
    do { if (!(eth->phy_reg_read(eth, rtl8201->addr, (0x03), &(id2.val)) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "read ID2 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 269
# 268 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
# 268 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
                                     ...
                                     ;
    do { if (!(id1.oui_msb == 0x1C && id2.oui_lsb == 0x32 && id2.vendor_model == 0x1)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "wrong chip ID" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,
 271
# 270 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
...
static esp_err_t rtl8201_deinit(esp_eth_phy_t *phy)
{
    ...
    do { if (!(rtl8201_pwrctl(phy, 
# 280 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
   0
# 280 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
   ) == 0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 280); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 280); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 280); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 280); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "power control failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 280); } } while(0); } while(0); goto err; } } while (0);
    return 0;
err:
    return -1;
}
...
esp_eth_phy_t *esp_eth_phy_new_rtl8201(const eth_phy_config_t *config)
{
    do { if (!(config)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 288); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 288); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 288); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 288); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "can't set phy config to null" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 288); } } while(0); } while(0); goto err; } } while (0);
    phy_rtl8201_t *rtl8201 = calloc(1, sizeof(phy_rtl8201_t));
    do { if (!(rtl8201)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): " "calloc rtl8201 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): " "calloc rtl8201 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s(%d): " "calloc rtl8201 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s(%d): " "calloc rtl8201 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): " "calloc rtl8201 failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__, 290); } } while(0); } while(0); goto err; } } while (0);
...
err:
    return 
# 308 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c" 3 4
          ((void *)0)
# 308 "/home/dieter/Development/esp-idf/components/esp_eth/src/esp_eth_phy_rtl8201.c"
              ;
}
