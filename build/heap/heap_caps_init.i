# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/heap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
# 14 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_private.h" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_private.h" 2
...
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 2
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 2
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 2
...
# 26 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 2
...
static void register_heap(heap_t *region)
{
    ...
    ((heap_size <= (0x400000)) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c", 35, __func__, "heap_size <= HEAP_SIZE_MAX"));
    region->heap = multi_heap_register((void *)region->start, heap_size);
    if (region->heap != 
# 37 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                       ((void *)0)
# 37 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                           ) {
...
void heap_caps_enable_nonos_stack_heaps()
{
    ...
    for ((heap) = (((&registered_heaps))->slh_first); (heap); (heap) = (((heap))->next.sle_next)) {
        ...
        if (heap->heap == 
# 48 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                         ((void *)0)
# 48 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                             ) {
            register_heap(heap);
            if (heap->heap != 
# 50 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                             ((void *)0)
# 50 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                                 ) {
...
void heap_caps_init()
{
    ...
    for (int i = 0; i < num_regions; i++) {
        ...
        heap_idx++;
        ((heap_idx <= num_heaps) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c", 105, __func__, "heap_idx <= num_heaps"));
        ...
        if (type->startup_stack) {
            ...
            heap->heap = 
# 113 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                        ((void *)0)
# 113 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                            ;
        } else {
            register_heap(heap);
        }
        ((heap)->next.sle_next) = 
# 117 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                                ((void *)0)
# 117 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                                    ;
    ...
    ((heap_idx == num_heaps) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c", 123, __func__, "heap_idx == num_heaps"));




    ((((&registered_heaps)->slh_first == 
# 128 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
   ((void *)0)
# 128 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
   )) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c", 128, __func__, "SLIST_EMPTY(&registered_heaps)"));

    heap_t *heaps_array = 
# 130 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                         ((void *)0)
# 130 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                             ;
    for (int i = 0; i < num_heaps; i++) {
        if (heap_caps_match(&temp_heaps[i], (1<<2)|(1<<11))) {
            ...
            if (heaps_array != 
# 135 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                              ((void *)0)
# 135 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                                  ) {
                break;
            }
        }
    ...
    ((heaps_array != 
# 140 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
   ((void *)0)
# 140 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
   ) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c", 140, __func__, "heaps_array != NULL"));
...
# 146 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                                  ((void *)0)
# 146 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                                      ) {
...
esp_err_t heap_caps_add_region_with_caps(const uint32_t caps[], intptr_t start, intptr_t end)
{
    esp_err_t err = -1;
    if (caps == 
# 178 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
               ((void *)0) 
# 178 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                    || start == 0 || end == 0 || end <= start) {
        return 0x102;
    }
# 203 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
    heap_t *heap;
    for ((heap) = (((&registered_heaps))->slh_first); (heap); (heap) = (((heap))->next.sle_next)) {
    ...
    heap_t *p_new = heap_caps_malloc(sizeof(heap_t), (1<<11)|(1<<2));
    if (p_new == 
# 212 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                ((void *)0)
# 212 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                    ) {
        err = 0x101;
        goto done;
    }
    ...
    ((p_new)->next.sle_next) = 
# 221 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                             ((void *)0)
# 221 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                                 ;
    if (p_new->heap == 
# 222 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                      ((void *)0)
# 222 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                          ) {
        err = 0x104;
        goto done;
    }
