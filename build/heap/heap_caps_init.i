...
static void register_heap(heap_t *region)
{
    ...
    if (region->heap != 
# 35 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                       ((void *)0)
# 35 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                           ) {
...
void heap_caps_enable_nonos_stack_heaps()
{
    ...
    for ((heap) = (((&registered_heaps))->slh_first); (heap); (heap) = (((heap))->next.sle_next)) {
        ...
        if (heap->heap == 
# 46 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                         ((void *)0)
# 46 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                             ) {
            register_heap(heap);
            if (heap->heap != 
...
void heap_caps_init()
{
    ...
    for (int i = 0; i < num_regions; i++) {
        ...
        heap_idx++;
        ((heap_idx <= num_heaps) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c", 103, __func__, "heap_idx <= num_heaps"));
        ...
        if (type->startup_stack) {
            ...
            heap->heap = 
# 111 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                        ((void *)0)
# 111 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                            ;
        } else {
            register_heap(heap);
        }
        ((heap)->next.sle_next) = 
# 115 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                                ((void *)0)
# 115 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                                    ;
    ...
    ((heap_idx == num_heaps) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c", 121, __func__, "heap_idx == num_heaps"));




    ((((&registered_heaps)->slh_first == 
# 126 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
   ((void *)0)
# 126 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
   )) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c", 126, __func__, "SLIST_EMPTY(&registered_heaps)"));
...
# 128 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
    ...
    for (int i = 0; i < num_heaps; i++) {
        if (heap_caps_match(&temp_heaps[i], (1<<2)|(1<<11))) {
            ...
            if (heaps_array != 
# 133 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                              ((void *)0)
# 133 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                                  ) {
                break;
            }
        }
    ...
    ((heaps_array != 
# 138 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
   ((void *)0)
# 138 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
   ) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c", 138, __func__, "heaps_array != NULL"));
...
# 144 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                                  ((void *)0)
# 144 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                                      ) {
...
esp_err_t heap_caps_add_region_with_caps(const uint32_t caps[], intptr_t start, intptr_t end)
{
    esp_err_t err = -1;
    if (caps == 
# 176 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
               ((void *)0) 
# 176 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                    || start == 0 || end == 0 || end <= start) {
        return 0x102;
    }
# 201 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
    heap_t *heap;
    for ((heap) = (((&registered_heaps))->slh_first); (heap); (heap) = (((heap))->next.sle_next)) {
    ...
    if (p_new == 
# 210 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                ((void *)0)
# 210 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                    ) {
        err = 0x101;
        goto done;
    }
    ...
    ((p_new)->next.sle_next) = 
# 219 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                             ((void *)0)
# 219 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                                 ;
    if (p_new->heap == 
# 220 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c" 3 4
                      ((void *)0)
# 220 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/heap/heap_caps_init.c"
                          ) {
        err = 0x104;
        goto done;
    }
