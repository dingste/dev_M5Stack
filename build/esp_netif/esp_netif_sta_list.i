# 1 "/home/dieter/Development/esp-idf/components/esp_netif/lwip/esp_netif_sta_list.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_netif//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_netif/lwip/esp_netif_sta_list.c"
# 15 "/home/dieter/Development/esp-idf/components/esp_netif/lwip/esp_netif_sta_list.c"
...
# 16 "/home/dieter/Development/esp-idf/components/esp_netif/lwip/esp_netif_sta_list.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp_netif/lwip/esp_netif_sta_list.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/esp_netif/lwip/esp_netif_sta_list.c" 2
...
esp_err_t esp_netif_get_sta_list(const wifi_sta_list_t *wifi_sta_list, esp_netif_sta_list_t *netif_sta_list)
{
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s entered" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s entered" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s entered" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s entered" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s entered" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);

    if ((wifi_sta_list == 
# 29 "/home/dieter/Development/esp-idf/components/esp_netif/lwip/esp_netif_sta_list.c" 3 4
                         ((void *)0)
# 29 "/home/dieter/Development/esp-idf/components/esp_netif/lwip/esp_netif_sta_list.c"
                             ) || (netif_sta_list == 
# 29 "/home/dieter/Development/esp-idf/components/esp_netif/lwip/esp_netif_sta_list.c" 3 4
                                                     ((void *)0)
# 29 "/home/dieter/Development/esp-idf/components/esp_netif/lwip/esp_netif_sta_list.c"
