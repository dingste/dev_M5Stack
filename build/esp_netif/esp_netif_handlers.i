# 1 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c"
# 1 "/home/dieter/Development/ProjektEi/build/esp_netif//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c"
# 15 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c"
...
# 16 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c" 2
...
# 21 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c" 2
# 29 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c"
static const char *TAG = "esp_netif_handlers";

void esp_netif_action_start(void *esp_netif, esp_event_base_t base, int32_t event_id, void *data)
{
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_netif action has started with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_netif action has started with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_netif action has started with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_netif action has started with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_netif action has started with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } } while(0); } while(0);
    esp_netif_start(esp_netif);
}

void esp_netif_action_stop(void *esp_netif, esp_event_base_t base, int32_t event_id, void *data)
{
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_netif action stopped with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_netif action stopped with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_netif action stopped with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_netif action stopped with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_netif action stopped with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } } while(0); } while(0);
...
void esp_netif_action_connected(void *esp_netif, esp_event_base_t base, int32_t event_id, void *data)
{
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_netif action connected with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_netif action connected with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_netif action connected with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_netif action connected with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_netif action connected with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } } while(0); } while(0);
    ...
    if (status == ESP_NETIF_DHCP_INIT) {
        ...
        if (esp_netif_is_valid_static_ip(&ip)) {
            ip_event_got_ip_t evt = {
                    ...
                    .if_index = -1,
                    .ip_changed = 
# 65 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c" 3 4
                                 0
# 65 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c"
                                      ,
            };

            if (memcmp(&ip, &old_ip, sizeof(ip))) {
                evt.ip_changed = 
# 69 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c" 3 4
                                1
# 69 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c"
                                    ;
            }
            ...
            do{ esp_err_t __err = (esp_event_send_internal(IP_EVENT, esp_netif_get_event_id(esp_netif, ESP_NETIF_IP_EVENT_GOT_IP) , &evt, sizeof(evt), 0)); if ((0) != __err) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,

 77
# 75 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c"
            , ("esp_event_send_internal in esp_netif_action_connected"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,

 77
# 75 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c"
            , ("esp_event_send_internal in esp_netif_action_connected"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,

 77
# 75 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c"
            , ("esp_event_send_internal in esp_netif_action_connected"), __err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,

 77
# 75 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c"
            , ("esp_event_send_internal in esp_netif_action_connected"), __err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s %d %s ret=0x%X" "\033[0m" "\n", esp_log_timestamp(), TAG, __FUNCTION__,

 77
# 75 "/home/dieter/Development/esp-idf/components/esp_netif/esp_netif_handlers.c"
            , ("esp_event_send_internal in esp_netif_action_connected"), __err); } } while(0); } while(0); return; }} while(0)

                                                                                  ;
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "static ip: ip changed=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, evt.ip_changed); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "static ip: ip changed=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, evt.ip_changed); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "static ip: ip changed=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, evt.ip_changed); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "static ip: ip changed=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, evt.ip_changed); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "static ip: ip changed=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, evt.ip_changed); } } while(0); } while(0);
        } else {
...
void esp_netif_action_disconnected(void *esp_netif, esp_event_base_t base, int32_t event_id, void *data)
{
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_netif action disconnected with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_netif action disconnected with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_netif action disconnected with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_netif action disconnected with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_netif action disconnected with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } } while(0); } while(0);
...
void esp_netif_action_got_ip(void *esp_netif, esp_event_base_t base, int32_t event_id, void *data)
{
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_netif action got_ip with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_netif action got_ip with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_netif action got_ip with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_netif action got_ip with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_netif action got_ip with netif%p from event_id=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif, event_id); } } while(0); } while(0);
    const ip_event_got_ip_t *event = (const ip_event_got_ip_t *) data;
    do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif_get_desc(esp_netif), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[3])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[3])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[3]))); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif_get_desc(esp_netif), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[3])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[3])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[3]))); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif_get_desc(esp_netif), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[3])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[3])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[3]))); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif_get_desc(esp_netif), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[3])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[3])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[3]))); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s ip: " "%d.%d.%d.%d" ", mask: " "%d.%d.%d.%d" ", gw: " "%d.%d.%d.%d" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_netif_get_desc(esp_netif), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.ip)->addr))[3])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.netmask)->addr))[3])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[0])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[1])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[2])), ((uint16_t)(((const uint8_t*)(&(&event->ip_info.gw)->addr))[3]))); } } while(0); } while(0)
