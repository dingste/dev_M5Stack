# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c"
# 11 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c"
...
# 12 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c" 2
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c" 2
...
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c" 2
...
options_start(coap_pdu_t *pdu) {
  ...
  if (pdu && pdu->hdr &&
    ...
    return (*opt == 0xFF) ? 
# 32 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c" 3 4
                                         ((void *)0) 
# 32 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c"
                                              : opt;

  } else
    return 
# 35 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c" 3 4
          ((void *)0)
# 35 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c"
              ;
}
...
coap_opt_parse(const coap_opt_t *opt, size_t length, coap_option_t *result) {
  ...
  ((opt) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c", 43, __func__, "opt")); ((result) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c", 43, __func__, "result"));
# 53 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c"
  if (length < 1)
    return 0;
...
coap_option_iterator_init(coap_pdu_t *pdu, coap_opt_iterator_t *oi,
     const coap_opt_filter_t filter) {
  ((pdu) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c", 122, __func__, "pdu"));
  ((pdu->hdr) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c", 123, __func__, "pdu->hdr"));
  ((oi) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c", 124, __func__, "oi"));
  ...
  if ((unsigned char *)pdu->hdr + pdu->length <= oi->next_option) {
    oi->bad = 1;
    return 
# 132 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c" 3 4
          ((void *)0)
# 132 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c"
              ;
  }

  (((sizeof(coap_hdr_t) + pdu->hdr->token_length) <= pdu->length) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c", 135, __func__, "(sizeof(coap_hdr_t) + pdu->hdr->token_length) <= pdu->length"));
...
opt_finished(coap_opt_iterator_t *oi) {
  ((oi) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c", 148, __func__, "oi"));
...
# 161 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c" 3 4
                           ((void *)0)
# 161 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c"
                               ;
  size_t optsize;
  int b;

  ((oi) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c", 165, __func__, "oi"));

  if (opt_finished(oi))
    return 
# 168 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c" 3 4
          ((void *)0)
# 168 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c"
              ;
  ...
  while (1) {
    ...
    if (optsize) {
      ((optsize <= oi->length) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c", 180, __func__, "optsize <= oi->length"));
      ...
      oi->bad = 1;
      return 
# 188 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c" 3 4
            ((void *)0)
# 188 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c"
                ;
    }
 ...
 (b = coap_option_getb(oi->filter, oi->type)) > 0)
      ...
      oi->bad = 1;
      return 
# 201 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c" 3 4
            ((void *)0)
# 201 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c"
                ;
    }
  }
...
coap_opt_setheader(coap_opt_t *opt, size_t maxlen,
  ...
  ((opt) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c", 333, __func__, "opt"));
...
coap_opt_encode(coap_opt_t *opt, size_t maxlen, unsigned short delta,
  ...
  ((l <= maxlen) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c", 389, __func__, "l <= maxlen"));
...
# 448 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/coap/libcoap/src/option.c"
static int
