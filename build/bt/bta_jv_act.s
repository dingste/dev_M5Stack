...
.LVL6:
	.loc 2 2416 0
	beqz.n	a8, .L6
	.loc 2 2416 0 is_stmt 0 discriminator 1
	l32i.n	a9, a8, 16
	bne	a9, a2, .L7
.L6:
	.loc 2 2421 0 is_stmt 1
	mov.n	a2, a8
.LVL7:
	retw.n
.LFE90:
...
.LVL21:
	bltui	a2, 2, .L11
	.loc 2 2336 0 is_stmt 0 discriminator 1
	call8	esp_log_timestamp
.LVL22:
	l32r	a11, .LC5
	l32r	a12, .LC10
...
.L44:
	.loc 2 2397 0
	beqz.n	a3, .L41
	.loc 2 2397 0 is_stmt 0 discriminator 1
	movi.n	a12, 6
	addi.n	a11, a2, 8
	mov.n	a10, a3
	call8	memcmp
.LVL37:
	...
	retw.n
.L41:
	.loc 2 2402 0 is_stmt 1 discriminator 1
	l32i.n	a8, a2, 32
	bany	a4, a8, .L42
.L43:
	.loc 2 2406 0
...
.L63:
	.loc 2 2360 0
	beqz.n	a2, .L64
	.loc 2 2360 0 is_stmt 0 discriminator 1
	l16ui	a8, a2, 10
	bne	a8, a5, .L65
	retw.n
.L75:
...
.L89:
	beqz.n	a4, .L88
	.loc 2 2482 0 is_stmt 0 discriminator 1
	l32i.n	a8, a4, 0
	bne	a2, a8, .L101
	j	.L106
.LVL88:
.L108:
	.loc 2 2493 0 is_stmt 1
	l32i.n	a4, a2, 0
	s32i.n	a4, a3, 0
.L97:
	.loc 2 2497 0
...
.L94:
	beqz.n	a3, .L93
	.loc 2 2500 0 is_stmt 0 discriminator 1
	l32i.n	a4, a3, 4
	bne	a2, a4, .L102
	j	.L107
.LVL91:
...
.LFE92:
	...
	.literal .LC18, -65524
	.literal .LC19, bt_base_uuid$12187+4
	.literal .LC20, 65280
...
.L111:
.LBE59:
	.loc 2 869 0 discriminator 1
	l32i.n	a2, a5, 0
	movi	a11, 0x80
	l32i.n	a2, a2, 28
	.loc 2 868 0 discriminator 1
	s8i	a4, sp, 128
	.loc 2 869 0 discriminator 1
	mov.n	a12, a3
	add.n	a11, sp, a11
...
.L152:
	...
	s32i.n	a10, a4, 0
	s32i.n	a10, a5, 16
	.loc 2 2448 0 discriminator 3
	beqz.n	a10, .L152
	.loc 2 2448 0 is_stmt 0 discriminator 2
	call8	fcclient_find_by_id
.LVL149:
	bnez.n	a10, .L152
	.loc 2 2452 0 is_stmt 1
	l8ui	a8, a5, 33
	.loc 2 2451 0
	s16i	a2, a5, 30
	.loc 2 2452 0
...
.LBE76:
	...
	l8ui	a8, a8, 0
	beqz.n	a8, .L193
	.loc 2 445 0 is_stmt 0 discriminator 1
	l32i	a8, a9, 1000
	bne	a8, a2, .L193
	movi	a11, 0x42a
	add.n	a11, a7, a11
...
.L351:
	...
	l8ui	a3, a3, 0
	beqz.n	a3, .L353
	.loc 2 1834 0 is_stmt 0 discriminator 1
	call8	esp_log_timestamp
.LVL383:
	l32r	a11, .LC71
	l32r	a12, .LC82
...
.LVL400:
	...
	.loc 2 1255 0
	bgeu	a4, a2, .L385
	.loc 2 1255 0 is_stmt 0 discriminator 1
	addx2	a4, a2, a2
	addx8	a4, a4, a5
	l32i.n	a4, a4, 32
	beqz.n	a4, .L384
...
.LVL442:
	...
	l8ui	a8, a8, 0
	beqz.n	a8, .L431
	.loc 2 734 0 is_stmt 0 discriminator 1
	call8	esp_log_timestamp
.LVL443:
	l32r	a11, .LC91
	l32r	a12, .LC93
...
.LVL447:
	l8ui	a3, a3, 0
	beqz.n	a3, .L431
	.loc 2 738 0 is_stmt 0 discriminator 1
	call8	esp_log_timestamp
.LVL448:
	l32r	a11, .LC91
	l32r	a12, .LC95
...
.LVL551:
	...
	l8ui	a3, sp, 52
	beqz.n	a3, .L547
	.loc 2 1325 0 is_stmt 0 discriminator 1
	l8ui	a3, sp, 54
	bnei	a3, 3, .L547
...
.L623:
	...
	call8	BTM_SetSecurityLevel
.LVL641:
	.loc 2 2005 0 discriminator 1
	beqz.n	a10, .L627
	j	.L626
.L624:
	.loc 2 2008 0 discriminator 1
	call8	esp_log_timestamp
.LVL642:
	l32r	a11, .LC169
	mov.n	a13, a10
...
.LVL643:
	...
	l8ui	a3, a3, 0
	beqz.n	a3, .L628
	.loc 2 2014 0 is_stmt 0 discriminator 1
	call8	esp_log_timestamp
.LVL644:
	l32r	a11, .LC169
	l32r	a12, .LC175
...
.LVL664:
	l8ui	a2, a2, 0
	beqz.n	a2, .L647
	.loc 2 2076 0 is_stmt 0 discriminator 1
	call8	esp_log_timestamp
.LVL665:
	l32r	a11, .LC182
	l32r	a12, .LC184
...
.L665:
	...
	l8ui	a2, a2, 0
	beqz.n	a2, .L661
	.loc 2 2150 0 is_stmt 0 discriminator 1
	call8	esp_log_timestamp
.LVL694:
	l32r	a11, .LC187
	l32r	a12, .LC189
...
.LCFI47:
	...
	l8ui	a3, a4, 0
	bltui	a3, 3, .L671
	.loc 2 2169 0 is_stmt 0 discriminator 1
	call8	esp_log_timestamp
.LVL697:
	l8ui	a3, a2, 13
	l32r	a11, .LC191
...
.L688:
	...
	l8ui	a2, a4, 0
	bltui	a2, 2, .L670
	.loc 2 2187 0 is_stmt 0 discriminator 1
	call8	esp_log_timestamp
.LVL736:
	l32r	a11, .LC191
	l32r	a12, .LC202
...
.L710:
	...
	l8ui	a8, a8, 0
	bltui	a8, 3, .L712
	.loc 2 2234 0 is_stmt 0 discriminator 1
	call8	esp_log_timestamp
.LVL745:
	l32r	a11, .LC204
	s32i.n	a3, sp, 0
...
.LFE98:
	...
	.section	.data.fcr$12499,"aw",@progbits
	.align	4
	.type	fcr$12499, @object
	.size	fcr$12499, 28
fcr$12499:
	...
	.short	-1
	.zero	4
	.section	.rodata.__func__$12321,"a",@progbits
	.type	__func__$12321, @object
	.size	__func__$12321, 25
__func__$12321:
	.string	"bta_jv_l2cap_write_fixed"
	.section	.rodata.__func__$12314,"a",@progbits
	.type	__func__$12314, @object
	.size	__func__$12314, 19
__func__$12314:
	.string	"bta_jv_l2cap_write"
	.section	.data.bt_base_uuid$12187,"aw",@progbits
	.type	bt_base_uuid$12187, @object
	.size	bt_base_uuid$12187, 16
bt_base_uuid$12187:
	.byte	0
	.byte	0
	.byte	0
	...
	.byte	52
	.byte	-5
	.section	.rodata.__func__$12162,"a",@progbits
	.type	__func__$12162, @object
	.size	__func__$12162, 20
__func__$12162:
	.string	"bta_jv_set_free_psm"
	.section	.rodata.__func__$12094,"a",@progbits
	.type	__func__$12094, @object
	.size	__func__$12094, 30
__func__$12094:
