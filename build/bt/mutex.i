# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c"
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c"
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c" 2
...
int osi_mutex_new(osi_mutex_t *mutex)
{
    ...
    *mutex = xQueueCreateMutex( ( ( uint8_t ) 1U ) );
    ...
    if (*mutex != 
# 35 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c" 3 4
                 ((void *)0)
# 35 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c"
                     ) {
        xReturn = 0;
    }
...
# 49 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c" 3 4
           ((void *)0)
# 49 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c"
           , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            ret = -1;
        }
    } else {
        if (xQueueGenericReceive( ( QueueHandle_t ) ( *mutex ), 
# 53 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c" 3 4
           ((void *)0)
# 53 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c"
...
# 65 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c" 3 4
   ((void *)0)
# 65 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c"
...
void osi_mutex_free(osi_mutex_t *mutex)
{
    ...
    *mutex = 
# 73 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c" 3 4
            ((void *)0)
# 73 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c"
                ;
}
...
int osi_mutex_global_init(void)
{
    ...
    if (gl_mutex == 
# 79 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c" 3 4
                   ((void *)0)
# 79 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/mutex.c"
                       ) {
        return -1;
    }
