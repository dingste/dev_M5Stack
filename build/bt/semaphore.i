# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c"
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c"
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c" 2
...
int osi_sem_new(osi_sem_t *sem, uint32_t max_count, uint32_t init_count)
{
    ...
    if (sem) {
        *sem = xQueueCreateCountingSemaphore( ( max_count ), ( init_count ) );
        if ((*sem) != 
# 32 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c" 3 4
                     ((void *)0)
# 32 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c"
                         ) {
            ret = 0;
        }
    }
...
# 44 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c" 3 4
   ((void *)0)
# 44 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}
# 54 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c"
int
...
# 60 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c" 3 4
           ((void *)0)
# 60 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c"
           , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            ret = -1;
        }
    } else {
        if (xQueueGenericReceive( ( QueueHandle_t ) ( *sem ), 
# 64 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c" 3 4
           ((void *)0)
# 64 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c"
...
void osi_sem_free(osi_sem_t *sem)
{
    ...
    *sem = 
# 76 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c" 3 4
          ((void *)0)
# 76 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/common/osi/semaphore.c"
              ;
}
