...
BOOLEAN SMP_CreateLocalSecureConnectionsOobData (tBLE_BD_ADDR *addr_to_send_to)
{
    ...
    if (addr_to_send_to == 
# 591 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                          ((void *)0)
# 591 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                              ) {
...
# 593 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
    ...
    if ((p_cb->state != SMP_STATE_IDLE) || (p_cb->smp_over_br)) {
        {if ((*smp_cb_ptr).trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_SMP", "\033[0;" "33" "m" "W" " (%d) %s: " "%s creation of local OOB data set " "starts only in IDLE state" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };}
                                                                     ;
        return 
# 608 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
              0
# 608 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                   ;
    }
...
# 612 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
    ...
    return 
# 614 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
          1
# 614 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
              ;
}
