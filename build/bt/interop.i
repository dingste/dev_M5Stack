...
# 41 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/device/interop.c" 3 4
_Bool 
# 41 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/device/interop.c"
    interop_match(const interop_feature_t feature, const bt_bdaddr_t *addr)
{
    ((addr) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/device/interop.c", 43, __func__, "addr"));
    ...
    for (size_t i = 0; i != db_size; ++i) {
        if (feature == interop_database[i].feature &&
            ...
            {if (3 >= ESP_LOG_WARN) esp_log_write(ESP_LOG_WARN, "BT_LOG", "\033[0;" "33" "m" "W" " (%d) %s: " "%s() Device %s is a match for interop workaround %s" "\033[0m" "\n", esp_log_timestamp(), "BT_LOG", __func__, bdaddr_to_string(addr, bdstr, sizeof(bdstr)), interop_feature_string(feature)); }
                                                                                                   ;
            return 
# 53 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/device/interop.c" 3 4
                  1
# 53 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/device/interop.c"
                      ;
        }
    }

    return 
# 57 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/device/interop.c" 3 4
          0
# 57 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/device/interop.c"
               ;
}
