                          ...
                          esp_spp_role_t role, uint8_t remote_scn, esp_bd_addr_t peer_bd_addr)
{
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_spp_args_t), 
# 107 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/api/esp_spp_api.c" 3 4
                                                                    ((void *)0)
# 107 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/api/esp_spp_api.c"
                                                                        ) == BT_STATUS_SUCCESS ? 0 : -1);
}
...
esp_err_t esp_spp_disconnect(uint32_t handle)
{
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_spp_args_t), 
# 122 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/api/esp_spp_api.c" 3 4
                                                                    ((void *)0)
# 122 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/api/esp_spp_api.c"
                                                                        ) == BT_STATUS_SUCCESS ? 0 : -1);
}
                            ...
                            esp_spp_role_t role, uint8_t local_scn, const char *name)
{
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_spp_args_t), 
# 146 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/api/esp_spp_api.c" 3 4
                                                                    ((void *)0)
# 146 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/api/esp_spp_api.c"
                                                                        ) == BT_STATUS_SUCCESS ? 0 : -1);
}
