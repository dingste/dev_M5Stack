...
# 394 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c"
static void gatt_disc_res_cback (UINT16 conn_id, tGATT_DISC_TYPE disc_type, tGATT_DISC_RES *p_data)
{
    ...
    if (p_clcb == 
# 399 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c" 3 4
                 ((void *)0)
# 399 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c"
                     ) {
        return;
    }
...
# 432 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c"
static void gatt_disc_cmpl_cback (UINT16 conn_id, tGATT_DISC_TYPE disc_type, tGATT_STATUS status)
{
    {if ((*gatt_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_GATT", "D" " (%d) %s: " "%s" "\033[0m" "\n", esp_log_timestamp(), "BT_GATT",__func__); };};
    tGATT_PROFILE_CLCB *p_clcb = gatt_profile_find_clcb_by_conn_id(conn_id);
    ...
    if (p_clcb == 
# 437 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c" 3 4
                 ((void *)0)
# 437 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c"
                     ) {
        return;
    }
...
# 459 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c"
                                   ...
                                   tGATT_STATUS status, tGATT_CL_COMPLETE *p_data)
{
    ...
    if (p_clcb == 
# 465 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c" 3 4
                 ((void *)0)
# 465 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c"
                     ) {
        return;
    }
...
# 484 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c"
static void gatt_cl_start_config_ccc(tGATT_PROFILE_CLCB *p_clcb)
{
...
# 555 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c"
    ...
    if (p_clcb == 
# 559 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c" 3 4
                 ((void *)0)
# 559 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c"
                     ) {
        return;
    }
    ...
    if (GATT_GetConnIdIfConnected ((*gatt_cb_ptr).gatt_if, remote_bda, &p_clcb->conn_id, transport)) {
        p_clcb->connected = 
# 564 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c" 3 4
                           1
# 564 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c"
                               ;
    }

    GATT_Connect((*gatt_cb_ptr).gatt_if, remote_bda, 0XFF, 
# 567 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c" 3 4
                                                                    1
# 567 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/stack/gatt/gatt_attr.c"
                                                                        , transport);
    p_clcb->ccc_stage = 1;
