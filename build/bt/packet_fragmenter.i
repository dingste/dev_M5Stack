...
# 81 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/hci/packet_fragmenter.c"
    ...
    if (remaining_length > max_packet_size) {
        ...
        callbacks->fragmented(packet, 
# 98 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                                     0
# 98 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/hci/packet_fragmenter.c"
                                          );
        ...
        if (packet->layer_specific) {
            ...
            if (packet->layer_specific == 0) {
                ...
                current_fragment_packet = 
# 118 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                                         ((void *)0)
# 118 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/hci/packet_fragmenter.c"
                                             ;
                callbacks->transmit_finished(packet, 
# 119 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                                                    0
# 119 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/hci/packet_fragmenter.c"
                                                         );
                return;
            }
        }
        ...
        current_fragment_packet = 
# 124 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/hci/packet_fragmenter.c" 3 4
                                 ((void *)0)
# 124 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/hci/packet_fragmenter.c"
                                     ;
        callbacks->fragmented(packet, 
...
static void reassemble_and_dispatch(BT_HDR *packet)
{
    ...
    if ((packet->event & 0xFF00) == 0x1100) {
        ...
        ((acl_length == packet->len - 4) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/bt/bluedroid/hci/packet_fragmenter.c", 143, __func__, "acl_length == packet->len - HCI_ACL_PREAMBLE_SIZE"));
