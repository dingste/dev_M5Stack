# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_mmc.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/sdmmc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_mmc.c"
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_mmc.c"
...
# 9 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/include/sys/unistd.h" 2
...
# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/include/sys/types.h"
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_mmc.c" 2
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_mmc.c" 2
...
esp_err_t sdmmc_init_mmc_read_ext_csd(sdmmc_card_t* card)
{
    ...
    uint8_t* ext_csd = heap_caps_malloc(512, (1<<3));
    if (!ext_csd) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: could not allocate ext_csd" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: could not allocate ext_csd" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: could not allocate ext_csd" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: could not allocate ext_csd" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: could not allocate ext_csd" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        return 0x101;
    }

    uint32_t sectors = 0;

    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "MMC version: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, card->csd.mmc_ver); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "MMC version: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, card->csd.mmc_ver); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "MMC version: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, card->csd.mmc_ver); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "MMC version: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, card->csd.mmc_ver); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "MMC version: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, card->csd.mmc_ver); } } while(0); } while(0);
    if (card->csd.mmc_ver < 4) {
        err = 0x106;
        goto out;
    }


    err = sdmmc_mmc_send_ext_csd_data(card, ext_csd, 512);
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: send_ext_csd_data error 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: send_ext_csd_data error 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: send_ext_csd_data error 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: send_ext_csd_data error 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: send_ext_csd_data error 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } } while(0); } while(0);
        goto out;
    }
    ...
    card->is_ddr = 0;
    if (card_type & (1 << 2)) {
        card->max_freq_khz = 52000;
        if ((card->host.flags & (1UL << (4))) &&
                card->host.max_freq_khz >= 26000 &&
                card->host.get_bus_width(card->host.slot) == 4) {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "card and host support DDR mode" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "card and host support DDR mode" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "card and host support DDR mode" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "card and host support DDR mode" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "card and host support DDR mode" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
            card->is_ddr = 1;
        }
    } else if (card_type & (1 << 1)) {
        card->max_freq_khz = 52000;
    } else if (card_type & (1 << 0)) {
        card->max_freq_khz = 26000;
    } else {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: unknown CARD_TYPE 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, card_type); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: unknown CARD_TYPE 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, card_type); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: unknown CARD_TYPE 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, card_type); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: unknown CARD_TYPE 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, card_type); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: unknown CARD_TYPE 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, card_type); } } while(0); } while(0);
    }

    card->csd.tr_speed = card->max_freq_khz * 1000;
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "MMC card type %d, max_freq_khz=%d, is_ddr=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, card_type, card->max_freq_khz, card->is_ddr); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "MMC card type %d, max_freq_khz=%d, is_ddr=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, card_type, card->max_freq_khz, card->is_ddr); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "MMC card type %d, max_freq_khz=%d, is_ddr=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, card_type, card->max_freq_khz, card->is_ddr); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "MMC card type %d, max_freq_khz=%d, is_ddr=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, card_type, card->max_freq_khz, card->is_ddr); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "MMC card type %d, max_freq_khz=%d, is_ddr=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, card_type, card->max_freq_khz, card->is_ddr); } } while(0); } while(0);
    card->max_freq_khz = ((card->max_freq_khz) < (card->host.max_freq_khz) ? (card->max_freq_khz) : (card->host.max_freq_khz));

    if (card->host.flags & (1UL << (2))) {
        card->ext_csd.power_class = ext_csd[(card->max_freq_khz > 26000) ?
                202 : 203] >> 4;
        card->log_bus_width = 3;
    } else if (card->host.flags & (1UL << (1))) {
        card->ext_csd.power_class = ext_csd[(card->max_freq_khz > 26000) ?
                202 : 203] & 0x0f;
        card->log_bus_width = 2;
    } else {
        card->ext_csd.power_class = 0;
...
esp_err_t sdmmc_init_mmc_bus_width(sdmmc_card_t* card)
{
    ...
    if (card->ext_csd.power_class != 0) {
        err = sdmmc_mmc_switch(card, (1U << 0),
                187, card->ext_csd.power_class);
        if (err != 0) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: can't change power class (%d bit), 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, card->ext_csd.power_class, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: can't change power class (%d bit), 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, card->ext_csd.power_class, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: can't change power class (%d bit), 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, card->ext_csd.power_class, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: can't change power class (%d bit), 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, card->ext_csd.power_class, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: can't change power class (%d bit), 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, card->ext_csd.power_class, err); } } while(0); } while(0)
                                                               ;
            return err;
        }
    }
    ...
    if (card->log_bus_width > 0) {
        ...
        if (card->log_bus_width == 2) {
            if (card->is_ddr) {
                csd_bus_width_value = 5;
            } else {
                csd_bus_width_value = 1;
            }
            bus_width = 4;
        } else if (card->log_bus_width == 3) {
            if (card->is_ddr) {
                csd_bus_width_value = 6;
            } else {
                csd_bus_width_value = 2;
            }
            bus_width = 8;
        }
        err = sdmmc_mmc_switch(card, (1U << 0),
                183, csd_bus_width_value);
        if (err != 0) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: can't change bus width (%d bit), 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, bus_width, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: can't change bus width (%d bit), 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, bus_width, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: can't change bus width (%d bit), 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, bus_width, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: can't change bus width (%d bit), 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, bus_width, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: can't change bus width (%d bit), 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, bus_width, err); } } while(0); } while(0)
                                             ;
            return err;
        }
    }
...
{
    esp_err_t err;
    if (card->max_freq_khz > 26000) {

        err = sdmmc_mmc_switch(card, (1U << 0),
                185, 1);
        if (err != 0) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: mmc_switch EXT_CSD_HS_TIMING_HS error 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: mmc_switch EXT_CSD_HS_TIMING_HS error 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: mmc_switch EXT_CSD_HS_TIMING_HS error 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: mmc_switch EXT_CSD_HS_TIMING_HS error 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: mmc_switch EXT_CSD_HS_TIMING_HS error 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } } while(0); } while(0)
                                  ;
            return err;
        }
    }
...
esp_err_t sdmmc_mmc_decode_cid(int mmc_ver, sdmmc_response_t resp, sdmmc_cid_t* out_cid)
{
    if (mmc_ver == 0 ||
            mmc_ver == 1) {
        out_cid->mfg_id = MMC_RSP_BITS((resp), 104, 24);
        out_cid->oem_id = 0;
        do { (out_cid->name)[0] = MMC_RSP_BITS((resp), 96, 8); (out_cid->name)[1] = MMC_RSP_BITS((resp), 88, 8); (out_cid->name)[2] = MMC_RSP_BITS((resp), 80, 8); (out_cid->name)[3] = MMC_RSP_BITS((resp), 72, 8); (out_cid->name)[4] = MMC_RSP_BITS((resp), 64, 8); (out_cid->name)[5] = MMC_RSP_BITS((resp), 56, 8); (out_cid->name)[6] = MMC_RSP_BITS((resp), 48, 8); (out_cid->name)[7] = '\0'; } while (0);
        out_cid->revision = MMC_RSP_BITS((resp), 40, 8);
        out_cid->serial = MMC_RSP_BITS((resp), 16, 24);
        out_cid->date = MMC_RSP_BITS((resp), 8, 8);
    } else if (mmc_ver == 2 ||
            mmc_ver == 3 ||
            mmc_ver == 4) {
...
esp_err_t sdmmc_mmc_decode_csd(sdmmc_response_t response, sdmmc_csd_t* out_csd)
{
    ...
    if (out_csd->csd_ver == 1 ||
            out_csd->csd_ver == 2 ||
            out_csd->csd_ver == 3) {
        out_csd->mmc_ver = MMC_RSP_BITS((response), 122, 4);
        ...
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "unknown MMC CSD structure version 0x%x\n" "\033[0m" "\n", esp_log_timestamp(), TAG, out_csd->csd_ver); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "unknown MMC CSD structure version 0x%x\n" "\033[0m" "\n", esp_log_timestamp(), TAG, out_csd->csd_ver); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "unknown MMC CSD structure version 0x%x\n" "\033[0m" "\n", esp_log_timestamp(), TAG, out_csd->csd_ver); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "unknown MMC CSD structure version 0x%x\n" "\033[0m" "\n", esp_log_timestamp(), TAG, out_csd->csd_ver); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "unknown MMC CSD structure version 0x%x\n" "\033[0m" "\n", esp_log_timestamp(), TAG, out_csd->csd_ver); } } while(0); } while(0);
        return 1;
    }
...
esp_err_t sdmmc_mmc_send_ext_csd_data(sdmmc_card_t* card, void *out_data, size_t datalen)
{
    ((esp_ptr_dma_capable(out_data)) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_mmc.c", 205, __func__, "esp_ptr_dma_capable(out_data)"));
    sdmmc_command_t cmd = {
        .data = out_data,
        .datalen = datalen,
        .blklen = datalen,
        .opcode = 8,
        .arg = 0,
        .flags = 0x0010 | (0x1000|0x0400|0x0800) | 0x0040
    };
...
esp_err_t sdmmc_mmc_switch(sdmmc_card_t* card, uint8_t set, uint8_t index, uint8_t value)
{
    sdmmc_command_t cmd = {
            .opcode = 6,
            .arg = (0x03 << 24) | (index << 16) | (value << 8) | set,
            .flags = (0x1000|0x0400|0x0800|0x0100) | 0x0000 | 0x2000,
    };
    esp_err_t err = sdmmc_send_cmd(card, &cmd);
    if (err == 0) {

        if (((cmd.response)[0]) & (1<<7))
            err = 0x108;
    }
