# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/sdmmc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c"
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c"
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c" 2
...
esp_err_t sdmmc_init_ocr(sdmmc_card_t* card)
{
    ...
    if (err == 0x107 && !host_is_spi(card)) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "send_op_cond timeout, trying MMC" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "send_op_cond timeout, trying MMC" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "send_op_cond timeout, trying MMC" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "send_op_cond timeout, trying MMC" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "send_op_cond timeout, trying MMC" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        card->is_mmc = 1;
        err = sdmmc_send_cmd_send_op_cond(card, host_ocr, &card->ocr);
    }
...
esp_err_t sdmmc_init_cid(sdmmc_card_t* card)
{
    ...
    if (!host_is_spi(card)) {
        ...
        if (card->is_mmc) {
            ...
            if (err != 0) {
                do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: send_csd returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: send_csd returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: send_csd returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: send_csd returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: send_csd returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } } while(0); } while(0);
                return err;
            }
        ...
        if (err != 0) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: decoding CID failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: decoding CID failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: decoding CID failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: decoding CID failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: decoding CID failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } } while(0); } while(0);
            return err;
        }
    } else {
...
esp_err_t sdmmc_init_csd(sdmmc_card_t* card)
{
    ((card->is_mem == 1) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c", 116, __func__, "card->is_mem == 1"));
...
esp_err_t sdmmc_init_select_card(sdmmc_card_t* card)
{
    ((!host_is_spi(card)) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c", 135, __func__, "!host_is_spi(card)"));
...
esp_err_t sdmmc_init_host_bus_width(sdmmc_card_t* card)
{
    ...
    if ((card->host.flags & (1UL << (1))) &&
        ...
        bus_width = 4;
    } else if ((card->host.flags & (1UL << (2))) &&
        (card->log_bus_width == 3)) {
        bus_width = 8;
    }
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: using %d-bit bus" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, bus_width); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: using %d-bit bus" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, bus_width); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: using %d-bit bus" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, bus_width); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: using %d-bit bus" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, bus_width); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: using %d-bit bus" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, bus_width); } } while(0); } while(0);
    if (bus_width > 1) {
        esp_err_t err = (*card->host.set_bus_width)(card->host.slot, bus_width);
        if (err != 0) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "host.set_bus_width failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "host.set_bus_width failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "host.set_bus_width failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "host.set_bus_width failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "host.set_bus_width failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
            return err;
        }
    }
    return 0;
...
esp_err_t sdmmc_init_host_frequency(sdmmc_card_t* card)
{
    ((card->max_freq_khz <= card->host.max_freq_khz) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c", 187, __func__, "card->max_freq_khz <= card->host.max_freq_khz"));
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: using %d kHz bus frequency" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, selected_freq); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: using %d kHz bus frequency" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, selected_freq); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: using %d kHz bus frequency" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, selected_freq); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: using %d kHz bus frequency" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, selected_freq); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: using %d kHz bus frequency" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, selected_freq); } } while(0); } while(0);
    if (selected_freq > 400) {
        esp_err_t err = (*card->host.set_card_clk)(card->host.slot, selected_freq);
        if (err != 0) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "failed to switch bus frequency (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "failed to switch bus frequency (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "failed to switch bus frequency (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "failed to switch bus frequency (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "failed to switch bus frequency (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
            return err;
        }
    }

    if (card->is_ddr) {
        if (card->host.set_bus_ddr_mode == 
# 219 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c" 3 4
                                          ((void *)0)
# 219 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c"
                                              ) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "host doesn't support DDR mode or voltage switching" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "host doesn't support DDR mode or voltage switching" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "host doesn't support DDR mode or voltage switching" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "host doesn't support DDR mode or voltage switching" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "host doesn't support DDR mode or voltage switching" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
            return 0x106;
        }
        esp_err_t err = (*card->host.set_bus_ddr_mode)(card->host.slot, 
# 223 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c" 3 4
                                                                       1
# 223 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c"
                                                                           );
        if (err != 0) {
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "failed to switch bus to DDR mode (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "failed to switch bus to DDR mode (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "failed to switch bus to DDR mode (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "failed to switch bus to DDR mode (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "failed to switch bus to DDR mode (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
            return err;
        }
    }
    return 0;
...
void sdmmc_flip_byte_order(uint32_t* response, size_t size)
{
    ((size % (2 * sizeof(uint32_t)) == 0) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c", 234, __func__, "size % (2 * sizeof(uint32_t)) == 0"));
...
# 246 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c" 3 4
   _Bool 
# 246 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c"
        print_scr = 
# 246 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c" 3 4
                    0
# 246 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c"
...
# 247 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c" 3 4
   _Bool 
# 247 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c"
        print_csd = 
# 247 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c" 3 4
                    0
# 247 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c"
    ...
    if (card->is_sdio) {
        type = "SDIO";
        print_scr = 
# 252 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c" 3 4
                   1
# 252 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c"
                       ;
        print_csd = 
# 253 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c" 3 4
                   1
# 253 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c"
                       ;
    } else if (card->is_mmc) {
        type = "MMC";
        print_csd = 
# 256 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c" 3 4
                   1
# 256 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_common.c"
                       ;
    } else {
...
esp_err_t sdmmc_fix_host_flags(sdmmc_card_t* card)
{
    ...
    if (slot_bit_width == 1 &&
        ...
        if ((card->host.flags & width_4bit) == 0) {
            do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "slot width set to 4, but host flags don't have 4 line mode enabled; using 1 line mode" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "slot width set to 4, but host flags don't have 4 line mode enabled; using 1 line mode" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "slot width set to 4, but host flags don't have 4 line mode enabled; using 1 line mode" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "slot width set to 4, but host flags don't have 4 line mode enabled; using 1 line mode" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "slot width set to 4, but host flags don't have 4 line mode enabled; using 1 line mode" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
            card->host.flags &= ~width_mask;
            card->host.flags |= width_1bit;
        } else {
            card->host.flags &= ~width_mask;
