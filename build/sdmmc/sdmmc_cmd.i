# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/sdmmc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c"
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c"
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c" 2
...
esp_err_t sdmmc_send_cmd_read_ocr(sdmmc_card_t *card, uint32_t *ocrp)
{
    ((ocrp) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c", 176, __func__, "ocrp"));
    sdmmc_command_t cmd = {
        .opcode = 58,
...
esp_err_t sdmmc_send_cmd_all_send_cid(sdmmc_card_t* card, sdmmc_response_t* out_raw_cid)
{
    ((out_raw_cid) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c", 192, __func__, "out_raw_cid"));
    sdmmc_command_t cmd = {
            .opcode = 2,
            .flags = 0x0030 | (0x1000|0x0400|0x0200)
    };
...
esp_err_t sdmmc_send_cmd_send_cid(sdmmc_card_t *card, sdmmc_cid_t *out_cid)
{
    ((out_cid) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c", 207, __func__, "out_cid"));
    ((host_is_spi(card) && "SEND_CID should only be used in SPI mode") ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c", 208, __func__, "host_is_spi(card) && \"SEND_CID should only be used in SPI mode\""));
    ((!card->is_mmc && "MMC cards are not supported in SPI mode") ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c", 209, __func__, "!card->is_mmc && \"MMC cards are not supported in SPI mode\""));
...
esp_err_t sdmmc_send_cmd_set_relative_addr(sdmmc_card_t* card, uint16_t* out_rca)
{
    ((out_rca) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c", 229, __func__, "out_rca"));
    sdmmc_command_t cmd = {
            .opcode = 3,
            .flags = 0x0030 | (0x1000|0x0400|0x0800)
    };
    ...
    *out_rca = (card->is_mmc) ? mmc_rca : ((((cmd.response))[0]) >> 16);
    return 0;
}
...
esp_err_t sdmmc_send_cmd_send_csd(sdmmc_card_t* card, sdmmc_csd_t* out_csd)
{
    ...
    const 
# 267 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
         _Bool 
# 267 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c"
...
esp_err_t sdmmc_send_cmd_send_scr(sdmmc_card_t* card, sdmmc_scr_t *out_scr)
{
    ...
    if (buf == 
# 309 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
              ((void *)0)
# 309 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c"
                  ) {
        return 0x101;
    }
    sdmmc_command_t cmd = {
...
esp_err_t sdmmc_send_cmd_crc_on_off(sdmmc_card_t* card, 
# 338 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
                                                       _Bool 
# 338 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c"
                                                            crc_enable)
{
    ((host_is_spi(card) && "CRC_ON_OFF can only be used in SPI mode") ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c", 340, __func__, "host_is_spi(card) && \"CRC_ON_OFF can only be used in SPI mode\""));
    sdmmc_command_t cmd = {
            .opcode = 59,
            .arg = crc_enable ? 1 : 0,
            .flags = 0x0000 | (0x1000|0x0400|0x0800)
        ...
        size_t start_block, size_t block_count)
{
    ...
    if (esp_ptr_dma_capable(src) && (intptr_t)src % 4 == 0) {
        ...
        if (tmp_buf == 
# 378 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
                      ((void *)0)
# 378 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c"
                          ) {
            return 0x101;
        }
        ...
        size_t start_block, size_t block_count)
{
    ...
    if (esp_ptr_dma_capable(dst) && (intptr_t)dst % 4 == 0) {
        ...
        void* tmp_buf = heap_caps_malloc(block_size, (1<<3));
        if (tmp_buf == 
# 453 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
                      ((void *)0)
# 453 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_cmd.c"
                          ) {
            return 0x101;
        }
