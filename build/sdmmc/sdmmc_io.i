# 1 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
# 1 "/home/dieter/Development/ProjektEi/build/sdmmc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
# 18 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
...
# 19 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 2
# 1 "/home/dieter/Development/esp-idf/components/xtensa/include/esp_attr.h" 1
# 20 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 2
# 29 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
...
static const cis_tuple_t cis_table[] = {
    (cis_tuple_t) {.code=0x00, .name="NULL", .func=&cis_tuple_func_default, },
    (cis_tuple_t) {.code=0x01, .name="DEVICE", .func=&cis_tuple_func_default, },
    (cis_tuple_t) {.code=0x10, .name="CHKSUM", .func=&cis_tuple_func_default, },
    (cis_tuple_t) {.code=0x15, .name="VERS1", .func=&cis_tuple_func_default, },
    (cis_tuple_t) {.code=0x16, .name="ALTSTR", .func=&cis_tuple_func_default, },
    (cis_tuple_t) {.code=0x1A, .name="CONFIG", .func=&cis_tuple_func_default, },
    (cis_tuple_t) {.code=0x1B, .name="CFTABLE_ENTRY", .func=&(cis_tuple_func_cftable_entry), },
    (cis_tuple_t) {.code=0x20, .name="MANFID", .func=&(cis_tuple_func_manfid), },
    (cis_tuple_t) {.code=0x21, .name="FUNCID", .func=&cis_tuple_func_default, },
    (cis_tuple_t) {.code=0x22, .name="FUNCE", .func=&cis_tuple_func_default, },
    (cis_tuple_t) {.code=0x80, .name="VENDER_BEGIN", .func=&cis_tuple_func_default, },
    (cis_tuple_t) {.code=0x8F, .name="VENDER_END", .func=&cis_tuple_func_default, },
    (cis_tuple_t) {.code=0x91, .name="SDIO_STD", .func=&cis_tuple_func_default, },
    (cis_tuple_t) {.code=0x92, .name="SDIO_EXT", .func=&cis_tuple_func_default, },
    (cis_tuple_t) {.code=0xFF, .name="END", .func=&(cis_tuple_func_end), },
};
...
esp_err_t sdmmc_io_reset(sdmmc_card_t* card)
{
    ...
    esp_err_t err = sdmmc_io_rw_direct(card, 0, 0x06, (1<<31), &sdio_reset);
    if (err == 0x107 || (host_is_spi(card) && err == 0x106)) {
        ...
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: unexpected return: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: unexpected return: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: unexpected return: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: unexpected return: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: unexpected return: 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } } while(0); } while(0);
        return err;
    }
    return 0;
}
...
esp_err_t sdmmc_init_io(sdmmc_card_t* card)
{
    ...
    if (err != 0) {
        ...
        if (err != 0) {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: sdmmc_enable_int failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: sdmmc_enable_int failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: sdmmc_enable_int failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: sdmmc_enable_int failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: sdmmc_enable_int failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } } while(0); } while(0);
        }
    }
    return 0;
}
...
esp_err_t sdmmc_io_enable_hs_mode(sdmmc_card_t* card)
{
    ...
    if (card->host.max_freq_khz < 20000) {
        card->max_freq_khz = card->host.max_freq_khz;
        return 0;
    } else if (card->host.max_freq_khz < 40000) {
...
esp_err_t sdmmc_io_send_op_cond(sdmmc_card_t* card, uint32_t ocr, uint32_t *ocrp)
{
    ...
    if (err == 0 && ocrp != 
# 201 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                                ((void *)0)
# 201 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                                    )
        *ocrp = ((cmd.response)[0]);
        ...
        uint32_t addr, uint8_t in_byte, uint8_t* out_byte)
{
    ...
    if (out_byte != 
# 254 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                   ((void *)0)
# 254 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                       ) {
        *out_byte = tmp_byte;
    }
    return 0;
...
# 383 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                                   ((void *)0)
# 383 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                                       ) {
        return 0x106;
    }
...
# 391 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                                 ((void *)0)
# 391 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                                     ) {
        return 0x106;
    }
...
static esp_err_t cis_tuple_func_manfid(const void* p, uint8_t* data, FILE* fp)
{
    ...
    do {int store_size = (size); if((store_size) < (4)) return 0x104;} while(0);
...
static esp_err_t cis_tuple_func_cftable_entry(const void* p, uint8_t* data, FILE* fp)
{
    ...
    int size = *(data++);
    fprintf(fp, "TUPLE: %s, size: %d\n", tuple->name, size);
    do {int store_size = (size); if((store_size) < (2)) return 0x104;} while(0);

    do {int store_size = (size--); if((store_size) < (1)) return 0x104;} while(0);
    
# 445 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
   _Bool 
# 445 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
        interface = data[0] & (1UL << (7));
    
# 446 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
   _Bool 
# 446 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
        def = data[0] & (1UL << (6));
...
# 456 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
   _Bool 
# 456 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
        misc = data[0] & (1UL << (7));
    int mem_space = (data[0] >> 5 )&(0x3);
    
# 458 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
   _Bool 
# 458 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
        irq = data[0] & (1UL << (4));
    
# 459 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
   _Bool 
# 459 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
        io_sp = data[0] & (1UL << (3));
    
# 460 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
   _Bool 
# 460 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
        timing = data[0] & (1UL << (2));
    int power = data[0] & 3;
    fprintf(fp, "  FS: %02X, misc: %d, mem_space: %d, irq: %d, io_space: %d, timing: %d, power: %d\n", *(data++), misc, mem_space, irq, io_sp, timing, power);

    do {if(!(power == 0)) return 0x106;} while(0);
    do {if(!(!timing)) return 0x106;} while(0);
    do {if(!(!io_sp)) return 0x106;} while(0);

    if (irq) {
        do {int store_size = (size--); if((store_size) < (1)) return 0x104;} while(0);
        
# 470 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
       _Bool 
# 470 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
            mask = data[0] & (1UL << (4));
    ...
    if (mem_space) {
        do {int store_size = (size); if((store_size) < (2)) return 0x104;} while(0);
        size-=2;
        do {if(!(mem_space==1)) return 0x106;} while(0);
        int len = *(uint16_t*)data;
        fprintf(fp, "  LEN: %04X\n", len);
        data+=2;
    }

    do {if(!(misc==0)) return 0x106;} while(0);
    return 0;
}
...
static const cis_tuple_t* get_tuple(uint8_t code)
{
    ...
    return 
# 498 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
          ((void *)0)
# 498 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
              ;
}

esp_err_t sdmmc_io_print_cis_info(uint8_t* buffer, size_t buffer_size, FILE* fp)
{
    do { if ( 3 >= (ESP_LOG_DEBUG) ) { esp_log_buffer_hexdump_internal( "CIS", buffer, buffer_size, ESP_LOG_DEBUG); } } while(0);
    if (!fp) fp = 
# 504 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                 ((__getreent())->_stdout)
# 504 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                       ;
    ...
    do {
        ...
        if (tuple) {
            ...
            ret = cis_tuple_func_default(
# 514 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                                        ((void *)0)
# 514 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                                            , cis, fp);
        }
        if (ret != 0) return ret;
        cis += 2 + size;
        if (tuple && tuple->code == 0xFF) break;
    } while (cis < buffer + buffer_size) ;
    return 0;
}
# 538 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
static 
# 538 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
      _Bool 
# 538 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
           check_tuples_in_buffer(uint8_t* buf, int buffer_size, int* inout_cis_offset)
{
...
# 545 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
   ((
# 545 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
   cis_offset >= 0
# 545 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c", 545, __func__, 
# 545 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
   "cis_offset >= 0"
# 545 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
   ))
# 545 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
    ...
    while (1) {
        if (cis_offset < buffer_size) {
            ...
            if (buf[cis_offset] == 0xFF) {
                *inout_cis_offset = cis_offset + 1;
                return 
# 551 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                      1
# 551 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                          ;
            }
        }
    ...
    *inout_cis_offset = cis_offset;
    return 
# 561 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
          0
# 561 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
               ;
}
...
esp_err_t sdmmc_io_get_cis_data(sdmmc_card_t* card, uint8_t* out_buffer, size_t buffer_size, size_t* inout_cis_size)
{
    ...
    size_t max_reading = 
# 586 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                        (0xffffffffU)
# 586 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                                  ;
...
# 598 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
   _Bool 
# 598 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
        end_tuple_found = 
# 598 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                          0
# 598 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                               ;
    do {
        ret = sdmmc_io_read_bytes(card, 0, addr + buffer_offset, &buf, 32);
        if (ret != 0) return ret;


        int offset = cur_cis_offset - buffer_offset;
        
# 605 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
       _Bool 
# 605 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
            finish = check_tuples_in_buffer(buf, 32, &offset);

        int remain_size = buffer_size - buffer_offset;
        int copy_len;
        if (finish) {
            copy_len = 
# 610 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                      ((
# 610 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                      offset
# 610 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                      ) < (
# 610 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
...
# 610 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                                              ;
            end_tuple_found = 
# 611 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                             1
# 611 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                                 ;
        } else {
            copy_len = 
# 613 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                      ((
# 613 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
                      32
# 613 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c" 3 4
                      ) < (
# 613 "/home/dieter/Development/esp-idf/components/sdmmc/sdmmc_io.c"
