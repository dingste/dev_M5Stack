# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_sd.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/sdmmc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_sd.c"
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_sd.c"
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_sd.c" 2
...
esp_err_t sdmmc_init_sd_if_cond(sdmmc_card_t* card)
{
    ...
    } else if (host_is_spi(card) && err == 0x106) {
...
esp_err_t sdmmc_init_sd_scr(sdmmc_card_t* card)
{
    ...
    if ((card->scr.bus_width & (1 << 2))
            && (card->host.flags & (1UL << (1)))) {
...
esp_err_t sdmmc_init_sd_bus_width(sdmmc_card_t* card)
{
    ...
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "set_bus_width failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "set_bus_width failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "set_bus_width failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "set_bus_width failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "set_bus_width failed (0x%x)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); } } while(0); } while(0);
        return err;
    }
    return 0;
}
...
esp_err_t sdmmc_enable_hs_mode(sdmmc_card_t* card)
{
    ...
    if (response == 
# 185 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_sd.c" 3 4
                   ((void *)0)
# 185 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_sd.c"
                       ) {
        return 0x101;
    }
...
esp_err_t sdmmc_enable_hs_mode_and_check(sdmmc_card_t* card)
{
    ...
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: select_card (1) returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: select_card (1) returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: select_card (1) returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: select_card (1) returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: select_card (1) returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } } while(0); } while(0);
        return err;
    }
...
esp_err_t sdmmc_check_scr(sdmmc_card_t* card)
{
    ...
    if (err != 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: send_scr returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: send_scr returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: send_scr returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: send_scr returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: send_scr returned 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, err); } } while(0); } while(0);
        return err;
    }
...
esp_err_t sdmmc_init_spi_crc(sdmmc_card_t* card)
{
    ...
    ((host_is_spi(card)) ? (void)0 : __assert_func ("/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_sd.c", 282, __func__, "host_is_spi(card)"));
    esp_err_t err = sdmmc_send_cmd_crc_on_off(card, 
# 283 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_sd.c" 3 4
                                                   1
# 283 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/sdmmc/sdmmc_sd.c"
                                                       );
    if (err != 0) {
