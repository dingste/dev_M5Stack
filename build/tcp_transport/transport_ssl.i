# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/tcp_transport//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 2
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 2
...
# 38 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/port/esp32/include/arch/sys_arch.h"
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 2
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 2
...
# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/include/esp_transport_ssl.h" 1
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/include/esp_transport_ssl.h"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/include/esp_transport.h" 1
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/include/esp_transport_ssl.h" 2
...
# 26 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 2
...
# 27 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 2
...
# 41 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 3 4
   _Bool 
# 41 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
                            ssl_initialized;
...
static int ssl_connect_async(esp_transport_handle_t t, const char *host, int port, int timeout_ms)
{
    ...
    if (ssl->conn_state == TRANS_SSL_INIT) {
        ...
        ssl->cfg.non_block = 
# 52 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 3 4
                            1
# 52 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
                                ;
        ssl->ssl_initialized = 
# 53 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 3 4
                              1
# 53 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
                                  ;
...
static int ssl_connect(esp_transport_handle_t t, const char *host, int port, int timeout_ms)
{
    ...
    ssl->cfg.timeout_ms = timeout_ms;
    ssl->ssl_initialized = 
# 71 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 3 4
                          1
# 71 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
                              ;
...
static int ssl_poll_read(esp_transport_handle_t t, int timeout_ms)
{
    ...
    _types_fd_set errset;
    (__extension__ (void)({ size_t __i; char *__tmp = (char *)&readset; for (__i = 0; __i < sizeof (*(&readset)); ++__i) *__tmp++ = 0; }));
    (__extension__ (void)({ size_t __i; char *__tmp = (char *)&errset; for (__i = 0; __i < sizeof (*(&errset)); ++__i) *__tmp++ = 0; }));
    ((&readset)->fds_bits[(ssl->tls->sockfd)/(sizeof (fd_mask) * 8)] |= (1L << ((ssl->tls->sockfd) % (sizeof (fd_mask) * 8))));
    ((&errset)->fds_bits[(ssl->tls->sockfd)/(sizeof (fd_mask) * 8)] |= (1L << ((ssl->tls->sockfd) % (sizeof (fd_mask) * 8))));
    struct timeval timeout;
    esp_transport_utils_ms_to_timeval(timeout_ms, &timeout);

    ret = select(ssl->tls->sockfd + 1, &readset, 
# 94 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 3 4
                                                ((void *)0)
# 94 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
                                                    , &errset, &timeout);
    if (ret > 0 && ((&errset)->fds_bits[(ssl->tls->sockfd)/(sizeof (fd_mask) * 8)] & (1L << ((ssl->tls->sockfd) % (sizeof (fd_mask) * 8))))) {
        int sock_errno = 0;
        uint32_t optlen = sizeof(sock_errno);
        getsockopt(ssl->tls->sockfd, 0xfff, 0x1007, &sock_errno, &optlen);
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ssl_poll_read select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), ssl->tls->sockfd); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ssl_poll_read select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), ssl->tls->sockfd); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ssl_poll_read select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), ssl->tls->sockfd); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ssl_poll_read select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), ssl->tls->sockfd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ssl_poll_read select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), ssl->tls->sockfd); } } while(0); } while(0);
        ret = -1;
    }
    return ret;
}
...
static int ssl_poll_write(esp_transport_handle_t t, int timeout_ms)
{
    ...
    (__extension__ (void)({ size_t __i; char *__tmp = (char *)&errset; for (__i = 0; __i < sizeof (*(&errset)); ++__i) *__tmp++ = 0; }));
    ((&writeset)->fds_bits[(ssl->tls->sockfd)/(sizeof (fd_mask) * 8)] |= (1L << ((ssl->tls->sockfd) % (sizeof (fd_mask) * 8))));
    ((&errset)->fds_bits[(ssl->tls->sockfd)/(sizeof (fd_mask) * 8)] |= (1L << ((ssl->tls->sockfd) % (sizeof (fd_mask) * 8))));
    struct timeval timeout;
    esp_transport_utils_ms_to_timeval(timeout_ms, &timeout);
    ret = select(ssl->tls->sockfd + 1, 
# 117 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 3 4
                                      ((void *)0)
# 117 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
                                          , &writeset, &errset, &timeout);
    if (ret > 0 && ((&errset)->fds_bits[(ssl->tls->sockfd)/(sizeof (fd_mask) * 8)] & (1L << ((ssl->tls->sockfd) % (sizeof (fd_mask) * 8))))) {
        int sock_errno = 0;
        uint32_t optlen = sizeof(sock_errno);
        getsockopt(ssl->tls->sockfd, 0xfff, 0x1007, &sock_errno, &optlen);
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ssl_poll_write select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), ssl->tls->sockfd); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ssl_poll_write select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), ssl->tls->sockfd); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ssl_poll_write select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), ssl->tls->sockfd); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ssl_poll_write select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), ssl->tls->sockfd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ssl_poll_write select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), ssl->tls->sockfd); } } while(0); } while(0);
        ret = -1;
    }
    return ret;
}
...
static int ssl_write(esp_transport_handle_t t, const char *buffer, int len, int timeout_ms)
{
    ...
    if ((poll = esp_transport_poll_write(t, timeout_ms)) <= 0) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Poll timeout or error, errno=%s, fd=%d, timeout_ms=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno())), ssl->tls->sockfd, timeout_ms); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Poll timeout or error, errno=%s, fd=%d, timeout_ms=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno())), ssl->tls->sockfd, timeout_ms); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Poll timeout or error, errno=%s, fd=%d, timeout_ms=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno())), ssl->tls->sockfd, timeout_ms); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Poll timeout or error, errno=%s, fd=%d, timeout_ms=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno())), ssl->tls->sockfd, timeout_ms); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Poll timeout or error, errno=%s, fd=%d, timeout_ms=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno())), ssl->tls->sockfd, timeout_ms); } } while(0); } while(0);
        return poll;
    }
    ret = esp_tls_conn_write(ssl->tls, (const unsigned char *) buffer, len);
    if (ret < 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_tls_conn_write error, errno=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno()))); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_tls_conn_write error, errno=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno()))); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_tls_conn_write error, errno=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno()))); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_tls_conn_write error, errno=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno()))); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_tls_conn_write error, errno=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno()))); } } while(0); } while(0);
    }
    return ret;
}
...
static int ssl_read(esp_transport_handle_t t, char *buffer, int len, int timeout_ms)
{
    ...
    if (ret < 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "esp_tls_conn_read error, errno=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno()))); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "esp_tls_conn_read error, errno=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno()))); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "esp_tls_conn_read error, errno=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno()))); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "esp_tls_conn_read error, errno=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno()))); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "esp_tls_conn_read error, errno=%s" "\033[0m" "\n", esp_log_timestamp(), TAG, strerror((*__errno()))); } } while(0); } while(0);
    }
    if (ret == 0) {
        ret = -1;
    }
...
static int ssl_close(esp_transport_handle_t t)
{
    ...
    if (ssl->ssl_initialized) {
        ...
        ssl->ssl_initialized = 
# 170 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 3 4
                              0
# 170 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
                                   ;
    }
    return ret;
}
...
# 187 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 3 4
                                      1
# 187 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
                                          ;
    }
}
...
# 222 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 3 4
                                   1
# 222 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
                                       ;
    }
}
...
esp_transport_handle_t esp_transport_ssl_init()
{
    ...
    if (!(ssl)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c", 230, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c", 230, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c", 230, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c", 230, __FUNCTION__, "Memory exhausted"); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c", 230, __FUNCTION__, "Memory exhausted"); } } while(0); } while(0); return 
# 230 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c" 3 4
   ((void *)0)
# 230 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_ssl.c"
   ; };
