# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/tcp_transport//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
# 115 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/lwip/src/include/lwip/dns.h"
                                       keep_fallback);
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
# 27 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
# 28 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
static int resolve_dns(const char *host, struct sockaddr_in *ip) {
    ...
    int err = lwip_getaddrinfo(host, 
# 43 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
             ((void *)0)
# 43 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
             , &hints, &res);
    if(err != 0 || res == 
# 44 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
                         ((void *)0)
# 44 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
                             ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "DNS lookup failed err=%d res=%p" "\033[0m" "\n", esp_log_timestamp(), TAG, err, res); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "DNS lookup failed err=%d res=%p" "\033[0m" "\n", esp_log_timestamp(), TAG, err, res); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "DNS lookup failed err=%d res=%p" "\033[0m" "\n", esp_log_timestamp(), TAG, err, res); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "DNS lookup failed err=%d res=%p" "\033[0m" "\n", esp_log_timestamp(), TAG, err, res); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "DNS lookup failed err=%d res=%p" "\033[0m" "\n", esp_log_timestamp(), TAG, err, res); } } while(0); } while(0);
        return -1;
    }
    ip->sin_family = 2;
...
static int tcp_connect(esp_transport_handle_t t, const char *host, int port, int timeout_ms)
{
    ...
    setsockopt(tcp->sock, 0xfff, 0x1005, &tv, sizeof(tv));
...
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((void *)0)
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
   ) ? "NULL" : ((((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) != 
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((void *)0)
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
   ) && (((&*((const ip_addr_t*)&remote_ip.sin_addr.s_addr))->type) == IPADDR_TYPE_V6))) ? ip6addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip6))) : ip4addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip4))))), port); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) == 
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((void *)0)
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
   ) ? "NULL" : ((((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) != 
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((void *)0)
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
   ) && (((&*((const ip_addr_t*)&remote_ip.sin_addr.s_addr))->type) == IPADDR_TYPE_V6))) ? ip6addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip6))) : ip4addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip4))))), port); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) == 
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((void *)0)
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
   ) ? "NULL" : ((((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) != 
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((void *)0)
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
   ) && (((&*((const ip_addr_t*)&remote_ip.sin_addr.s_addr))->type) == IPADDR_TYPE_V6))) ? ip6addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip6))) : ip4addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip4))))), port); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) == 
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((void *)0)
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
   ) ? "NULL" : ((((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) != 
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((void *)0)
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
   ) && (((&*((const ip_addr_t*)&remote_ip.sin_addr.s_addr))->type) == IPADDR_TYPE_V6))) ? ip6addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip6))) : ip4addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip4))))), port); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) == 
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((void *)0)
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
   ) ? "NULL" : ((((((const ip_addr_t*)&remote_ip.sin_addr.s_addr) != 
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((void *)0)
# 84 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
   ) && (((&*((const ip_addr_t*)&remote_ip.sin_addr.s_addr))->type) == IPADDR_TYPE_V6))) ? ip6addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip6))) : ip4addr_ntoa((&(((const ip_addr_t*)&remote_ip.sin_addr.s_addr)->u_addr.ip4))))), port); } } while(0); } while(0)
                                                                                        ;
...
static int tcp_poll_read(esp_transport_handle_t t, int timeout_ms)
{
    ...
    ((&errset)->fds_bits[(tcp->sock)/(sizeof (fd_mask) * 8)] |= (1L << ((tcp->sock) % (sizeof (fd_mask) * 8))));
    struct timeval timeout;
    esp_transport_utils_ms_to_timeval(timeout_ms, &timeout);
    ret = select(tcp->sock + 1, &readset, 
# 130 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
                                         ((void *)0)
# 130 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
                                             , &errset, &timeout);
    if (ret > 0 && ((&errset)->fds_bits[(tcp->sock)/(sizeof (fd_mask) * 8)] & (1L << ((tcp->sock) % (sizeof (fd_mask) * 8))))) {
        int sock_errno = 0;
        uint32_t optlen = sizeof(sock_errno);
        getsockopt(tcp->sock, 0xfff, 0x1007, &sock_errno, &optlen);
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "tcp_poll_read select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), tcp->sock); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "tcp_poll_read select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), tcp->sock); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "tcp_poll_read select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), tcp->sock); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "tcp_poll_read select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), tcp->sock); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "tcp_poll_read select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), tcp->sock); } } while(0); } while(0);
        ret = -1;
    }
    return ret;
}
...
static int tcp_poll_write(esp_transport_handle_t t, int timeout_ms)
{
    ...
    struct timeval timeout;
    esp_transport_utils_ms_to_timeval(timeout_ms, &timeout);
    ret = select(tcp->sock + 1, 
# 153 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
                               ((void *)0)
# 153 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
                                   , &writeset, &errset, &timeout);
    if (ret > 0 && ((&errset)->fds_bits[(tcp->sock)/(sizeof (fd_mask) * 8)] & (1L << ((tcp->sock) % (sizeof (fd_mask) * 8))))) {
        int sock_errno = 0;
        uint32_t optlen = sizeof(sock_errno);
        getsockopt(tcp->sock, 0xfff, 0x1007, &sock_errno, &optlen);
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "tcp_poll_write select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), tcp->sock); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "tcp_poll_write select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), tcp->sock); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "tcp_poll_write select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), tcp->sock); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "tcp_poll_write select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), tcp->sock); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "tcp_poll_write select error %d, errno = %s, fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_errno, strerror(sock_errno), tcp->sock); } } while(0); } while(0);
        ret = -1;
    }
    return ret;
}
...
esp_transport_handle_t esp_transport_tcp_init()
{
    ...
    if (!(tcp)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c", 187, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c", 187, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c", 187, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c", 187, __FUNCTION__, "Memory exhausted"); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c", 187, __FUNCTION__, "Memory exhausted"); } } while(0); } while(0); return 
# 187 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((void *)0)
# 187 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/tcp_transport/transport_tcp.c"
   ; };
    tcp->sock = -1;
