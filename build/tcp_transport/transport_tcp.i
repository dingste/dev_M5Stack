# 1 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
# 1 "/home/dieter/Development/ProjektEi/build/tcp_transport//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
# 15 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
...
# 16 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
# 115 "/home/dieter/Development/esp-idf/components/lwip/lwip/src/include/lwip/dns.h"
                                       keep_fallback);
# 20 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 21 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
# 23 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
# 27 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
# 28 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 2
...
static int resolve_dns(const char *host, struct sockaddr_in *ip) {
    ...
    if (he == 
# 40 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
             ((void *)0)
# 40 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
                 ) {
        return -1;
    }
    addr_list = (struct in_addr **)he->h_addr_list;
    if (addr_list[0] == 
# 44 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
                       ((void *)0)
# 44 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
                           ) {
        return -1;
    }
    ip->sin_family = 2;
...
static int tcp_connect(esp_transport_handle_t t, const char *host, int port, int timeout_ms)
{
    ...
    if (lwip_inet_pton(2,host,&remote_ip.sin_addr) != 1) {
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ipaddr_ntoa((const ip_addr_t*)&remote_ip.sin_addr.s_addr), port); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ipaddr_ntoa((const ip_addr_t*)&remote_ip.sin_addr.s_addr), port); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ipaddr_ntoa((const ip_addr_t*)&remote_ip.sin_addr.s_addr), port); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ipaddr_ntoa((const ip_addr_t*)&remote_ip.sin_addr.s_addr), port); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "[sock=%d],connecting to server IP:%s,Port:%d..." "\033[0m" "\n", esp_log_timestamp(), TAG, tcp->sock, ipaddr_ntoa((const ip_addr_t*)&remote_ip.sin_addr.s_addr), port); } } while(0); } while(0)
                                                                                        ;
...
# 120 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   _types_fd_set 
# 120 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
          readset;
    
# 121 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   _types_fd_set 
# 121 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
          errset;
    
# 122 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 122 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
   &readset
# 122 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
...
# 123 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 123 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
   &errset
# 123 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ; for (__i = 0; __i < sizeof (*(
# 123 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
...
# 124 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((
# 124 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
   &readset
# 124 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   )->fds_bits[(
# 124 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
...
# 125 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((
# 125 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
   &errset
# 125 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   )->fds_bits[(
# 125 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
...
# 128 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
                                         ((void *)0)
# 128 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
                                             , &errset, &timeout);
    if (ret > 0 && 
# 129 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
                  ((
# 129 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
                  &errset
# 129 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
                  )->fds_bits[(
# 129 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
...
# 143 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   _types_fd_set 
# 143 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
          writeset;
    
# 144 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   _types_fd_set 
# 144 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
          errset;
    
# 145 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 145 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
   &writeset
# 145 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ; for (__i = 0; __i < sizeof (*(
# 145 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
...
# 146 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 146 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
   &errset
# 146 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ; for (__i = 0; __i < sizeof (*(
# 146 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
...
# 147 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((
# 147 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
   &writeset
# 147 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   )->fds_bits[(
# 147 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
...
# 148 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((
# 148 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
   &errset
# 148 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   )->fds_bits[(
# 148 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
...
# 151 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
                               ((void *)0)
# 151 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
                                   , &writeset, &errset, &timeout);
    if (ret > 0 && 
# 152 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
                  ((
# 152 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
                  &errset
# 152 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
                  )->fds_bits[(
# 152 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
...
esp_transport_handle_t esp_transport_tcp_init(void)
{
    ...
    if (!(tcp)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c", 185, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c", 185, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c", 185, __FUNCTION__, "Memory exhausted"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c", 185, __FUNCTION__, "Memory exhausted"); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c", 185, __FUNCTION__, "Memory exhausted"); } } while(0); } while(0); return 
# 185 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c" 3 4
   ((void *)0)
# 185 "/home/dieter/Development/esp-idf/components/tcp_transport/transport_tcp.c"
   ; };
    tcp->sock = -1;
