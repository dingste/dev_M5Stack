# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/esp_http_server//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
...
# 11 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/include/sys/errno.h"
...
# 12 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/newlib/include/sys/errno.h" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 2
...
# 42 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/lwip/port/esp32/include/arch/cc.h"
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/esp_httpd_priv.h" 2
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 2
...
{
    if (r == 
# 57 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
            ((void *)0) 
# 57 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                 || buf == 
# 57 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
                           ((void *)0)
# 57 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
    ...
    if (!
# 61 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
        1
# 61 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                          ) {
        return -2;
    }
    ...
    if (ret < 0) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error in send_fn" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error in send_fn" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error in send_fn" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error in send_fn" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error in send_fn" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        return ret;
    }
    return ret;
}
...
static esp_err_t httpd_send_all(httpd_req_t *r, const char *buf, size_t buf_len)
{
    ...
    while (buf_len > 0) {
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "sent = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "sent = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "sent = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "sent = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "sent = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } } while(0); } while(0);
        buf += ret;
        buf_len -= ret;
    }
    return 0;
...
static size_t httpd_recv_pending(httpd_req_t *r, char *buf, size_t buf_len)
{
    ...
    buf_len = ((ra->sd->pending_len) < (buf_len) ? (ra->sd->pending_len) : (buf_len));
...
int httpd_recv_with_opt(httpd_req_t *r, char *buf, size_t buf_len, 
# 105 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
                                                                  _Bool 
# 105 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                                                                       halt_after_pending)
{
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "requested length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, buf_len); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "requested length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, buf_len); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "requested length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, buf_len); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "requested length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, buf_len); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "requested length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, buf_len); } } while(0); } while(0);
    ...
    if (ra->sd->pending_len > 0) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "pending length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->sd->pending_len); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "pending length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->sd->pending_len); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "pending length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->sd->pending_len); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "pending length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->sd->pending_len); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "pending length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->sd->pending_len); } } while(0); } while(0);
    ...
    if (ret < 0) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error in recv_fn" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error in recv_fn" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error in recv_fn" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error in recv_fn" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error in recv_fn" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "received length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret + pending_len); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "received length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret + pending_len); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "received length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret + pending_len); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "received length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret + pending_len); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "received length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret + pending_len); } } while(0); } while(0);
...
# 149 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
                                               0
# 149 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                                                    );
}
...
size_t httpd_unrecv(struct httpd_req *r, const char *buf, size_t buf_len)
{
    ...
    ra->sd->pending_len = ((sizeof(ra->sd->pending_data)) < (buf_len) ? (sizeof(ra->sd->pending_data)) : (buf_len));



    size_t offset = sizeof(ra->sd->pending_data) - ra->sd->pending_len;
    memcpy(ra->sd->pending_data + offset, buf, ra->sd->pending_len);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->sd->pending_len); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->sd->pending_len); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->sd->pending_len); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->sd->pending_len); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->sd->pending_len); } } while(0); } while(0);
...
{
    if (r == 
# 172 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
            ((void *)0) 
# 172 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                 || field == 
# 172 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
                             ((void *)0) 
# 172 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
...
# 172 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
    ...
    if (!
# 176 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
        1
# 176 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                          ) {
        return ((0x8000) + 3);
    }
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "new header = %s: %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, field, value); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "new header = %s: %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, field, value); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "new header = %s: %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, field, value); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "new header = %s: %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, field, value); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "new header = %s: %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, field, value); } } while(0); } while(0);
    return 0;
}
...
{
    if (r == 
# 203 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
            ((void *)0) 
# 203 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                 || status == 
# 203 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
                              ((void *)0)
# 203 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
    ...
    if (!
# 207 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
        1
# 207 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                          ) {
        return ((0x8000) + 3);
    }
...
{
    if (r == 
# 222 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
            ((void *)0) 
# 222 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                 || type == 
# 222 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
                            ((void *)0)
# 222 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
    ...
    if (!
# 226 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
        1
# 226 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                          ) {
        return ((0x8000) + 3);
    }
...
{
    if (r == 
# 237 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
            ((void *)0)
# 237 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                ) {
        return 0x102;
    }

    if (!
# 241 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
        1
# 241 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                          ) {
        return ((0x8000) + 3);
    }
...
{
    if (r == 
# 304 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
            ((void *)0)
# 304 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                ) {
        return 0x102;
    }

    if (!
# 308 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
        1
# 308 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                          ) {
        return ((0x8000) + 3);
    }
    ...
    if (!ra->first_chunk_sent) {
        ...
        ra->first_chunk_sent = 
# 360 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
                              1
# 360 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                                  ;
    }
...
esp_err_t httpd_resp_send_err(httpd_req_t *req, httpd_err_code_t error, const char *usr_msg)
{
    ...
    do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "%s - %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, status, msg); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "%s - %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, status, msg); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "%s - %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, status, msg); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "%s - %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, status, msg); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "%s - %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, status, msg); } } while(0); } while(0);
    ...
    if (setsockopt(ra->sd->fd, 6, 0x01, &nodelay, sizeof(nodelay)) < 0) {
        ...
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error calling setsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error calling setsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error calling setsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error calling setsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error calling setsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } } while(0); } while(0);
        nodelay = 0;
    }
    ...
    if (nodelay == 1) {
        ...
        if (setsockopt(ra->sd->fd, 6, 0x01, &nodelay, sizeof(nodelay)) < 0) {
            ...
            do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error calling setsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error calling setsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error calling setsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error calling setsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error calling setsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } } while(0); } while(0);
            return 0x103;
        }
    }
...
{
    if (handle == 
# 476 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
                 ((void *)0) 
# 476 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
...
# 501 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
                                       ((void *)0)
# 501 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                                           );
        ret = -1;
    }
    return ret;
...
{
    if (r == 
# 509 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
            ((void *)0) 
# 509 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                 || buf == 
# 509 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
                           ((void *)0)
# 509 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
    ...
    if (!
# 513 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
        1
# 513 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                          ) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "invalid request" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "invalid request" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "invalid request" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "invalid request" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "invalid request" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        return -2;
    }

    struct httpd_req_aux *ra = r->aux;
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "remaining length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->remaining_len); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "remaining length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->remaining_len); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "remaining length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->remaining_len); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "remaining length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->remaining_len); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "remaining length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ra->remaining_len); } } while(0); } while(0);
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "received length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "received length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "received length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "received length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "received length = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ret); } } while(0); } while(0);
    return ret;
}
...
{
    if (r == 
# 540 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
            ((void *)0)
# 540 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                ) {
        return -1;
    }

    if (!
# 544 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
        1
# 544 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                          ) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "invalid request" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "invalid request" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "invalid request" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "invalid request" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "invalid request" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        return -1;
    }
...
static int httpd_sock_err(const char *ctx, int sockfd)
{
    ...
    if (getsockopt(sockfd, 0xfff, 0x1007, &sock_err, &sock_err_len) < 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error calling getsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error calling getsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error calling getsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error calling getsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error calling getsockopt : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } } while(0); } while(0);
        return -1;
    }
    do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error in %s : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ctx, sock_err); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error in %s : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ctx, sock_err); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error in %s : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ctx, sock_err); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error in %s : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ctx, sock_err); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error in %s : %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, ctx, sock_err); } } while(0); } while(0);
...
int httpd_default_send(httpd_handle_t hd, int sockfd, const char *buf, size_t buf_len, int flags)
{
    (void)hd;
    if (buf == 
# 585 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
              ((void *)0)
# 585 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                  ) {
        return -2;
    }
...
int httpd_default_recv(httpd_handle_t hd, int sockfd, char *buf, size_t buf_len, int flags)
{
    (void)hd;
    if (buf == 
# 599 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c" 3 4
              ((void *)0)
# 599 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_txrx.c"
                  ) {
        return -2;
    }
