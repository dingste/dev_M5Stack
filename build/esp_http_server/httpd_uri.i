# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/esp_http_server//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 2
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 2
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 2
...
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 2

static const char *TAG = "httpd_uri";

static 
# 26 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
      _Bool 
# 26 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
...
# 32 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
_Bool 
# 32 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
    httpd_uri_match_wildcard(const char *template, const char *uri, size_t len)
{
    ...
    const 
# 40 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
         _Bool 
# 40 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
              asterisk = last == '*' || (prevlast == '*' && last == '?');
    const 
# 41 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
         _Bool 
# 41 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
              quest = last == '?' || (prevlast == '?' && last == '*');
# 54 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
    if (exact_match_chars < asterisk + quest*2) {
        return 
# 55 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
              0
# 55 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                   ;
    }
    ...
    if (len < exact_match_chars) {
        return 
# 62 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
              0
# 62 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                   ;
    }
    ...
    if (!quest) {
        if (!asterisk && len != exact_match_chars) {
            ...
            return 
# 68 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                  0
# 68 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                       ;
        }
        ...
        if (len > exact_match_chars && template[exact_match_chars] != uri[exact_match_chars]) {
            ...
            return 
# 77 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                  0
# 77 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                       ;
        }
        if (strncmp(template, uri, exact_match_chars) != 0) {

            return 
# 81 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                  0
# 81 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                       ;
        }
                                           ...
                                           httpd_err_code_t *err)
{
    ...
    for (int i = 0; i < hd->config.max_uri_handlers; i++) {
        ...
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "[%d] = %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "[%d] = %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "[%d] = %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "[%d] = %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "[%d] = %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } } while(0); } while(0);
    ...
    return 
# 131 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
          ((void *)0)
# 131 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
              ;
}
...
{
    if (handle == 
# 137 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                 ((void *)0) 
# 137 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                      || uri_handler == 
# 137 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                        ((void *)0)
# 137 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
    ...
    if (httpd_find_uri_handler(handle, uri_handler->uri,
                               ...
                               uri_handler->method, 
# 149 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                                   ((void *)0)
# 149 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                                       ) != 
# 149 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                                            ((void *)0)
# 149 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                                                ) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "handler %s with method %d already registered" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri_handler->uri, uri_handler->method); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "handler %s with method %d already registered" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri_handler->uri, uri_handler->method); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "handler %s with method %d already registered" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri_handler->uri, uri_handler->method); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "handler %s with method %d already registered" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri_handler->uri, uri_handler->method); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "handler %s with method %d already registered" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri_handler->uri, uri_handler->method); } } while(0); } while(0)
                                                       ;
        return ((0x8000) + 2);
    }
    ...
    for (int i = 0; i < hd->config.max_uri_handlers; i++) {
        if (hd->hd_calls[i] == 
# 156 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                              ((void *)0)
# 156 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                  ) {
            hd->hd_calls[i] = malloc(sizeof(httpd_uri_t));
            if (hd->hd_calls[i] == 
# 158 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                  ((void *)0)
# 158 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                      ) {
...
# 165 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                       ((void *)0)
# 165 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                           ) {
            ...
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "[%d] installed %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, uri_handler->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "[%d] installed %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, uri_handler->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "[%d] installed %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, uri_handler->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "[%d] installed %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, uri_handler->uri); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "[%d] installed %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, uri_handler->uri); } } while(0); } while(0);
            return 0;
        }
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "[%d] exists %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "[%d] exists %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "[%d] exists %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "[%d] exists %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "[%d] exists %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } } while(0); } while(0);
    }
    do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "no slots left for registering handler" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "no slots left for registering handler" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "no slots left for registering handler" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "no slots left for registering handler" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "no slots left for registering handler" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
    return ((0x8000) + 1);
}
...
{
    if (handle == 
# 187 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                 ((void *)0) 
# 187 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                      || uri == 
# 187 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                ((void *)0)
# 187 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
    ...
    for (int i = 0; i < hd->config.max_uri_handlers; i++) {
        ...
        if ((hd->hd_calls[i]->method == method) &&
            ...
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "[%d] removing %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "[%d] removing %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "[%d] removing %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "[%d] removing %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "[%d] removing %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } } while(0); } while(0);

            free((char*)hd->hd_calls[i]->uri);
            free(hd->hd_calls[i]);
            hd->hd_calls[i] = 
# 202 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                             ((void *)0)
# 202 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                 ;
            ...
            hd->hd_calls[i-1] = 
# 213 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                               ((void *)0)
# 213 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                   ;
            return 0;
        }
    }
    do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "handler %s with method %d not found" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri, method); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "handler %s with method %d not found" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri, method); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "handler %s with method %d not found" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri, method); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "handler %s with method %d not found" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri, method); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "handler %s with method %d not found" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri, method); } } while(0); } while(0);
    return 0x105;
}
...
{
    if (handle == 
# 223 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                 ((void *)0) 
# 223 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                      || uri == 
# 223 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                ((void *)0)
# 223 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
...
# 228 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
   _Bool 
# 228 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
        found = 
# 228 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                0
# 228 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
    ...
    for (; i < hd->config.max_uri_handlers; i++) {
        ...
        if (strcmp(hd->hd_calls[i]->uri, uri) == 0) {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "[%d] removing %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, uri); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "[%d] removing %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, uri); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "[%d] removing %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, uri); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "[%d] removing %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, uri); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "[%d] removing %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, uri); } } while(0); } while(0);

            free((char*)hd->hd_calls[i]->uri);
            free(hd->hd_calls[i]);
            hd->hd_calls[i] = 
# 240 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                             ((void *)0)
# 240 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                 ;
            found = 
# 241 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                   1
# 241 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                       ;
    ...
    for (int k = (i - j); k < i; k++) {
        hd->hd_calls[k] = 
# 252 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                         ((void *)0)
# 252 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                             ;
    }

    if (!found) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "no handler found for URI %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "no handler found for URI %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "no handler found for URI %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "no handler found for URI %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "no handler found for URI %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, uri); } } while(0); } while(0);
    }
...
void httpd_unregister_all_uri_handlers(struct httpd_data *hd)
{
    for (unsigned i = 0; i < hd->config.max_uri_handlers; i++) {
        ...
        free(hd->hd_calls[i]);
        hd->hd_calls[i] = 
# 271 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                         ((void *)0)
# 271 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                             ;
    }
}
...
{
    httpd_uri_t *uri = 
# 277 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                 ((void *)0)
# 277 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                     ;
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "request for %s with type %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->uri, req->method); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "request for %s with type %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->uri, req->method); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "request for %s with type %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->uri, req->method); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "request for %s with type %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->uri, req->method); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "request for %s with type %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->uri, req->method); } } while(0); } while(0);
    ...
    if (uri == 
# 293 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
              ((void *)0)
# 293 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                  ) {
        switch (err) {
            case HTTPD_404_NOT_FOUND:
                do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "URI '%s' not found" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->uri); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "URI '%s' not found" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->uri); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "URI '%s' not found" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->uri); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "URI '%s' not found" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->uri); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "URI '%s' not found" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->uri); } } while(0); } while(0);
                return httpd_req_handle_err(req, HTTPD_404_NOT_FOUND);
            case HTTPD_405_METHOD_NOT_ALLOWED:
                do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "Method '%d' not allowed for URI '%s'" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->method, req->uri); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "Method '%d' not allowed for URI '%s'" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->method, req->uri); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "Method '%d' not allowed for URI '%s'" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->method, req->uri); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "Method '%d' not allowed for URI '%s'" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->method, req->uri); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "Method '%d' not allowed for URI '%s'" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, req->method, req->uri); } } while(0); } while(0)
                                               ;
    ...
    if (uri->handler(req) != 0) {
        ...
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "uri handler execution failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "uri handler execution failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "uri handler execution failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "uri handler execution failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "uri handler execution failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        return -1;
    }
    return 0;
}
