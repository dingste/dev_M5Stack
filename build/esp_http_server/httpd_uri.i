...
{
    if (handle == 
# 45 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                 ((void *)0) 
# 45 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                      || uri_handler == 
# 45 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                        ((void *)0)
# 45 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
...
# 62 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
            ...
            if (hd->hd_calls[i] == 
# 64 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                  ((void *)0)
# 64 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                      ) {
...
# 71 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                       ((void *)0)
# 71 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                           ) {
...
{
    if (handle == 
# 93 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                 ((void *)0) 
# 93 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                      || uri == 
# 93 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                ((void *)0)
# 93 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
    ...
    if (i != -1) {
        ...
        free(hd->hd_calls[i]);
        hd->hd_calls[i] = 
# 105 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                         ((void *)0)
# 105 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                             ;
        return 0;
    }
...
{
    if (handle == 
# 114 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                 ((void *)0) 
# 114 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                      || uri == 
# 114 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                ((void *)0)
# 114 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
...
# 119 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
   _Bool 
# 119 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
        found = 
# 119 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                0
# 119 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
    ...
    for (int i = 0; i < hd->config.max_uri_handlers; i++) {
        if ((hd->hd_calls[i] != 
# 122 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                               ((void *)0)
# 122 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                   ) &&
            (strcmp(hd->hd_calls[i]->uri, uri) == 0)) {
            ...
            free(hd->hd_calls[i]);
            hd->hd_calls[i] = 
# 128 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                             ((void *)0)
# 128 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                 ;
            found = 
# 129 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                   1
# 129 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                       ;
        }
    }
    if (!found) {
                                            ...
                                            httpd_method_t method)
{
    *err = 0;
    for (int i = 0; i < hd->config.max_uri_handlers; i++) {
        if (hd->hd_calls[i]) {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "[%d] = %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "[%d] = %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "[%d] = %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "[%d] = %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "[%d] = %s" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, i, hd->hd_calls[i]->uri); } } while(0); } while(0);
            if ((strlen(hd->hd_calls[i]->uri) == uri_len) &&
    ...
    return 
# 179 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
          ((void *)0)
# 179 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
              ;
}
...
{
    httpd_uri_t *uri = 
# 184 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
                                 ((void *)0)
# 184 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                                     ;
    ...
    if (uri == 
# 201 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c" 3 4
              ((void *)0)
# 201 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_uri.c"
                  ) {
        switch (err) {
