# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/esp_http_server//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 2
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 2



# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/include/esp_http_server.h" 1
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/include/esp_http_server.h"
...
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/include/esp_http_server.h" 2
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/include/sdkconfig.h" 1
...
# 24 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 2
...
# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/util/ctrl_sock.h" 1
# 48 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/util/ctrl_sock.h"
int cs_create_ctrl_sock(int port);
# 58 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/util/ctrl_sock.h"
void cs_free_ctrl_sock(int fd);
# 75 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/util/ctrl_sock.h"
int cs_send_to_ctrl_sock(int send_fd, int port, void *data, unsigned int data_len);
# 93 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/util/ctrl_sock.h"
int cs_recv_from_ctrl_sock(int fd, void *data, unsigned int data_len);
# 26 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 2
...
# 32 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
                                      1
# 32 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                                          ) {
    ...
    if (new_fd < 0) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error in accept (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error in accept (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error in accept (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error in accept (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error in accept (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } } while(0); } while(0);
        return -1;
    }
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "newfd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, new_fd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "newfd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, new_fd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "newfd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, new_fd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "newfd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, new_fd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "newfd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, new_fd); } } while(0); } while(0);

    struct timeval tv;

    tv.tv_sec = hd->config.recv_wait_timeout;
    tv.tv_usec = 0;
    setsockopt(new_fd, 0xfff, 0x1006, (const char*)&tv, sizeof(tv));


    tv.tv_sec = hd->config.send_wait_timeout;
    tv.tv_usec = 0;
    setsockopt(new_fd, 0xfff, 0x1005, (const char*)&tv, sizeof(tv));

    if (0 != httpd_sess_new(hd, new_fd)) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "session creation failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "session creation failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "session creation failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "session creation failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "session creation failed" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        close(new_fd);
        return -1;
    }
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "complete" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "complete" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "complete" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "complete" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "complete" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
    return 0;
}
...
{
    if (handle == 
# 85 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
                 ((void *)0) 
# 85 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                      || work == 
# 85 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
                                 ((void *)0)
# 85 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
    ...
    if (ret < 0) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "failed to queue work" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "failed to queue work" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "failed to queue work" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "failed to queue work" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "failed to queue work" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        return -1;
    }
...
static void httpd_close_all_sessions(struct httpd_data *hd)
{
    ...
    while ((fd = httpd_sess_iterate(hd, fd)) != -1) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "cleaning up socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "cleaning up socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "cleaning up socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "cleaning up socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "cleaning up socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } } while(0); } while(0);
...
static void httpd_process_ctrl_msg(struct httpd_data *hd)
{
    ...
    if (ret <= 0) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error in recv (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error in recv (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error in recv (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error in recv (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error in recv (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } } while(0); } while(0);
        return;
    }
    if (ret != sizeof(msg)) {
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "incomplete msg" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "incomplete msg" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "incomplete msg" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "incomplete msg" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "incomplete msg" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        return;
    }
    ...
    case HTTPD_CTRL_WORK:
        if (msg.hc_work) {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "work" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "work" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "work" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "work" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "work" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
            (*msg.hc_work)(msg.hc_work_arg);
        }
        break;
    case HTTPD_CTRL_SHUTDOWN:
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "shutdown" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "shutdown" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "shutdown" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "shutdown" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "shutdown" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
...
{
    _types_fd_set read_set;
    (__extension__ (void)({ size_t __i; char *__tmp = (char *)&read_set; for (__i = 0; __i < sizeof (*(&read_set)); ++__i) *__tmp++ = 0; }));
    if (hd->config.lru_purge_enable || httpd_is_sess_available(hd)) {



        ((&read_set)->fds_bits[(hd->listen_fd)/(sizeof (fd_mask) * 8)] |= (1L << ((hd->listen_fd) % (sizeof (fd_mask) * 8))));
    }
    ((&read_set)->fds_bits[(hd->ctrl_fd)/(sizeof (fd_mask) * 8)] |= (1L << ((hd->ctrl_fd) % (sizeof (fd_mask) * 8))));

    int tmp_max_fd;
    httpd_sess_set_descriptors(hd, &read_set, &tmp_max_fd);
    int maxfd = ((hd->listen_fd) > (tmp_max_fd) ? (hd->listen_fd) : (tmp_max_fd));
    tmp_max_fd = maxfd;
    maxfd = ((hd->ctrl_fd) > (tmp_max_fd) ? (hd->ctrl_fd) : (tmp_max_fd));

    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "doing select maxfd+1 = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, maxfd + 1); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "doing select maxfd+1 = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, maxfd + 1); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "doing select maxfd+1 = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, maxfd + 1); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "doing select maxfd+1 = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, maxfd + 1); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "doing select maxfd+1 = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, maxfd + 1); } } while(0); } while(0);
    int active_cnt = select(maxfd + 1, &read_set, 
# 174 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
                                                 ((void *)0)
# 174 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                                                     , 
# 174 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
                                                       ((void *)0)
# 174 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
...
# 174 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
    ...
    if (active_cnt < 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error in select (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error in select (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error in select (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error in select (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error in select (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } } while(0); } while(0);
        httpd_sess_delete_invalid(hd);
        return 0;
    }


    if (((&read_set)->fds_bits[(hd->ctrl_fd)/(sizeof (fd_mask) * 8)] & (1L << ((hd->ctrl_fd) % (sizeof (fd_mask) * 8))))) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "processing ctrl message" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "processing ctrl message" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "processing ctrl message" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "processing ctrl message" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "processing ctrl message" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        httpd_process_ctrl_msg(hd);
        if (hd->hd_td.status == THREAD_STOPPING) {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "stopping thread" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "stopping thread" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "stopping thread" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "stopping thread" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "stopping thread" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
            return -1;
        }
    }
    ...
    int fd = -1;
    while ((fd = httpd_sess_iterate(hd, fd)) != -1) {
        if (((&read_set)->fds_bits[(fd)/(sizeof (fd_mask) * 8)] & (1L << ((fd) % (sizeof (fd_mask) * 8)))) || (httpd_sess_pending(hd, fd))) {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "processing socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "processing socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "processing socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "processing socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "processing socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } } while(0); } while(0);
            if (httpd_sess_process(hd, fd) != 0) {
                do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "closing socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "closing socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "closing socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "closing socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "closing socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } } while(0); } while(0);
                close(fd);
    ...
    if (((&read_set)->fds_bits[(hd->listen_fd)/(sizeof (fd_mask) * 8)] & (1L << ((hd->listen_fd) % (sizeof (fd_mask) * 8))))) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "processing listen socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, hd->listen_fd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "processing listen socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, hd->listen_fd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "processing listen socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, hd->listen_fd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "processing listen socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, hd->listen_fd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "processing listen socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, hd->listen_fd); } } while(0); } while(0);
        if (httpd_accept_conn(hd, hd->listen_fd) != 0) {
            do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error accepting new connection" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error accepting new connection" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error accepting new connection" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error accepting new connection" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error accepting new connection" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        }
    }
    return 0;
}
...
static void httpd_thread(void *arg)
{
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "web server started" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "web server started" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "web server started" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "web server started" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "web server started" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
    while (1) {
        ret = httpd_server(hd);
        if (ret != 0) {
            break;
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "web server exiting" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "web server exiting" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "web server exiting" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "web server exiting" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "web server exiting" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
    close(hd->msg_fd);
...
static esp_err_t httpd_server_init(struct httpd_data *hd)
{
    ...
    if (fd < 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error in socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error in socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error in socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error in socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error in socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } } while(0); } while(0);
        return -1;
    }
    ...
    struct sockaddr_in6 serv_addr = {
        ...
        .sin6_port = lwip_htons(hd->config.server_port)
    };
    ...
    if (setsockopt(fd, 0xfff, 0x0004, &enable, sizeof(enable)) < 0) {
        ...
        do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error enabling SO_REUSEADDR (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error enabling SO_REUSEADDR (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error enabling SO_REUSEADDR (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error enabling SO_REUSEADDR (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error enabling SO_REUSEADDR (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } } while(0); } while(0);
    }

    int ret = bind(fd, (struct sockaddr *)&serv_addr, sizeof(serv_addr));
    if (ret < 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error in bind (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error in bind (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error in bind (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error in bind (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error in bind (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } } while(0); } while(0);
        close(fd);
        return -1;
    }
    ...
    if (ret < 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error in listen (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error in listen (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error in listen (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error in listen (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error in listen (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } } while(0); } while(0);
        close(fd);
        return -1;
    }
    ...
    if (ctrl_fd < 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error in creating ctrl socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error in creating ctrl socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error in creating ctrl socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error in creating ctrl socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error in creating ctrl socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } } while(0); } while(0);
        close(fd);
        return -1;
    }
    ...
    if (msg_fd < 0) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "error in creating msg socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "error in creating msg socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "error in creating msg socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "error in creating msg socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "error in creating msg socket (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, (*__errno())); } } while(0); } while(0);
        close(fd);
        close(ctrl_fd);
        return -1;
    }
...
static struct httpd_data *httpd_create(const httpd_config_t *config)
{
    ...
    if (!hd) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP server instance" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP server instance" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP server instance" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP server instance" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP server instance" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        return 
# 307 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
              ((void *)0)
# 307 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                  ;
    }
    hd->hd_calls = calloc(config->max_uri_handlers, sizeof(httpd_uri_t *));
    if (!hd->hd_calls) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP URI handlers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP URI handlers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP URI handlers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP URI handlers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP URI handlers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        free(hd);
        return 
# 313 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
              ((void *)0)
# 313 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                  ;
    }
    hd->hd_sd = calloc(config->max_open_sockets, sizeof(struct sock_db));
    if (!hd->hd_sd) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP session data" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP session data" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP session data" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP session data" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP session data" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        free(hd->hd_calls);
        free(hd);
        return 
# 320 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
              ((void *)0)
# 320 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                  ;
    }
    struct httpd_req_aux *ra = &hd->hd_req_aux;
    ra->resp_hdrs = calloc(config->max_resp_headers, sizeof(struct resp_hdr));
    if (!ra->resp_hdrs) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP response headers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP response headers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP response headers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP response headers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP response headers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        free(hd->hd_sd);
        free(hd->hd_calls);
        free(hd);
        return 
# 329 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
              ((void *)0)
# 329 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                  ;
    }
    hd->err_handler_fns = calloc(HTTPD_ERR_CODE_MAX, sizeof(httpd_err_handler_func_t));
    if (!hd->err_handler_fns) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP error handlers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP error handlers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP error handlers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP error handlers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "Failed to allocate memory for HTTP error handlers" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
        free(ra->resp_hdrs);
        free(hd->hd_sd);
        free(hd->hd_calls);
        free(hd);
        return 
# 338 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
              ((void *)0)
# 338 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                  ;
    }
...
{
    if (handle == 
# 361 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
                 ((void *)0) 
# 361 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                      || config == 
# 361 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
                                   ((void *)0)
# 361 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
...
# 375 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
    if (10 < config->max_open_sockets + 3) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Configuration option max_open_sockets is too large (max allowed %d)\n\t" "Either decrease this or configure LWIP_MAX_SOCKETS to a larger value" "\033[0m" "\n", esp_log_timestamp(), TAG, 10 - 3); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Configuration option max_open_sockets is too large (max allowed %d)\n\t" "Either decrease this or configure LWIP_MAX_SOCKETS to a larger value" "\033[0m" "\n", esp_log_timestamp(), TAG, 10 - 3); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Configuration option max_open_sockets is too large (max allowed %d)\n\t" "Either decrease this or configure LWIP_MAX_SOCKETS to a larger value" "\033[0m" "\n", esp_log_timestamp(), TAG, 10 - 3); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Configuration option max_open_sockets is too large (max allowed %d)\n\t" "Either decrease this or configure LWIP_MAX_SOCKETS to a larger value" "\033[0m" "\n", esp_log_timestamp(), TAG, 10 - 3); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Configuration option max_open_sockets is too large (max allowed %d)\n\t" "Either decrease this or configure LWIP_MAX_SOCKETS to a larger value" "\033[0m" "\n", esp_log_timestamp(), TAG, 10 - 3); } } while(0); } while(0)
    ...
    if (hd == 
# 383 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
             ((void *)0)
# 383 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                 ) {
...
esp_err_t httpd_stop(httpd_handle_t handle)
{
    struct httpd_data *hd = (struct httpd_data *) handle;
    if (hd == 
# 410 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
             ((void *)0)
# 410 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                 ) {
        return 0x102;
    }
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "sent control msg to stop server" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "sent control msg to stop server" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "sent control msg to stop server" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "sent control msg to stop server" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "sent control msg to stop server" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
...
# 431 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
                                    ((void *)0)
# 431 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                                        ;
    }
...
# 441 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c" 3 4
                                         ((void *)0)
# 441 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_main.c"
                                             ;
    }

    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "server stopped" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "server stopped" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "server stopped" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "server stopped" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "server stopped" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
    httpd_delete(hd);
    return 0;
}
