# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/esp_http_server//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 2
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 2

static const char *TAG = "httpd_sess";


# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
_Bool 
# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
    httpd_is_sess_available(struct httpd_data *hd)
{
    int i;
    for (i = 0; i < hd->config.max_open_sockets; i++) {
        if (hd->hd_sd[i].fd == -1) {
            return 
# 30 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
                  1
# 30 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                      ;
        }
    }
    return 
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
          0
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
               ;
}
...
{
    if (hd == 
# 38 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
             ((void *)0)
# 38 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                 ) {
        return 
# 39 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
              ((void *)0)
# 39 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                  ;
    }
    ...
    return 
# 56 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
          ((void *)0)
# 56 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
              ;
}

esp_err_t httpd_sess_new(struct httpd_data *hd, int newfd)
{
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } } while(0); } while(0);

    if (httpd_sess_get(hd, newfd)) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "session already exists with fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "session already exists with fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "session already exists with fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "session already exists with fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "session already exists with fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } } while(0); } while(0);
        return -1;
    }
        ...
        if (hd->hd_sd[i].fd == -1) {
            ...
            if (hd->config.open_fn) {
                ...
                if (ret != 0) {
                    ...
                    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "open_fn failed for fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "open_fn failed for fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "open_fn failed for fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "open_fn failed for fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "open_fn failed for fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } } while(0); } while(0);
                    return ret;
                }
            }
            return 0;
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "unable to launch session for fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "unable to launch session for fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "unable to launch session for fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "unable to launch session for fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "unable to launch session for fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, newfd); } } while(0); } while(0);
    return -1;
}
...
void *httpd_sess_get_ctx(httpd_handle_t handle, int sockfd)
{
    ...
    if (sd == 
# 107 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
             ((void *)0)
# 107 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                 ) {
        return 
# 108 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
              ((void *)0)
# 108 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                  ;
    }
...
void httpd_sess_set_ctx(httpd_handle_t handle, int sockfd, void *ctx, httpd_free_ctx_fn_t free_fn)
{
    struct sock_db *sd = httpd_sess_get(handle, sockfd);
    if (sd == 
# 125 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
             ((void *)0)
# 125 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                 ) {
        return;
    }
...
void *httpd_sess_get_transport_ctx(httpd_handle_t handle, int sockfd)
{
    struct sock_db *sd = httpd_sess_get(handle, sockfd);
    if (sd == 
# 159 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
             ((void *)0)
# 159 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                 ) {
        return 
# 160 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
              ((void *)0)
# 160 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                  ;
    }
...
void httpd_sess_set_transport_ctx(httpd_handle_t handle, int sockfd, void *ctx, httpd_free_ctx_fn_t free_fn)
{
    struct sock_db *sd = httpd_sess_get(handle, sockfd);
    if (sd == 
# 169 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
             ((void *)0)
# 169 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                 ) {
        return;
    }
...
void httpd_sess_set_descriptors(struct httpd_data *hd,
                                _types_fd_set *fdset, int *maxfd)
{
    int i;
    *maxfd = -1;
    for (i = 0; i < hd->config.max_open_sockets; i++) {
        if (hd->hd_sd[i].fd != -1) {
            ((fdset)->fds_bits[(hd->hd_sd[i].fd)/(sizeof (fd_mask) * 8)] |= (1L << ((hd->hd_sd[i].fd) % (sizeof (fd_mask) * 8))));
...
void httpd_sess_delete_invalid(struct httpd_data *hd)
{
    for (int i = 0; i < hd->config.max_open_sockets; i++) {
        if (hd->hd_sd[i].fd != -1 && !fd_is_valid(hd->hd_sd[i].fd)) {
            do { if ( 3 >= ESP_LOG_WARN ) do { if (ESP_LOG_WARN==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "Closing invalid socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, hd->hd_sd[i].fd); } else if (ESP_LOG_WARN==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "Closing invalid socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, hd->hd_sd[i].fd); } else if (ESP_LOG_WARN==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "Closing invalid socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, hd->hd_sd[i].fd); } else if (ESP_LOG_WARN==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "Closing invalid socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, hd->hd_sd[i].fd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "Closing invalid socket %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, hd->hd_sd[i].fd); } } while(0); } while(0);
            httpd_sess_delete(hd, hd->hd_sd[i].fd);
        }
    }
}
...
{
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, fd); } } while(0); } while(0);
    int i;
    int pre_sess_fd = -1;
    for (i = 0; i < hd->config.max_open_sockets; i++) {
        if (hd->hd_sd[i].fd == fd) {
            ...
            if (hd->hd_sd[i].ctx) {
                ...
                hd->hd_sd[i].ctx = 
# 237 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
                                  ((void *)0)
# 237 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                                      ;
                hd->hd_sd[i].free_ctx = 
# 238 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
                                       ((void *)0)
# 238 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                                           ;
            }
            ...
            if (hd->hd_sd[i].transport_ctx) {
                ...
                hd->hd_sd[i].transport_ctx = 
# 248 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
                                            ((void *)0)
# 248 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                                                ;
                hd->hd_sd[i].free_transport_ctx = 
# 249 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
                                                 ((void *)0)
# 249 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                                                     ;
            }
...
void httpd_sess_init(struct httpd_data *hd)
{
    ...
    for (i = 0; i < hd->config.max_open_sockets; i++) {
        hd->hd_sd[i].fd = -1;
        hd->hd_sd[i].ctx = 
# 270 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
                          ((void *)0)
# 270 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                              ;
    }
}


# 274 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
_Bool 
# 274 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
    httpd_sess_pending(struct httpd_data *hd, int fd)
{
    ...
    if (sd->pending_fn) {
        ...
        if (sd->pending_fn(hd, fd) > 0) return 
# 284 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
                                              1
# 284 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                                                  ;
    }
...
esp_err_t httpd_sess_process(struct httpd_data *hd, int newfd)
{
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "httpd_req_new" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "httpd_req_new" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "httpd_req_new" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "httpd_req_new" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "httpd_req_new" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
    if (httpd_req_new(hd, sd) != 0) {
        return -1;
    }
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "httpd_req_delete" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "httpd_req_delete" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "httpd_req_delete" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "httpd_req_delete" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "httpd_req_delete" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
    if (httpd_req_delete(hd) != 0) {
        return -1;
    }
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "success" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "success" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "success" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "success" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "success" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__); } } while(0); } while(0);
...
{
    if (handle == 
# 316 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c" 3 4
                 ((void *)0)
# 316 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/esp_http_server/src/httpd_sess.c"
                     ) {
        return 0x102;
    }
...
esp_err_t httpd_sess_close_lru(struct httpd_data *hd)
{
    uint64_t lru_counter = 0xffffffffffffffffULL;
    int lru_fd = -1;
    int i;
    for (i = 0; i < hd->config.max_open_sockets; i++) {
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, lru_fd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, lru_fd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, lru_fd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, lru_fd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s: " "fd = %d" "\033[0m" "\n", esp_log_timestamp(), TAG, __func__, lru_fd); } } while(0); } while(0);
...
static void httpd_sess_close(void *arg)
{
    ...
    if (sock_db) {
        if (sock_db->lru_counter == 0) {
            do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Skipping session close for %d as it seems to be a race condition" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_db->fd); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Skipping session close for %d as it seems to be a race condition" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_db->fd); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Skipping session close for %d as it seems to be a race condition" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_db->fd); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Skipping session close for %d as it seems to be a race condition" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_db->fd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Skipping session close for %d as it seems to be a race condition" "\033[0m" "\n", esp_log_timestamp(), TAG, sock_db->fd); } } while(0); } while(0);
            return;
        }
        int fd = sock_db->fd;
