# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/gpio.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/gpio.c"
# 14 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/gpio.c"
...
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/gpio.c" 2
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/gpio.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/gpio.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/gpio.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/gpio.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/include/soc/rtc_periph.h"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/rtc_cntl_reg.h" 1
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/include/soc/rtc_periph.h" 2
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/gpio.c" 2
...
esp_err_t gpio_pullup_en(gpio_num_t gpio_num)
{
    ...
    if (rtc_gpio_is_valid_gpio(gpio_num)) {
        ...
        ({ ; (*(volatile uint32_t*)(GPIO_PIN_MUX_REG[gpio_num]) |= (((1UL << (8))))); });
    }
    return 0;
}
...
esp_err_t gpio_pulldown_en(gpio_num_t gpio_num)
{
    ...
    if (rtc_gpio_is_valid_gpio(gpio_num)) {
        ...
        ({ ; (*(volatile uint32_t*)(GPIO_PIN_MUX_REG[gpio_num]) |= (((1UL << (7))))); });
    }
    return 0;
}
...
static esp_err_t gpio_output_disable(gpio_num_t gpio_num)
{
    ...
    ({ ; (*(volatile uint32_t *)((0x3ff44000 + 0x0530) + (gpio_num * 4))) = (256); })
                               ;
...
esp_err_t gpio_set_direction(gpio_num_t gpio_num, gpio_mode_t mode)
{
    ...
    esp_err_t ret = 0;
    if (mode & (0x00000001)) {
        ({ ; ({ ; (*((volatile uint32_t *)((GPIO_PIN_MUX_REG[gpio_num])))) = (uint32_t)((({ ; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[gpio_num]))); })|(((1UL << (9)))))); }); });
    } else {
        ({ ; ({ ; (*((volatile uint32_t *)((GPIO_PIN_MUX_REG[gpio_num])))) = (uint32_t)((({ ; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[gpio_num]))); })&(~(((1UL << (9))))))); }); });
    }
    if (mode & (0x00000002)) {
    ...
    do {
        ...
        if (((gpio_pin_mask >> io_num) & (1UL << (0)))) {
            ...
            if ((pGPIOConfig->mode) & (0x00000001)) {
                input_en = 1;
                ({ ; ({ ; (*((volatile uint32_t *)((GPIO_PIN_MUX_REG[io_num])))) = (uint32_t)((({ ; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[io_num]))); })|(((1UL << (9)))))); }); });
            } else {
                ({ ; ({ ; (*((volatile uint32_t *)((GPIO_PIN_MUX_REG[io_num])))) = (uint32_t)((({ ; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[io_num]))); })&(~(((1UL << (9))))))); }); });
            }
            ...
            ({ ; (({ ; (*(volatile uint32_t *)((io_reg))) = (((({ ; (*(volatile uint32_t *)(io_reg)); }) & ~((0x7) << (12)))|(((2) & (0x7))<<(12)))); })); });
        }
        io_num++;
    } while (io_num < 40);
    return 0;
...
esp_err_t gpio_set_drive_capability(gpio_num_t gpio_num, gpio_drive_cap_t strength)
{
    ...
    if (rtc_gpio_is_valid_gpio(gpio_num)) {
        ...
        ({ ; (({ ; (*((volatile uint32_t *)((GPIO_PIN_MUX_REG[gpio_num])))) = (uint32_t)((({ ; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[gpio_num]))); })&(~((0x3)<<(10))))|(((strength) & 0x3)<<(10))); })); });
    }
    return 0;
}
...
# 519 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/gpio.c"
    ...
    if (rtc_gpio_is_valid_gpio(gpio_num)) {
        ...
        *strength = ({ ; ((({ ; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[gpio_num]))); })>>(10))&(0x3)); });
    }
    return 0;
}
...
esp_err_t gpio_hold_en(gpio_num_t gpio_num)
{
    ...
    if (rtc_gpio_is_valid_gpio(gpio_num)) {
        ...
        ({ ; ({ ; (*((volatile uint32_t *)(((0x3ff48400 + 0x74))))) = (uint32_t)((({ ; (*((volatile uint32_t *)((0x3ff48400 + 0x74)))); })|(GPIO_HOLD_MASK[gpio_num]))); }); });
    } else {
        r = 0x106;
    }
    return r == 0 ? 0 : 0x106;
...
{
    vTaskEnterCritical(&gpio_spinlock);
    ({ ; ({ ; (*((volatile uint32_t *)(((0x3ff48000 + 0x88))))) = (uint32_t)((({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x88)))); })|(((1UL << (11)))))); }); });
    vTaskExitCritical(&gpio_spinlock);
}
...
void gpio_iomux_in(uint32_t gpio, uint32_t signal_idx)
{
    ...
    ({ ; ({ ; (*((volatile uint32_t *)((GPIO_PIN_MUX_REG[gpio])))) = (uint32_t)((({ ; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[gpio]))); })|(((1UL << (9)))))); }); });
}
                                                    ...
                                                    oen_inv)
{
    ...
    ({ ; (({ ; (*(volatile uint32_t *)((GPIO_PIN_MUX_REG[gpio_num]))) = (((({ ; (*(volatile uint32_t *)(GPIO_PIN_MUX_REG[gpio_num])); }) & ~((0x7) << (12)))|(((func) & (0x7))<<(12)))); })); });
}
