# 1 "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c"
# 1 "/home/dieter/Development/ProjektEi/build/driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c"
# 14 "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c"
...
# 15 "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c" 2
# 1 "/home/dieter/Development/esp-idf/components/driver/include/driver/sigmadelta.h" 1
# 17 "/home/dieter/Development/esp-idf/components/driver/include/driver/sigmadelta.h"
...
# 18 "/home/dieter/Development/esp-idf/components/driver/include/driver/sigmadelta.h" 2
# 1 "/home/dieter/Development/esp-idf/components/soc/include/soc/sigmadelta_periph.h" 1
# 15 "/home/dieter/Development/esp-idf/components/soc/include/soc/sigmadelta_periph.h"
       
# 1 "/home/dieter/Development/esp-idf/components/soc/esp32/include/soc/gpio_sd_struct.h" 1
# 23 "/home/dieter/Development/esp-idf/components/soc/esp32/include/soc/gpio_sd_struct.h"
...
# 17 "/home/dieter/Development/esp-idf/components/soc/include/soc/sigmadelta_periph.h" 2
# 1 "/home/dieter/Development/esp-idf/components/soc/esp32/include/soc/gpio_sd_reg.h" 1
# 17 "/home/dieter/Development/esp-idf/components/soc/esp32/include/soc/gpio_sd_reg.h"
...
# 18 "/home/dieter/Development/esp-idf/components/soc/esp32/include/soc/gpio_sd_reg.h" 2
# 17 "/home/dieter/Development/esp-idf/components/soc/include/soc/sigmadelta_periph.h" 2
# 19 "/home/dieter/Development/esp-idf/components/driver/include/driver/sigmadelta.h" 2
...
# 776 "/home/dieter/Development/esp-idf/components/driver/include/driver/gpio.h"
                                                    oen_inv);
# 20 "/home/dieter/Development/esp-idf/components/driver/include/driver/sigmadelta.h" 2
# 28 "/home/dieter/Development/esp-idf/components/driver/include/driver/sigmadelta.h"
typedef enum{
...
# 59 "/home/dieter/Development/esp-idf/components/driver/include/driver/sigmadelta.h"
esp_err_t sigmadelta_config(const sigmadelta_config_t *config);
# 77 "/home/dieter/Development/esp-idf/components/driver/include/driver/sigmadelta.h"
esp_err_t sigmadelta_set_duty(sigmadelta_channel_t channel, int8_t duty);
# 90 "/home/dieter/Development/esp-idf/components/driver/include/driver/sigmadelta.h"
esp_err_t sigmadelta_set_prescale(sigmadelta_channel_t channel, uint8_t prescale);
# 102 "/home/dieter/Development/esp-idf/components/driver/include/driver/sigmadelta.h"
esp_err_t sigmadelta_set_pin(sigmadelta_channel_t channel, gpio_num_t gpio_num);
# 16 "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c" 2

static const char* SIGMADELTA_TAG = "SIGMADELTA";
# 26 "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c"
esp_err_t sigmadelta_config(const sigmadelta_config_t *config)
{
    if(!(config->channel < SIGMADELTA_CHANNEL_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 28, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SIGMADELTA_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 28, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SIGMADELTA_TAG, "D" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 28, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SIGMADELTA_TAG, "V" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 28, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else { esp_log_write(ESP_LOG_INFO, SIGMADELTA_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 28, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } } while(0); } while(0); return (0x102); };
    if(!(((((config->sigmadelta_gpio < 40 && GPIO_PIN_MUX_REG[config->sigmadelta_gpio] != 0))) && (config->sigmadelta_gpio < 34)))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 29, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SIGMADELTA_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 29, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SIGMADELTA_TAG, "D" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 29, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SIGMADELTA_TAG, "V" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 29, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, SIGMADELTA_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 29, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); } } while(0); } while(0); return (0x102); };
...
esp_err_t sigmadelta_set_duty(sigmadelta_channel_t channel, int8_t duty)
{
    if(!(channel < SIGMADELTA_CHANNEL_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 38, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SIGMADELTA_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 38, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SIGMADELTA_TAG, "D" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 38, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SIGMADELTA_TAG, "V" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 38, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else { esp_log_write(ESP_LOG_INFO, SIGMADELTA_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 38, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } } while(0); } while(0); return (0x102); };
...
esp_err_t sigmadelta_set_prescale(sigmadelta_channel_t channel, uint8_t prescale)
{
    if(!(channel < SIGMADELTA_CHANNEL_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 45, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SIGMADELTA_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 45, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SIGMADELTA_TAG, "D" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 45, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SIGMADELTA_TAG, "V" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 45, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else { esp_log_write(ESP_LOG_INFO, SIGMADELTA_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 45, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } } while(0); } while(0); return (0x102); };
...
esp_err_t sigmadelta_set_pin(sigmadelta_channel_t channel, gpio_num_t gpio_num)
{
    if(!(channel < SIGMADELTA_CHANNEL_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 52, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SIGMADELTA_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 52, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SIGMADELTA_TAG, "D" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 52, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SIGMADELTA_TAG, "V" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 52, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } else { esp_log_write(ESP_LOG_INFO, SIGMADELTA_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 52, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); } } while(0); } while(0); return (0x102); };
    if(!(((((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0))) && (gpio_num < 34)))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 53, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SIGMADELTA_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 53, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SIGMADELTA_TAG, "D" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 53, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SIGMADELTA_TAG, "V" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 53, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, SIGMADELTA_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 53, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); } } while(0); } while(0); return (0x102); };
...
# 54 "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c" 3 4
   ((
# 54 "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c"
...
# 54 "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/driver/sigmadelta.c", 54, __func__, 
# 54 "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c"
   "\"(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff13FFC))"
# 54 "/home/dieter/Development/esp-idf/components/driver/sigmadelta.c" 3 4
   ))
