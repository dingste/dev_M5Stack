# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c"
# 14 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c"
...
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 2
...
# 23 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 2
...
# 24 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 2
...
# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 2
...
# 27 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 2
...
# 28 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 2
...
# 30 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 2
...
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/include/driver/uart_select.h" 1
# 25 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/include/driver/uart_select.h"
typedef enum {
...
# 33 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 2




static const char* UART_TAG = "uart";
# 61 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c"
typedef struct {
    uart_event_type_t type;
    struct {
        int brk_len;
...
# 83 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 3 4
   _Bool 
# 83 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c"
        coll_det_flg;
...
# 90 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 3 4
   _Bool 
# 90 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c"
        rx_buffer_full_flg;
    int rx_cur_remain;
    uint8_t* rx_ptr;
    uint8_t* rx_head_ptr;
...
# 105 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 3 4
   _Bool 
# 105 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c"
        tx_waiting_fifo;
    uint8_t* tx_ptr;
...
esp_err_t uart_set_word_length(uart_port_t uart_num, uart_word_length_t data_bit)
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 124, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 124, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 124, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 124, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 124, "uart_num error"); } } while(0); } while(0); return (-1); };
    if (!((data_bit < UART_DATA_BITS_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 125, "data bit error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 125, "data bit error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 125, "data bit error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 125, "data bit error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 125, "data bit error"); } } while(0); } while(0); return (-1); };
...
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 141, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 141, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 141, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 141, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 141, "uart_num error"); } } while(0); } while(0); return (-1); };
    if (!((stop_bit < UART_STOP_BITS_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 142, "stop bit error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 142, "stop bit error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 142, "stop bit error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 142, "stop bit error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 142, "stop bit error"); } } while(0); } while(0); return (-1); };
...
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 159, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 159, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 159, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 159, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 159, "uart_num error"); } } while(0); } while(0); return (-1); };
...
esp_err_t uart_set_parity(uart_port_t uart_num, uart_parity_t parity_mode)
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 171, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 171, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 171, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 171, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 171, "uart_num error"); } } while(0); } while(0); return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
esp_err_t uart_get_parity(uart_port_t uart_num, uart_parity_t* parity_mode)
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 181, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 181, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 181, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 181, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 181, "uart_num error"); } } while(0); } while(0); return (-1); };
...
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 197, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 197, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 197, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 197, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 197, "uart_num error"); } } while(0); } while(0); return (-1); };
    esp_err_t ret = 0;
    vTaskEnterCritical(&uart_spinlock[uart_num]);
    int uart_clk_freq;
...
esp_err_t uart_get_baudrate(uart_port_t uart_num, uint32_t* baudrate)
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 221, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 221, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 221, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 221, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 221, "uart_num error"); } } while(0); } while(0); return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
esp_err_t uart_set_line_inverse(uart_port_t uart_num, uint32_t inverse_mask)
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 235, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 235, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 235, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 235, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 235, "uart_num error"); } } while(0); } while(0); return (-1); };
    if (!((((inverse_mask & ~(0x3f << 19)) == 0) || (inverse_mask == 0)))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 236, "inverse_mask error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 236, "inverse_mask error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 236, "inverse_mask error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 236, "inverse_mask error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 236, "inverse_mask error"); } } while(0); } while(0); return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
esp_err_t uart_set_sw_flow_ctrl(uart_port_t uart_num, 
# 244 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c" 3 4
                                                     _Bool 
# 244 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c"
                                                          enable, uint8_t rx_thresh_xon, uint8_t rx_thresh_xoff)
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 246, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 246, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 246, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 246, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 246, "uart_num error"); } } while(0); } while(0); return (-1); };
    if (!((rx_thresh_xon < (128)))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 247, "rx flow xon thresh error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 247, "rx flow xon thresh error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 247, "rx flow xon thresh error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 247, "rx flow xon thresh error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 247, "rx flow xon thresh error"); } } while(0); } while(0); return (-1); };
    if (!((rx_thresh_xoff < (128)))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 248, "rx flow xon thresh error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 248, "rx flow xon thresh error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 248, "rx flow xon thresh error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 248, "rx flow xon thresh error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 248, "rx flow xon thresh error"); } } while(0); } while(0); return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
esp_err_t uart_set_hw_flow_ctrl(uart_port_t uart_num, uart_hw_flowcontrol_t flow_ctrl, uint8_t rx_thresh)
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 263, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 263, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 263, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 263, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 263, "uart_num error"); } } while(0); } while(0); return (-1); };
    if (!((rx_thresh < (128)))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 264, "rx flow thresh error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 264, "rx flow thresh error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 264, "rx flow thresh error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 264, "rx flow thresh error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 264, "rx flow thresh error"); } } while(0); } while(0); return (-1); };
    if (!((flow_ctrl < UART_HW_FLOWCTRL_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 265, "hw_flowctrl mode error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 265, "hw_flowctrl mode error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 265, "hw_flowctrl mode error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 265, "hw_flowctrl mode error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 265, "hw_flowctrl mode error"); } } while(0); } while(0); return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
esp_err_t uart_get_hw_flow_ctrl(uart_port_t uart_num, uart_hw_flowcontrol_t* flow_ctrl)
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 284, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 284, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 284, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 284, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 284, "uart_num error"); } } while(0); } while(0); return (-1); };
...
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 298, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 298, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 298, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 298, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 298, "uart_num error"); } } while(0); } while(0); return (-1); };




    while(UART[uart_num]->status.rxfifo_cnt != 0 || (UART[uart_num]->mem_rx_status.wr_addr != UART[uart_num]->mem_rx_status.rd_addr)) {
        ({ ; (*((volatile uint32_t *)(((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0)))); });
    }
    return 0;
}
...
esp_err_t uart_clear_intr_status(uart_port_t uart_num, uint32_t clr_mask)
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 311, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 311, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 311, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 311, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 311, "uart_num error"); } } while(0); } while(0); return (-1); };
...
esp_err_t uart_enable_intr_mask(uart_port_t uart_num, uint32_t enable_mask)
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 319, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 319, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 319, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 319, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 319, "uart_num error"); } } while(0); } while(0); return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
esp_err_t uart_disable_intr_mask(uart_port_t uart_num, uint32_t disable_mask)
{
    if (!((uart_num < UART_NUM_MAX))) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 329, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, UART_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 329, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, UART_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 329, "uart_num error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, UART_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 329, "uart_num error"); } else { esp_log_write(ESP_LOG_INFO, UART_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 329, "uart_num error"); } } while(0); } while(0); return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
# 803 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c"
                    ...
                    if (p_uart->tx_len_tot > 0 && p_uart->tx_ptr && p_uart->tx_len_cur > 0) {
                        ...
                        if (((p_uart_obj[uart_num]->uart_mode == UART_MODE_RS485_HALF_DUPLEX))) {
                            vTaskEnterCritical(&uart_spinlock[uart_num]);
...
# 927 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c"
            ...
            uart_reg->int_clr.at_cmd_char_det = 1;
            uart_event.type = UART_PATTERN_DET;
        } else if ((uart_intr_status & ((1UL << (17))))
                || (uart_intr_status & ((1UL << (16))))
                || (uart_intr_status & ((1UL << (15))))) {

            uart_clear_intr_status(uart_num, ((1UL << (17))));
            vTaskEnterCritical(&uart_spinlock[uart_num]);
            uart_reset_rx_fifo(uart_num);
...
# 1511 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c"
        ...
        uart_enable_intr_mask(uart_num, ((1UL << (8)))
                                        | ((1UL << (0)))
                                        | ((1UL << (17)))
                                        | ((1UL << (16)))
                                        | ((1UL << (15))));
...
# 1587 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/uart.c"
    ...
    UART[uart_num]->sleep_conf.active_threshold = wakeup_threshold - (2);
    return 0;
}
