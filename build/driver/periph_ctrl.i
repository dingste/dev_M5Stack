# 1 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
# 1 "/home/dieter/Development/ProjektEi/build/driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
# 14 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
...
# 15 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 2
# 1 "/home/dieter/Development/esp-idf/components/soc/esp32/include/soc/syscon_reg.h" 1
# 20 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 2
...
# 21 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 2
...
# 27 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 3 4
                                                       _Bool 
# 27 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
                                                            enable);
...
# 35 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 3 4
   1
# 35 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
   ))))));
...
void periph_module_disable(periph_module_t periph)
{
    ...
    (*((volatile uint32_t *)(((get_clk_en_reg(periph)))))) = (uint32_t)(((DPORT_READ_PERI_REG(get_clk_en_reg(periph))&(~(get_clk_en_mask(periph))))));
    (*((volatile uint32_t *)(((get_rst_en_reg(periph)))))) = (uint32_t)(((DPORT_READ_PERI_REG(get_rst_en_reg(periph))|(get_rst_en_mask(periph, 
# 43 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 3 4
   0
# 43 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
   )))));
    do { if (xPortInIsrContext()) { vTaskExitCritical(&periph_spinlock); } else { vTaskExitCritical(&periph_spinlock); } } while(0);
}
...
void periph_module_reset(periph_module_t periph)
{
    do { if (xPortInIsrContext()) { vTaskEnterCritical(&periph_spinlock); } else { vTaskEnterCritical(&periph_spinlock); } } while(0);
    (*((volatile uint32_t *)(((get_rst_en_reg(periph)))))) = (uint32_t)(((DPORT_READ_PERI_REG(get_rst_en_reg(periph))|(get_rst_en_mask(periph, 
# 50 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 3 4
   0
# 50 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
   )))));
    (*((volatile uint32_t *)(((get_rst_en_reg(periph)))))) = (uint32_t)(((DPORT_READ_PERI_REG(get_rst_en_reg(periph))&(~(get_rst_en_mask(periph, 
# 51 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 3 4
   0
# 51 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
   ))))));
    do { if (xPortInIsrContext()) { vTaskExitCritical(&periph_spinlock); } else { vTaskExitCritical(&periph_spinlock); } } while(0);
}
...
static uint32_t get_clk_en_mask(periph_module_t periph)
{
    switch(periph) {
        ...
        case PERIPH_SPI_DMA_MODULE:
            return ((1UL << (22)));
# 122 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
...
static uint32_t get_rst_en_mask(periph_module_t periph, 
# 159 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 3 4
                                                       _Bool 
# 159 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
                                                            enable)
{
    switch(periph) {
        case PERIPH_RMT_MODULE:
        ...
        case PERIPH_SPI_DMA_MODULE:
            return ((1UL << (22)));
# 226 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
        case PERIPH_SDMMC_MODULE:
            return ((1UL << (6)));
        case PERIPH_SDIO_SLAVE_MODULE:
            return ((1UL << (5)));
        ...
        case PERIPH_AES_MODULE:
            if (enable == 
# 236 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 3 4
                         1
# 236 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
                             ) {
        ...
        case PERIPH_SHA_MODULE:
            if (enable == 
# 244 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 3 4
                         1
# 244 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
                             ) {
        ...
        case PERIPH_RSA_MODULE:
            if (enable == 
# 252 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 3 4
                         1
# 252 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
                             ) {
...
static 
# 271 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 3 4
      _Bool 
# 271 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
           is_wifi_clk_peripheral(periph_module_t periph)
{
    ...
    case PERIPH_BT_LC_MODULE:
        return 
# 285 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 3 4
              1
# 285 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
                  ;
    default:
        return 
# 287 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c" 3 4
              0
# 287 "/home/dieter/Development/esp-idf/components/driver/periph_ctrl.c"
                   ;
    }
}
