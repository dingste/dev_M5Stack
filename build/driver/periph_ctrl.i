# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
# 14 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
...
# 15 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 2
...
# 16 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 2
...
# 17 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 2
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 2
...
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 2
...
# 26 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 3 4
                                                       _Bool 
# 26 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
                                                            enable);
...
void periph_module_enable(periph_module_t periph)
{
    do { if (xPortInIsrContext()) { vTaskEnterCritical(&periph_spinlock); } else { vTaskEnterCritical(&periph_spinlock); } } while(0);
...
# 34 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 3 4
   1
# 34 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
   ))))));
    do { if (xPortInIsrContext()) { vTaskExitCritical(&periph_spinlock); } else { vTaskExitCritical(&periph_spinlock); } } while(0);
}
...
void periph_module_disable(periph_module_t periph)
{
    ...
    (*((volatile uint32_t *)(((get_clk_en_reg(periph)))))) = (uint32_t)(((DPORT_READ_PERI_REG(get_clk_en_reg(periph))&(~(get_clk_en_mask(periph))))));
    (*((volatile uint32_t *)(((get_rst_en_reg(periph)))))) = (uint32_t)(((DPORT_READ_PERI_REG(get_rst_en_reg(periph))|(get_rst_en_mask(periph, 
# 42 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 3 4
   0
# 42 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
   )))));
    do { if (xPortInIsrContext()) { vTaskExitCritical(&periph_spinlock); } else { vTaskExitCritical(&periph_spinlock); } } while(0);
}
...
void periph_module_reset(periph_module_t periph)
{
    do { if (xPortInIsrContext()) { vTaskEnterCritical(&periph_spinlock); } else { vTaskEnterCritical(&periph_spinlock); } } while(0);
    (*((volatile uint32_t *)(((get_rst_en_reg(periph)))))) = (uint32_t)(((DPORT_READ_PERI_REG(get_rst_en_reg(periph))|(get_rst_en_mask(periph, 
# 49 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 3 4
   0
# 49 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
   )))));
    (*((volatile uint32_t *)(((get_rst_en_reg(periph)))))) = (uint32_t)(((DPORT_READ_PERI_REG(get_rst_en_reg(periph))&(~(get_rst_en_mask(periph, 
# 50 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 3 4
   0
# 50 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
   ))))));
    do { if (xPortInIsrContext()) { vTaskExitCritical(&periph_spinlock); } else { vTaskExitCritical(&periph_spinlock); } } while(0);
}
...
static uint32_t get_rst_en_mask(periph_module_t periph, 
# 132 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 3 4
                                                       _Bool 
# 132 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
                                                            enable)
{
    switch(periph) {
        case PERIPH_RMT_MODULE:
        ...
        case PERIPH_AES_MODULE:
            if (enable == 
# 188 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 3 4
                         1
# 188 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
                             ) {
        ...
        case PERIPH_SHA_MODULE:
            if (enable == 
# 196 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 3 4
                         1
# 196 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
                             ) {
        ...
        case PERIPH_RSA_MODULE:
            if (enable == 
# 204 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 3 4
                         1
# 204 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
                             ) {
...
static 
# 222 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 3 4
      _Bool 
# 222 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
           is_wifi_clk_peripheral(periph_module_t periph)
{
    ...
    case PERIPH_BT_LC_MODULE:
        return 
# 236 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 3 4
              1
# 236 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
                  ;
    default:
        return 
# 238 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c" 3 4
              0
# 238 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/periph_ctrl.c"
                   ;
    }
}
