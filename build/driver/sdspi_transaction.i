# 1 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c"
# 1 "/home/dieter/Development/ProjektEi/build/driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c"
# 15 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c"
...
# 16 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c" 2
...
# 21 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c" 2
...
# 23 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c" 2
...
# 24 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c" 2

static const char* TAG = "sdspi_transaction";

static _lock_t s_lock;
static 
# 28 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c" 3 4
      _Bool 
# 28 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c"
           s_app_cmd;

static uint8_t sdspi_msg_crc7(sdspi_hw_cmd_t* hw_cmd)
{
    const size_t bytes_to_crc = 
# 32 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c" 3 4
                               __builtin_offsetof (
# 32 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c"
                               sdspi_hw_cmd_t
# 32 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c" 3 4
                               , 
# 32 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c"
...
{
    if (r1 & (1<<7)) {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "cmd=%d, R1 response not found" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "cmd=%d, R1 response not found" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "cmd=%d, R1 response not found" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "cmd=%d, R1 response not found" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "cmd=%d, R1 response not found" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } } while(0); } while(0);
        *out_err = 0x107;
    } else if (r1 & (1<<3)) {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "cmd=%d, R1 response: command CRC error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "cmd=%d, R1 response: command CRC error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "cmd=%d, R1 response: command CRC error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "cmd=%d, R1 response: command CRC error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "cmd=%d, R1 response: command CRC error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } } while(0); } while(0);
        *out_err = 0x109;
    } else if (r1 & (1<<2)) {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "cmd=%d, R1 response: command not supported" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "cmd=%d, R1 response: command not supported" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "cmd=%d, R1 response: command not supported" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "cmd=%d, R1 response: command not supported" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "cmd=%d, R1 response: command not supported" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } } while(0); } while(0);
        *out_err = 0x106;
    } else if (r1 & (1<<6)) {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "cmd=%d, R1 response: size error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "cmd=%d, R1 response: size error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "cmd=%d, R1 response: size error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "cmd=%d, R1 response: size error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "cmd=%d, R1 response: size error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } } while(0); } while(0);
        *out_err = 0x104;
    } else if (r1 & (1<<4)) {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "cmd=%d, R1 response: function number error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "cmd=%d, R1 response: function number error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "cmd=%d, R1 response: function number error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "cmd=%d, R1 response: function number error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "cmd=%d, R1 response: function number error" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); } } while(0); } while(0);
        *out_err = 0x102;
    } else if (r1 & (1<<0)) {

    } else if (r1 != 0) {
        do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "cmd=%d, R1 response: unexpected value 0x%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd, r1); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "cmd=%d, R1 response: unexpected value 0x%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd, r1); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "cmd=%d, R1 response: unexpected value 0x%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd, r1); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "cmd=%d, R1 response: unexpected value 0x%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd, r1); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "cmd=%d, R1 response: unexpected value 0x%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd, r1); } } while(0); } while(0);
        *out_err = 0x108;
    }
}
...
esp_err_t sdspi_host_do_transaction(int slot, sdmmc_command_t *cmdinfo)
{
    ...
    __attribute__((aligned(4))) sdspi_hw_cmd_t hw_cmd;
    ...
    if (!s_app_cmd && cmdinfo->opcode == 8) {
        ...
        flags |= (1UL << (8));
    } else if (!s_app_cmd && cmdinfo->opcode == 5) {
        flags |= (1UL << (5));
    } else if (!s_app_cmd && cmdinfo->opcode == 52) {
        flags |= (1UL << (6));
    } else if (!s_app_cmd && cmdinfo->opcode == 53) {
        flags |= (1UL << (6)) | (1UL << (0));
        if (cmdinfo->arg & (1<<31)) flags |= (1UL << (1));

        if (cmdinfo->arg & (1<<27)) flags |= (1UL << (9));
    } else {
        flags |= (1UL << (2));
    }
    ...
    if (ret == 0) {
        ...
        s_app_cmd = 
# 184 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c" 3 4
                   0
# 184 "/home/dieter/Development/esp-idf/components/driver/sdspi_transaction.c"
                        ;
    }
