# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
# 1 "/home/dieter/SoftwareDevelop/others/dev_M5Stack/build/driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
# 121 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
...
# 122 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/include/driver/spi_common.h" 1
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/include/driver/spi_common.h"
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/include/driver/spi_common.h" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/xtensa/lib/gcc/xtensa-esp32-elf/5.2.0/include/stdbool.h" 1 3 4
# 21 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/include/driver/spi_common.h" 2
...
# 22 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/include/driver/spi_common.h" 2
...
# 19 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/include/soc/spi_periph.h"
...
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/include/soc/spi_periph.h" 2
...
# 18 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/spi_reg.h"
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/soc/esp32/include/soc/soc.h" 1
...
# 123 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 2
# 1 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/include/driver/spi_master.h" 1
# 20 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/include/driver/spi_master.h"
...
# 125 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 2
...
# 134 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 2
...
# 138 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 2
...
# 144 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 2
...
# 146 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 2

typedef struct spi_device_t spi_device_t;
typedef typeof(SPI1.clock) spi_clock_reg_t;
# 166 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
typedef struct {
...
typedef struct {
    struct { spi_device_t* volatile __val; } device[3];
    intr_handle_t intr;
    spi_dev_t *hw;
...
# 181 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
   _Bool 
# 181 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
        polling;
    
# 182 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
   _Bool 
# 182 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
        isr_free;
    
# 183 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
   _Bool 
# 183 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
        bus_locked;
    lldesc_t *dmadesc_tx;
    lldesc_t *dmadesc_rx;
    uint32_t flags;
...
# 210 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
   _Bool 
# 210 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
               waiting;
};
...
# 228 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
   _Bool 
# 228 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
        spi_chan_claimed, dma_chan_claimed;
    esp_err_t ret = 0;
    esp_err_t err;

    if (!(host!=SPI_HOST)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): ""SPI1 is not supported" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 232); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): ""SPI1 is not supported" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 232); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): ""SPI1 is not supported" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 232); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): ""SPI1 is not supported" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 232); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): ""SPI1 is not supported" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 232); } } while(0); } while(0); return (0x106); };

    if (!(host>=SPI_HOST && host<=VSPI_HOST)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): ""invalid host" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 234); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): ""invalid host" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 234); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): ""invalid host" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 234); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): ""invalid host" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 234); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): ""invalid host" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 234); } } while(0); } while(0); return (0x102); };
    if (!(dma_chan >= 0 && dma_chan <= 2)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): ""invalid dma channel" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 235); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): ""invalid dma channel" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 235); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): ""invalid dma channel" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 235); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): ""invalid dma channel" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 235); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): ""invalid dma channel" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 235); } } while(0); } while(0); return (0x102); };
    if (!((bus_config->intr_flags & (((1<<4)|(1<<5)|(1<<6)|(1<<7))|(1<<9)|(1<<11)))==0)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): ""intr flag not allowed" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 236); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): ""intr flag not allowed" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 236); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): ""intr flag not allowed" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 236); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): ""intr flag not allowed" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 236); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): ""intr flag not allowed" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 236); } } while(0); } while(0); return (0x102); };
    ...
    if ( dma_chan != 0 ) {
        ...
        if ( !dma_chan_claimed ) {
            ...
            if (!(
# 248 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
           0
# 248 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
           )) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): ""dma channel already in use" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 248); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): ""dma channel already in use" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 248); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): ""dma channel already in use" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 248); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): ""dma channel already in use" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 248); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): ""dma channel already in use" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 248); } } while(0); } while(0); return (0x103); };
        }
    }

    spihost[host]=malloc(sizeof(spi_host_t));
    if (spihost[host]==
# 253 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
                      ((void *)0)
# 253 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
                          ) {
        ret = 0x101;
        goto cleanup;
    }
    ...
    __atomic_store_n(&(&spihost[host]->acquire_cs)->__val, 3, memory_order_seq_cst);
    spihost[host]->polling = 
# 302 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
                            0
# 302 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
                                 ;
    spihost[host]->isr_free = 
# 303 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
                             1
# 303 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
                                 ;
    spihost[host]->bus_locked = 
# 304 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
                               0
# 304 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
                                    ;
...
cleanup:
    ...
    free(spihost[host]);
    spihost[host] = 
# 347 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
                   ((void *)0)
# 347 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
                       ;
    spicommon_periph_free(host);
...
{
    int x;
    if (!(host>=SPI_HOST && host<=VSPI_HOST)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): ""invalid host" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 356); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): ""invalid host" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 356); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): ""invalid host" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 356); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): ""invalid host" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 356); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): ""invalid host" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 356); } } while(0); } while(0); return (0x102); };
    if (!(spihost[host]!=
# 357 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
   ((void *)0)
# 357 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
   )) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): ""host not in use" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 357); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): ""host not in use" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 357); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): ""host not in use" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 357); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): ""host not in use" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 357); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): ""host not in use" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 357); } } while(0); } while(0); return (0x103); };
    for (x=0; x<3; x++) {
        if (!(__atomic_load_n(&(&spihost[host]->device[x])->__val, memory_order_seq_cst)==
# 359 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
       ((void *)0)
# 359 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
       )) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, SPI_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): ""not all CSses freed" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 359); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, SPI_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): ""not all CSses freed" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 359); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, SPI_TAG, "D" " (%d) %s: " "%s(%d): ""not all CSses freed" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 359); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, SPI_TAG, "V" " (%d) %s: " "%s(%d): ""not all CSses freed" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 359); } else { esp_log_write(ESP_LOG_INFO, SPI_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): ""not all CSses freed" "\033[0m" "\n", esp_log_timestamp(), SPI_TAG, __FUNCTION__, 359); } } while(0); } while(0); return (0x103); };
    }
    ...
    free(spihost[host]);
    spihost[host]=
# 376 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
                 ((void *)0)
# 376 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
                     ;
    return 0;
}

void spi_get_timing(
# 380 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c" 3 4
                   _Bool 
# 380 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
                        gpio_is_used, int input_delay_ns, int eff_clk, int* dummy_o, int* cycles_remain_o)
{
...
static void __attribute__((section(".iram1" "." "18"))) spi_setup_device(spi_host_t *host, int dev_id )
{
    ...
    spi_device_t *dev = __atomic_load_n(&(&host->device[dev_id])->__val, memory_order_seq_cst);
...
{
    int acquire_cs = __atomic_load_n(&(&dev->host->acquire_cs)->__val, memory_order_seq_cst);
...
# 700 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
       , ( 0 ), ( ( BaseType_t ) 0 ) );
        ...
        int no_cs = 3;
        __atomic_compare_exchange_n(&(&host->acquire_cs)->__val, &no_cs, handle->id, 1, memory_order_seq_cst, memory_order_seq_cst);
        if (__atomic_load_n(&(&host->acquire_cs)->__val, memory_order_seq_cst) != handle->id) {
...
static __attribute__((section(".iram1" "." "21"))) void device_release_bus_internal(spi_host_t *host)
{
    ...
    for (int i = 0; i < 3; i++) {
        ...
        if (dev && dev->waiting) {
            int no_cs = 3;
            __atomic_compare_exchange_n(&(&host->acquire_cs)->__val, &no_cs, i, 1, memory_order_seq_cst, memory_order_seq_cst);
            if (__atomic_load_n(&(&host->acquire_cs)->__val, memory_order_seq_cst) == i) {
...
# 866 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
    ...
    int cmdlen;
    int addrlen;
    if (!(dev->cfg.flags & (1<<4)) && dev->cfg.cs_ena_pretrans != 0) {
...
# 967 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
    ...
    if ((!(dev->cfg.flags & (1<<4)) && trans_buf->buffer_to_rcv) ||
...
static void __attribute__((section(".iram1" "." "24"))) spi_post_trans(spi_host_t *host)
{
    ...
    spi_device_t* dev = __atomic_load_n(&(&host->device[host->cur_cs])->__val, memory_order_seq_cst);
...
static void __attribute__((section(".iram1" "." "25"))) spi_intr(void *arg)
{
    ...
    if (host->cur_cs != 3) {
        ...
        xQueueGenericSendFromISR( ( __atomic_load_n(&(&host->device[cs])->__val, memory_order_seq_cst)->ret_queue ), ( &host->cur_trans_buf ), ( &do_yield ), ( ( BaseType_t ) 0 ) );
...
# 1043 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
    ...
    int acquire_cs = __atomic_load_n(&(&host->acquire_cs)->__val, memory_order_seq_cst);
    if (acquire_cs != 3) {
...
# 1078 "/home/dieter/SoftwareDevelop/oxypoint-am/Prerequisites/esp-idf/components/driver/spi_master.c"
    ...
    if (i != 3) {
        ...
        spi_new_trans(__atomic_load_n(&(&host->device[i])->__val, memory_order_seq_cst), cur_trans_buf);
