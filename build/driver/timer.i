# 1 "/home/dieter/Development/esp-idf/components/driver/timer.c"
# 1 "/home/dieter/Development/ProjektEi/build/driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/driver/timer.c"
# 14 "/home/dieter/Development/esp-idf/components/driver/timer.c"
...
# 15 "/home/dieter/Development/esp-idf/components/driver/timer.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/driver/timer.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/driver/timer.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/driver/timer.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/driver/timer.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/driver/include/driver/timer.h" 2
...
# 21 "/home/dieter/Development/esp-idf/components/driver/timer.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/driver/timer.c" 2
...
# 32 "/home/dieter/Development/esp-idf/components/soc/esp32/include/hal/timer_ll.h"
...
# 23 "/home/dieter/Development/esp-idf/components/driver/timer.c" 2
...
# 24 "/home/dieter/Development/esp-idf/components/driver/timer.c" 2

static const char* TIMER_TAG = "timer_group";
# 40 "/home/dieter/Development/esp-idf/components/driver/timer.c"
__attribute__((section(".dram1" "." "2"))) static timg_dev_t *TG[2] = {&TIMERG0, &TIMERG1};
...
esp_err_t timer_get_counter_value(timer_group_t group_num, timer_idx_t timer_num, uint64_t* timer_val)
{
    ...
    if (!(timer_val != 
# 50 "/home/dieter/Development/esp-idf/components/driver/timer.c" 3 4
   ((void *)0)
# 50 "/home/dieter/Development/esp-idf/components/driver/timer.c"
...
esp_err_t timer_get_counter_time_sec(timer_group_t group_num, timer_idx_t timer_num, double* time)
{
    if (!(group_num < TIMER_GROUP_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 65, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 65, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 65, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 65, "TIMER GROUP NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 65, "TIMER GROUP NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(timer_num < TIMER_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 66, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 66, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 66, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 66, "HW TIMER NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 66, "HW TIMER NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(time != 
# 67 "/home/dieter/Development/esp-idf/components/driver/timer.c" 3 4
   ((void *)0)
# 67 "/home/dieter/Development/esp-idf/components/driver/timer.c"
   )) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 67, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 67, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 67, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 67, "HW TIMER PARAM ADDR ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 67, "HW TIMER PARAM ADDR ERROR"); } } while(0); } while(0); return (0x102); };
...
esp_err_t timer_start(timer_group_t group_num, timer_idx_t timer_num)
{
    if (!(group_num < TIMER_GROUP_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 100, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 100, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 100, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 100, "TIMER GROUP NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 100, "TIMER GROUP NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(timer_num < TIMER_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 101, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 101, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 101, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 101, "HW TIMER NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 101, "HW TIMER NUM ERROR"); } } while(0); } while(0); return (0x102); };
    do { if (xPortInIsrContext()) { vTaskEnterCritical(&timer_spinlock[group_num]); } else { vTaskEnterCritical(&timer_spinlock[group_num]); } } while(0);;
...
esp_err_t timer_pause(timer_group_t group_num, timer_idx_t timer_num)
{
    if (!(group_num < TIMER_GROUP_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 110, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 110, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 110, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 110, "TIMER GROUP NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 110, "TIMER GROUP NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(timer_num < TIMER_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 111, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 111, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 111, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 111, "HW TIMER NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 111, "HW TIMER NUM ERROR"); } } while(0); } while(0); return (0x102); };
    do { if (xPortInIsrContext()) { vTaskEnterCritical(&timer_spinlock[group_num]); } else { vTaskEnterCritical(&timer_spinlock[group_num]); } } while(0);;
...
esp_err_t timer_set_counter_mode(timer_group_t group_num, timer_idx_t timer_num, timer_count_dir_t counter_dir)
{
    if (!(group_num < TIMER_GROUP_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 120, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 120, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 120, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 120, "TIMER GROUP NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 120, "TIMER GROUP NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(timer_num < TIMER_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 121, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 121, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 121, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 121, "HW TIMER NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 121, "HW TIMER NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(counter_dir < TIMER_COUNT_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 122, "HW TIMER COUNTER DIR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 122, "HW TIMER COUNTER DIR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 122, "HW TIMER COUNTER DIR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 122, "HW TIMER COUNTER DIR ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 122, "HW TIMER COUNTER DIR ERROR"); } } while(0); } while(0); return (0x102); };
    do { if (xPortInIsrContext()) { vTaskEnterCritical(&timer_spinlock[group_num]); } else { vTaskEnterCritical(&timer_spinlock[group_num]); } } while(0);;
...
esp_err_t timer_set_auto_reload(timer_group_t group_num, timer_idx_t timer_num, timer_autoreload_t reload)
{
    if (!(group_num < TIMER_GROUP_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 131, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 131, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 131, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 131, "TIMER GROUP NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 131, "TIMER GROUP NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(timer_num < TIMER_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 132, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 132, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 132, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 132, "HW TIMER NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 132, "HW TIMER NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(reload < TIMER_AUTORELOAD_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 133, "HW TIMER AUTORELOAD ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 133, "HW TIMER AUTORELOAD ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 133, "HW TIMER AUTORELOAD ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 133, "HW TIMER AUTORELOAD ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 133, "HW TIMER AUTORELOAD ERROR"); } } while(0); } while(0); return (0x102); };
    do { if (xPortInIsrContext()) { vTaskEnterCritical(&timer_spinlock[group_num]); } else { vTaskEnterCritical(&timer_spinlock[group_num]); } } while(0);;
...
esp_err_t timer_set_divider(timer_group_t group_num, timer_idx_t timer_num, uint32_t divider)
{
    if (!(group_num < TIMER_GROUP_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 142, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 142, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 142, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 142, "TIMER GROUP NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 142, "TIMER GROUP NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(timer_num < TIMER_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 143, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 143, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 143, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 143, "HW TIMER NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 143, "HW TIMER NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(divider > 1 && divider < 65537)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 144, "HW TIMER divider outside of [2, 65536] range error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 144, "HW TIMER divider outside of [2, 65536] range error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 144, "HW TIMER divider outside of [2, 65536] range error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 144, "HW TIMER divider outside of [2, 65536] range error"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 144, "HW TIMER divider outside of [2, 65536] range error"); } } while(0); } while(0); return (0x102); };
    do { if (xPortInIsrContext()) { vTaskEnterCritical(&timer_spinlock[group_num]); } else { vTaskEnterCritical(&timer_spinlock[group_num]); } } while(0);;
...
esp_err_t timer_set_alarm_value(timer_group_t group_num, timer_idx_t timer_num, uint64_t alarm_value)
{
    if (!(group_num < TIMER_GROUP_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 156, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 156, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 156, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 156, "TIMER GROUP NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 156, "TIMER GROUP NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(timer_num < TIMER_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 157, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 157, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 157, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 157, "HW TIMER NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 157, "HW TIMER NUM ERROR"); } } while(0); } while(0); return (0x102); };
    do { if (xPortInIsrContext()) { vTaskEnterCritical(&timer_spinlock[group_num]); } else { vTaskEnterCritical(&timer_spinlock[group_num]); } } while(0);;
...
esp_err_t timer_get_alarm_value(timer_group_t group_num, timer_idx_t timer_num, uint64_t* alarm_value)
{
    ...
    if (!(alarm_value != 
# 169 "/home/dieter/Development/esp-idf/components/driver/timer.c" 3 4
   ((void *)0)
# 169 "/home/dieter/Development/esp-idf/components/driver/timer.c"
   )) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 169, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 169, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 169, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 169, "HW TIMER PARAM ADDR ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 169, "HW TIMER PARAM ADDR ERROR"); } } while(0); } while(0); return (0x102); };
    do { if (xPortInIsrContext()) { vTaskEnterCritical(&timer_spinlock[group_num]); } else { vTaskEnterCritical(&timer_spinlock[group_num]); } } while(0);
...
esp_err_t timer_set_alarm(timer_group_t group_num, timer_idx_t timer_num, timer_alarm_t alarm_en)
{
    ...
    if (!(alarm_en < TIMER_ALARM_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 181, "HW TIMER ALARM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 181, "HW TIMER ALARM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 181, "HW TIMER ALARM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 181, "HW TIMER ALARM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 181, "HW TIMER ALARM ERROR"); } } while(0); } while(0); return (0x102); };
    do { if (xPortInIsrContext()) { vTaskEnterCritical(&timer_spinlock[group_num]); } else { vTaskEnterCritical(&timer_spinlock[group_num]); } } while(0);;
...
{
    if (!(group_num < TIMER_GROUP_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 191, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 191, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 191, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 191, "TIMER GROUP NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 191, "TIMER GROUP NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(timer_num < TIMER_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 192, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 192, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 192, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 192, "HW TIMER NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 192, "HW TIMER NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(fn != 
# 193 "/home/dieter/Development/esp-idf/components/driver/timer.c" 3 4
   ((void *)0)
# 193 "/home/dieter/Development/esp-idf/components/driver/timer.c"
   )) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 193, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 193, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 193, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 193, "HW TIMER PARAM ADDR ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 193, "HW TIMER PARAM ADDR ERROR"); } } while(0); } while(0); return (0x102); };
...
esp_err_t timer_init(timer_group_t group_num, timer_idx_t timer_num, const timer_config_t *config)
{
    if (!(group_num < TIMER_GROUP_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 224, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 224, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 224, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 224, "TIMER GROUP NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 224, "TIMER GROUP NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(timer_num < TIMER_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 225, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 225, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 225, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 225, "HW TIMER NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 225, "HW TIMER NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(config != 
# 226 "/home/dieter/Development/esp-idf/components/driver/timer.c" 3 4
   ((void *)0)
# 226 "/home/dieter/Development/esp-idf/components/driver/timer.c"
   )) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 226, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 226, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 226, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 226, "HW TIMER PARAM ADDR ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 226, "HW TIMER PARAM ADDR ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(config->divider > 1 && config->divider < 65537)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 227, "HW TIMER divider outside of [2, 65536] range error"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 227, "HW TIMER divider outside of [2, 65536] range error"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 227, "HW TIMER divider outside of [2, 65536] range error"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 227, "HW TIMER divider outside of [2, 65536] range error"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 227, "HW TIMER divider outside of [2, 65536] range error"); } } while(0); } while(0); return (0x102); };
...
esp_err_t timer_get_config(timer_group_t group_num, timer_idx_t timer_num, timer_config_t *config)
{
    ...
    if (!(timer_num < TIMER_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 261, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 261, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 261, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 261, "HW TIMER NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 261, "HW TIMER NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(config != 
# 262 "/home/dieter/Development/esp-idf/components/driver/timer.c" 3 4
   ((void *)0)
# 262 "/home/dieter/Development/esp-idf/components/driver/timer.c"
   )) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 262, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 262, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 262, "HW TIMER PARAM ADDR ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 262, "HW TIMER PARAM ADDR ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 262, "HW TIMER PARAM ADDR ERROR"); } } while(0); } while(0); return (0x102); };
    do { if (xPortInIsrContext()) { vTaskEnterCritical(&timer_spinlock[group_num]); } else { vTaskEnterCritical(&timer_spinlock[group_num]); } } while(0);;
...
esp_err_t timer_enable_intr(timer_group_t group_num, timer_idx_t timer_num)
{
    if (!(group_num < TIMER_GROUP_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 297, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 297, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 297, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 297, "TIMER GROUP NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 297, "TIMER GROUP NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(timer_num < TIMER_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 298, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 298, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 298, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 298, "HW TIMER NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 298, "HW TIMER NUM ERROR"); } } while(0); } while(0); return (0x102); };
    return timer_group_intr_enable(group_num, ((timer_num)==TIMER_0? TIMER_INTR_T0: TIMER_INTR_T1));
}

esp_err_t timer_disable_intr(timer_group_t group_num, timer_idx_t timer_num)
{
    if (!(group_num < TIMER_GROUP_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 304, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 304, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 304, "TIMER GROUP NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 304, "TIMER GROUP NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 304, "TIMER GROUP NUM ERROR"); } } while(0); } while(0); return (0x102); };
    if (!(timer_num < TIMER_MAX)) { do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TIMER_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 305, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TIMER_TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 305, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TIMER_TAG, "D" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 305, "HW TIMER NUM ERROR"); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TIMER_TAG, "V" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 305, "HW TIMER NUM ERROR"); } else { esp_log_write(ESP_LOG_INFO, TIMER_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), TIMER_TAG, __FUNCTION__, 305, "HW TIMER NUM ERROR"); } } while(0); } while(0); return (0x102); };
    return timer_group_intr_disable(group_num, ((timer_num)==TIMER_0? TIMER_INTR_T0: TIMER_INTR_T1));
}

timer_intr_t __attribute__((section(".iram1" "." "3"))) timer_group_intr_get_in_isr(timer_group_t group_num)
{
    return timer_ll_intr_status_get(TG[group_num]);
}

void __attribute__((section(".iram1" "." "4"))) timer_group_intr_clr_in_isr(timer_group_t group_num, timer_idx_t timer_num)
{
    timer_ll_intr_status_clear(TG[group_num], ((timer_num)==TIMER_0? TIMER_INTR_T0: TIMER_INTR_T1));
}

void __attribute__((section(".iram1" "." "5"))) timer_group_enable_alarm_in_isr(timer_group_t group_num, timer_idx_t timer_num)
{
    timer_ll_set_alarm_enable(TG[group_num], timer_num, 
# 321 "/home/dieter/Development/esp-idf/components/driver/timer.c" 3 4
                                                       1
# 321 "/home/dieter/Development/esp-idf/components/driver/timer.c"
                                                           );
}

uint64_t __attribute__((section(".iram1" "." "6"))) timer_group_get_counter_value_in_isr(timer_group_t group_num, timer_idx_t timer_num)
{
    uint64_t val;
...
void __attribute__((section(".iram1" "." "7"))) timer_group_set_alarm_value_in_isr(timer_group_t group_num, timer_idx_t timer_num, uint64_t alarm_val)
{
    timer_ll_set_alarm_value(TG[group_num], timer_num, alarm_val);
}

void __attribute__((section(".iram1" "." "8"))) timer_group_set_counter_enable_in_isr(timer_group_t group_num, timer_idx_t timer_num, timer_start_t counter_en)
{
    timer_ll_set_counter_enable(TG[group_num], timer_num, counter_en);
}

void __attribute__((section(".iram1" "." "9"))) timer_group_clr_intr_sta_in_isr(timer_group_t group_num, timer_intr_t intr_mask)
{
    timer_ll_intr_status_clear(TG[group_num], intr_mask);
}


# 346 "/home/dieter/Development/esp-idf/components/driver/timer.c" 3 4
_Bool 
# 346 "/home/dieter/Development/esp-idf/components/driver/timer.c"
    __attribute__((section(".iram1" "." "10"))) timer_group_get_auto_reload_in_isr(timer_group_t group_num, timer_idx_t timer_num)
{
