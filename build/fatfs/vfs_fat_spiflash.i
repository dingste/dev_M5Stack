# 1 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
# 1 "/home/dieter/Development/ProjektEi/build/fatfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
# 15 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
...
# 16 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 2
...
# 21 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 2

# 1 "/home/dieter/Development/esp-idf/components/fatfs/diskio/diskio_rawflash.h" 1
# 30 "/home/dieter/Development/esp-idf/components/fatfs/diskio/diskio_rawflash.h"
...
# 24 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 2


# 1 "/home/dieter/Development/esp-idf/components/fatfs/diskio/diskio_wl.h" 1
# 31 "/home/dieter/Development/esp-idf/components/fatfs/diskio/diskio_wl.h"
...
# 27 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 2
    ...
    wl_handle_t* wl_handle)
{
    ...
    void *workbuf = 
# 36 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 3 4
                   ((void *)0)
# 36 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
                       ;
    ...
    if (data_partition == 
# 42 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 3 4
                         ((void *)0)
# 42 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
                             ) {
    ...
    if (fresult != FR_OK) {
        ...
        if (workbuf == 
# 84 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 3 4
                      ((void *)0)
# 84 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
                          ) {
            result = 0x101;
            goto fail;
        }
        ...
        free(workbuf);
        workbuf = 
# 99 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 3 4
                 ((void *)0)
# 99 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
                     ;
...
# 113 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 3 4
   ((void *)0)
# 113 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
   );
    return result;
}
...
esp_err_t esp_vfs_fat_spiflash_unmount(const char *base_path, wl_handle_t wl_handle)
{
    ...
    f_mount(0, drv, 0);
    ff_diskio_register(pdrv, 
# 126 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 3 4
   ((void *)0)
# 126 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
   );
    ...
    const esp_vfs_fat_mount_config_t* mount_config)
{
    ...
    if (data_partition == 
# 143 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 3 4
                         ((void *)0)
# 143 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
                             ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } } while(0); } while(0);
        return 0x105;
    }
...
fail:
    esp_vfs_fat_unregister_path(base_path);
    ff_diskio_register(pdrv, 
# 183 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 3 4
   ((void *)0)
# 183 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
   );
    return result;
}
...
esp_err_t esp_vfs_fat_rawflash_unmount(const char *base_path, const char* partition_label)
{
    ...
    if (data_partition == 
# 193 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 3 4
                         ((void *)0)
# 193 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
                             ) {
        do { if ( 3 >= ESP_LOG_ERROR ) do { if (ESP_LOG_ERROR==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else if (ESP_LOG_ERROR==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "Failed to find FATFS partition (type='data', subtype='fat', partition_label='%s'). Check the partition table." "\033[0m" "\n", esp_log_timestamp(), TAG, partition_label); } } while(0); } while(0);
        return 0x105;
    }
    ...
    f_mount(0, drv, 0);
    ff_diskio_register(pdrv, 
# 205 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c" 3 4
   ((void *)0)
# 205 "/home/dieter/Development/esp-idf/components/fatfs/vfs/vfs_fat_spiflash.c"
   );
    esp_err_t err = esp_vfs_fat_unregister_path(base_path);
    return err;
}
