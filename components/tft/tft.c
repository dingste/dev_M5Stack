...
#include "tftspi.h"
#include "../../main/HardwareLife/Lcd/Defines_Lcd.h"
...
void TFT_setFont(uint8_t font, const char *font_file) {
	...
	else if (font == BIGNUMBER_FONT) cfont.font = MontserratEB90;
	else if (font == SMALLNUMBER_FONT) cfont.font = MontserratSB24;
	else if (font == TEXT_FONT) cfont.font = MontserratR20;
...
/*
void listSpiff(char *path, char *match) {
