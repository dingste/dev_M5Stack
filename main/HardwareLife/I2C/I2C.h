...
public:
 ...
 //   static const gpio_num_t DEFAULT_CLK_PIN = GPIO_NUM_26;
    ...
    I2C(const gpio_num_t SDA_PIN, const gpio_num_t CLK_PIN, i2c_port_t I2C_NUM);
    void beginTransaction();
    void endTransaction();
    uint8_t getAddress() const;
    void init(uint8_t address, gpio_num_t sdaPin, gpio_num_t sclPin, uint32_t clkSpeed, i2c_port_t portNum, bool pullup = true);
